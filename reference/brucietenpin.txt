...
void sub_1369(unknown uParam0)
{
    ...
    iVar8 = 11;
    bVar9 = false;
    if ((g_U22274[iVar3]._fU144 == 9) || (g_U22274[iVar3]._fU144 == 4))
    {
        bVar9 = true;
    }
    if (bVar9)
...
void sub_14634()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_14672( 5, g_U569[I] )) == 1))
        {
...
void sub_21036()
{
    ...
    l_U108 = 0;
    if ((NOT (IS_CHAR_DEAD( l_U276 ))) AND (NOT (l_U276 == nil)))
    {
...
void sub_22691()
{
    ...
    {
        iVar3 = sub_22719( 13 );
        if ((g_U9932[g_U9999[I]._fU0]._fU0) AND (sub_22764( 13, iVar3 )))
        {
    ...
    {
        iVar3 = sub_22719( 11 );
        if ((g_U9932[g_U10090[I]._fU0]._fU0) AND (sub_22764( 11, iVar3 )))
        {
    ...
    {
        iVar3 = sub_23197( I );
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_22764( g_U10324[I]._fU12, iVar3 )))
        {
...
void sub_23734()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_23197( I )))
        {
            iVar4++;
        }
    }
...
void sub_29313()
{
    ...
    {
        STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_1495(), ref uVar2 );
        if ((NOT (IS_CHAR_IN_MODEL( sub_1495(), -488123221 ))) AND (NOT (IS_CHAR_IN_MODEL( sub_1495(), 837858166 ))))
        {
...
int sub_32243()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_14672( 1, g_U569[I] )) != 0))
        {
            sub_14958( I );
            return 1;
        }
...
int sub_39650()
{
    ...
    fVar3 = 0.00000000;
    GET_CAR_SPEED( uVar2, ref fVar3 );
    if ((sub_39725( 1, 1 )) AND (fVar3 < 0.01000000))
    {
        if (NOT l_U113)
        {
...
int sub_40088()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    bVar3 = false;
    if ((IS_PLAYER_PRESSING_HORN( sub_4002() )) AND ((sub_39725( 1, 1 )) AND (IS_CHAR_IN_ANY_CAR( sub_1495() ))))
    {
        if (l_U113)
        {
            return 0;
...
int sub_40692(unknown uParam0, unknown uParam1)
{
    ...
    iVar11 = 0;
    if ((NOT l_U119) AND (IS_CHAR_IN_ANY_CAR( sub_1495() )))
    {
...
void sub_46704()
{
    ...
    sub_47037( iVar3[8], 1199.12800000, -683.22090000, 17.80500000, 273.93520000, 1196.14900000, -694.14830000, 20.29530000, -13.84020000, 0.00000000, -18.34430000 );
...
void sub_51665()
{
    ...
    sub_51993( iVar3[30], -437.20600000, 463.31500000, 11.30600000, 273.22870000, -451.98690000, 469.22640000, 14.42270000, -12.98044000, 0.00000000, -130.48930000 );
        ...
        for ( I = 0; I < 2; I++ )
        {
            if (l_U337 == -1)
            {
                if (sub_53792( I ))
                {
                    ...
                    if ((NOT (sub_38627( sub_1495() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1495(), l_U401[I]._fU4._fU0, l_U401[I]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar7 )))
                    {
...
int sub_60232(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, boolean bParam5, unknown uParam6)
{
    ...
    if (bVar10)
    {
        ...
        {
            if ((NOT (IS_CHAR_DEAD( iParam1 ))) AND (NOT (IS_CHAR_DEAD( sub_1495() ))))
            {
                TASK_LEAVE_ANY_CAR( sub_1495() );
    ...
    if (l_U325 == 7)
    {
        ...
        else if ((IS_CHAR_DEAD( iParam1 )) || (IS_CHAR_DEAD( sub_1495() )))
        {
            l_U325++;
        }
        else
    ...
    if (l_U325 == 12)
    {
        ...
        if ((TIMERA() > 7000) || (sub_70694( iParam1, l_U359 )))
        {
            l_U325++;
        }
    }
...
void sub_72033(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    sub_75041( uParam2 );
    sub_75181();
    if ((l_U868._fU8) AND (NOT (IS_CHAR_DEAD( sub_1495() ))))
    {
...
int sub_82724(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 5; Result++ )
    {
        ...
        if ((NOT (sub_82859( iVar4 ))) AND (sub_82796( Result )))
        {
            iVar5 = g_U10324[iVar4]._fU28 == g_U9937;
            fVar6 = l_U802[Result]._fU4._fU8;
            if ((NOT (sub_38627( sub_1495() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1495(), l_U802[Result]._fU4._fU0, l_U802[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )))
            {
...
int sub_83210(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_83269( Result ))
        {
            ...
            if ((NOT (sub_38627( sub_1495() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1495(), l_U429[Result]._fU4._fU0, l_U429[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )))
            {
                if (sub_83067( uParam0 ))
                {
                    return Result;
...
int sub_98631(unknown uParam0)
{
    ...
    if ((sub_98721( uParam0, "Bada_room1" )) || ((sub_98721( uParam0, "Bada_room2" )) || ((sub_98721( uParam0, "Bada-Private" )) || (sub_98721( uParam0, "Bada_room1" )))))
    {
        return 1;
    }
    if ((sub_98721( uParam0, "clammainroom" )) || ((sub_98721( uParam0, "clamfronrm" )) || ((sub_98721( uParam0, "clampalbkrm" )) || (sub_98721( uParam0, "clammainroom" )))))
    {
        return 1;
    }
    return 0;
...
void sub_99664(unknown uParam0)
{
    ...
    if (l_U344._fU12)
    {
        if (g_U22274[l_U158]._fU688._fU24 >= 0)
        {
            ...
            if (NOT l_U344._fU24)
            {
                if (((sub_83982( l_U147 )) > 5) || (sub_99720( ref l_U147 )))
                {
                    bVar5 = true;
                }
            }
...
void sub_100325()
{
    ...
    if ((NOT (sub_38627( sub_1495() ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_1495() )))
    {
        sub_3575( "MF10AUD" );
        sub_3694( 0, sub_1495(), "NIKO", 0 );
...
int sub_101437(unknown uParam0)
{
    ...
    if ((l_U344._fU24) || (sub_101446()))
    {
        return 0;
    }
    if (NOT l_U344._fU8)
    {
        if ((NOT (IS_CHAR_DEAD( uParam0 ))) AND (NOT (IS_CHAR_DEAD( sub_1495() ))))
        {
            if (IS_CHAR_IN_ANY_CAR( sub_1495() ))
            {
                STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_1495(), ref uVar3 );
