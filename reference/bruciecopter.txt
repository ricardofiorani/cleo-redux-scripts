...
void sub_15360()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_15398( 5, g_U569[I] )) == 1))
        {
...
int sub_28412()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_15398( 1, g_U569[I] )) != 0))
        {
            sub_15684( I );
            return 1;
        }
...
int sub_37301()
{
    ...
    fVar3 = 0.00000000;
    GET_CAR_SPEED( uVar2, ref fVar3 );
    if ((sub_37376( 1, 1 )) AND (fVar3 < 0.01000000))
    {
        if (NOT l_U113)
        {
...
int sub_37739()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    bVar3 = false;
    if ((IS_PLAYER_PRESSING_HORN( sub_4728() )) AND ((sub_37376( 1, 1 )) AND (IS_CHAR_IN_ANY_CAR( sub_1328() ))))
    {
        if (l_U113)
        {
            return 0;
    ...
    switch (l_U793)
    {
        ...
        if (l_U328 == 0)
        {
            ...
            if (l_U795 == nil)
            {
                ...
                {
                    sub_45809( 843.97410000, -148.49150000, 13.41214000, -2.79368900, 0.00000000, -28.41207000, 45, l_U794 );
                    if (DOES_CAM_EXIST( l_U794 ))
                    {
                        POINT_CAM_AT_PED( l_U794, sub_1328() );
                    }
        ...
        break;
        case 2:
        if ((sub_46731()) || (sub_46521( 8, ref l_U141 )))
        {
            l_U325++;
        }
        break;
