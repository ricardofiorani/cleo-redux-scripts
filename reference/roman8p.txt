    ...
    while (true)
    {
        ...
        switch (l_U483)
        {
            ...
            if (sub_1464( iVar14 ))
            {
                ...
                {
                    if ((NOT sub_2460()) || ((sub_2404( 0 )) || ((sub_2353()) || (LOCATE_CHAR_ANY_MEANS_2D( sub_2265(), 809.85820000, -262.74130000, 150.00000000, 150.00000000, 0 )))))
                    {
                    ...
                    {
                        l_U486 = 0;
                        if ((LOCATE_CHAR_ANY_MEANS_2D( sub_2265(), g_U64764._fU0, g_U64764._fU4, 150.00000000, 150.00000000, 0 )) AND (g_U64767))
                        {
                            l_U486 = 1;
                        }
                        if (NOT sub_2460())
                        ...
                        else
                        {
                            ...
                            {
                                if ((IS_CAR_IN_WATER( l_U570 )) || ((CHECK_STUCK_TIMER( g_U64761, 0, 5000 )) || ((CHECK_STUCK_TIMER( g_U64761, 1, 40000 )) || ((CHECK_STUCK_TIMER( g_U64761, 2, 30000 )) || (CHECK_STUCK_TIMER( g_U64761, 3, 60000 ))))))
                                {
                            ...
                            else if (IS_CHAR_IN_ANY_CAR( sub_2265() ))
                            {
                                ...
                                if (IS_VEH_DRIVEABLE( l_U570 ))
                                {
                                    ...
                                    {
                                        if ((IS_CAR_IN_WATER( l_U570 )) || ((CHECK_STUCK_TIMER( l_U570, 0, 5000 )) || ((CHECK_STUCK_TIMER( l_U570, 1, 40000 )) || ((CHECK_STUCK_TIMER( l_U570, 2, 30000 )) || (CHECK_STUCK_TIMER( l_U570, 3, 60000 ))))))
                                        {
            ...
            case 1:
            l_U484 = 0;
            if ((NOT g_U91._fU580) AND (NOT g_U10978))
            {
                sub_8838();
            }
            else
...
int sub_2686(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_2265() ))) AND (IS_CHAR_IN_ANY_CAR( sub_2265() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_3239()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
int sub_14494()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_9347( 1, g_U569[I] )) != 0))
        {
            sub_9598( I );
            return 1;
        }
