void main()
{
    ...
    l_U711 = {697.07280000, -305.23360000, 9.87040000};
    ...
    l_U723 = {690.05290000, -305.16500000, 22.88690000};
...
void sub_2077()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_2115( 5, g_U569[I] )) == 1))
        {
...
void sub_3748()
{
    ...
    if (NOT (IS_CHAR_DEAD( sub_2988() )))
    {
        ...
        if (IS_CHAR_IN_ANY_CAR( sub_2988() ))
        {
            ...
            {
                if ((IS_CAR_MODEL( l_U570, 2027357303 )) || ((IS_CAR_MODEL( l_U570, 353883353 )) || ((IS_CAR_MODEL( l_U570, 837858166 )) || (IS_CAR_MODEL( l_U570, -1660661558 )))))
                {
                    SET_CHAR_COORDINATES( sub_2988(), 787.54210000, -197.84740000, 5.91600000 );
                    SET_CHAR_HEADING( sub_2988(), 116.63840000 );
                }
                else if ((IS_CAR_MODEL( l_U570, -488123221 )) || ((IS_CAR_MODEL( l_U570, -1043459709 )) || ((IS_CAR_MODEL( l_U570, 1759673526 )) || ((IS_CAR_MODEL( l_U570, 290013743 )) || ((IS_CAR_MODEL( l_U570, 1064455782 )) || ((IS_CAR_MODEL( l_U570, 1033245328 )) || ((IS_CAR_MODEL( l_U570, 861409633 )) || (IS_CAR_MODEL( l_U570, 400514754 )))))))))
                {
    ...
    while ((NOT (HAS_MODEL_LOADED( 237497537 ))) || ((NOT (HAS_MODEL_LOADED( -1341473171 ))) || ((NOT (HAS_MODEL_LOADED( -459749237 ))) || ((NOT (HAS_MODEL_LOADED( 1983427299 ))) || ((NOT (HAS_MODEL_LOADED( 1185749008 ))) || ((NOT (HAS_MODEL_LOADED( 904750859 ))) || ((NOT (HAS_MODEL_LOADED( l_U596 ))) || (NOT (HAS_MODEL_LOADED( l_U596 ))))))))))
    {
        WAIT( 0 );
    }
    ...
    while ((NOT (HAVE_ANIMS_LOADED( "LIFT_BOX" ))) || (NOT (HAVE_ANIMS_LOADED( "MISSFINALE1B" ))))
    {
        WAIT( 0 );
    }
    sub_6036();
    ...
    CREATE_OBJECT( -459749237, 754.65800000, -217.91900000, 4.83930000, ref l_U574, 1 );
    ...
    sub_11112();
    sub_11437( 1 );
    if ((NOT (IS_CHAR_DEAD( l_U499[1] ))) AND ((NOT (IS_CHAR_DEAD( l_U499[0] ))) AND ((NOT (IS_CHAR_DEAD( l_U556[2] ))) AND ((NOT (IS_CHAR_DEAD( l_U556[1] ))) AND (NOT (IS_CHAR_DEAD( l_U556[0] )))))))
    {
...
void sub_6036()
{
    l_U726[0] = {755.66730000, -216.50860000, 4.81880000};
    ...
    l_U736[1] = {732.09200000, -238.85130000, 8.87790000};
    ...
    l_U736[8] = {707.47200000, -242.82430000, 8.87119900};
    ...
    l_U736[15] = {672.45640000, -324.08000000, 8.87240100};
    ...
    l_U856[1] = {704.10640000, -299.67800000, 8.87420000};
    ...
    l_U875[0] = {713.01470000, -252.21060000, 15.25670000};
    ...
    l_U892[3] = {702.09340000, -283.75620000, 3.22810000};
    ...
    l_U915[0] = {689.30620000, -315.08730000, 3.09340000};
...
void sub_9195()
{
    ...
    for ( I = 0; I <= 16; I++ )
    {
        ...
        else if ((HAS_CHAR_GOT_WEAPON( l_U503[I], 10 )) || (HAS_CHAR_GOT_WEAPON( l_U503[I], 12 )))
        {
    ...
    SET_CHAR_ANGLED_DEFENSIVE_AREA( l_U503[16], 724.90990000, -219.46000000, 8.18000000, 714.96990000, -215.27000000, 12.24000000, 12 );
    return;
}
...
void sub_12508()
{
    ...
    if ((l_U631) || (IS_SCREEN_FADED_IN()))
    {
        if ((NOT IS_SCREEN_FADING()) AND (((l_U631) || (TIMERA() >= 1000)) AND ((NOT (l_U1026 == 6)) AND ((NOT (l_U1026 == 0)) AND ((l_U631) || (sub_12535()))))))
        {
            CLEAR_PRINTS();
            if (NOT l_U631)
            {
    ...
    switch (l_U1026)
    {
        ...
        SET_CAM_POS( l_U600, 751.94140000, -210.10920000, 6.23417300 );
        ...
        while ((NOT (HAS_CAR_RECORDING_BEEN_LOADED( 331 ))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 330 ))))
        {
            WAIT( 0 );
        }
        ...
        if ((TIMERB() >= 4000) AND (l_U1011 == 0))
        {
            PRINT_NOW( "FIN1B_CUT1", 7500, 1 );
            l_U1011 = 1;
        }
        if ((IS_VEH_DRIVEABLE( l_U568 )) AND ((TIMERB() >= 2000) AND (NOT l_U633)))
        {
            START_PLAYBACK_RECORDED_CAR( l_U568, 330 );
            l_U633 = 1;
        }
        if ((IS_VEH_DRIVEABLE( l_U569 )) AND ((TIMERB() >= 2000) AND (NOT l_U634)))
        {
            START_PLAYBACK_RECORDED_CAR( l_U569, 331 );
            l_U634 = 1;
        }
        if ((DOES_OBJECT_EXIST( l_U575 )) AND ((DOES_OBJECT_EXIST( l_U574 )) AND ((NOT (IS_CHAR_DEAD( l_U499[1] ))) AND ((NOT (IS_CHAR_DEAD( l_U499[0] ))) AND ((TIMERB() >= 1900) AND (NOT l_U635))))))
        {
        ...
        if (TIMERB() >= 12000)
        {
            ...
            if ((NOT (IS_CHAR_INJURED( l_U556[0] ))) AND (NOT (IS_CHAR_INJURED( l_U496 ))))
            {
        ...
        break;
        case 2:
        if ((TIMERB() >= 600) AND (l_U1011 == 1))
        {
            PRINT_NOW( "FIN1B_CUT2", 7500, 1 );
            l_U1011 = 2;
        }
        if ((l_U1012 == 0) AND (TIMERB() >= 8000))
        {
            sub_15889( "FIN1B_SHIP", 0, 1, ref l_U613, 7, 1 );
            SET_CAM_POS( l_U599, 693.66480000, -293.59940000, 3.43608500 );
        ...
        if ((l_U1012 == 1) AND (TIMERB() >= 4000))
        {
            ...
            SET_CAM_POS( l_U600, 708.03460000, -293.84850000, 18.88340000 );
            SET_CAM_ROT( l_U600, 11.70112000, -0.00000000, 120.88680000 );
            ...
            LOAD_SCENE( 705.90100000, -307.87630000, 14.66784000 );
            WAIT( 2200 );
            BEGIN_CAM_COMMANDS( ref l_U602 );
...
void sub_19243()
{
    ...
    for ( I = 0; I <= 3; I++ )
    {
        ...
        else if ((HAS_CHAR_GOT_WEAPON( l_U521[I], 10 )) || (HAS_CHAR_GOT_WEAPON( l_U521[I], 12 )))
        {
...
void sub_20917()
{
    ...
    if (NOT l_U641)
    {
        if (NOT l_U639)
        {
            ...
            {
                if ((NOT (IS_CHAR_INJURED( l_U499[2] ))) AND (NOT l_U639))
                {
        ...
        {
            if ((l_U640) || (TIMERA() >= 14000))
            {
                if ((NOT (sub_22957( l_U625 ))) AND (NOT (IS_CHAR_INJURED( l_U499[2] ))))
                {
        ...
        if ((NOT (sub_22957( l_U625 ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_2988(), 748.52000000, -211.59470000, 7.88690000, 1.50000000, 1.50000000, 1.50000000, 0 )))
        {
            sub_22711( "FIN1B_SHIP2", ref l_U625, 7, 1 );
            sub_23152();
        }
    ...
    if ((NOT l_U641) AND (NOT l_U638))
    {
        ...
        for ( I = 0; I <= 2; I++ )
        {
            if (NOT (IS_CHAR_DEAD( l_U499[I] )))
            {
                ...
                if (((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U499[I], sub_2988() )) AND ((LOCATE_CHAR_ANY_MEANS_2D( sub_2988(), l_U1006, l_U1007, 9, 9, 0 )) AND (IS_CHAR_ARMED( sub_2988(), 7 )))) || (((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U499[I], sub_2988() )) AND ((LOCATE_CHAR_ANY_MEANS_2D( sub_2988(), l_U1006, l_U1007, 12, 12, 0 )) AND ((IS_CHAR_ARMED( sub_2988(), 7 )) AND ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_3568(), l_U499[I] )) || (IS_PLAYER_TARGETTING_CHAR( sub_3568(), l_U499[I] )))))) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U499[I], sub_2988(), 0 ))))
                {
                    bVar2 = true;
                }
            }
        ...
        {
            if ((NOT (IS_CHAR_IN_ANY_CAR( l_U497 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U497, sub_2988(), 0 )))
            {
                bVar2 = true;
            }
        }
    ...
    if (NOT l_U644)
    {
        if ((DOES_CHAR_EXIST( l_U499[0] )) AND (IS_CHAR_DEAD( l_U499[0] )))
        {
    ...
    GET_CHAR_COORDINATES( sub_2988(), ref l_U1006, ref l_U1007, ref l_U1008 );
    if ((NOT l_U651) AND (l_U1008 > 20.00000000))
    {
        if ((LOCATE_CHAR_ON_FOOT_3D( sub_2988(), 683.72000000, -302.61000000, 22.97000000, 1.20000000, 1.20000000, 1.80000000, 0 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_2988(), l_U705._fU0, l_U705._fU4, l_U705._fU8, 1.20000000, 1.20000000, 1.80000000, 0 )))
        {
            l_U651 = 1;
        }
    }
...
void sub_20952()
{
    ...
    for ( I = 0; I <= 16; I++ )
    {
        if ((IS_CHAR_DEAD( l_U503[I] )) AND (DOES_CHAR_EXIST( l_U503[I] )))
        {
    ...
    for ( I = 0; I <= 6; I++ )
    {
        if ((IS_CHAR_DEAD( l_U530[I] )) AND (DOES_CHAR_EXIST( l_U530[I] )))
        {
    ...
    for ( I = 0; I <= 2; I++ )
    {
        if ((IS_CHAR_DEAD( l_U499[I] )) AND (DOES_CHAR_EXIST( l_U499[I] )))
        {
    ...
    for ( I = 0; I <= 3; I++ )
    {
        if ((IS_CHAR_DEAD( l_U521[I] )) AND (DOES_CHAR_EXIST( l_U521[I] )))
        {
    ...
    for ( I = 0; I <= 2; I++ )
    {
        if ((IS_CHAR_DEAD( l_U526[I] )) AND (DOES_CHAR_EXIST( l_U526[I] )))
        {
    ...
    for ( I = 0; I <= 0; I++ )
    {
        if ((IS_CHAR_DEAD( l_U538[I] )) AND (DOES_CHAR_EXIST( l_U538[I] )))
        {
    ...
    for ( I = 0; I <= 5; I++ )
    {
        if ((IS_CHAR_DEAD( l_U540[I] )) AND (DOES_CHAR_EXIST( l_U540[I] )))
        {
    ...
    for ( I = 0; I <= 5; I++ )
    {
        if ((IS_CHAR_DEAD( l_U547[I] )) AND (DOES_CHAR_EXIST( l_U547[I] )))
        {
            MARK_CHAR_AS_NO_LONGER_NEEDED( ref l_U547[I] );
        }
    }
    if ((IS_CHAR_DEAD( l_U497 )) AND (DOES_CHAR_EXIST( l_U497 )))
    {
...
void sub_21624()
{
    ...
    if (NOT l_U672)
    {
        ...
        {
            PLAY_SOUND_FROM_POSITION( -1, "FIN1B_KILL_DIMITRI_FIN1B_MA_01_INSIDE", 683.72020000, -316.69130000, 16.76225000 );
            l_U672 = 1;
        }
    }
    if (NOT l_U673)
...
void sub_22086()
{
    ...
    for ( I = 0; I <= 2; I++ )
    {
        ...
        else if ((HAS_CHAR_GOT_WEAPON( l_U526[I], 10 )) || (HAS_CHAR_GOT_WEAPON( l_U526[I], 12 )))
        {
...
void sub_25032()
{
    if (NOT l_U674[0])
    {
        ...
        {
            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U503[11], sub_2988(), 0 )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U503[11], sub_2988(), 10.00000000, 10.00000000, 10.00000000, 0 )))
            {
                l_U674[0] = 1;
                l_U680[0] = 1;
            }
    ...
    if ((NOT l_U680[0]) AND (l_U674[0]))
    {
        if (NOT (IS_CHAR_INJURED( l_U503[11] )))
        {
            GET_SCRIPT_TASK_STATUS( l_U503[11], 29, ref l_U612 );
            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U503[11], sub_2988(), 7.00000000, 7.00000000, 7.00000000, 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U503[11], sub_2988(), 0 )) || (l_U612 == 7)))
            {
                l_U680[0] = 1;
    ...
    if (NOT l_U674[1])
    {
        if (IS_CHAR_IN_ANGLED_AREA_3D( sub_2988(), 702.50000000, -308.77000000, 8.79000000, 704.00000000, -305.82000000, 13.59000000, 12.00000000, 0 ))
        {
            if (NOT (IS_CHAR_INJURED( l_U503[12] )))
            {
                OPEN_SEQUENCE_TASK( ref l_U611 );
                TASK_FLUSH_ROUTE();
                TASK_EXTEND_ROUTE( 681.80020000, -297.33090000, 8.87119900 );
                TASK_FOLLOW_POINT_ROUTE( 0, 3, 0 );
        ...
        {
            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U503[12], sub_2988(), 0 )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U503[12], sub_2988(), 7.00000000, 7.00000000, 7.00000000, 0 )))
            {
                l_U674[1] = 1;
                l_U680[1] = 1;
            }
    ...
    if ((NOT l_U680[1]) AND (l_U674[1]))
    {
        if (NOT (IS_CHAR_INJURED( l_U503[12] )))
        {
            GET_SCRIPT_TASK_STATUS( l_U503[12], 29, ref l_U612 );
            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U503[12], sub_2988(), 5.00000000, 5.00000000, 5.00000000, 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U503[12], sub_2988(), 0 )) || (l_U612 == 7)))
            {
                l_U680[1] = 1;
    ...
    if (NOT l_U674[2])
    {
        if (IS_CHAR_IN_ANGLED_AREA_3D( sub_2988(), 733.14000000, -243.45000000, 8.79000000, 743.00000000, -220.82000000, 13.59000000, 9.00000000, 0 ))
        {
            if (NOT (IS_CHAR_INJURED( l_U503[13] )))
            {
                ...
                TASK_CLIMB( 0, 1 );
                TASK_GO_TO_COORD_WHILE_SHOOTING( 0, 725.96880000, -237.61190000, 10.93320000, 3, 1.00000000, 2.00000000, sub_2988(), 0 );
                CLOSE_SEQUENCE_TASK( l_U611 );
        ...
        {
            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U503[13], sub_2988(), 0 )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U503[13], sub_2988(), 8.00000000, 8.00000000, 8.00000000, 0 )))
            {
                l_U674[2] = 1;
                l_U680[2] = 1;
            }
    ...
    if ((NOT l_U680[2]) AND (l_U674[2]))
    {
        if (NOT (IS_CHAR_INJURED( l_U503[13] )))
        {
            GET_SCRIPT_TASK_STATUS( l_U503[13], 29, ref l_U612 );
            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U503[13], sub_2988(), 4.00000000, 4.00000000, 4.00000000, 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U503[13], sub_2988(), 0 )) || (l_U612 == 7)))
            {
                l_U680[2] = 1;
    ...
    if (NOT l_U674[3])
    {
        if (IS_CHAR_IN_ANGLED_AREA_3D( sub_2988(), 725.90010000, -258.64000000, 8.79000000, 734.45000000, -240.25000000, 13.59000000, 7.00000000, 0 ))
        {
            if (NOT (IS_CHAR_INJURED( l_U503[14] )))
            {
                OPEN_SEQUENCE_TASK( ref l_U611 );
                TASK_GO_STRAIGHT_TO_COORD( 0, 711.19590000, -275.04100000, 9.84570100, 2, -2 );
        ...
        {
            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U503[14], sub_2988(), 0 )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U503[14], sub_2988(), 8.00000000, 8.00000000, 8.00000000, 0 )))
            {
                l_U674[3] = 1;
                l_U680[3] = 1;
            }
    ...
    if ((NOT l_U680[3]) AND (l_U674[3]))
    {
        if (NOT (IS_CHAR_INJURED( l_U503[14] )))
        {
            GET_SCRIPT_TASK_STATUS( l_U503[14], 29, ref l_U612 );
            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U503[14], sub_2988(), 4.00000000, 4.00000000, 4.00000000, 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U503[14], sub_2988(), 0 )) || (l_U612 == 7)))
            {
                l_U680[3] = 1;
    ...
    if (NOT l_U674[4])
    {
        ...
        {
            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U503[15], sub_2988(), 0 )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U503[15], sub_2988(), 10.00000000, 10.00000000, 10.00000000, 0 )))
            {
                l_U674[4] = 1;
                l_U680[4] = 1;
            }
    ...
    if ((NOT l_U680[4]) AND (l_U674[4]))
    {
        if (NOT (IS_CHAR_INJURED( l_U503[15] )))
        {
            GET_SCRIPT_TASK_STATUS( l_U503[15], 29, ref l_U612 );
            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U503[15], sub_2988(), 4.00000000, 4.00000000, 4.00000000, 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U503[15], sub_2988(), 0 )) || (l_U612 == 7)))
            {
                l_U680[4] = 1;
...
void sub_28056()
{
    if (NOT l_U686)
    {
        ...
        {
            if ((l_U690) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U526[0], sub_2988(), 0 )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U526[0], sub_2988(), 3.00000000, 3.00000000, 3.00000000, 0 ))))
            {
    ...
    if ((NOT l_U687) AND (l_U686))
    {
        if (NOT (IS_CHAR_INJURED( l_U526[0] )))
        {
            GET_SCRIPT_TASK_STATUS( l_U526[0], 33, ref l_U612 );
            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U526[0], sub_2988(), 3.00000000, 3.00000000, 3.00000000, 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U526[0], sub_2988(), 0 )) || (l_U612 == 7)))
            {
                l_U687 = 1;
    ...
    if (NOT l_U688)
    {
        ...
        {
            if ((l_U690) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U530[0], sub_2988(), 0 )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U530[0], sub_2988(), 8.00000000, 8.00000000, 8.00000000, 0 ))))
            {
    ...
    if ((NOT l_U689) AND (l_U688))
    {
        if (NOT (IS_CHAR_INJURED( l_U530[0] )))
        {
            GET_SCRIPT_TASK_STATUS( l_U530[0], 29, ref l_U612 );
            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U530[0], sub_2988(), 4.00000000, 4.00000000, 4.00000000, 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U530[0], sub_2988(), 0 )) || (l_U612 == 7)))
            {
                l_U689 = 1;
    ...
    if (NOT l_U690)
    {
        ...
        {
            if ((l_U688) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U530[3], sub_2988(), 0 )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U530[3], sub_2988(), 8.00000000, 8.00000000, 8.00000000, 0 ))))
            {
...
void sub_29837()
{
    ...
    for ( I = 0; I <= 6; I++ )
    {
        ...
        else if ((HAS_CHAR_GOT_WEAPON( l_U530[I], 10 )) || (HAS_CHAR_GOT_WEAPON( l_U530[I], 12 )))
        {
...
int sub_30818(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_3568() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_3568() )))
            {
                if (((g_U9202) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_3568() )))))
                {
                    if (NOT sub_30914())
                    {
...
void sub_32324()
{
    if ((TIMERA() >= 1000) AND ((IS_SCREEN_FADED_IN()) AND ((NOT l_U646) AND ((NOT (l_U1027 == 3)) AND ((NOT (l_U1027 == 0)) AND (sub_12535()))))))
    {
        DO_SCREEN_FADE_OUT( 500 );
        l_U646 = 1;
    }
    ...
    else
    {
        switch (l_U1027)
        {
            ...
            if ((IS_SCREEN_FADED_OUT()) AND (TIMERB() >= 1800))
            {
                BEGIN_CAM_COMMANDS( ref l_U602 );
...
void sub_34320()
{
    ...
    for ( I = 0; I <= 5; I++ )
    {
        ...
        else if ((HAS_CHAR_GOT_WEAPON( l_U540[I], 10 )) || (HAS_CHAR_GOT_WEAPON( l_U540[I], 12 )))
        {
...
void sub_35105()
{
    ...
    for ( I = 0; I <= 5; I++ )
    {
        ...
        else if ((HAS_CHAR_GOT_WEAPON( l_U547[I], 10 )) || (HAS_CHAR_GOT_WEAPON( l_U547[I], 12 )))
        {
...
void sub_36132()
{
    ...
    for ( I = 0; I <= 3; I++ )
    {
        ...
        else if ((HAS_CHAR_GOT_WEAPON( l_U556[I], 10 )) || (HAS_CHAR_GOT_WEAPON( l_U556[I], 12 )))
        {
...
void sub_36981()
{
    ...
    if (NOT l_U698)
    {
        if ((LOCATE_CHAR_ANY_MEANS_2D( sub_2988(), 682.33000000, -302.38000000, 2.00000000, 2.00000000, 0 )) || (IS_CHAR_IN_ANGLED_AREA_3D( sub_2988(), 694.19000000, -309.14000000, 21.88000000, 695.79000000, -307.01000000, 24.52000000, -2, 0 )))
        {
    ...
    if ((NOT l_U699) AND (l_U698))
    {
        if (NOT (IS_CHAR_INJURED( l_U540[0] )))
        {
            GET_SCRIPT_TASK_STATUS( l_U540[0], 29, ref l_U612 );
            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U540[0], sub_2988(), 3.00000000, 3.00000000, 3.00000000, 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U540[0], sub_2988(), 0 )) || (l_U612 == 7)))
            {
                l_U699 = 1;
    ...
    if ((NOT l_U700) AND (l_U698))
    {
        if (NOT (IS_CHAR_INJURED( l_U540[2] )))
        {
            GET_SCRIPT_TASK_STATUS( l_U540[2], 20, ref l_U612 );
            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U540[2], sub_2988(), 3.00000000, 3.00000000, 3.00000000, 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U540[2], sub_2988(), 0 )) || (l_U612 == 7)))
            {
                l_U700 = 1;
    ...
    if ((NOT l_U701) AND (l_U698))
    {
        if (NOT (IS_CHAR_INJURED( l_U540[4] )))
        {
            GET_SCRIPT_TASK_STATUS( l_U540[4], 20, ref l_U612 );
            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U540[4], sub_2988(), 3.00000000, 3.00000000, 3.00000000, 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U540[4], sub_2988(), 0 )) || (l_U612 == 7)))
            {
                l_U701 = 1;
    ...
    if ((NOT l_U702) AND (l_U698))
    {
        if (NOT (IS_CHAR_INJURED( l_U540[5] )))
        {
            GET_SCRIPT_TASK_STATUS( l_U540[5], 29, ref l_U612 );
            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U540[5], sub_2988(), 3.00000000, 3.00000000, 3.00000000, 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U540[5], sub_2988(), 0 )) || (l_U612 == 7)))
            {
                l_U702 = 1;
    ...
    if (NOT l_U696)
    {
        ...
        {
            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U540[1], sub_2988(), 0 )) || (IS_CHAR_IN_ANGLED_AREA_3D( sub_2988(), 694.51000000, -314.29000000, 14.04000000, 697.57000000, -315.83000000, 16.31000000, 9, 0 )))
            {
    ...
    if (NOT l_U694)
    {
        ...
        {
            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U540[3], sub_2988(), 0 )) || ((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U540[3], sub_2988() )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U540[3], sub_2988(), 3.00000000, 3.00000000, 3.00000000, 0 ))))
            {
    ...
    if ((NOT l_U695) AND (l_U694))
    {
        if (NOT (IS_CHAR_INJURED( l_U540[3] )))
        {
            GET_SCRIPT_TASK_STATUS( l_U540[3], 33, ref l_U612 );
            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U540[3], sub_2988(), 0 )) || (l_U612 == 7))
            {
                l_U695 = 1;
                SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U540[3], 0 );
                TASK_COMBAT( l_U540[3], sub_2988() );
    ...
    if (NOT l_U692)
    {
        ...
        {
            if ((LOCATE_CHAR_ON_FOOT_3D( sub_2988(), 696.99000000, -304.79100000, 9.88000000, 1.20000000, 1.20000000, 1.20000000, 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U547[5], sub_2988(), 0 )) || ((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U547[5], sub_2988() )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U547[5], sub_2988(), 4.00000000, 4.00000000, 4.00000000, 0 )))))
            {
                l_U692 = 1;
                l_U693 = 1;
    ...
    if ((NOT l_U693) AND (l_U692))
    {
        if (NOT (IS_CHAR_INJURED( l_U547[5] )))
        {
            GET_SCRIPT_TASK_STATUS( l_U547[5], 20, ref l_U612 );
            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U547[5], sub_2988(), 3.00000000, 3.00000000, 3.00000000, 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U547[5], sub_2988(), 0 )) || (l_U612 == 7)))
            {
                l_U693 = 1;
                SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U547[5], 0 );
    ...
    if (NOT l_U649)
    {
        if ((sub_31103( 1, 1 )) AND (IS_CHAR_IN_ANGLED_AREA_3D( sub_2988(), 708.67000000, -286.67000000, 2.31000000, 713.31000000, -276.54000000, 5.74000000, 20, 0 )))
        {
            l_U1025 = 5;
            l_U649 = 1;
        }
    ...
    else if (NOT (IS_CHAR_INJURED( l_U496 )))
    {
        ...
        if ((l_U660) AND ((NOT l_U661) AND (sub_41341( l_U496 ))))
        {
            l_U1025 = 7;
            l_U661 = 1;
        }
    ...
    if (l_U660)
    {
        if ((NOT l_U661) AND (NOT (IS_CHAR_DEAD( l_U496 ))))
        {
    ...
    if ((l_U663) AND (IS_CHAR_INJURED( l_U496 )))
    {
...
void sub_40422()
{
    if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (sub_22957( l_U619 ))))
    {
        if (l_U1004 >= l_U1005)
        {
...
int sub_41341(unknown uParam0)
{
    ...
    if (DOES_CHAR_EXIST( uParam0 ))
    {
        if (NOT (IS_CHAR_INJURED( sub_2988() )))
        {
            if (NOT (IS_CHAR_INJURED( uParam0 )))
            {
                if (((IS_CONTROL_JUST_PRESSED( 0, 4 )) AND ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_3568(), uParam0 )) AND (NOT IS_USING_CONTROLLER()))) || (GET_CHAR_MELEE_ACTION_FLAG0( uParam0 )))
                {
                    if ((NOT (IS_CHAR_INJURED( uParam0 ))) AND (NOT (IS_CHAR_INJURED( sub_2988() ))))
                    {
                        SET_CHAR_READY_TO_BE_EXECUTED( uParam0, 0 );
...
void sub_41576()
{
    if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (sub_22957( l_U613 ))))
    {
        if (l_U1002 >= l_U1003)
        {
...
void sub_42175()
{
    if ((TIMERA() >= 1000) AND ((IS_SCREEN_FADED_IN()) AND ((NOT l_U646) AND ((NOT (l_U1029 == 2)) AND ((NOT (l_U1029 == 0)) AND (sub_12535()))))))
    {
        DO_SCREEN_FADE_OUT( 500 );
        while (NOT IS_SCREEN_FADED_OUT())
        {
    ...
    switch (l_U1029)
    {
        ...
        break;
        case 1:
        if ((l_U1016 == 0) AND ((l_U1014 == 0) AND ((TIMERA() >= 4000) || (LOCATE_CHAR_ANY_MEANS_2D( sub_2988(), 702.08740000, -278.02730000, 0.50000000, 0.50000000, 0 )))))
        {
            CLEAR_CHAR_TASKS_IMMEDIATELY( sub_2988() );
            ...
            BEGIN_CAM_COMMANDS( ref l_U602 );
            SET_CAM_POS( l_U598, 699.78990000, -279.33000000, 3.00159400 );
        ...
        if ((l_U1014 == 0) AND ((TIMERA() >= 600) AND (l_U1016 == 1)))
        {
            sub_15889( "FIN1B_SHIP", 1, 0, ref l_U613, 7, 1 );
            l_U1014 = 1;
        }
        if ((l_U1014 == 1) AND ((sub_43440( l_U613 )) == 3))
        {
            BEGIN_CAM_COMMANDS( ref l_U602 );
        ...
        if ((l_U1014 == 2) AND ((sub_43440( l_U613 )) == 4))
        {
            BEGIN_CAM_COMMANDS( ref l_U602 );
        ...
        if ((l_U1016 == 1) AND ((l_U1014 == 3) AND ((sub_43440( l_U613 )) == 5)))
        {
            l_U1016 = 2;
            SETTIMERA( 0 );
        }
        if ((TIMERA() >= 3000) AND (l_U1016 == 2))
        {
            BEGIN_CAM_COMMANDS( ref l_U602 );
            SET_CAM_POS( l_U598, 691.16650000, -291.15740000, 2.62528200 );
            SET_CAM_ROT( l_U598, 9.51510700, 0.00000000, -61.89611000 );
            SET_CAM_FOV( l_U598, 39.00001000 );
            SET_CAM_FAR_DOF( l_U598, 18 );
            END_CAM_COMMANDS( ref l_U602 );
            l_U1014 = 4;
        }
        if ((l_U1016 == 2) AND ((l_U1014 == 4) AND ((sub_43440( l_U613 )) == 7)))
        {
            l_U1016 = 3;
            SETTIMERA( 0 );
            sub_44015();
        ...
        if ((TIMERA() >= 2300) AND (l_U1016 == 3))
        {
            BEGIN_CAM_COMMANDS( ref l_U602 );
            SET_USE_HIGHDOF( 0 );
            SET_CAM_POS( l_U598, 702.77950000, -272.23960000, 4.47124600 );
            SET_CAM_ROT( l_U598, -9.66208500, 0.00000000, 156.84970000 );
            SET_CAM_FOV( l_U598, 33.10000000 );
            END_CAM_COMMANDS( ref l_U602 );
            l_U1014 = 5;
        }
        if ((TIMERA() >= 3600) AND (l_U1014 == 5))
        {
            l_U1029 = 2;
        }
        break;
...
void sub_44015()
{
    ...
    for ( I = 0; I <= 2; I++ )
    {
        ...
        else if ((HAS_CHAR_GOT_WEAPON( l_U561[I], 10 )) || (HAS_CHAR_GOT_WEAPON( l_U561[I], 12 )))
        {
...
{
    if ((NOT (IS_CHAR_DEAD( sub_2988() ))) AND (NOT (IS_CHAR_INJURED( l_U561[0] ))))
    {
    ...
    if ((NOT (IS_CHAR_DEAD( sub_2988() ))) AND (NOT (IS_CHAR_INJURED( l_U561[1] ))))
    {
    ...
    if ((NOT (IS_CHAR_DEAD( sub_2988() ))) AND (NOT (IS_CHAR_INJURED( l_U561[2] ))))
    {
...
void sub_45955()
{
    ...
    for ( I = 0; I <= 1; I++ )
    {
        ...
        else if ((HAS_CHAR_GOT_WEAPON( l_U565[I], 10 )) || (HAS_CHAR_GOT_WEAPON( l_U565[I], 12 )))
        {
...
void sub_46430()
{
    ...
    GET_INTERIOR_AT_COORDS( 689.30620000, -315.08730000, 4.09340000, ref uVar2 );
    ACTIVATE_INTERIOR( uVar2, 1 );
    if (NOT (IS_CHAR_INJURED( l_U565[0] )))
    {
...
void sub_46971()
{
    ...
    if ((TIMERA() >= 1000) AND ((IS_SCREEN_FADED_IN()) AND ((NOT l_U646) AND ((NOT (l_U1028 == 2)) AND ((NOT (l_U1028 == 0)) AND (sub_12535()))))))
    {
        DO_SCREEN_FADE_OUT( 500 );
        while (NOT IS_SCREEN_FADED_OUT())
        {
    ...
    switch (l_U1028)
    {
        ...
        if ((NOT (IS_CHAR_DEAD( l_U496 ))) AND (NOT (IS_CHAR_DEAD( sub_2988() ))))
        {
            CLEAR_CHAR_TASKS_IMMEDIATELY( sub_2988() );
        ...
        BEGIN_CAM_COMMANDS( ref l_U602 );
        SET_USE_HIGHDOF( 1 );
        SET_CAM_POS( l_U598, 691.50160000, -297.66780000, 3.82808500 );
        ...
        break;
        case 1:
        if ((TIMERB() > 200) AND (((sub_43440( l_U613 )) == 2) AND (NOT l_U662)))
        {
            if (NOT (IS_CHAR_DEAD( l_U496 )))
            {
                TASK_AIM_GUN_AT_COORD( sub_2988(), 693.46540000, -296.77410000, 3.76132300, 60000 );
                SETTIMERB( 0 );
                l_U662 = 1;
            }
        }
        if ((TIMERB() > 300) AND ((l_U1015 == 0) AND (l_U662)))
        {
            BEGIN_CAM_COMMANDS( ref l_U602 );
        ...
        if ((l_U1015 == 1) AND ((sub_43440( l_U613 )) == 5))
        {
            BEGIN_CAM_COMMANDS( ref l_U602 );
        ...
        if ((NOT (HAS_CHAR_GOT_WEAPON( sub_2988(), 9 ))) AND (NOT (HAS_CHAR_GOT_WEAPON( sub_2988(), 7 ))))
        {
...
void sub_49209(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    switch (l_U1030)
    {
        ...
        SET_CAM_POINT_OFFSET( l_U1039, -0.83999990, 0.14400000, 0.35200000 );
    ...
    if ((NOT (IS_CHAR_DEAD( l_U496 ))) AND (IS_CHAR_PLAYING_ANIM( sub_2988(), "missfinale1b", "player_execute" )))
    {
