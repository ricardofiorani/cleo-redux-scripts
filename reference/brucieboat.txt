...
void sub_15358()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_15396( 5, g_U569[I] )) == 1))
        {
...
void sub_18377()
{
    ...
    for ( I = 0; I < 2; I++ )
    {
        if ((NOT (IS_CHAR_DEAD( l_U294[I]._fU4 ))) AND (NOT (l_U294[I]._fU4 == nil)))
        {
...
void sub_25231()
{
    ...
    if (IS_CHAR_IN_ANY_POLICE_VEHICLE( sub_1328() ))
    {
        ...
        if ((NOT (IS_CHAR_IN_MODEL( sub_1328(), -488123221 ))) AND (NOT (IS_CHAR_IN_MODEL( sub_1328(), 837858166 ))))
        {
...
int sub_28479()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_15396( 1, g_U569[I] )) != 0))
        {
            sub_15682( I );
            return 1;
        }
...
int sub_38128()
{
    ...
    fVar3 = 0.00000000;
    GET_CAR_SPEED( uVar2, ref fVar3 );
    if ((sub_38203( 1, 1 )) AND (fVar3 < 0.01000000))
    {
        if (NOT l_U113)
        {
...
int sub_38566()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    bVar3 = false;
    if ((IS_PLAYER_PRESSING_HORN( sub_4726() )) AND ((sub_38203( 1, 1 )) AND (IS_CHAR_IN_ANY_CAR( sub_1328() ))))
    {
        if (l_U113)
        {
            return 0;
...
int sub_39170(unknown uParam0, unknown uParam1)
{
    ...
    iVar11 = 0;
    if ((NOT l_U119) AND (IS_CHAR_IN_ANY_CAR( sub_1328() )))
    {
        ...
        switch (l_U794)
        {
            ...
            if (l_U328 == 0)
            {
                ...
                if (l_U796 == nil)
                {
                    ...
                    {
                        sub_44731( 843.97410000, -148.49150000, 13.41214000, -2.79368900, 0.00000000, -28.41207000, 45, l_U795 );
                        if (DOES_CAM_EXIST( l_U795 ))
                        {
                            POINT_CAM_AT_PED( l_U795, sub_1328() );
                        }
            ...
            break;
            case 2:
            if ((sub_45635()) || (sub_45425( 8, ref l_U141 )))
            {
                l_U325++;
            }
            break;
    ...
    if (l_U325 == 1)
    {
        ...
        for ( I = 0; I < 1; I++ )
        {
            if (l_U337 == -1)
            {
                if (sub_48217( I ))
                {
                    if ((NOT (sub_37105( sub_1328() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1328(), l_U401[I]._fU4._fU0, l_U401[I]._fU4._fU4, l_U401[I]._fU4._fU8, 30.00000000, 30.00000000, 30.00000000, 0 )))
                    {
