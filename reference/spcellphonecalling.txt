void main()
{
    ...
    while (true)
    {
        ...
        if (NOT sub_4054())
        {
            if ((NOT l_U254) AND (NOT g_U91._fU504))
            {
                g_U91._fU504 = 1;
                ABORT_SCRIPTED_CONVERSATION( 0 );
                if ((g_U91._fU0 == 1004) || (bVar2))
                {
        ...
        else if (IS_PLAYER_SCRIPT_CONTROL_ON( sub_4066() ))
        {
            switch (g_U91._fU0)
            {
                ...
                {
                    if ((NOT sub_5286()) AND (IS_CHAR_IN_ANY_CAR( sub_4490() )))
                    {
        ...
        {
            case 1000:
            if ((NOT bVar2) AND ((NOT g_U91._fU376) AND (g_U91._fU48)))
            {
            ...
            if (sub_16939( ref l_U147, 2 ))
            {
                ...
                if ((g_U91._fU508 >= 4) AND (sub_21398()))
                {
                    if (NOT l_U253)
                    {
                        if (NOT g_U91._fU384)
            ...
            if (l_U255)
            {
                if (((sub_18147( g_U91._fU524 )) == 7) || (TIMERB() >= 2500))
                {
                    STOP_SOUND( l_U256 );
            ...
            else if (NOT IS_MOBILE_PHONE_CALL_ONGOING())
            {
                ...
                else if ((g_U15946[g_U91._fU60]._fU132._fU24 != 5) AND (g_U15946[g_U91._fU60]._fU132._fU24 != 4))
                {
                    g_U15946[g_U91._fU60]._fU132._fU24 = 6;
                }
...
int sub_21398()
{
    ...
    if (NOT l_U254)
    {
        ...
        switch (uVar2)
        {
            case 7:
            case 2:
            if ((g_U91._fU508 >= 4) || (g_U91._fU0 != 1005))
            {
...
int sub_22331(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_4490() ))) AND (IS_CHAR_IN_ANY_CAR( sub_4490() )))
    {
