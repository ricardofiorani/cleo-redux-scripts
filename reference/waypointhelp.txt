void main()
{
    ...
    while (bVar3)
    {
        ...
        if (NOT g_U10978)
        {
            ...
            {
                if ((NOT sub_107()) AND (NOT (IS_THREAD_ACTIVE( g_U812 ))))
                {
    ...
    while ((sub_533( l_U0 )) AND (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "WAYPNT1" )))
    {
        WAIT( 0 );
    }
    sub_582( l_U0 );
    ...
    while ((sub_533( l_U0 )) AND (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "WAYPNT2" )))
    {
        WAIT( 0 );
    }
    sub_582( l_U0 );
