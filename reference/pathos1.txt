...
void sub_1088()
{
    if ((NOT l_U111) AND ((l_U110) AND (l_U109)))
    {
        if (sub_1120())
        {
            sub_1167( 0 );
...
void sub_3367()
{
    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U119, sub_2220(), 0 )) || (IS_CHAR_INJURED( l_U119 )))
    {
        sub_964( ref l_U154, 0 );
        if (IS_HINT_RUNNING())
        {
    ...
    if ((IS_CHAR_ON_FOOT( sub_2220() )) AND (sub_3616() < 25))
    {
    ...
    {
        case 0:
        if ((IS_WANTED_LEVEL_GREATER( sub_885(), 0 )) || ((IS_CHAR_ON_FIRE( l_U119 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U119, sub_2220(), 0 )) || (IS_CHAR_INJURED( l_U119 )))))
        {
        ...
        if (NOT (IS_CHAR_INJURED( l_U119 )))
        {
            if ((IS_CHAR_ON_FOOT( sub_2220() )) AND (sub_3616() < 18))
            {
                if ((NOT l_U169) AND (NOT IS_HINT_RUNNING()))
                {
...
void sub_8992()
{
    ...
    switch (l_U106)
    {
        ...
        if ((NOT (IS_CHAR_INJURED( l_U121 ))) AND (IS_CHAR_INJURED( l_U120 )))
        {
            if (NOT (IS_CHAR_INJURED( l_U119 )))
            {
        ...
        if ((NOT (IS_CHAR_ON_SCREEN( l_U119 ))) AND (sub_3616() > 150))
        {
            if (NOT (IS_CHAR_INJURED( l_U119 )))
            {
                DELETE_CHAR( ref l_U119 );
        ...
        if ((NOT (IS_CHAR_DEAD( l_U119 ))) AND ((IS_CHAR_INJURED( l_U121 )) AND (IS_CHAR_INJURED( l_U120 ))))
        {
        ...
        break;
        case 7:
        if ((l_U118) || ((TIMERB() > 6000) || (NOT (IS_CHAR_ON_SCREEN( l_U119 )))))
        {
            if (NOT (IS_CHAR_INJURED( sub_2220() )))
            {
