...
void sub_14292()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_14330( 5, g_U569[I] )) == 1))
        {
...
void sub_20694()
{
    ...
    l_U108 = 0;
    if ((NOT (IS_CHAR_DEAD( l_U195 ))) AND (NOT (l_U195 == nil)))
    {
...
void sub_22325()
{
    ...
    {
        iVar3 = sub_22353( 13 );
        if ((g_U9932[g_U9999[I]._fU0]._fU0) AND (sub_22398( 13, iVar3 )))
        {
    ...
    {
        iVar3 = sub_22353( 11 );
        if ((g_U9932[g_U10090[I]._fU0]._fU0) AND (sub_22398( 11, iVar3 )))
        {
    ...
    {
        iVar3 = sub_22831( I );
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_22398( g_U10324[I]._fU12, iVar3 )))
        {
...
void sub_23368()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_22831( I )))
        {
            iVar4++;
        }
    }
...
void sub_29000()
{
    ...
    {
        STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_1591(), ref uVar2 );
        if ((NOT (IS_CHAR_IN_MODEL( sub_1591(), -488123221 ))) AND (NOT (IS_CHAR_IN_MODEL( sub_1591(), 837858166 ))))
        {
...
int sub_31926()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_14330( 1, g_U569[I] )) != 0))
        {
            sub_14616( I );
            return 1;
        }
...
int sub_39330()
{
    ...
    fVar3 = 0.00000000;
    GET_CAR_SPEED( uVar2, ref fVar3 );
    if ((sub_39405( 1, 1 )) AND (fVar3 < 0.01000000))
    {
        if (NOT l_U113)
        {
...
int sub_39768()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    bVar3 = false;
    if ((IS_PLAYER_PRESSING_HORN( sub_3660() )) AND ((sub_39405( 1, 1 )) AND (IS_CHAR_IN_ANY_CAR( sub_1591() ))))
    {
        if (l_U113)
        {
            return 0;
...
int sub_40372(unknown uParam0, unknown uParam1)
{
    ...
    iVar11 = 0;
    if ((NOT l_U119) AND (IS_CHAR_IN_ANY_CAR( sub_1591() )))
    {
...
void sub_46384()
{
    ...
    sub_46708( iVar3[10], 1150.94800000, 735.32490000, 35.89890000, 109.25990000, 1163.71000000, 769.05490000, 44.09430000, -24.06020000, 0.00000000, 140.83640000 );
    for ( I = 0; I < l_U413; I++ )
    {
        if (NOT l_U414[I])
        {
...
void sub_51258()
{
    ...
    sub_51586( iVar3[30], -437.20600000, 463.31500000, 11.30600000, 273.22870000, -451.98690000, 469.22640000, 14.42270000, -12.98044000, 0.00000000, -130.48930000 );
        ...
        for ( I = 0; I < 1; I++ )
        {
            if (l_U337 == -1)
            {
                if (sub_53385( I ))
                {
                    ...
                    if ((NOT (sub_38307( sub_1591() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1591(), l_U401[I]._fU4._fU0, l_U401[I]._fU4._fU4, fVar6, 1.60000000, 1.60000000, 1.60000000, iVar7 )))
                    {
...
int sub_59666(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, boolean bParam5, unknown uParam6)
{
    ...
    if (bVar10)
    {
        ...
        {
            if ((NOT (IS_CHAR_DEAD( iParam1 ))) AND (NOT (IS_CHAR_DEAD( sub_1591() ))))
            {
                TASK_LEAVE_ANY_CAR( sub_1591() );
    ...
    if (l_U325 == 7)
    {
        ...
        else if ((IS_CHAR_DEAD( iParam1 )) || (IS_CHAR_DEAD( sub_1591() )))
        {
            l_U325++;
        }
        else
    ...
    if (l_U325 == 12)
    {
        ...
        if ((TIMERA() > 7000) || (sub_70128( iParam1, l_U359 )))
        {
            l_U325++;
        }
    }
...
void sub_71467(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    sub_74475( uParam2 );
    sub_74615();
    if ((l_U856._fU8) AND (NOT (IS_CHAR_DEAD( sub_1591() ))))
    {
...
int sub_82158(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 5; Result++ )
    {
        ...
        if ((NOT (sub_82293( iVar4 ))) AND (sub_82230( Result )))
        {
            iVar5 = g_U10324[iVar4]._fU28 == g_U9937;
            fVar6 = l_U790[Result]._fU4._fU8;
            if ((NOT (sub_38307( sub_1591() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1591(), l_U790[Result]._fU4._fU0, l_U790[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )))
            {
...
int sub_82644(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_82703( Result ))
        {
            ...
            if ((NOT (sub_38307( sub_1591() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1591(), l_U417[Result]._fU4._fU0, l_U417[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )))
            {
                if (sub_82501( uParam0 ))
                {
                    return Result;
...
int sub_98201(unknown uParam0)
{
    ...
    if ((sub_98291( uParam0, "Bada_room1" )) || ((sub_98291( uParam0, "Bada_room2" )) || ((sub_98291( uParam0, "Bada-Private" )) || (sub_98291( uParam0, "Bada_room1" )))))
    {
        return 1;
    }
    if ((sub_98291( uParam0, "clammainroom" )) || ((sub_98291( uParam0, "clamfronrm" )) || ((sub_98291( uParam0, "clampalbkrm" )) || (sub_98291( uParam0, "clammainroom" )))))
    {
        return 1;
    }
    return 0;
...
void sub_99235(unknown uParam0)
{
    ...
    if (l_U344._fU12)
    {
        if (g_U22274[l_U158]._fU688._fU24 >= 0)
        {
            ...
            if (NOT l_U344._fU24)
            {
                if (((sub_83416( l_U147 )) > 5) || (sub_99291( ref l_U147 )))
                {
                    bVar5 = true;
                }
            }
...
void sub_99896()
{
    ...
    if ((NOT (sub_38307( sub_1591() ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_1591() )))
    {
        sub_3237( "MF10AUD" );
        sub_3356( 0, sub_1591(), "NIKO", 0 );
...
int sub_101008(unknown uParam0)
{
    ...
    if ((l_U344._fU24) || (sub_101017()))
    {
        return 0;
    }
    if (NOT l_U344._fU8)
    {
        if ((NOT (IS_CHAR_DEAD( uParam0 ))) AND (NOT (IS_CHAR_DEAD( sub_1591() ))))
        {
            if (IS_CHAR_IN_ANY_CAR( sub_1591() ))
            {
                STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_1591(), ref uVar3 );
