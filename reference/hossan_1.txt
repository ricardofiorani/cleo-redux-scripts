void main()
{
    ...
    if (sub_703( l_U502, l_U463 ))
    {
        ...
        {
            sub_1451( ref l_U517 );
            if ((l_U517._fU8._fU0 <= 20) || (l_U517._fU8._fU0 >= 6))
            {
                    ...
                    while (true)
                    {
                        ...
                        if (NOT l_U236)
                        {
                            if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
                            {
                                ...
                                {
                                    sub_3133();
                                    if ((sub_3628( ref l_U283, 22.00000000 )) || (sub_3536( ref l_U283 )))
                                    {
                                        sub_3805();
                                    }
                                    sub_4178( ref l_U290 );
                        ...
                        if (l_U236)
                        {
                            if (NOT l_U277)
                            {
                                ...
                                if (l_U270)
                                {
                                    ...
                                    {
                                        if ((NOT (IS_CHAR_ON_SCREEN( l_U284 ))) AND ((sub_3168( ref l_U284 )) > 200.00000000))
                                        {
                            ...
                            if ((NOT l_U231) AND (IS_KEYBOARD_KEY_PRESSED( 31 )))
                            {
                                l_U231 = 1;
                                sub_36905();
                            }
                            if ((NOT l_U231) AND (IS_KEYBOARD_KEY_PRESSED( 30 )))
                            {
                                if (NOT (IS_CHAR_INJURED( l_U284 )))
                                {
...
int sub_3133()
{
    if (l_U237)
    {
        if (IS_HINT_RUNNING())
        {
            if ((sub_3333()) || ((sub_3168( ref l_U283 )) > 18.00000000))
            {
                HINT_CAM( 0.00000000, 0.00000000, 0.50000000, l_U283, 0, 0, 0 );
                l_U237 = 0;
                return 1;
...
void sub_4284()
{
    switch (l_U213)
    {
        ...
        if ((l_U234) AND (NOT l_U235))
        {
            if ((HAS_MODEL_LOADED( l_U196._fU4 )) AND (HAVE_ANIMS_LOADED( "misshossan1" )))
            {
...
void sub_10051()
{
    ...
    l_U521._fU24 = {-428.72740000, -212.42280000, 8.41530100};
    ...
    l_U521._fU116[1] = {-429.34210000, -214.87250000, 9.71173500};
...
void sub_13581()
{
    ...
    if ((NOT l_U225[0]) AND (IS_KEYBOARD_KEY_PRESSED( 36 )))
    {
...
int sub_14358(unknown uParam0)
{
    ...
    if (((sub_3168( ref uParam0 )) < (10.00000000 * 2.00000000)) AND (IS_PLAYER_PRESSING_HORN( sub_1404() )))
    {
        return 1;
    }
    return 0;
...
int sub_15302(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
    {
        if (IS_PED_IN_GROUP( (uParam0^) ))
        {
            ...
            if ((IS_CHAR_ON_FOOT( sub_2202() )) AND (IS_CHAR_ON_FOOT( (uParam0^) )))
            {
                return 1;
            }
            if (DOES_VEHICLE_EXIST( (uParam1^) ))
            {
                ...
                {
                    if ((IS_CHAR_SITTING_IN_CAR( sub_2202(), (uParam1^) )) AND (IS_CHAR_SITTING_IN_CAR( (uParam0^), (uParam1^) )))
                    {
                        return 1;
                    }
                }
...
void sub_20541()
{
    ...
    SET_CAM_ROT( l_U450, -11.99968000, 0.00000000, -84.25821000 );
    SET_CAM_FOV( l_U450, 30.90004000 );
    SET_CAM_POS( l_U442, -491.58440000, -360.37040000, 5.82248600 );
    SET_CAM_ROT( l_U442, -7.04405200, -0.00000000, 17.97008000 );
    ...
    SET_CAM_POS( l_U444, -493.68900000, -355.73640000, 6.08344500 );
    ...
    SET_CAM_POS( l_U452, -502.00770000, -360.76390000, 5.11107300 );
    SET_CAM_ROT( l_U452, 6.11464100, 0.00000000, -18.83132000 );
    SET_CAM_FOV( l_U452, 31.80003000 );
    SET_CAM_POS( l_U453, -502.00770000, -360.76390000, 5.11107300 );
...
void sub_23378()
{
    ...
    switch (l_U218)
    {
        ...
        break;
        case 16:
        if ((l_U471[0] == 1) || (NOT IS_CAM_INTERPOLATING()))
        {
            if (NOT (IS_CHAR_INJURED( l_U284 )))
            {
                if (NOT (IS_CAR_DEAD( l_U288 )))
...
void sub_29530(unknown uParam0)
{
    ...
    if ((iVar3 != 4) AND ((NOT sub_712()) AND ((NOT (IS_CHAR_DEAD( (uParam0^) ))) AND ((IS_CHAR_IN_ANY_CAR( sub_2202() )) AND (IS_CONTROL_PRESSED( 0, 51 ))))))
    {
...
void sub_30283(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, boolean bParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15)
{
    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
    {
        if ((DOES_BLIP_EXIST( (uParam5^) )) || (DOES_BLIP_EXIST( (uParam3^) )))
        {
            if (NOT (IS_PED_IN_GROUP( (uParam0^) )))
            {
...
{
    if ((IS_CHAR_ON_FOOT( (uParam1^) )) || ((IS_CHAR_IN_CAR( sub_2202(), (uParam0^) )) || (((iParam3 < iParam4) AND (((sub_3168( uParam1 )) < 10) AND ((uParam2^) < 0.50000000))) || ((iParam3 < 200) || (((GET_ENGINE_HEALTH( (uParam0^) )) < 200) || ((GET_PETROL_TANK_HEALTH( (uParam0^) )) < 200))))))
    {
        return 1;
    }
    return 0;
...
void sub_32574()
{
    ...
    switch (l_U221)
    {
        ...
        SET_CAM_POS( l_U441, -427.69270000, -194.50000000, 11.15225000 );
            ...
            if (NOT (IS_CHAR_INJURED( l_U283 )))
            {
                if (NOT (sub_15732( l_U503[0] )))
                {
                    ...
                    if (NOT (IS_CAR_DEAD( l_U290 )))
                    {
                        ...
                        OPEN_SEQUENCE_TASK( ref l_U495 );
                        TASK_LEAVE_CAR( 0, l_U290 );
                        TASK_FOLLOW_NAV_MESH_TO_COORD( 0, -415.94540000, -193.64280000, 9.52630100, 2, -1, 0.10000000 );
                        CLOSE_SEQUENCE_TASK( l_U495 );
                        TASK_PERFORM_SEQUENCE( l_U283, l_U495 );
                        CLEAR_SEQUENCE_TASK( l_U495 );
                        l_U221 = 6;
        ...
        if (NOT (IS_CHAR_INJURED( l_U283 )))
        {
            ...
            if ((l_U500 == 7) || (NOT (IS_CHAR_ON_SCREEN( l_U283 ))))
            {
                l_U221 = 11;
            }
        }
    ...
    sub_15064();
    if ((NOT l_U225[1]) AND (IS_KEYBOARD_KEY_PRESSED( 36 )))
    {
        SET_CHAR_COORDINATES( sub_2202(), -425.59310000, -208.80750000, 8.38309900 );
        l_U225[1] = 1;
    }
    return;
}
...
void sub_33023()
{
    ...
    SET_CAM_ROT( l_U443, 6.60900400, 0.00000000, 38.01209000 );
    SET_CAM_FOV( l_U443, 33.80003000 );
    SET_CAM_POS( l_U444, -421.48840000, -202.09990000, 8.90257500 );
    SET_CAM_ROT( l_U444, 6.60900400, 0.00000000, 38.01209000 );
    ...
    else if (DOES_VEHICLE_EXIST( l_U290 ))
    {
        if (IS_VEH_DRIVEABLE( l_U290 ))
        {
            ...
            {
                CLEAR_AREA( -426.87610000, -184.85850000, 9.47430100, 4.00000000, 1 );
                SET_CAR_HEADING( l_U290, 359.65950000 );
                SET_CAR_COORDINATES( l_U290, -426.87610000, -184.85850000, 9.47430100 );
            }
        }
    }
    CLEAR_PRINTS();
    ...
    SET_CAM_ROT( l_U441, -17.68506000, 3.49407500, 144.83520000 );
