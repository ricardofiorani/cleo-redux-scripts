...
int sub_1491(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_444() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_444() )))
            {
                if (((g_U9202) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_444() )))))
                {
                    if (NOT sub_1587())
                    {
