    ...
    while (true)
    {
        ...
        if (NOT l_U677)
        {
            if (NOT g_U10978)
            {
                ...
                if (sub_6058( l_U633 ))
                {
                    if ((NOT sub_6966()) || ((sub_6910( 8 )) || (sub_6859())))
                    {
...
int sub_1917()
{
    if ((ProtectedGet(g_U64681) > 2) AND ((ProtectedGet(g_U64680) > 2) AND (ProtectedGet(g_U64679) > 2)))
    {
        return 1;
    }
    return 0;
...
int sub_4498()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_4536( 1, g_U569[I] )) != 0))
        {
            sub_4799( I );
            return 1;
        }
...
int sub_7154(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_7411() ))) AND (IS_CHAR_IN_ANY_CAR( sub_7411() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_7743()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
