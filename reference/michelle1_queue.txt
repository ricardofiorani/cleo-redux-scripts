void main()
{
    ...
    while (true)
    {
        ...
        switch (l_U344)
        {
            ...
            while ((NOT (HAS_MODEL_LOADED( 897868981 ))) || (NOT (HAVE_ANIMS_LOADED( "amb@nightclub_ext" ))))
            {
                REQUEST_ANIMS( "amb@nightclub_ext" );
                REQUEST_MODEL( 897868981 );
                WAIT( 0 );
                ...
                if ((CAN_CREATE_RANDOM_CHAR( 0, 1 )) || (CAN_CREATE_RANDOM_CHAR( 1, 0 )))
                {
                    ...
                    if (DOES_CHAR_EXIST( l_U68[l_U312]._fU0 ))
                    {
                        if (NOT (IS_CHAR_DEAD( l_U68[l_U312]._fU0 )))
                        {
                            ...
                            if ((iVar5 == -142386662) || ((iVar5 == -1827421800) || (iVar5 == -1080673049)))
                            {
                                if (NOT (IS_CHAR_DEAD( l_U68[l_U312]._fU0 )))
                                {
        ...
        if (NOT l_U328)
        {
            if (sub_4562( l_U309, 83 ))
            {
                ...
                for ( l_U312 = 0; l_U312 < 7; l_U312++ )
                {
                    ...
                    {
                        if ((DOES_CHAR_EXIST( l_U68[l_U312]._fU0 )) AND ((NOT (IS_CHAR_INJURED( l_U68[l_U312]._fU0 ))) AND (NOT (IS_CHAR_DEAD( l_U68[l_U312]._fU0 )))))
                        {
                            if (NOT (IS_CHAR_DEAD( l_U309 )))
                            {
                ...
                if ((DOES_CHAR_EXIST( l_U310 )) AND ((NOT (IS_CHAR_INJURED( l_U310 ))) AND (NOT (IS_CHAR_DEAD( l_U310 )))))
                {
                    if (l_U329 == 1)
                    {
...
void sub_7865()
{
    if (DOES_CHAR_EXIST( l_U309 ))
    {
        if ((NOT (IS_CHAR_INJURED( l_U309 ))) AND (NOT (IS_CHAR_DEAD( l_U309 ))))
        {
            FREEZE_CHAR_POSITION( l_U309, 0 );
        }
    }
    ...
    {
        if ((NOT (IS_CHAR_INJURED( l_U310 ))) AND (NOT (IS_CHAR_DEAD( l_U310 ))))
        {
            CLEAR_CHAR_TASKS_IMMEDIATELY( l_U310 );
        }
    }
