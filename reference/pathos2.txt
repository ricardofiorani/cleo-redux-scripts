void main()
{
    ...
    l_U251 = {92.76329000, 143.00740000, 13.66130000};
    l_U254 = 0;
    l_U259 = 2;
    l_U260 = 1000;
    l_U261 = 1;
...
void sub_2584()
{
    switch (l_U197)
    {
        ...
        while ((NOT (HAVE_ANIMS_LOADED( "MOVE_INJURED_GENERIC" ))) || (NOT (HAVE_ANIMS_LOADED( "misspathos2" ))))
        {
            WAIT( 0 );
        }
...
void sub_3543()
{
    ...
    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U220, sub_2182(), 0 )) || (IS_CHAR_INJURED( l_U220 )))
    {
        sub_1345( ref l_U273, 0 );
        if (IS_HINT_RUNNING())
        {
    ...
    if ((IS_CHAR_ON_FOOT( sub_2182() )) AND (sub_3719() < 25))
    {
    ...
    {
        case 0:
        if ((IS_WANTED_LEVEL_GREATER( sub_1266(), 0 )) || ((IS_CHAR_ON_FIRE( l_U220 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U220, sub_2182(), 0 )) || (IS_CHAR_INJURED( l_U220 )))))
        {
        ...
        {
            if ((IS_CHAR_ON_FOOT( sub_2182() )) AND (sub_3719() < 18))
            {
                if ((NOT l_U306) AND (NOT IS_HINT_RUNNING()))
                {
...
void sub_9183()
{
            ...
            if (NOT (IS_GROUP_MEMBER( l_U220, sub_6681() )))
            {
                ...
                if (DOES_BLIP_EXIST( l_U226 ))
                {
                    if (sub_3719() < 12.00000000)
                    {
                        ...
                        if (NOT (IS_CHAR_INJURED( l_U220 )))
                        {
                            if ((NOT (IS_CHAR_IN_ANY_CAR( sub_2182() ))) AND (NOT (IS_CHAR_INJURED( sub_2182() ))))
                            {
                                if (NOT l_U314)
                                {
    ...
    switch (l_U201)
    {
        ...
        while ((NOT (HAS_MODEL_LOADED( -196312163 ))) || (NOT (HAS_MODEL_LOADED( -1143910864 ))))
        {
            WAIT( 0 );
        }
        ...
        TASK_FOLLOW_NAV_MESH_TO_COORD_NO_STOP( 0, 96.57791000, 149.70090000, 14.77750000, 2, -2, 1.50000000 );
        ...
        else
        {
            ...
            while ((NOT (IS_CHAR_ON_SCREEN( l_U222 ))) AND ((NOT (IS_CHAR_INJURED( l_U222 ))) AND ((NOT (IS_CHAR_ON_SCREEN( l_U221 ))) AND ((NOT (IS_CHAR_INJURED( l_U221 ))) AND ((NOT (IS_CHAR_ON_SCREEN( l_U220 ))) AND (NOT (IS_CHAR_INJURED( l_U220 ))))))))
            {
                WAIT( 0 );
            }
        ...
        if ((NOT (IS_CHAR_INJURED( l_U220 ))) AND (IS_EXPLOSION_IN_SPHERE( -1, l_U242._fU0, l_U242._fU4, l_U242._fU8, 5.00000000 )))
        {
        ...
        if ((IS_CHAR_INJURED( l_U222 )) AND (IS_CHAR_INJURED( l_U221 )))
        {
        ...
        if (NOT l_U314)
        {
            if ((NOT sub_16414()) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
            {
        ...
        if ((NOT (IS_VEH_DRIVEABLE( l_U223 ))) AND (DOES_VEHICLE_EXIST( l_U223 )))
        {
        ...
        if (NOT (IS_WANTED_LEVEL_GREATER( sub_1266(), 0 )))
        {
            if (NOT (IS_CHAR_INJURED( l_U220 )))
            {
                ...
                {
                    if ((sub_5942( 1, 1 )) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_2182(), l_U251._fU0, l_U251._fU4, l_U251._fU8 + 2.50000000, 2.50000000, 2.50000000, 2.50000000, 1 )))
                    {
                        if (IS_CHAR_IN_ANY_CAR( sub_2182() ))
                        {
                            if ((NOT (IS_CAR_UPSIDEDOWN( l_U223 ))) AND (IS_VEH_DRIVEABLE( l_U223 )))
                            {
                                if (DOES_BLIP_EXIST( l_U229 ))
                                {
                                    REMOVE_BLIP( l_U229 );
                                ...
                                if ((NOT (IS_CHAR_INJURED( l_U220 ))) AND (IS_VEH_DRIVEABLE( l_U223 )))
                                {
                        ...
                        else if (IS_CHAR_ON_FOOT( sub_2182() ))
                        {
                            ...
                            if (NOT (IS_CHAR_INJURED( sub_2182() )))
                            {
                                ...
                                SET_CHAR_HEADING( sub_2182(), 68.01619000 );
        ...
        if (NOT l_U205)
        {
            ...
            if ((IS_CHAR_ON_FOOT( sub_2182() )) AND (NOT (IS_CHAR_INJURED( sub_2182() ))))
            {
        ...
        break;
        case 14:
        if ((TIMERB() > 8000) || ((l_U315 == 1) || ((NOT (IS_CHAR_ON_SCREEN( l_U220 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U220, 96.57791000, 149.70090000, 14.27750000, 1.50000000, 1.50000000, 1.50000000, 0 )))))
        {
