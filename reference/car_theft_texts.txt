void main()
{
    ...
    while (true)
    {
        ...
        switch (l_U937)
        {
            ...
            {
                if ((NOT g_U10978) AND (IS_CHAR_IN_ANY_CAR( sub_5492() )))
                {
                    STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_5492(), ref l_U645 );
                    GET_CAR_MODEL( l_U645, ref l_U679 );
                    if ((IS_VEH_DRIVEABLE( l_U645 )) AND ((NOT (IS_THIS_MODEL_A_HELI( l_U679 ))) AND (NOT (IS_THIS_MODEL_A_BOAT( l_U679 )))))
                    {
                        if ((sub_8374( l_U645 )) AND (sub_8269( l_U645 )))
                        {
                            sub_8430( 9, 1 );
                            l_U547 = 1;
            ...
            break;
            case 1:
            if ((IS_GARAGE_CLOSED( "BxGRG1" )) AND ((LOCATE_CHAR_IN_CAR_3D( sub_5492(), l_U548._fU0, l_U548._fU4, l_U548._fU8, 50.00000000, 50.00000000, 15.00000000, 0 )) AND (NOT (IS_CHAR_INJURED( sub_5492() )))))
            {
                OPEN_GARAGE( "BxGRG1" );
            }
            if ((NOT g_U10978) AND (NOT (IS_CHAR_INJURED( sub_5492() ))))
            {
                if (NOT (l_U546 >= 30))
                {
                ...
                if (l_U937 == 1)
                {
                    if ((NOT sub_8901()) AND ((NOT sub_8849()) AND ((IS_GARAGE_OPEN( "BxGRG1" )) AND (LOCATE_CHAR_IN_CAR_3D( sub_5492(), l_U548._fU0, l_U548._fU4, l_U548._fU8, 20.00000000, 20.00000000, 15.00000000, 0 )))))
                    {
                        if (NOT (l_U546 >= 30))
                        {
                    ...
                    if ((NOT g_U9893._fU12) AND ((NOT sub_9079()) AND ((IS_GARAGE_OPEN( "BxGRG1" )) AND (LOCATE_CHAR_IN_CAR_3D( sub_5492(), l_U548._fU0, l_U548._fU4 - 2.00000000, l_U548._fU8 + 2.50000000, 2.50000000, 2.50000000, 2.50000000, 1 )))))
                    {
                        if (l_U546 >= 30)
                        {
                            STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_5492(), ref l_U645 );
                            ...
                            if (sub_9173())
                            {
                                ...
                                while ((NOT (sub_9523( sub_5492() ))) AND (NOT (IS_CHAR_INJURED( sub_5492() ))))
                                {
                                    WAIT( 0 );
                                }
                                l_U937 = 3;
            ...
            if (NOT (IS_CHAR_INJURED( sub_5492() )))
            {
                if (IS_VEH_DRIVEABLE( l_U645 ))
                {
                    ...
                    if (l_U347 > 0)
                    {
                        ...
                        while ((IS_CHAR_SITTING_IN_ANY_CAR( sub_5492() )) || ((IS_CHAR_IN_ANY_CAR( sub_5492() )) AND (NOT (IS_CHAR_INJURED( sub_5492() )))))
                        {
                            WAIT( 0 );
                        }
                        CLEAR_PRINTS();
            ...
            break;
            case 8:
            if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_5492(), 722.57200000, 1381.49300000, 15.73600000, 10.00000000, 10.00000000, 10.00000000, 0 ))) AND (NOT (IS_CHAR_INJURED( sub_5492() ))))
            {
                l_U938 = 0;
                if (IS_GARAGE_OPEN( "BxGRG1" ))
                {
                ...
                else if ((NOT (IS_CHAR_IN_ANY_CAR( sub_5492() ))) AND ((NOT (IS_CHAR_INJURED( sub_5492() ))) AND (DOES_VEHICLE_EXIST( l_U645 ))))
                {
                    DELETE_CAR( ref l_U645 );
                }
                if (NOT (l_U546 >= 30))
...
void sub_2197()
{
    ...
    l_U551[1] = {-448.77850000, 668.76180000, 9.43080100};
    ...
    l_U551[24] = {1589.18300000, 768.14860000, 28.11740000};
    ...
    l_U551[28] = {-1267.81900000, 1643.98400000, 29.76840000};
...
void sub_3949()
{
    ...
    {
        iVar3 = sub_3977( 13 );
        if ((g_U9932[g_U9999[I]._fU0]._fU0) AND (sub_4022( 13, iVar3 )))
        {
    ...
    {
        iVar3 = sub_3977( 11 );
        if ((g_U9932[g_U10090[I]._fU0]._fU0) AND (sub_4022( 11, iVar3 )))
        {
    ...
    {
        iVar3 = sub_4501( I );
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_4022( g_U10324[I]._fU12, iVar3 )))
        {
...
void sub_5038()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_4501( I )))
        {
            iVar4++;
        }
    }
...
int sub_6613()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_6651( 1, g_U569[I] )) != 0))
        {
            sub_6914( I );
            return 1;
        }
...
int sub_8269(unknown uParam0)
{
    if (IS_CHAR_IN_CAR( sub_5492(), uParam0 ))
    {
        ...
        if ((l_U449 == l_U384[g_U9340]) AND (l_U448 == l_U352[g_U9340]))
        {
            return 1;
        }
    }
...
int sub_9173()
{
    if ((sub_9311( l_U645 )) || ((sub_9225( l_U645 )) || ((IS_CAR_A_MISSION_CAR( l_U645 )) || ((IS_THIS_MODEL_A_HELI( l_U679 )) || (IS_THIS_MODEL_A_BOAT( l_U679 ))))))
    {
        return 0;
    }
    return 1;
...
{
    if ((IS_CAR_MODEL( uParam0, 1938952078 )) || ((IS_CAR_MODEL( uParam0, 1171614426 )) || ((IS_CAR_MODEL( uParam0, 1127131465 )) || ((IS_CAR_MODEL( uParam0, -1627000575 )) || ((IS_CAR_MODEL( uParam0, 2046537925 )) || ((IS_CAR_MODEL( uParam0, 148777611 )) || (IS_CAR_MODEL( uParam0, -350085182 ))))))))
    {
        return 1;
    }
    return 0;
