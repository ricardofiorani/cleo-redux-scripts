...
void sub_118()
{
    ...
    sub_162( 1, -146.81070000, 72.92670000, 16.06900000, -154.53580000, 86.56289000, 13.78270000, 200 );
    ...
    sub_162( 11, 118.34760000, 640.66160000, 15.91000000, 120.55730000, 661.74850000, 13.69930000, 180 );
    ...
    sub_162( 20, 921.12400000, -489.47710000, 16.59100000, 918.59810000, -505.09470000, 14.01790000, 0 );
    sub_162( 17, 1150.94800000, 735.32490000, 35.89890000, 1179.39600000, 750.80550000, 35.06250000, 180 );
    sub_162( 18, -437.13140000, 463.51540000, 11.14300000, -416.82850000, 464.30540000, 10.73370000, 120 );
    sub_162( 19, 118.44390000, 557.17170000, 15.94000000, 119.92800000, 579.07170000, 13.66650000, 180 );
    sub_162( 16, -477.32320000, 1414.15900000, 16.67100000, -458.61460000, 1415.95200000, 14.43390000, 90 );
    sub_162( 21, 1199.12800000, -683.22090000, 17.74300000, 1186.95400000, -682.86620000, 15.43990000, 270 );
    sub_162( 22, -567.91620000, 87.84670000, 6.09270000, -565.89650000, 55.86460000, 3.66190000, 0 );
    sub_162( 23, 1150.94800000, 735.32490000, 35.89890000, 1138.15600000, 758.95690000, 33.87960000, 270 );
...
void sub_1390()
{
    ...
    sub_1432( 17, 1139.32900000, 740.73420000, 36.55957000, -8.33696200, 0.01961200, -120.22000000 );
    sub_1432( 18, -451.98690000, 469.22640000, 14.42270000, -12.98044000, 0.00000000, -130.48930000 );
...
void sub_2562()
{
    ...
    sub_2602( 15, "dp_RSTAR_MH_N", 27.99910000, 980.06630000, 14.59650000 );
...
int sub_4995(int iParam0, int iParam1)
{
    ...
    if (l_U203 == 0)
    {
        if (NOT ((g_U9914._fU0) || (IS_AUTO_SAVE_IN_PROGRESS())))
        {
...
void sub_5807()
{
    ...
    {
        case 0:
        if (((g_U15654[56]) || (g_U15654[30])) || ((NOT (sub_5853( 1 ))) || (NOT (sub_5853( 2 )))))
        {
            l_U213 = 1;
        }
        break;
...
void sub_5946(unknown uParam0)
{
    ...
    for ( I = 0; I < 12; I++ )
    {
        if ((I != l_U212) AND ((I != l_U211) AND (I != l_U210)))
        {
            if (sub_6000( I ))
            {
...
void sub_9630()
{
    ...
    {
        case 0:
        if (((GET_INT_STAT( 363 )) >= 2) AND (sub_6000( l_U210 )))
        {
...
void sub_10303()
{
    ...
    else
    {
        ...
        {
            if ((NOT (sub_6000( 2 ))) AND (NOT (sub_6000( 1 ))))
            {
                if (NOT l_U566)
                {
