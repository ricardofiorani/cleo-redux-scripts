void main()
{
    ...
    if (GET_IS_WIDESCREEN())
    {
        ...
        sub_2423( ref l_U450[1], 0.77999990, 0.09000000, 0.05000000, 0.06000000, 1 );
    ...
    else
    {
        ...
        sub_2423( ref l_U450[1], 0.83999990, 0.09000000, 0.06000000, 0.06000000, 1 );
    ...
    while (true)
    {
        ...
        {
            if ((NOT l_U489) AND (sub_9889( ref uVar9 )))
            {
        ...
        if (NOT g_U857._fU92)
        {
            ...
            else if ((iVar8 == 6) AND (g_U851._fU8 == -1))
            {
                DRAW_SPRITE( l_U499[0], g_U851._fU0, g_U851._fU4, 0.10000000, 0.12000000, 0.00000000, 255, 255, 255, 255 );
            }
            else
...
void sub_10915()
{
    ...
    switch (g_U857._fU0)
    {
        ...
        if ((GET_NUMBER_OF_WEB_PAGE_LINKS( g_U857._fU4 )) != 0)
        {
            ...
            {
                if ((g_U851._fU8 < (GET_NUMBER_OF_WEB_PAGE_LINKS( g_U857._fU4 ))) AND (g_U851._fU8 != -1))
                {
...
{
    if ((iParam0 < (GET_NUMBER_OF_WEB_PAGE_LINKS( g_U857._fU4 ))) AND (iParam0 != -1))
    {
...
int sub_15627()
{
    ...
    else if ((l_U432 == 1) AND (NOT (IS_MOUSE_BUTTON_PRESSED( 1 ))))
    {
        l_U432 = 0;
        return 0;
    }
    ...
    else if ((((IS_GAME_KEYBOARD_KEY_JUST_PRESSED( 203 )) AND ((IS_GAME_KEYBOARD_KEY_PRESSED( 184 )) || (IS_GAME_KEYBOARD_KEY_PRESSED( 56 )))) || (IS_MOUSE_BUTTON_JUST_PRESSED( 2 ))) AND (g_U857._fU0 > 2))
    {
        return 3;
    }
    ...
    else if ((IS_GAME_KEYBOARD_KEY_JUST_PRESSED( 205 )) AND (((IS_GAME_KEYBOARD_KEY_PRESSED( 184 )) || (IS_GAME_KEYBOARD_KEY_PRESSED( 56 ))) AND (g_U857._fU0 > 2)))
    {
        return 4;
    }
    else if (((IS_GAME_KEYBOARD_KEY_JUST_PRESSED( 63 )) AND (g_U857._fU0 > 2)) || (IS_BUTTON_JUST_PRESSED( 0, 14 )))
    {
        return 2;
    };;;;;;;;;
    return 6;
...
void sub_17617(int iParam0)
{
    ...
    if (g_U857._fU0 > 2)
    {
        ...
        if (g_U857._fU92)
        {
            if (NOT (COMPARE_STRING( ref g_U857._fU100, "" )))
            {
                if (((GET_LENGTH_OF_LITERAL_STRING( ref g_U857._fU100 )) > 63) || ((GET_STRING_WIDTH_WITH_STRING( "STRING", ref g_U857._fU100 )) > (l_U450[4]._fU8._fU0 * 0.98000000)))
                {
                    g_U857._fU96 = 0;
                }
                else
        ...
        if (g_U943)
        {
            if (g_U857._fU28)
            {
                DRAW_SPRITE( l_U478[9], 0.86500000, 0.58000000, 0.02000000, 0.83999990, 0.00000000, 255, 255, 255, 255 );
    ...
    if (iParam1 == l_U449)
    {
        if (g_U943)
        {
            if (iParam1 == 28)
            {
                if (l_U446)
                {
                    DRAW_SPRITE( l_U433[7], 0.68699990, uParam3 + 0.00150000, 0.10200000, 0.08800000, 0.00000000, 255, 255, 255, l_U444 / 2 );
                }
                else
                {
                    DRAW_SPRITE( l_U433[6], 0.68699990, uParam3 + 0.00150000, 0.10200000, 0.08800000, 0.00000000, 255, 255, 255, l_U444 / 2 );
                }
            }
            else if (l_U446)
            {
