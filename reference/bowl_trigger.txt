    ...
    while (true)
    {
        ...
        if (DOES_OBJECT_EXIST( l_U552[0] ))
        {
            if (IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE( l_U552[0] ))
            {
                ...
                if (NOT (l_U563 == nil))
                {
                    if ((l_U563 == l_U561) || (l_U563 == l_U562))
                    {
                        if ((IS_CHAR_IN_ANY_CAR( sub_1413() )) || (IS_CHAR_SHOOTING( sub_1413() )))
                        {
                ...
                switch (l_U567)
                {
                    ...
                    if (DOES_OBJECT_EXIST( l_U552[0] ))
                    {
                        ...
                        {
                            if ((LOCATE_OBJECT_3D( l_U552[0], -577.89600000, 67.75747000, 4.41782500, 2.00000000, 2.00000000, 2.00000000, 0 )) || (LOCATE_OBJECT_3D( l_U552[0], 1188.67500000, -674.34700000, 16.04562000, 2.00000000, 2.00000000, 2.00000000, 0 )))
                            {
                                l_U567 = 4;
                            }
                            else
                        ...
                        if (NOT sub_1616())
                        {
                            ...
                            if (NOT l_U532)
                            {
                                ...
                                if (g_U9371)
                                {
                                    ...
                                    {
                                        if ((LOCATE_CHAR_ON_FOOT_3D( sub_1413(), l_U468._fU0, l_U468._fU4, l_U468._fU8 + 0.50000000, 1.50000000, 1.00000000, 1.00000000, 1 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_1413(), l_U465._fU0, l_U465._fU4, l_U465._fU8 + 0.50000000, 1.50000000, 1.00000000, 1.00000000, 1 )))
                                        {
                    ...
                    {
                        if ((IS_CAR_IN_AREA_3D( l_U539, -574.80860000, 75.52549000, 3.00000000, -600.64850000, 47.15890000, 7.00000000, 0 )) || (IS_CAR_IN_AREA_3D( l_U539, 1168.07700000, -651.59450000, 15.00000000, 1196.95000000, -677.57710000, 18.00000000, 0 )))
                        {
...
int sub_9495()
{
    ...
    if ((REQUEST_AMBIENT_AUDIO_BANK( "SCRIPT_AMBIENT/BOWLING_ALLEY" )) AND ((HAVE_ANIMS_LOADED( "MINI_BOWLING" )) AND ((HAS_MODEL_LOADED( -1776787973 )) AND ((HAS_MODEL_LOADED( -890350484 )) AND ((HAS_MODEL_LOADED( -190707996 )) AND ((HAS_MODEL_LOADED( -1862626618 )) AND (HAS_MODEL_LOADED( l_U560 ))))))))
    {
        l_U251 = GET_SOUND_ID();
        l_U252 = GET_SOUND_ID();
        l_U253 = GET_SOUND_ID();
...
void sub_15420()
{
    ...
    switch (l_U569)
    {
        ...
        if (DOES_CHAR_EXIST( l_U534[l_U248] ))
        {
            if (NOT (IS_CHAR_INJURED( l_U534[l_U248] )))
            {
                if ((IS_CHAR_PLAYING_ANIM( l_U534[l_U248], "MINI_BOWLING", "PICK_UP_R" )) || (IS_CHAR_PLAYING_ANIM( l_U534[l_U248], "MINI_BOWLING", "PICK_UP_L" )))
                {
                    if (l_U510)
                    {
        ...
        if (NOT l_U491)
        {
            ...
            if (l_U492)
            {
                if (DOES_CHAR_EXIST( l_U534[l_U248] ))
                {
                    if (NOT (IS_CHAR_INJURED( l_U534[l_U248] )))
                    {
                        if ((IS_CHAR_PLAYING_ANIM( l_U534[l_U248], "MINI_BOWLING", "F_PED_STRAFE_R" )) || (IS_CHAR_PLAYING_ANIM( l_U534[l_U248], "MINI_BOWLING", "PED_STRAFE_R" )))
                        {
        ...
        if (NOT l_U490)
        {
            ...
            if (l_U493)
            {
                if (DOES_CHAR_EXIST( l_U534[l_U248] ))
                {
                    if (NOT (IS_CHAR_INJURED( l_U534[l_U248] )))
                    {
                        if ((IS_CHAR_PLAYING_ANIM( l_U534[l_U248], "MINI_BOWLING", "F_PED_STRAFE_L" )) || (IS_CHAR_PLAYING_ANIM( l_U534[l_U248], "MINI_BOWLING", "PED_STRAFE_L" )))
                        {
                            GET_CHAR_EXTRACTED_DISPLACEMENT( l_U534[l_U248], 1, ref uVar14._fU0, ref uVar14._fU4, ref uVar14._fU8 );
...
void sub_23423()
{
    ...
    switch (l_U571)
    {
        ...
        if (DOES_OBJECT_EXIST( l_U552[5] ))
        {
            if ((l_U441._fU4 < l_U438._fU4) || (l_U441._fU0 < l_U438._fU0))
            {
                if (l_U510)
                {
...
void sub_26802()
{
    ...
    for ( I = 1; I <= 10; I++ )
    {
        if (DOES_OBJECT_EXIST( l_U540[I] ))
        {
            ...
            if ((fVar7 > 0.20000000) || (NOT (IS_OBJECT_UPRIGHT( l_U540[I], 15.00000000 ))))
            {
                Result++;
                l_U496[I] = 0;
            }
