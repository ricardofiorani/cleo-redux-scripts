...
void sub_2417()
{
    switch (l_U196)
    {
        ...
        while ((NOT (HAVE_ANIMS_LOADED( "MISSMARNIE2" ))) || (NOT (HAS_MODEL_LOADED( l_U236 ))))
        {
            WAIT( 0 );
        }
...
void sub_3156()
{
    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U214, sub_2065(), 0 )) || (IS_CHAR_INJURED( l_U214 )))
    {
        if (IS_HINT_RUNNING())
        {
            HINT_CAM( -1.00000000, -1.00000000, -1.00000000, l_U214, 0, 0, 0 );
    ...
    if ((IS_CHAR_ON_FOOT( sub_2065() )) AND (sub_3335() < 25))
    {
    ...
    {
        case 0:
        if ((IS_WANTED_LEVEL_GREATER( sub_1075(), 0 )) || ((IS_CHAR_ON_FIRE( l_U214 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U214, sub_2065(), 0 )) || (IS_CHAR_INJURED( l_U214 )))))
        {
        ...
        if (NOT (IS_CHAR_INJURED( l_U214 )))
        {
            if ((IS_CHAR_ON_FOOT( sub_2065() )) AND (sub_3335() < 18))
            {
                if ((NOT l_U264) AND (NOT IS_HINT_RUNNING()))
                {
...
void sub_7726()
{
            ...
            if (NOT (IS_GROUP_MEMBER( l_U214, sub_5214() )))
            {
                ...
                if (DOES_BLIP_EXIST( l_U217 ))
                {
                    if (sub_3335() < 12.00000000)
                    {
                        ...
                        if (NOT (IS_CHAR_INJURED( l_U214 )))
                        {
                            if ((NOT (IS_CHAR_IN_ANY_CAR( sub_2065() ))) AND (NOT (IS_CHAR_INJURED( sub_2065() ))))
                            {
                                if (NOT l_U281)
                                {
    ...
    switch (l_U200)
    {
        ...
        if ((NOT (IS_VEH_DRIVEABLE( l_U215 ))) AND (DOES_VEHICLE_EXIST( l_U215 )))
        {
        ...
        if (NOT (IS_CHAR_INJURED( l_U214 )))
        {
            ...
            {
                if ((sub_4497( 1, 1 )) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_2065(), l_U228._fU0, l_U228._fU4, l_U228._fU8 + 2.50000000, 2.50000000, 2.50000000, 2.50000000, 1 )))
                {
                    if (sub_9361( l_U244 ))
                    {
                        sub_1154( ref l_U244, 0 );
                    ...
                    if (IS_CHAR_IN_ANY_CAR( sub_2065() ))
                    {
                        if (NOT (IS_CAR_UPSIDEDOWN( l_U215 )))
                        {
                            ...
                            {
                                l_U285 = 1;
                                while ((NOT (sub_13090( sub_2065() ))) || (NOT (sub_13015( l_U215 ))))
                                {
                                    WAIT( 0 );
                                }
                                DO_SCREEN_FADE_OUT( 250 );
                            ...
                            else
                            {
                                ...
                                CLEAR_AREA( 22.12860000, -49.74600000, 13.84180000, 15.00000000, 1 );
                                CLEAR_AREA_OF_CARS( l_U228._fU0, l_U228._fU4, l_U228._fU8, 30.00000000 );
                                if ((NOT (IS_CHAR_INJURED( l_U214 ))) AND (NOT (IS_CAR_DEAD( l_U215 ))))
                                {
                            ...
                            if ((NOT (IS_CHAR_INJURED( sub_2065() ))) AND ((NOT (IS_CHAR_INJURED( l_U214 ))) AND (NOT l_U204)))
                            {
        ...
        break;
        case 10:
        if ((TIMERB() > 5000) || ((l_U213 == 1) || ((NOT (IS_CHAR_ON_SCREEN( l_U214 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U214, l_U231._fU0, l_U231._fU4, l_U231._fU8 + 1.60000000, 1.60000000, 1.60000000, 1.60000000, 0 )))))
        {
            if (NOT (IS_CAR_DEAD( l_U215 )))
            {
                if (IS_THIS_MODEL_A_HELI( l_U237 ))
...
int sub_13015(unknown uParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        ...
        if ((IS_CAR_STOPPED( uParam0 )) || (fVar3 < 0.50000000))
        {
            return 1;
        }
    }
