    ...
    while (IS_PLAYER_PLAYING( sub_515() ))
    {
        ...
        switch (l_U1054)
        {
            ...
            switch (l_U1055)
            {
                ...
                break;
                case 1:
                if ((sub_6906( 8 )) AND (HAS_MODEL_LOADED( -1660661558 )))
                {
                    SETTIMERA( 0 );
                    l_U1055++;
                }
                ...
                bVar2 = false;
                if ((NOT (sub_7103( l_U837._fU0._fU0, l_U837._fU0._fU4, l_U837._fU0._fU8, 5.00000000, 1128792064 ))) AND (TIMERA() > 5000))
                {
                    bVar2 = true;
                }
            ...
            switch (l_U1055)
            {
                ...
                break;
                case 1:
                if ((NOT (IS_KEYBOARD_KEY_JUST_PRESSED( 49 ))) AND (TIMERA() < 600000))
                {
                    if (l_U829)
                    {
                        l_U837 = {sub_1570( g_U64920 )};
            ...
            if (IS_VEH_DRIVEABLE( l_U1074 ))
            {
                if (NOT (IS_CHAR_INJURED( l_U1064 )))
                {
                    ...
                    {
                        if ((NOT (LOCATE_CAR_2D( l_U1074, l_U850._fU0._fU0, l_U850._fU0._fU4, 50.00000000, 50.00000000, 0 ))) AND (NOT (LOCATE_CAR_3D( l_U1074, l_U850._fU0._fU0, l_U850._fU0._fU4, l_U850._fU0._fU8, 7.00000000, 7.00000000, 5.00000000, 1 ))))
                        {
                            ...
                            if (NOT l_U834)
                            {
                                if ((l_U1053 > 5000.00000000) AND (l_U1052 < 2000.00000000))
                                {
            ...
            if (l_U1054 == 4)
            {
                ...
                if (IS_VEH_DRIVEABLE( l_U1074 ))
                {
                    if ((CHECK_STUCK_TIMER( l_U1074, 0, 5000 )) || ((CHECK_STUCK_TIMER( l_U1074, 1, 5000 )) || ((CHECK_STUCK_TIMER( l_U1074, 2, 5000 )) || (CHECK_STUCK_TIMER( l_U1074, 3, 5000 )))))
                    {
                        bVar2 = true;
                    }
                }
            ...
            switch (l_U1055)
            {
                ...
                if (IS_PLAYER_PLAYING( sub_515() ))
                {
                    ...
                    if ((l_U831) AND (IS_VEH_DRIVEABLE( l_U1074 )))
                    {
                ...
                if (IS_PLAYER_PLAYING( sub_515() ))
                {
                    if (IS_VEH_DRIVEABLE( l_U1074 ))
                    {
                        if ((NOT (sub_24505( l_U1074 ))) AND ((NOT (sub_24334( l_U1074 ))) AND ((NOT (sub_24089( sub_810() ))) AND (NOT (IS_CHAR_IN_CAR( sub_810(), l_U1074 ))))))
                        {
                            if (DOES_BLIP_EXIST( l_U810 ))
                            {
                                REMOVE_BLIP( l_U810 );
...
void sub_1028()
{
    if ((DOES_CAM_EXIST( l_U1049 )) || ((DOES_CAM_EXIST( l_U1047 )) || ((DOES_CAM_EXIST( l_U1048 )) || (DOES_CAM_EXIST( l_U1046 )))))
    {
        if (IS_PLAYER_PLAYING( sub_515() ))
        {
            sub_782( 1 );
...
void sub_1440()
{
    if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "BRCH4" )) || ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "BRCH3" )) || ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "BRCH2" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "BRCH1" )))))
    {
        CLEAR_HELP();
    }
    return;
...
void sub_1590()
{
    ...
    l_U100[3]._fU32 = {160.08150000, -592.97450000, 261.71950000};
    ...
    l_U100[6]._fU48 = 1;
    l_U100[7]._fU0 = {-235.64820000, 739.35420000, 6.17110000};
    ...
    l_U100[11]._fU32 = {1470.00000000, 694.23290000, 41.14000000};
    ...
    l_U100[18]._fU32 = {-1191.20400000, 931.90990000, 99.74670000};
...
int sub_4885()
{
    if (IS_PLAYER_PLAYING( sub_515() ))
    {
        if ((IS_CHAR_IN_AREA_3D( sub_810(), -512.00000000, -1016.00000000, -100.00000000, -384.00000000, -896.00000000, 100.00000000, 0 )) || (IS_CHAR_IN_AREA_3D( sub_810(), -832.00000000, -1096.00000000, -100.00000000, -462.80000000, -616.00000000, 100.00000000, 0 )))
        {
            return 1;
        }
    }
...
void sub_10106()
{
    ...
    if (l_U837._fU48)
    {
        ...
        {
            if ((NOT (LOCATE_CHAR_ON_FOOT_3D( sub_810(), l_U837._fU32._fU0, l_U837._fU32._fU4, l_U837._fU32._fU8, 2.00000000, 2.00000000, 5.00000000, 0 ))) AND (NOT (LOCATE_CHAR_ON_FOOT_3D( sub_810(), l_U837._fU16._fU0, l_U837._fU16._fU4, l_U837._fU16._fU8, 2.00000000, 2.00000000, 5.00000000, 0 ))))
            {
                l_U811 = 0;
            }
        }
...
void sub_26446()
{
    if (l_U819)
    {
        if ((NOT (sub_17346( 1 ))) AND ((NOT (sub_17265( 1 ))) AND ((NOT (IS_GAME_KEYBOARD_NAV_LEFT_PRESSED( 0 ))) AND ((NOT (IS_GAME_KEYBOARD_NAV_RIGHT_PRESSED( 0 ))) AND ((NOT (IS_GAME_KEYBOARD_NAV_DOWN_PRESSED( 0 ))) AND ((NOT (IS_GAME_KEYBOARD_NAV_UP_PRESSED( 0 ))) AND ((NOT (IS_BUTTON_PRESSED( 0, 10 ))) AND ((NOT (IS_BUTTON_PRESSED( 0, 11 ))) AND ((NOT (IS_BUTTON_PRESSED( 0, 9 ))) AND ((NOT (IS_BUTTON_PRESSED( 0, 8 ))) AND ((NOT (IS_CONTROL_PRESSED( 2, 84 ))) AND ((NOT (IS_CONTROL_PRESSED( 2, 82 ))) AND ((NOT (IS_CONTROL_PRESSED( 2, 83 ))) AND ((NOT (IS_CONTROL_PRESSED( 2, 81 ))) AND ((NOT (IS_CONTROL_PRESSED( 2, 3 ))) AND ((NOT (IS_CONTROL_PRESSED( 2, 2 ))) AND ((NOT (IS_CONTROL_PRESSED( 2, 78 ))) AND (NOT (IS_CONTROL_PRESSED( 2, 77 ))))))))))))))))))))
        {
            l_U819 = 0;
        }
    }
...
void sub_31246()
{
    ...
    if (IS_CHAR_IN_ANY_POLICE_VEHICLE( sub_810() ))
    {
        ...
        if ((NOT (IS_CHAR_IN_MODEL( sub_810(), -488123221 ))) AND (NOT (IS_CHAR_IN_MODEL( sub_810(), 837858166 ))))
        {
