...
void sub_2114()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_2152( 5, g_U569[I] )) == 1))
        {
...
void sub_4338()
{
    ...
    CREATE_PICKUP_ROTATE( 1069950328, 22, 200, -184.95100000, 583.28010000, 119.54000000, 0.00000000, 0, 90, ref l_U2306[0] );
...
void sub_8165()
{
    ...
    if ((l_U795 != nil) AND ((NOT (IS_CAR_DEAD( l_U795 ))) AND (DOES_VEHICLE_EXIST( l_U795 ))))
    {
        ...
        {
            if ((l_U796 != nil) AND (l_U796 != l_U795))
            {
...
void sub_8537()
{
    switch (l_U2672)
    {
        ...
        while ((NOT (REQUEST_MISSION_AUDIO_BANK( "SCRIPT_MISSION/HOTEL_ATTACK" ))) || ((NOT (HAVE_ANIMS_LOADED( "missray6" ))) || ((NOT (HAVE_ANIMS_LOADED( "missray6" ))) || ((NOT (HAS_MODEL_LOADED( -252599135 ))) || ((NOT (HAS_MODEL_LOADED( -859769635 ))) || ((NOT (HAS_MODEL_LOADED( 1289046123 ))) || ((NOT (HAS_MODEL_LOADED( 1739259976 ))) || ((NOT (HAS_MODEL_LOADED( l_U1289 ))) || ((NOT (HAS_MODEL_LOADED( 467469635 ))) || ((NOT (HAS_MODEL_LOADED( -196312163 ))) || ((NOT (HAS_MODEL_LOADED( 549562642 ))) || ((NOT (HAS_MODEL_LOADED( -1346357795 ))) || ((NOT (HAS_MODEL_LOADED( -121234208 ))) || ((NOT (HAS_MODEL_LOADED( -24996117 ))) || ((NOT (HAS_MODEL_LOADED( -16333017 ))) || ((NOT (HAS_MODEL_LOADED( 948346586 ))) || ((NOT (HAS_MODEL_LOADED( 1667998832 ))) || ((NOT (HAS_MODEL_LOADED( -2090179830 ))) || (NOT (HAS_MODEL_LOADED( -471902624 )))))))))))))))))))))
        {
...
void sub_10786()
{
    switch (l_U1294)
    {
        ...
        {
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3418(), -165.99800000, 606.52580000, 14.71540000, 4.00000000, 1.00000000, 1.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3418(), -166.54880000, 611.85440000, 15.51190000, 1.60000000, 1.60000000, 1.60000000, 1 )))
            {
                if (sub_11185( 1, 1 ))
                {
                    if (NOT (IS_WANTED_LEVEL_GREATER( sub_3318(), 0 )))
...
void sub_11779()
{
    ...
    else if ((IS_SCREEN_FADED_IN()) AND ((NOT l_U2214) AND (l_U799 > 0)))
    {
        if (sub_11799())
        {
            CLEAR_PRINTS();
    ...
    switch (l_U799)
    {
        ...
        if (DOES_OBJECT_EXIST( l_U2231[0] ))
        {
            ...
            SET_CAM_POS( l_U2204, -164.51240000, 601.17390000, 15.24890000 );
        ...
        if ((NOT l_U2535) AND (NOT l_U2214))
        {
            if (NOT l_U2223)
            {
                if (NOT (IS_CHAR_DEAD( l_U2301 )))
        ...
        if (NOT (IS_CHAR_DEAD( l_U2301 )))
        {
            if ((l_U2535) || ((l_U2214) || (NOT (IS_CHAR_ON_SCREEN( l_U2301 )))))
            {
...
void sub_20048()
{
    switch (l_U2681)
    {
        ...
        l_U2671 = 0;
        l_U2380 = 1;
        LOAD_SCENE( -166.95640000, 594.43680000, 131.53910000 );
        SET_CHAR_COORDINATES( sub_3418(), -166.95640000, 594.43680000, 131.53910000 );
        ...
        if (IS_EXPLOSION_IN_AREA( -1, -185.46970000, 577.50300000, 125.00000000, -175.74670000, 587.29420000, 150.00000000 ))
        {
            if (DOES_CHAR_EXIST( l_U2104[2] ))
            {
                if (NOT (IS_CHAR_DEAD( l_U2104[2] )))
                {
                    ...
                    {
                        if ((sub_28840( sub_3418() )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3418(), -177.35420000, 594.56390000, 126.73830000, 9.00000000, 16.00000000, 2.00000000, 0 )))
                        {
                            if (IS_EXPLOSION_IN_AREA( -1, -185.46970000, 577.50300000, 125.00000000, -175.74670000, 587.29420000, 150.00000000 ))
                            {
                                WAIT( 500 );
    ...
    switch (uParam0)
    {
        ...
        if (NOT l_U2384)
        {
            ...
            if (NOT (DOES_CHAR_EXIST( l_U1657[27] )))
            {
                ...
                l_U1750[27] = 1;
                l_U1781[27]._fU0 = 0;
                l_U1781[27]._fU28 = {-151.50860000, 583.94930000, 113.21640000};
        ...
        if (NOT l_U2388)
        {
            if ((NOT (HAS_MODEL_LOADED( l_U1285 ))) || ((NOT (HAS_MODEL_LOADED( l_U1282 ))) || ((NOT (HAS_MODEL_LOADED( l_U1288 ))) || (NOT (HAS_MODEL_LOADED( l_U1290 ))))))
            {
                REQUEST_MODEL( l_U1290 );
                REQUEST_MODEL( l_U1288 );
                REQUEST_MODEL( l_U1282 );
                REQUEST_MODEL( l_U1285 );
                while ((NOT (HAS_MODEL_LOADED( l_U1285 ))) || ((NOT (HAS_MODEL_LOADED( l_U1282 ))) || ((NOT (HAS_MODEL_LOADED( l_U1288 ))) || (NOT (HAS_MODEL_LOADED( l_U1290 ))))))
                {
                    WAIT( 0 );
                }
            }
            ...
            if (NOT l_U2384)
            {
                CREATE_CHAR( 26, l_U1283, -172.47210000, 599.76350000, 119.03420000, ref l_U1657[3], 1 );
            ...
            if ((NOT l_U2120[0]) AND (NOT (DOES_CHAR_EXIST( l_U2104[0] ))))
            {
            ...
            if ((NOT l_U2120[1]) AND (NOT (DOES_CHAR_EXIST( l_U2104[1] ))))
            {
            ...
            if ((NOT l_U2120[2]) AND (NOT (DOES_CHAR_EXIST( l_U2104[2] ))))
            {
                CREATE_CHAR( 26, l_U1285, -176.88300000, 577.00480000, 125.98130000, ref l_U2104[2], 1 );
...
void sub_29001()
{
    ...
    else if ((IS_SCREEN_FADED_IN()) AND ((NOT l_U2567) AND ((l_U2559 < 5) AND (l_U2559 > 0))))
    {
        if (sub_11799())
        {
            CLEAR_PRINTS();
    ...
    switch (l_U2559)
    {
        ...
        case 4:
        GET_GAME_TIMER( ref l_U2545 );
        if ((l_U2567) || ((l_U2545 - l_U2544) > 5000))
        {
            if (NOT l_U2562)
            {
                ...
                GET_INTERIOR_AT_COORDS( -183.60840000, 591.54610000, 121.77930000, ref uVar15 );
        ...
        if (sub_34040())
        {
            ...
            if (NOT l_U2339[1])
            {
                ...
                if (iVar5 == nil)
                {
                    ...
                    if ((IS_CHAR_IN_ANY_HELI( sub_3418() )) || (uVar2._fU8 < 20.00000000))
                    {
...
int sub_34040()
{
    ...
    bVar4 = true;
    if ((l_U2524) || (IS_CHAR_DEAD( l_U2104[0] )))
    {
    ...
    if ((l_U2523) || (IS_CHAR_DEAD( l_U2104[1] )))
    {
        if (NOT l_U2120[1])
        {
            l_U2120[1] = 1;
...
int sub_34964()
{
    switch (l_U2639)
    {
        ...
        else if ((HAS_MODEL_LOADED( l_U2641 )) AND (HAS_MODEL_LOADED( l_U2640 )))
        {
            l_U2639++;
        }
        break;
...
int sub_52461()
{
    ...
    else
    {
        ...
        if (((l_U2521 - l_U2520) > 10000) || ((HAS_MODEL_LOADED( l_U1285 )) AND ((HAS_MODEL_LOADED( l_U1282 )) AND ((HAS_MODEL_LOADED( l_U1288 )) AND (HAS_MODEL_LOADED( l_U1290 ))))))
        {
            return 1;
        }
    }
...
void sub_54853(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, boolean bParam6, unknown uParam7)
{
    ...
    if ((uParam7) || (l_U1346[uVar19]._fU24._fU0 != l_U1346[uVar19]._fU4._fU0))
    {
...
void sub_55959(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    ...
    if (DOES_OBJECT_EXIST( uParam0 ))
    {
        ...
        if ((l_U625) || (l_U537))
        {
            if ((l_U625) || (IS_CONTROL_PRESSED( 0, 23 )))
            {
                if ((l_U625) || (l_U538))
                {
                    if ((l_U625) || (l_U536))
    ...
    if (NOT (IS_CHAR_DEAD( sub_3418() )))
    {
        if ((IS_CHAR_PLAYING_ANIM( sub_3418(), uParam4, "GET_IN_LIFT_TOP" )) || ((IS_CHAR_PLAYING_ANIM( sub_3418(), uParam4, "operate_lift_intro" )) || ((IS_CHAR_PLAYING_ANIM( sub_3418(), uParam4, "OPERATE_LIFT_SWITCH" )) || (IS_CHAR_PLAYING_ANIM( sub_3418(), uParam4, "GET_IN_LIFT_BOTTOM" )))))
        {
            l_U624 = 1;
        }
        else
...
int sub_58497(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_3318() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_3318() )))
            {
                if (((g_U9202) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_3318() )))))
                {
                    if (NOT sub_58593())
                    {
...
void sub_59919(unknown uParam0)
{
    ...
    if (l_U489)
    {
        if (l_U601)
        {
            if (NOT (IS_CHAR_DEAD( sub_3418() )))
            {
                if ((IS_CHAR_PLAYING_ANIM( sub_3418(), uParam0, "GET_IN_LIFT_TOP" )) || (IS_CHAR_PLAYING_ANIM( sub_3418(), uParam0, "GET_IN_LIFT_BOTTOM" )))
                {
                    l_U626 = 1;
                }
            }
...
void sub_61151(unknown uParam0, float fParam1, float fParam2, unknown uParam3)
{
    ...
    if ((l_U488) || ((iVar7 < 129) AND (iVar7 > 10)))
    {
...
void sub_63472()
{
    ...
    switch (l_U1281)
    {
        ...
        else if ((NOT l_U2390) AND ((NOT l_U2535) AND (NOT l_U2216)))
        {
            l_U2219 = 1;
            sub_67696();
        }
...
int sub_63662(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, boolean bParam17)
{
    ...
    switch (l_U2552)
    {
        ...
        if ((sub_58497( 4, 0 )) AND (LOCATE_CHAR_ON_FOOT_3D( sub_3418(), uVar20._fU0, uVar20._fU4, uVar23, 0.80000000, 0.80000000, 1.50000000, 0 )))
        {
...
int sub_64758(unknown uParam0)
{
    ...
    if ((l_U2535) || ((l_U2216) || ((iVar3 - l_U1346[uVar7]._fU68) >= l_U1346[uVar7]._fU72)))
    {
...
void sub_65685(unknown uParam0)
{
    ...
    if (NOT l_U2535)
    {
        ...
        else if ((NOT l_U2216) AND (l_U2539 > 0))
        {
            if (sub_11799())
            {
                if (NOT IS_SCREEN_FADING_IN())
    ...
    switch (l_U2539)
    {
        ...
        if (sub_64758( uParam0 ))
        {
            ...
            if ((NOT l_U2535) AND ((NOT l_U2216) AND (NOT l_U2377)))
            {
                l_U2377 = 1;
            }
            else if ((NOT l_U2535) AND (NOT l_U2216))
            {
...
void sub_67696()
{
    ...
    while (NOT bVar2)
    {
        ...
        else if ((NOT l_U2218) AND (l_U1293 > 0))
        {
            if (sub_11799())
            {
                CLEAR_PRINTS();
        ...
        switch (l_U1293)
        {
            ...
            case 2:
            GET_GAME_TIMER( ref l_U2220 );
            if ((l_U2218) || ((l_U2220 - l_U2221) >= 4000))
            {
                SET_GAME_CAM_HEADING( 0.00000000 );
                if (NOT l_U2218)
                {
...
void sub_70078()
{
    ...
    switch (l_U2300)
    {
        ...
        if (NOT l_U2384)
        {
            if (l_U2375)
            {
                ...
                if (((((l_U2634 - l_U2633) < 30000) AND (l_U2630)) || (NOT l_U2630)) AND ((NOT l_U2390) AND ((NOT l_U2315) AND ((NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_3418(), -177.06710000, 597.39250000, 114.71330000, 1.00000000, 2.00000000, 1.00000000, 0 ))) AND ((NOT (sub_70407( ref uVar5, 4, 1 ))) AND ((NOT (IS_CHAR_ARMED( sub_3418(), 7 ))) AND ((NOT (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U1657[15], sub_3418(), 0 ))) AND (NOT (IS_CHAR_INJURED( l_U1657[15] ))))))))))
                {
                    switch (l_U2583)
                    {
                        case 0:
                        ...
                        case 1:
                        GET_GAME_TIMER( ref l_U2634 );
                        if (((l_U2634 - l_U2633) < 15000) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_3418(), -180.16530000, 597.32500000, 114.71330000, 2.00000000, 1.00000000, 1.00000000, 0 ))))
                        {
        ...
        else if (l_U2375)
        {
            ...
            uVar5[4] = l_U1657[13];
            GET_CURRENT_CHAR_WEAPON( sub_3418(), ref iVar28 );
            if ((NOT (sub_70407( ref uVar5, 5, 1 ))) AND ((iVar28 == 0) AND ((NOT (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U1657[15], sub_3418(), 0 ))) AND (NOT (IS_CHAR_INJURED( l_U1657[15] ))))))
            {
                switch (l_U2583)
                {
                    case 0:
        ...
        if ((sub_72970( 0 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_3418(), -158.55940000, 592.51500000, 117.71330000, 2.00000000, 2.00000000, 2.00000000, l_U2396 )))
        {
            if (l_U2384)
            {
        ...
        if (NOT l_U2384)
        {
            if ((l_U2315) || ((l_U2383) || ((sub_72970( 0 )) || ((IS_BULLET_IN_AREA( -176.81540000, 595.74780000, 119.29890000, 4.00000000, 1 )) || ((sub_70407( ref uVar5, 6, 1 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_3418(), -161.26190000, 592.58940000, 117.71250000, 2.00000000, 2.00000000, 2.00000000, l_U2396 )))))))
            {
                l_U2552 = 0;
        ...
        {
            GET_CURRENT_CHAR_WEAPON( sub_3418(), ref iVar28 );
            if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_3418(), -165.20890000, 595.89720000, 118.78520000, 1.50000000, 6.00000000, 1.00000000, 0 ))) AND ((NOT (sub_70407( ref uVar5, 5, 1 ))) AND ((iVar28 == 0) AND ((NOT (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U1657[3], sub_3418(), 0 ))) AND (NOT (IS_CHAR_INJURED( l_U1657[3] )))))))
            {
        ...
        if (NOT l_U1315[2])
        {
            if ((l_U2383) || ((sub_70407( ref uVar5, 1, 1 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_3418(), -171.80600000, 596.55140000, 118.03410000, 3.00000000, 3.00000000, 3.00000000, l_U2396 ))))
            {
                l_U800[2]._fU4 = 1;
            }
        }
        ...
        if (NOT l_U2623)
        {
            if (NOT l_U2116[1])
            {
                ...
                if (CAM_IS_SPHERE_VISIBLE( uVar27, -180.49910000, 594.79220000, 118.29610000, 2.00000000 ))
                {
                    ...
                    TASK_FOLLOW_NAV_MESH_TO_COORD( 0, -182.05860000, 584.03710000, 118.30740000, 3, -2, 0.50000000 );
            ...
            else if (NOT l_U2624)
            {
                ...
                if (sub_70407( ref uVar5, 2, 2 ))
                {
                    if (NOT (IS_CHAR_DEAD( l_U2104[1] )))
                    {
                        ...
                        CLOSE_SEQUENCE_TASK( l_U2112[1] );
                        SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U2104[1], 1 );
                        if (((NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_3418(), -180.11020000, 597.69090000, 119.29890000, 3.00000000, 3.00000000, 1.00000000, 0 ))) AND (IS_CHAR_ON_SCREEN( l_U2104[1] ))) || (NOT (IS_CHAR_ON_SCREEN( l_U2104[1] ))))
                        {
        ...
        {
            if ((l_U2383) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U1657[9], sub_3418(), 0 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_3418(), -184.11470000, 591.30250000, 121.76770000, 2.00000000, 2.00000000, 2.00000000, l_U2396 ))))
            {
                if (NOT l_U1315[9])
                {
        ...
        if (NOT l_U2615)
        {
            if (NOT l_U2116[0])
            {
                if ((sub_80289()) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3418(), -180.76160000, 585.26310000, 122.77910000, 2.00000000, 1.00000000, 1.00000000, 0 )))
                {
        ...
        else if ((l_U2542) || (NOT (IS_CHAR_INJURED( l_U2104[0] ))))
        {
            if (NOT l_U2524)
            {
                if (NOT l_U2542)
        ...
        if ((l_U2383) || (LOCATE_CHAR_ON_FOOT_3D( sub_3418(), -181.66540000, 591.33340000, 124.02000000, 2.00000000, 2.00000000, 2.00000000, l_U2396 )))
        {
            if (NOT l_U1315[8])
            {
        ...
        uVar5[2] = l_U2104[2];
        uVar5[3] = l_U1657[9];
        if ((sub_86090()) || ((IS_BULLET_IN_AREA( -179.01100000, 589.83650000, 126.83510000, 5.50000000, 1 )) || ((IS_BULLET_IN_AREA( -179.20300000, 580.97000000, 126.85030000, 5.50000000, 1 )) || ((sub_85921( ref uVar5, 4, 1 )) || ((sub_70407( ref uVar5, 4, 1 )) || ((LOCATE_CHAR_ON_FOOT_3D( sub_3418(), -179.54500000, 595.03120000, 126.78840000, 5.50000000, 5.00000000, 3.00000000, l_U2396 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_3418(), -175.98610000, 590.46870000, 125.80560000, 2.00000000, 2.00000000, 2.00000000, l_U2396 ))))))))
        {
            SET_PED_IS_BLIND_RAGING( sub_3418(), 1 );
            if (NOT (IS_WANTED_LEVEL_GREATER( sub_3318(), 0 )))
            {
    ...
    if (l_U2384)
    {
        if ((l_U2300 == 7) || ((l_U2300 == 6) || (l_U2300 == 5)))
        {
            uVar5[0] = l_U1657[0];
            uVar5[1] = l_U1657[10];
            uVar5[2] = l_U1657[11];
...
int sub_70407(unknown uParam0, int iParam1, int iParam2)
{
    ...
    if (((iVar6 + iVar7) >= iParam2) || ((iVar7 >= iParam2) || (iVar6 >= iParam2)))
    {
        return 1;
    }
    return 0;
...
void sub_78044()
{
    ...
    switch (l_U2570)
    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U2104[1] )))
        {
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3418(), -184.00840000, 585.49380000, 119.30150000, 1.00000000, 3.50000000, 2.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3418(), -181.09530000, 588.12190000, 119.29850000, 2.00000000, 6.00000000, 1.00000000, 0 )))
            {
        ...
        if (DOES_CHAR_EXIST( l_U2104[1] ))
        {
            if (NOT (IS_CHAR_INJURED( l_U2104[1] )))
            {
                if (IS_CHAR_PLAYING_ANIM( l_U2104[1], "missray6", "plead" ))
                {
                    ...
                    {
                        if ((NOT (sub_51657( sub_3418(), l_U2104[1] ))) || (NOT (IS_CHAR_ON_SCREEN( l_U2104[1] ))))
                        {
...
int sub_80289()
{
    ...
    if (bVar4)
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( sub_3418(), -181.09270000, 588.14440000, 122.78430000, 4.00000000, 2.00000000, 2.00000000, 0 ))
        {
            return 1;
        }
    }
...
int sub_82176(unknown uParam0)
{
    ...
    if (DOES_CHAR_EXIST( uParam0 ))
    {
        if (NOT (IS_CHAR_INJURED( sub_3418() )))
        {
            if (NOT (IS_CHAR_INJURED( uParam0 )))
            {
                if (((IS_CONTROL_JUST_PRESSED( 0, 4 )) AND ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_3318(), uParam0 )) AND (NOT IS_USING_CONTROLLER()))) || (GET_CHAR_MELEE_ACTION_FLAG0( uParam0 )))
                {
                    if ((NOT (IS_CHAR_INJURED( uParam0 ))) AND (NOT (IS_CHAR_INJURED( sub_3418() ))))
                    {
    ...
    for ( I = 0; I <= 29; I++ )
    {
        ...
        if (l_U800[I]._fU4)
        {
            ...
            if (NOT (IS_CHAR_DEAD( l_U800[I]._fU0 )))
            {
                ...
                if ((l_U800[I]._fU12) || (NOT l_U800[I]._fU16))
                {
                    if (I == l_U2424)
                    {
                        ;
        ...
        if (NOT (IS_CHAR_INJURED( l_U1657[I] )))
        {
            if (NOT l_U1781[I]._fU16)
            {
                if (l_U1750[I])
                {
                    ...
                    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U1657[I], sub_3418(), 1 )) AND (iVar4 < 200))
                    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U2104[I] )))
        {
            if (NOT l_U2132[I]._fU16)
            {
                if (l_U2128[I])
                {
                    ...
                    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U2104[I], sub_3418(), 0 )) AND (iVar4 < 200))
                    {
            ...
            else
            {
                ...
                GET_GAME_TIMER( ref iVar3 );
                if (((iVar3 - l_U2132[I]._fU20) > l_U2132[I]._fU24) || (uVar11._fU8 < l_U2132[I]._fU28._fU8))
                {
...
void sub_90582()
{
    ...
    switch (l_U2554)
    {
        ...
        if (l_U2338)
        {
            if ((IS_CHAR_IN_AREA_ON_FOOT_2D( sub_3418(), -169.34470000, 590.04720000, -164.00850000, 599.89330000, 0 )) || (sub_70407( ref uVar2, 5, 1 )))
            {
                CLEAR_PRINTS();
                ...
                else if (NOT IS_MESSAGE_BEING_DISPLAYED())
                {
                    ...
                    else if (NOT l_U2339[28])
                    {
                        if (NOT IS_MESSAGE_BEING_DISPLAYED())
                        {
                            ...
                            {
                                OPEN_SEQUENCE_TASK( ref l_U1688[3] );
                                TASK_ACHIEVE_HEADING( 0, 99.09951000 );
                                CLOSE_SEQUENCE_TASK( l_U1688[3] );
                                if (NOT (IS_CHAR_INJURED( l_U1657[3] )))
                                {
                                    TASK_PERFORM_SEQUENCE( l_U1657[3], l_U1688[3] );
...
void sub_92175()
{
    ...
    while (NOT bVar2)
    {
        ...
        if ((fVar3 < 176.00000000) AND (fVar3 < 180.00000000))
        {
            fVar3 += 5.00000000;
