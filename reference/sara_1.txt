void main()
{
    ...
    if (sub_431( l_U358, l_U324 ))
    {
        ...
        {
            sub_1179( ref l_U342 );
            if ((l_U342._fU8._fU0 <= 5) || (l_U342._fU8._fU0 >= 21))
            {
                    ...
                    while (true)
                    {
                        ...
                        if (NOT l_U215)
                        {
                            if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
                            {
                                ...
                                {
                                    sub_2696();
                                    if ((sub_3191( ref l_U238, 22.00000000 )) || (sub_3099( ref l_U238 )))
                                    {
                                        sub_3368();
                                    }
                                    sub_3755( ref l_U241 );
                        ...
                        if (l_U215)
                        {
                            ...
                            if ((NOT l_U217) AND (IS_KEYBOARD_KEY_PRESSED( 30 )))
                            {
...
int sub_2696()
{
    if (l_U216)
    {
        if (IS_HINT_RUNNING())
        {
            if ((sub_2896()) || ((sub_2731( ref l_U238 )) > 18.00000000))
            {
                HINT_CAM( 0.00000000, 0.00000000, 0.50000000, l_U238, 0, 0, 0 );
                l_U216 = 0;
                return 1;
...
void sub_11264()
{
    switch (l_U203)
    {
        ...
        if ((NOT l_U206) AND (IS_KEYBOARD_KEY_PRESSED( 36 )))
        {
...
int sub_11775(unknown uParam0)
{
    ...
    if (((sub_2731( ref uParam0 )) < (10.00000000 * 2.00000000)) AND (IS_PLAYER_PRESSING_HORN( sub_1132() )))
    {
        return 1;
    }
    return 0;
...
int sub_12548(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
    {
        if (IS_PED_IN_GROUP( (uParam0^) ))
        {
            ...
            if ((IS_CHAR_ON_FOOT( sub_1930() )) AND (IS_CHAR_ON_FOOT( (uParam0^) )))
            {
                return 1;
            }
            if (DOES_VEHICLE_EXIST( (uParam1^) ))
            {
                ...
                {
                    if ((IS_CHAR_SITTING_IN_CAR( sub_1930(), (uParam1^) )) AND (IS_CHAR_SITTING_IN_CAR( (uParam0^), (uParam1^) )))
                    {
                        return 1;
                    }
                }
...
void sub_15904()
{
    ...
    if (NOT l_U222)
    {
        if (DOES_VEHICLE_EXIST( l_U241 ))
        {
            ...
            {
                if (LOCATE_CAR_3D( l_U241, -549.72560000, 1096.89200000, 8.96249900, 9.00000000, 9.00000000, 9.00000000, 0 ))
                {
        ...
        SET_CHAR_COORDINATES( sub_1930(), -550.72560000, 1096.89200000, 8.96249900 );
    ...
    if (IS_BIG_VEHICLE( l_U241 ))
    {
        ...
        SET_CAM_ROT( l_U316, -30.69725000, 10.38569000, -46.66827000 );
        SET_CAM_FOV( l_U316, 33.30004000 );
        SET_CAM_POS( l_U317, -559.87170000, 1080.64000000, 18.95524000 );
        SET_CAM_ROT( l_U317, -30.69725000, 10.38569000, -46.66827000 );
...
void sub_16154()
{
    ...
    SET_CAM_POS( l_U316, -562.04400000, 1081.57800000, 17.68784000 );
    SET_CAM_ROT( l_U316, -19.11198000, -8.14996800, -40.15344000 );
    SET_CAM_FOV( l_U316, 30.30004000 );
    SET_CAM_POS( l_U317, -562.04400000, 1081.57800000, 17.68784000 );
        ...
        if (NOT (IS_CHAR_INJURED( l_U239 )))
        {
            ...
            if (l_U356 == 7)
            {
                ...
                if ((l_U112) || (l_U232))
                {
                    ...
                    SET_CAM_POS( l_U306, -551.05130000, 1102.05100000, 10.25088000 );
                    SET_CAM_ROT( l_U306, 4.11227800, 0.11429900, -154.06620000 );
        ...
        if (NOT (IS_CHAR_INJURED( l_U239 )))
        {
            if (sub_12972( l_U359[0] ))
            {
                if ((sub_20035( l_U359[0] )) > 1)
                {
                    ...
                    SET_CAM_POS( l_U306, -550.79180000, 1100.12200000, 10.30008000 );
                    SET_CAM_ROT( l_U306, 20.86989000, 2.86448500, -11.85286000 );
                    SET_CAM_FOV( l_U306, 30.00004000 );
                    SET_CAM_POS( l_U307, -550.79180000, 1100.12200000, 10.30008000 );
        ...
        if (NOT (IS_CHAR_INJURED( l_U239 )))
        {
            ...
            if (l_U222)
            {
                if (IS_VEH_DRIVEABLE( l_U241 ))
                {
                    ...
                    if (l_U112)
                    {
                        SET_CAM_POS( l_U311, -555.51300000, 1098.29300000, 9.59023900 );
            ...
            else
            {
                ...
                TASK_PERFORM_SEQUENCE( sub_1930(), l_U355 );
                CLEAR_SEQUENCE_TASK( l_U355 );
                SET_CAM_POS( l_U311, -544.90590000, 1103.78200000, 10.67905000 );
