void main()
{
    ...
    while (true)
    {
        ...
        switch (l_U833)
        {
            ...
            break;
            case 2:
            if ((NOT sub_19307()) AND (IS_CHAR_IN_ANY_POLICE_VEHICLE( sub_5191() )))
            {
                if (NOT l_U923)
                {
                    l_U923 = 1;
            ...
            if ((NOT sub_9910()) AND ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT bVar2)))
            {
                bVar2 = true;
                l_U951 = 0;
...
void sub_1761()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_1799( 5, g_U569[I] )) == 1))
        {
...
void sub_3696()
{
    ...
    while ((NOT (HAS_MODEL_LOADED( -268530289 ))) || ((NOT (HAS_MODEL_LOADED( l_U853 ))) || ((NOT (HAS_MODEL_LOADED( l_U852 ))) || (NOT (HAS_MODEL_LOADED( -276900515 ))))))
    {
        WAIT( 0 );
    }
    ...
    sub_4951( "PD_ADAM", "PD_DIMAYEV" );
    LOAD_SCENE( -64.73371000, 54.27560000, 13.76190000 );
    WAIT( 2000 );
...
void sub_5505()
{
    ...
    switch (l_U844)
    {
        ...
        break;
        case 1:
        if (LOCATE_CHAR_ANY_MEANS_3D( sub_5191(), 1148.05900000, 558.10720000, 32.95150000, 180.00000000, 180.00000000, 180.00000000, 0 ))
        {
        ...
        if (LOCATE_CHAR_ANY_MEANS_3D( sub_5191(), 1148.05900000, 558.10720000, 32.95150000, 90.00000000, 90.00000000, 90.00000000, 0 ))
        {
            if (NOT l_U957)
            {
                if (l_U925)
        ...
        if (NOT l_U927)
        {
            ...
            {
                if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_5191(), l_U866, 11.00000000, 11.00000000, 11.00000000, 0 )) AND ((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U866, sub_5191() )) AND (l_U948)))
                {
                    l_U931 = 1;
                    if (NOT l_U928)
                    {
            ...
            for ( I = 0; I < l_U854; I++ )
            {
                ...
                if (NOT l_U932[I])
                {
                    ...
                    {
                        if (((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U854[I], sub_5191() )) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_5191(), l_U854[I], fVar2, fVar2, fVar2, 0 ))) AND (l_U948))
                        {
            ...
            if ((IS_PROJECTILE_IN_AREA( 1129, 556, -10, 1181, 582, 44 )) || ((IS_EXPLOSION_IN_AREA( -1, 1130, 556, -10, 1189, 589, 70 )) || (IS_CHAR_SHOOTING_IN_AREA( sub_5191(), 1130, 537, 1189, 589, 0 ))))
            {
                if (NOT l_U928)
                {
                    l_U928 = 1;
        ...
        if ((l_U946) AND (l_U945))
        {
            sub_19611();
        }
        if (((IS_CHAR_DEAD( l_U866 )) || (l_U845 >= 8)) AND ((l_U946) AND (NOT l_U953)))
        {
            sub_19906();
        }
        if ((NOT l_U954) AND (l_U953))
        {
            if (NOT (IS_CHAR_INJURED( l_U854[3] )))
            {
                GET_SCRIPT_TASK_STATUS( l_U854[3], 29, ref l_U825 );
                if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U854[3], sub_5191(), 0 )) || (l_U825 == 7))
                {
                    sub_16935( 3 );
        ...
        if ((IS_CHAR_DEAD( l_U866 )) AND ((NOT l_U944) AND (l_U967 == 1)))
        {
            for ( I = 0; I < l_U854; I++ )
            {
                if (NOT (IS_CHAR_INJURED( l_U854[I] )))
        ...
        if ((NOT l_U957) AND ((NOT bVar4) AND ((l_U925) AND (l_U956))))
        {
            sub_12022( 0 );
            l_U956 = 0;
        }
        if ((l_U958) AND ((NOT bVar4) AND ((sub_21632( 0 )) AND (NOT l_U926))))
        {
            WAIT( 800 );
            PRINT_NOW( "CIA2_KILLMAR", 7500, 0 );
            l_U926 = 1;
    ...
    switch (l_U845)
    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U866 )))
        {
            ...
            if (l_U825 == 7)
            {
                ...
                TASK_EXTEND_ROUTE( 1180.14700000, 579.85930000, 38.60200000 );
            ...
            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U866, sub_5191(), 0 )) || ((l_U976 < 34) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_5191(), 1136.67200000, 568.96370000, 32.38560000, 3.00000000, 3.00000000, 3.00000000, 0 ))))
            {
                TASK_COMBAT( l_U866, sub_5191() );
                l_U845 = 12;
            }
        ...
        if (NOT (IS_CHAR_INJURED( l_U866 )))
        {
            ...
            {
                OPEN_SEQUENCE_TASK( ref l_U824 );
                TASK_SEEK_COVER_TO_COORDS( 0, 1182.12600000, 602.35540000, 42.55340000, 1172.22600000, 587.64290000, 43.27680000, 0 );
                CLOSE_SEQUENCE_TASK( l_U824 );
                TASK_PERFORM_SEQUENCE( l_U866, l_U824 );
                CLEAR_SEQUENCE_TASK( l_U824 );
                l_U845 = 10;
        ...
        {
            GET_CHAR_COORDINATES( sub_5191(), ref l_U974, ref l_U975, ref l_U976 );
            if ((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U866, sub_5191() )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_5191(), l_U866, 15.00000000, 15.00000000, 3.00000000, 0 )))
            {
...
void sub_9818()
{
    if ((NOT (IS_CHAR_DEAD( l_U866 ))) AND (NOT (IS_CHAR_DEAD( sub_5191() ))))
    {
        if ((l_U928) AND ((l_U957) AND ((NOT (sub_9977( l_U846 ))) AND ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND ((NOT sub_9910()) AND ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U866, sub_5191(), 14.00000000, 14.00000000, 14.00000000, 0 )) AND (HAS_CHAR_SPOTTED_CHAR_IN_FRONT( sub_5191(), l_U866 ))))))))
        {
            if (l_U959)
            {
                l_U972 = l_U973;
...
void sub_11258()
{
    ...
    if ((NOT (IS_CHAR_IN_AREA_3D( sub_5191(), 1130, 556, -10, 1189, 589, 70, 0 ))) AND (IS_SNIPER_BULLET_IN_AREA( 1130, 556, -10, 1189, 589, 70 )))
    {
        for ( I = 0; I < l_U854; I++ )
        {
            if (NOT (IS_CHAR_INJURED( l_U854[I] )))
...
void sub_11459()
{
    if ((NOT (IS_CHAR_INJURED( l_U866 ))) AND ((NOT (IS_CHAR_INJURED( l_U854[10] ))) AND ((NOT (IS_CHAR_INJURED( l_U854[8] ))) AND ((NOT (IS_CHAR_INJURED( l_U854[7] ))) AND ((NOT (IS_CHAR_INJURED( l_U854[6] ))) AND ((NOT (IS_CHAR_INJURED( l_U854[1] ))) AND ((NOT (IS_CHAR_INJURED( l_U854[0] ))) AND ((NOT (IS_CHAR_INJURED( l_U854[5] ))) AND (NOT (IS_CHAR_INJURED( l_U854[4] )))))))))))
    {
...
int sub_12413(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_5191() ))) AND (IS_CHAR_IN_ANY_CAR( sub_5191() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_12928()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_17236()
{
    ...
    if ((NOT l_U953) AND (NOT (IS_CHAR_DEAD( l_U854[3] ))))
    {
...
void sub_17606()
{
    ...
    if ((IS_CHAR_DEAD( l_U854[3] )) AND ((IS_CHAR_DEAD( l_U854[2] )) AND ((IS_CHAR_DEAD( l_U854[1] )) AND ((IS_CHAR_DEAD( l_U854[0] )) AND (NOT (IS_CHAR_DEAD( l_U854[8] )))))))
    {
...
int sub_19307()
{
    if ((IS_CHAR_IN_MODEL( sub_5191(), 837858166 )) || ((IS_CHAR_IN_MODEL( sub_5191(), 353883353 )) || ((IS_CHAR_IN_MODEL( sub_5191(), -488123221 )) || (IS_CHAR_IN_MODEL( sub_5191(), 1911513875 )))))
    {
        return 1;
        break;
    }
...
void sub_34731()
{
    if (sub_2972())
    {
        ...
        CLEAR_HELP();
        g_U64947 = 0;
        if (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_5191(), 1148.05900000, 558.10720000, 32.95150000, 90.00000000, 90.00000000, 90.00000000, 0 )))
        {
...
int sub_35178()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_1799( 1, g_U569[I] )) != 0))
        {
            sub_2085( I );
            return 1;
        }
