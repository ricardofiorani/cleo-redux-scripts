...
int sub_23()
{
    ...
    {
        if ((NOT (IS_CHAR_IN_AREA_2D( sub_32(), 145.30000000, 260.54000000, 980.33000000, 283.87000000, 0 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_32(), 708.61000000, 269.32350000, 34.93950000, 300, 300, 300, 0 ))))
        {
            return 1;
        }
        return 0;
