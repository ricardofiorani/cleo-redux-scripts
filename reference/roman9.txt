void main()
{
    ...
    {
        LOAD_SCENE( 812.78410000, -259.71920000, 14.33700000 );
        SET_CHAR_COORDINATES( sub_8503(), 812.78410000, -259.71920000, 14.33700000 );
    ...
    while (true)
    {
        ...
        switch (l_U481)
        {
            ...
            case 1:
            if (LOCATE_CHAR_ANY_MEANS_3D( sub_8503(), 975.79240000, -169.55270000, 25.00000000, 6.00000000, 6.00000000, 3.00000000, 0 ))
            {
                sub_2503();
                if ((l_U492 != 2) AND (NOT l_U493))
                {
            ...
            {
                if ((NOT sub_23788()) AND (NOT sub_23726()))
                {
                    sub_23866();
                }
                else if (sub_23965() != 0)
            ...
            SETTIMERB( 0 );
            case 3:
            if ((l_U498 > -1) AND ((TIMERB() >= 1250) AND (sub_24429())))
            {
                l_U498 = -1;
            }
            switch (l_U498)
            {
                ...
                TASK_FOLLOW_NAV_MESH_TO_COORD( sub_8503(), 972.28010000, -172.43000000, 23.19000000, 2, -1, 0.50000000 );
                l_U498++;
                break;
                case 1:
            ...
            switch (sub_23965())
            {
                ...
                else
                {
                    switch (g_U851._fU16)
                    {
                        ...
                        break;
                        default:
                        if ((TIMERA() < 5000) || (NOT l_U513))
                        {
                            PRINT_HELP_FOREVER( "R9_OS_HELP_1" );
                            if (NOT l_U513)
                            {
                                GET_MOUSE_INPUT( ref iVar2, ref iVar3 );
                                if ((iVar3 != 0) || ((iVar2 != 0) || ((IS_BUTTON_PRESSED( 0, 1 )) || (IS_BUTTON_PRESSED( 0, 0 )))))
                                {
                                    l_U513 = 1;
                                    SETTIMERA( 0 );
                                }
                ...
                if (COMPARE_STRING( ref g_U857._fU232._fU0, "www.eyefind.info" ))
                {
                    ...
                    {
                        sub_26921( 0 );
                        if (((l_U517 == 2) AND (l_U515)) || ((l_U517 < 3) AND (TIMERA() > 6000)))
                        {
                            SETTIMERA( 0 );
                            l_U517++;
                            if ((l_U517 == 2) AND (l_U515))
                            {
                                l_U517++;
                            }
                        }
            ...
            break;
            case 6:
            if ((NOT l_U497) AND ((l_U492 != 2) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_8503(), 971.06700000, -172.14020000, 24.19370000, 1.80000000, 1.80000000, 1.80000000, 0 ))))
            {
...
void sub_1591()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_1629( 5, g_U569[I] )) == 1))
        {
...
void sub_2494(unknown uParam0)
{
    ...
    if ((l_U492 == 1) AND (NOT (IS_CHAR_INJURED( l_U489 ))))
    {
...
void sub_6958()
{
    ...
    {
        iVar3 = sub_6986( 13 );
        if ((g_U9932[g_U9999[I]._fU0]._fU0) AND (sub_7031( 13, iVar3 )))
        {
    ...
    {
        iVar3 = sub_6986( 11 );
        if ((g_U9932[g_U10090[I]._fU0]._fU0) AND (sub_7031( 11, iVar3 )))
        {
    ...
    {
        iVar3 = sub_7512( I );
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_7031( g_U10324[I]._fU12, iVar3 )))
        {
...
void sub_8049()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_7512( I )))
        {
            iVar4++;
        }
    }
...
void sub_22726()
{
    ...
    switch (l_U492)
    {
        ...
        else if (((IS_INTERIOR_SCENE()) AND (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_6023(), l_U489 ))) || (((IS_CHAR_ARMED( sub_8503(), 7 )) AND (IS_PLAYER_TARGETTING_CHAR( sub_6023(), l_U489 ))) || ((IS_PED_FLEEING( l_U489 )) || ((IS_PED_RETREATING( l_U489 )) || (IS_PED_IN_COMBAT( l_U489 ))))))
        {
            MARK_CHAR_AS_NO_LONGER_NEEDED( ref l_U489 );
            l_U492 = 2;
        }
...
int sub_23788()
{
    if (LOCATE_CHAR_ANY_MEANS_3D( sub_8503(), 975.79240000, -169.55270000, 25.00000000, 14.00000000, 14.00000000, 10.00000000, 0 ))
    {
        return 1;
    }
    return 0;
