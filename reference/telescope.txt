...
int sub_1852(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_737() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_737() )))
            {
                if (((g_U9202) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_737() )))))
                {
                    if (NOT sub_1948())
                    {
...
int sub_4948()
{
    if ((sub_4996()) || ((IS_BUTTON_PRESSED( 0, 16 )) || ((IS_BUTTON_PRESSED( 0, 15 )) || ((IS_BUTTON_PRESSED( 0, 14 )) || (IS_BUTTON_PRESSED( 0, 17 ))))))
    {
        CLEAR_CHAR_TASKS_IMMEDIATELY( sub_1132() );
        SET_PLAYER_CONTROL( sub_737(), 1 );
        return 1;
...
void sub_5650()
{
    ...
    if ((l_U17 >= 65408) AND (l_U17 < 65436))
    {
        if (l_U26)
        {
            if (DOES_CAM_EXIST( l_U99 ))
    ...
    if ((l_U16 >= 65408) AND (l_U16 < 65436))
    {
        if (DOES_CAM_EXIST( l_U99 ))
        {
            GET_CAM_ROT( l_U99, ref l_U39, ref l_U40, ref l_U41 );
