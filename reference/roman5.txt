void main()
{
    ...
    l_U514 = 0;
    l_U515 = 0;
    l_U516 = {946.08690000, 330.26000000, 32.43500000};
    ...
    while (true)
    {
        ...
        if (IS_PLAYER_PLAYING( sub_3364() ))
        {
            ...
            if (DOES_CHAR_EXIST( l_U537 ))
            {
                ...
                {
                    if ((l_U498 > 6) || (l_U498 == 0))
                    {
                        if ((l_U491 < 2) AND (l_U493 > 4))
                        {
...
void sub_1515()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_1553( 5, g_U569[I] )) == 1))
        {
...
void sub_6857()
{
    ...
    while ((NOT (HAVE_ANIMS_LOADED( "MISSROMAN5" ))) || ((NOT (HAS_MODEL_LOADED( -268530289 ))) || (NOT (HAS_MODEL_LOADED( -650575089 )))))
    {
        WAIT( 0 );
    }
...
void sub_7867()
{
    ...
    switch (l_U493)
    {
        ...
        if (IS_VEH_DRIVEABLE( l_U545 ))
        {
            if (IS_CHAR_SITTING_IN_CAR( sub_2472(), l_U545 ))
            {
                if ((sub_8340( 1, 1 )) AND (LOCATE_CHAR_IN_CAR_3D( sub_2472(), l_U516._fU0, l_U516._fU4, l_U516._fU8, 2.50000000, 2.50000000, 2.50000000, l_U501 )))
                {
                    l_U502 = 0;
                    SET_ROUTE( l_U535, 0 );
...
void sub_11479()
{
    ...
    switch (l_U498)
    {
        ...
        if (sub_11706())
        {
            if (sub_11755())
            {
                if ((sub_8340( 1, 1 )) AND ((IS_CHAR_SITTING_IN_CAR( sub_2472(), l_U545 )) AND ((IS_CHAR_SITTING_IN_CAR( l_U537, l_U545 )) AND (LOCATE_CHAR_IN_CAR_3D( sub_2472(), l_U519._fU0, l_U519._fU4, l_U519._fU8, 2.50000000, 2.50000000, 2.50000000, l_U501 )))))
                {
        ...
        if (TIMERB() > 4000)
        {
            while ((NOT (HAS_MODEL_LOADED( -183203150 ))) || ((NOT (HAS_CAR_RECORDING_BEEN_LOADED( 181 ))) || ((NOT (HAS_CAR_RECORDING_BEEN_LOADED( 180 ))) || (NOT (HAS_MODEL_LOADED( 2046537925 ))))))
            {
                WAIT( 0 );
            }
            ...
            CLEAR_HELP();
            CLEAR_AREA( 955.88570000, -390.38170000, 16.17380000, 10.00000000, 1 );
            ...
            SET_CAM_POS( l_U553[3], 967.32440000, -383.66940000, 15.96223000 );
...
void sub_17199()
{
    if (IS_WANTED_LEVEL_GREATER( sub_3364(), 0 ))
    {
        if (NOT l_U515)
        {
            if ((l_U495 > 4) || (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_2472(), l_U519._fU0, l_U519._fU4, l_U519._fU8, 30.00000000, 30.00000000, 10.00000000, 0 ))))
            {
...
void sub_18020()
{
    ...
    switch (l_U491)
    {
        ...
        if (sub_11706())
        {
            if (sub_11755())
            {
                if ((sub_8340( 1, 1 )) AND ((IS_CHAR_SITTING_IN_CAR( sub_2472(), l_U545 )) AND ((IS_CHAR_SITTING_IN_CAR( l_U537, l_U545 )) AND (LOCATE_CHAR_IN_CAR_3D( sub_2472(), l_U522._fU0, l_U522._fU4, l_U522._fU8, 2.50000000, 2.50000000, 2.50000000, l_U501 )))))
                {
                    SET_ROUTE( l_U535, 0 );
                    SET_PLAYER_CONTROL( sub_3364(), 0 );
                    sub_8676();
        ...
        {
            SET_NO_RESPRAYS( 0 );
            CLEAR_AREA( 942.57130000, 332.37810000, 30.19710000, 5.00000000, 1 );
            CREATE_CAM( 14, ref l_U553[0] );
