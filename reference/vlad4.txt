...
void sub_6797()
{
    ...
    if ((l_U2091[0] == 0) AND (LOCATE_CHAR_ANY_MEANS_2D( l_U2156, 820.19050000, -264.48110000, 165.00000000, 165.50000000, 0 )))
    {
    ...
    if ((l_U2091[3] == 0) AND (LOCATE_CHAR_ANY_MEANS_2D( l_U2156, 836.96340000, -403.96730000, 40.00000000, 180.50000000, 0 )))
    {
    ...
    sub_7813();
    if ((NOT (IS_CAR_DEAD( l_U2482 ))) AND (l_U2091[0] == 1))
    {
        if ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U2482, l_U2156 )) || (((sub_8216( l_U2156, l_U2250, 1 )) < 8.00000000) || ((LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 817.44650000, -294.02660000, 15.49630000, 2.50000000, 2.40000000, 1.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_2D( l_U2156, 834.11170000, -340.11840000, 11.00000000, 20.00000000, 0 )))))
        {
            l_U2221 = 0;
            REMOVE_BLIP( l_U2484 );
            if ((NOT (IS_CAR_DEAD( l_U2482 ))) AND (NOT (IS_CHAR_DEAD( l_U2250 ))))
            {
        ...
        if (l_U2091[0] == 1)
        {
            if (((sub_17753( l_U2156, 814.03540000, -269.81020000, 15.34270000 )) < 8.00000000) || ((LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 823.32060000, -274.76620000, 15.34690000, 1.50000000, 3.00000000, 3.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 814.99680000, -244.41490000, 15.18060000, 3.50000000, 12.00000000, 6.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 871.51570000, -287.71920000, 17.05500000, 23.00000000, 31.00000000, 20.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 850.26240000, -244.51680000, 15.79550000, 4.00000000, 12.00000000, 3.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_2D( l_U2156, 811.08870000, -258.63010000, 3.50000000, 3.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_2D( l_U2156, 820.64900000, -245.94270000, 3.00000000, 11.00000000, 0 ))))))))
            {
                l_U2221 = 1;
                REMOVE_BLIP( l_U2484 );
                if ((NOT (IS_CAR_DEAD( l_U2482 ))) AND (NOT (IS_CHAR_DEAD( l_U2250 ))))
...
void sub_21735()
{
    ...
    if (NOT (IS_CAR_DEAD( l_U2482 )))
    {
        if (l_U2199 < 310.00000000)
        {
            ...
            if (((FIND_TIME_POSITION_IN_RECORDING( l_U2482 )) >= 43849.22000000) AND (l_U2221 == 0))
            {
                sub_24509( l_U2482, l_U2156, ref l_U2227, 38.00000000, 34.00000000, 55.00000000, 1.20000000, 1.80000000, 1065353216 );
            }
            if (((FIND_TIME_POSITION_IN_RECORDING( l_U2482 )) >= 46849.22000000) AND (l_U2221 == 0))
            {
                sub_24509( l_U2482, l_U2156, ref l_U2227, 38.00000000, 34.00000000, 55.00000000, 1.35000000, 1.80000000, 1065353216 );
            }
        }
        if ((((FIND_TIME_POSITION_IN_RECORDING( l_U2482 )) >= 28207.79000000) AND (l_U2221 == 1)) || (((FIND_TIME_POSITION_IN_RECORDING( l_U2482 )) >= 68166.00000000) AND (l_U2221 == 0)))
        {
        ...
        if ((NOT (IS_CAR_ON_SCREEN( l_U2482 ))) AND ((sub_8216( l_U2250, l_U2156, 1 )) > l_U2199))
        {
            REMOVE_BLIP( l_U2485 );
    ...
    PRINTFLOAT( l_U2227 );
    PRINTNL();
    if (((NOT l_U2091[0]) == 0) AND (LOCATE_CHAR_ANY_MEANS_2D( l_U2156, 1175.97000000, -378.41300000, 90.00000000, 90.00000000, 0 )))
    {
        sub_44664();
    ...
    if (DOES_VEHICLE_EXIST( l_U2482 ))
    {
        if (NOT (IS_CAR_DEAD( l_U2482 )))
        {
            ...
            {
                if ((NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U2482 ))) || ((((FIND_TIME_POSITION_IN_RECORDING( l_U2482 )) >= 44207.79000000) AND (l_U2221 == 1)) || (((FIND_TIME_POSITION_IN_RECORDING( l_U2482 )) >= 79066.00000000) AND (l_U2221 == 0))))
                {
                    ENABLE_CHASE_AUDIO( 0 );
...
void sub_27639(unknown uParam0, float fParam1)
{
    ...
    if (NOT l_U493)
    {
        ...
        if ((IS_SCREEN_FADED_OUT()) || (l_U1129 == 0))
        {
            iVar10 = 1;
        }
                    ...
                    if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U1863[I] ))
                    {
                        ...
                        if (DOES_CHAR_EXIST( uVar6 ))
                        {
                            if (NOT (IS_CHAR_INJURED( uVar6 )))
                            {
                                if (IS_PLAYER_PLAYING( sub_3643() ))
                                {
                                    if ((NOT l_U496) AND ((NOT l_U484) AND ((NOT l_U487) AND (IS_CHAR_TOUCHING_VEHICLE( sub_3597(), l_U1863[I] )))))
                                    {
                                        if (IS_CHAR_IN_ANY_CAR( sub_3597() ))
                                        {
                                            bVar16 = false;
                        ...
                        if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U1984[I] ))
                        {
                            ...
                            if (DOES_CHAR_EXIST( uVar5 ))
                            {
                                if (NOT (IS_CHAR_INJURED( uVar5 )))
                                {
                                    if (IS_PLAYER_PLAYING( sub_3643() ))
                                    {
                                        if ((NOT l_U484) AND ((NOT l_U487) AND (IS_CHAR_TOUCHING_VEHICLE( sub_3597(), l_U1984[I] ))))
                                        {
                                            if (IS_CHAR_IN_ANY_CAR( sub_3597() ))
                                            {
                                                bVar15 = false;
...
void sub_42893(unknown uParam0)
{
    ...
    if ((iVar3 != 4) AND ((NOT sub_43061()) AND ((NOT (IS_CHAR_DEAD( (uParam0^) ))) AND ((IS_CHAR_IN_ANY_CAR( sub_3597() )) AND (IS_CONTROL_PRESSED( 0, 51 ))))))
    {
...
void sub_45543()
{
    ...
    if (l_U2180[l_U2176] == 0)
    {
        ...
        if ((NOT (IS_CAR_DEAD( l_U2482 ))) AND (NOT (IS_CHAR_DEAD( l_U2250 ))))
        {
            if ((IS_CAR_ON_SCREEN( l_U2482 )) AND (LOCATE_CHAR_ANY_MEANS_CAR_2D( l_U2156, l_U2482, 35.00000000, 35.00000000, 0 )))
            {
    ...
    if ((l_U2204 == 0) AND (LOCATE_CHAR_ANY_MEANS_2D( l_U2156, 1175.13900000, -379.40640000, 48.00000000, 48.00000000, 0 )))
    {
    ...
    GET_GAME_TIMER( ref l_U2243 );
    if ((l_U2214 == 1) AND ((IS_CHAR_ON_FOOT( l_U2156 )) AND (((sub_46763( l_U2156 )) > 0.50000000) AND ((l_U2204 == 1) AND ((NOT (sub_22883( l_U2170 ))) AND ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND ((l_U2243 - l_U2242) > 22000)))))))
    {
    ...
    {
        if ((IS_CHAR_IN_ANY_HELI( l_U2156 )) || ((IS_BULLET_IN_AREA( 1174.04800000, -379.45940000, 26.23970000, 5.00000000, 1 )) || ((IS_PLAYER_FREE_AIMING_AT_CHAR( l_U2157, l_U2250 )) || ((IS_PLAYER_FREE_AIMING_AT_CHAR( l_U2157, l_U2250 )) || ((IS_PLAYER_TARGETTING_CHAR( l_U2157, l_U2250 )) || (LOCATE_CHAR_ON_FOOT_2D( l_U2156, 1175.13900000, -379.40640000, 15.00000000, 15.00000000, 0 )))))))
        {
            if (l_U2214 == 0)
            {
        ...
        {
            if ((IS_CHAR_PLAYING_ANIM( l_U2250, "missVlad4", "look_about" )) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1174.04800000, -379.45940000, 26.23970000, 1.50000000, 1.50000000, 1.50000000, 0 )))
            {
    ...
    if ((l_U2091[13] == 0) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1176.71700000, -366.90080000, 27.18590000, 1.00000000, 1.00000000, 1.00000000, 0 )))
    {
        PRINT_HELP_FOREVER( "VLA4H_05" );
        SETTIMERB( 0 );
        l_U2091[13] = 1;
    }
    if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1175.68700000, -379.40220000, 21.52380000, 2.00000000, 2.00000000, 2.00000000, 0 ))) AND (((l_U2091[13] == 1) || (l_U2091[9] == 1)) AND ((l_U2091[10] == 0) AND (TIMERB() > 8500))))
    {
        CLEAR_HELP();
    ...
    if ((NOT (sub_22883( l_U2170 ))) AND (((sub_8216( l_U2156, l_U2250, 1 )) < 20.00000000) AND ((l_U2091[0] == 1) AND ((l_U2091[2] == 0) AND (TIMERA() > 5000)))))
    {
        sub_21901( "V4_FIND", ref l_U2170, 8, 1 );
        l_U2091[2] = 1;
    }
    if ((NOT (sub_22883( l_U2170 ))) AND (((sub_8216( l_U2156, l_U2250, 1 )) < 20.00000000) AND ((l_U2091[0] == 1) AND ((l_U2091[3] == 0) AND (TIMERA() > 15000)))))
    {
        sub_21901( "V4_CHASE", ref l_U2170, 8, 1 );
        l_U2091[3] = 1;
    }
    if ((l_U2091[0] == 0) AND ((LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1175.76700000, -379.40220000, 24.91630000, 1.00000000, 1.00000000, 1.00000000, 0 )) || ((IS_CHAR_ON_FOOT( l_U2156 )) AND ((sub_47981( l_U2156 )) > 25.00000000))))
    {
        if (NOT (IS_CHAR_INJURED( l_U2250 )))
        {
    ...
    if (NOT (IS_CHAR_DEAD( l_U2250 )))
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1173.11000000, -365.15580000, 33.02390000, 1.00000000, 10.00000000, 1.00000000, 0 ))
        {
            if (NOT (IS_CHAR_INJURED( l_U2250 )))
            {
                if ((NOT (IS_CHAR_IN_ANY_HELI( l_U2156 ))) AND (NOT (IS_CHAR_ON_SCREEN( l_U2250 ))))
                {
    ...
    if ((l_U2091[4] == 0) AND ((((IS_CHAR_IN_ANY_HELI( l_U2156 )) || (IS_CHAR_ON_FOOT( l_U2156 ))) AND ((sub_47981( l_U2156 )) > 27.00000000)) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1172.69400000, -375.99700000, 27.26980000, 2.50000000, 2.50000000, 1.00000000, 0 ))))
    {
        if (NOT (IS_CHAR_INJURED( l_U2250 )))
        {
    ...
    if ((l_U2091[1] == 0) AND ((l_U2091[5] == 0) AND ((IS_CHAR_IN_ANY_HELI( l_U2156 )) || (((sub_47981( l_U2156 )) > 33.50000000) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1169.59100000, -366.86830000, 32.96820000, 10.50000000, 11.00000000, 1.00000000, 0 ))))))
    {
        if (NOT (IS_CHAR_INJURED( l_U2250 )))
        {
    ...
    if (l_U2091[6] == 0)
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1163.18800000, -366.07840000, 39.02080000, 11.50000000, 5.50000000, 1.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1168.76400000, -365.23640000, 39.02080000, 13.00000000, 5.50000000, 1.00000000, 0 )))
        {
            if ((l_U2091[1] == 0) AND (NOT (IS_CHAR_INJURED( l_U2250 ))))
            {
    ...
    if (NOT (IS_CHAR_DEAD( l_U2250 )))
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1165.43000000, -367.36410000, 35.95900000, 1.00000000, 4.00000000, 4.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1176.71700000, -366.82090000, 29.89490000, 1.00000000, 1.00000000, 2.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1172.75000000, -378.48780000, 27.24020000, 3.00000000, 3.50000000, 1.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1166.93700000, -379.03900000, 42.05800000, 1.00000000, 1.00000000, 4.50000000, 0 )))))
        {
    ...
    if (l_U2091[0] == 1)
    {
        if ((IS_BULLET_IN_AREA( 1164.80300000, -390.96860000, 45.56450000, 3.00000000, 1 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1165.01000000, -390.35730000, 45.56450000, 1.50000000, 14.00000000, 5.50000000, 0 )))
        {
            if (l_U2091[1] == 0)
            {
                if (NOT (IS_CHAR_INJURED( l_U2250 )))
    ...
    if ((l_U2091[11] == 0) AND ((NOT (IS_CHAR_DEAD( l_U2251[1] ))) AND ((NOT (IS_CHAR_DEAD( l_U2251[0] ))) AND ((sub_8216( l_U2251[0], l_U2156, 1 )) < 5.00000000))))
    {
    ...
    if (NOT (IS_CHAR_INJURED( l_U2250 )))
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1166.85800000, -377.36910000, 40.47110000, 1.00000000, 1.00000000, 1.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1165.15700000, -400.36430000, 45.56460000, 3.50000000, 3.50000000, 1.50000000, 0 )))
        {
            SET_GAME_CAM_HEADING( 0.00000000 );
...
void sub_66132()
{
    ...
    if (NOT (IS_CHAR_DEAD( l_U2250 )))
    {
        if ((IS_CHAR_IN_AIR( l_U2250 )) || (l_U2091[1] == 0))
        {
    ...
    if (NOT (IS_CHAR_DEAD( l_U2250 )))
    {
        if ((l_U2249 == 1) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1169.59600000, -409.25850000, 40.53150000, 10.00000000, 8.00000000, 2.00000000, 0 )))
        {
            if (l_U2091[1] == 0)
            {
                if (l_U2249 == 0)
    ...
    else if ((NOT (IS_CHAR_IN_AIR( l_U2156 ))) AND (l_U2230 == 1))
    {
        UNPOINT_CAM( l_U2154 );
    ...
    if (NOT (IS_CHAR_INJURED( l_U2250 )))
    {
        if ((l_U2211 == 0) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1167.61500000, -434.40880000, 37.27490000, 7.00000000, 1.00000000, 1.00000000, 0 )))
        {
            UNLOCK_RAGDOLL( l_U2250, 0 );
            l_U2211 = 1;
        }
        if (((sub_47981( l_U2250 )) < 33.20000000) AND ((NOT (IS_CHAR_IN_AIR( l_U2250 ))) AND ((l_U2212 == 0) AND (l_U2211 == 1))))
        {
            UNLOCK_RAGDOLL( l_U2250, 1 );
            l_U2212 = 1;
        }
    ...
    else if ((NOT (IS_CHAR_IN_AIR( l_U2156 ))) AND (l_U2231 == 1))
    {
        UNPOINT_CAM( l_U2154 );
        SET_CAM_FOV( l_U2154, 55.00000000 );
        sub_66463( ref l_U2154, 0 );
    ...
    else if ((NOT (IS_CHAR_IN_AIR( l_U2156 ))) AND (l_U2232 == 1))
    {
        if (NOT (IS_CHAR_INJURED( l_U2250 )))
        {
            CLEAR_CHAR_TASKS( l_U2250 );
    ...
    if ((NOT (IS_CHAR_IN_AIR( l_U2156 ))) AND ((sub_47981( l_U2156 )) < 20.00000000))
    {
        sub_66463( ref l_U2154, 0 );
        SET_CAM_FOV( l_U2154, 55.00000000 );
        ACTIVATE_SCRIPTED_CAMS( 0, 0 );
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1164.14000000, -411.05220000, 40.53130000, 8.50000000, 8.50000000, 1.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1165.15700000, -400.36430000, 45.56460000, 10.50000000, 10.50000000, 1.50000000, 0 )))
    {
    ...
    if (((sub_8216( l_U2156, l_U2250, 1 )) < 20.00000000) AND ((l_U2091[3] == 0) AND ((l_U2091[0] == 1) AND (NOT (sub_69718( l_U2250, 29 ))))))
    {
        l_U2091[3] = 1;
    }
    if ((l_U2091[2] == 0) AND ((l_U2091[0] == 1) AND (NOT (sub_69718( l_U2250, 29 )))))
    {
        if (NOT (IS_CHAR_INJURED( l_U2250 )))
        {
    ...
    sub_49155();
    if ((l_U2232 == 0) AND ((l_U2231 == 0) AND ((l_U2230 == 0) AND ((l_U2091[5] == 0) AND (DOES_CHAR_EXIST( l_U2250 ))))))
    {
        if (IS_CHAR_DEAD( l_U2250 ))
        {
            if (DOES_BLIP_EXIST( l_U2485 ))
    ...
    {
        if ((l_U2091[6] == 0) AND (NOT (IS_CHAR_DEAD( l_U2250 ))))
        {
...
void sub_70752()
{
    ...
    if (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1175.21300000, -491.69920000, 34.20850000, 1.00000000, 1.50000000, 1.50000000, 0 ))
    {
        ...
        if ((NOT (IS_CHAR_IN_AIR( l_U2156 ))) AND ((l_U2091[1] == 0) AND (IS_CONTROL_JUST_PRESSED( 0, 23 ))))
        {
            CLEAR_HELP();
            if (NOT (IS_CHAR_DEAD( l_U2250 )))
            {
        ...
        if ((NOT (IS_CHAR_IN_AIR( l_U2156 ))) AND ((l_U2091[2] == 0) AND (IS_CONTROL_PRESSED( 0, 62 ))))
        {
            CLEAR_HELP();
            l_U2215 = 1;
            ...
            l_U2176 = 8;
            SETTIMERA( 0 );
            while ((TIMERA() < 10000) AND ((sub_47981( l_U2250 )) > 18.00000000))
            {
                if (NOT (IS_CHAR_DEAD( l_U2250 )))
                {
    ...
    if (DOES_CHAR_EXIST( l_U2250 ))
    {
        if ((IS_CHAR_ON_FIRE( l_U2250 )) || (l_U2506 < l_U2228))
        {
