    ...
    while (true)
    {
        ...
        switch (l_U637)
        {
            ...
            switch (l_U638)
            {
                ...
                if ((NOT (IS_CHAR_IN_ANY_HELI( sub_6473() ))) AND (sub_42474( l_U682 )))
                {
                    for ( l_U641 = 0; l_U641 < 5; l_U641++ )
                    {
                        if (NOT (IS_CAR_DEAD( l_U664[l_U641] )))
                ...
                if (sub_48032())
                {
                    ...
                    for ( l_U641 = 0; l_U641 < 5; l_U641++ )
                    {
                        if (NOT (IS_CAR_DEAD( l_U664[l_U641] )))
                        {
                            if ((NOT (IS_CHAR_INJURED( l_U652[l_U641] ))) AND (NOT (IS_CHAR_DEAD( l_U652[l_U641] ))))
                            {
...
void sub_2474()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_2512( 5, g_U569[I] )) == 1))
        {
...
int sub_6242(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_6473() ))) AND (IS_CHAR_IN_ANY_CAR( sub_6473() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_6805()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
int sub_14072()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_2512( 1, g_U569[I] )) != 0))
        {
            sub_2798( I );
            return 1;
        }
...
void sub_15240()
{
    ...
    if (NOT g_U64683)
    {
        if ((l_U640 == 11) || ((l_U640 == 10) || (l_U640 == 4)))
        {
            ProtectedSet(g_U64679, ProtectedGet(g_U64679) + 1);
        }
        if ((l_U640 == 8) || ((l_U640 == 7) || (l_U640 == 5)))
        {
            ProtectedSet(g_U64680, ProtectedGet(g_U64680) + 1);
        }
        if ((l_U640 == 12) || ((l_U640 == 9) || (l_U640 == 6)))
        {
...
void sub_30192()
{
    ...
    if (NOT l_U730)
    {
        if ((IS_KEYBOARD_KEY_PRESSED( 2 )) AND (IS_KEYBOARD_KEY_PRESSED( 36 )))
        {
        ...
        if ((IS_KEYBOARD_KEY_PRESSED( 3 )) AND (IS_KEYBOARD_KEY_PRESSED( 36 )))
        {
            GET_RANDOM_CAR_MODEL_IN_MEMORY( 1, ref uVar3, ref uVar4 );
        ...
        if ((IS_KEYBOARD_KEY_PRESSED( 4 )) AND (IS_KEYBOARD_KEY_PRESSED( 36 )))
        {
            GET_RANDOM_CAR_MODEL_IN_MEMORY( 1, ref uVar3, ref uVar4 );
        ...
        if ((IS_KEYBOARD_KEY_PRESSED( 5 )) AND (IS_KEYBOARD_KEY_PRESSED( 36 )))
        {
            GET_RANDOM_CAR_MODEL_IN_MEMORY( 1, ref uVar3, ref uVar4 );
        ...
        if ((IS_KEYBOARD_KEY_PRESSED( 6 )) AND (IS_KEYBOARD_KEY_PRESSED( 36 )))
        {
            GET_RANDOM_CAR_MODEL_IN_MEMORY( 1, ref uVar3, ref uVar4 );
        ...
        if ((IS_KEYBOARD_KEY_PRESSED( 7 )) AND (IS_KEYBOARD_KEY_PRESSED( 36 )))
        {
            GET_RANDOM_CAR_MODEL_IN_MEMORY( 1, ref uVar3, ref uVar4 );
        ...
        if ((IS_KEYBOARD_KEY_PRESSED( 8 )) AND (IS_KEYBOARD_KEY_PRESSED( 36 )))
        {
            GET_RANDOM_CAR_MODEL_IN_MEMORY( 1, ref uVar3, ref uVar4 );
        ...
        if ((IS_KEYBOARD_KEY_PRESSED( 9 )) AND (IS_KEYBOARD_KEY_PRESSED( 36 )))
        {
            GET_RANDOM_CAR_MODEL_IN_MEMORY( 1, ref uVar3, ref uVar4 );
        ...
        if ((IS_KEYBOARD_KEY_PRESSED( 10 )) AND (IS_KEYBOARD_KEY_PRESSED( 36 )))
        {
            GET_RANDOM_CAR_MODEL_IN_MEMORY( 1, ref uVar3, ref uVar4 );
    ...
    else if ((NOT (IS_KEYBOARD_KEY_PRESSED( 11 ))) AND ((NOT (IS_KEYBOARD_KEY_PRESSED( 10 ))) AND ((NOT (IS_KEYBOARD_KEY_PRESSED( 9 ))) AND ((NOT (IS_KEYBOARD_KEY_PRESSED( 8 ))) AND ((NOT (IS_KEYBOARD_KEY_PRESSED( 7 ))) AND ((NOT (IS_KEYBOARD_KEY_PRESSED( 6 ))) AND ((NOT (IS_KEYBOARD_KEY_PRESSED( 5 ))) AND ((NOT (IS_KEYBOARD_KEY_PRESSED( 4 ))) AND ((NOT (IS_KEYBOARD_KEY_PRESSED( 3 ))) AND ((NOT (IS_KEYBOARD_KEY_PRESSED( 2 ))) AND (NOT (IS_KEYBOARD_KEY_PRESSED( 36 )))))))))))))
    {
        l_U730 = 0;
    }
    return;
...
int sub_32525()
{
    ...
    if ((HAS_MODEL_LOADED( l_U748[4] )) AND ((HAS_MODEL_LOADED( l_U748[3] )) AND ((HAS_MODEL_LOADED( l_U748[2] )) AND ((HAS_MODEL_LOADED( l_U748[1] )) AND (HAS_MODEL_LOADED( l_U748[0] ))))))
    {
        l_U729 = 1;
        return 1;
    }
...
int sub_33505()
{
    ...
    else if (CAN_CREATE_RANDOM_CHAR( 0, 0 ))
    {
        ...
        if ((NOT (IS_CAR_DEAD( l_U664[4] ))) AND ((NOT (IS_CAR_DEAD( l_U664[3] ))) AND ((NOT (IS_CAR_DEAD( l_U664[2] ))) AND ((NOT (IS_CAR_DEAD( l_U664[1] ))) AND (NOT (IS_CAR_DEAD( l_U664[0] )))))))
        {
            return 1;
        }
    }
...
void sub_33519(unknown uParam0)
{
    switch (uParam0)
    {
        ...
        l_U39[9] = {-658.26490000, 915.36730000, 5.71680000};
        ...
        l_U39[2] = {813.75410000, 224.67010000, 5.19830000};
        ...
        l_U39[10] = {9.41290000, -769.12950000, 4.11890000};
        l_U39[11] = {-139.14640000, -779.92320000, 4.26130000};
        ...
        l_U39[7] = {-454.49960000, 125.72830000, 8.88780100};
        ...
        l_U39[6] = {-1424.35200000, -71.86280000, 7.98719900};
        ...
        l_U39[12] = {-1479.52700000, 509.19730000, 18.60940000};
        ...
        l_U39[11] = {1999.87400000, 826.58460000, 8.22649900};
        ...
        l_U39[1] = {-1708.83600000, 12.58150000, 9.03050100};
        ...
        l_U39[10] = {-1636.85700000, 765.45180000, 28.87910000};
        ...
        l_U39[8] = {1313.05500000, 979.60560000, 12.71200000};
...
void sub_46006()
{
    ...
    if (DOES_BLIP_EXIST( l_U649 ))
    {
        switch (l_U640)
        {
            ...
            break;
            case 5:
            vVar2 = {-625.30220000, -209.11870000, 6.37610000};
            fVar5 = 193.70990000;
            break;
            case 6:
...
void sub_52514(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((iVar6 != 4) AND ((NOT sub_52607()) AND ((IS_CHAR_IN_ANY_CAR( sub_6473() )) AND (IS_CONTROL_PRESSED( 0, 51 )))))
    {
