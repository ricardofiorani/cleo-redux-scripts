void main()
{
    ...
    while (l_U583)
    {
        ...
        switch (l_U549)
        {
            ...
            sub_2595( l_U613 );
            sub_2544( ")\n" );
            if ((NOT g_U15654[11]) || ((g_U15654[54]) AND (l_U613 >= l_U614)))
            {
                l_U549 = 3;
            }
            break;
            ...
            break;
            case 4:
            if (((g_U9914._fU0) || (IS_AUTO_SAVE_IN_PROGRESS())) || (GET_MISSION_FLAG()))
            {
                if (l_U588)
                {
                    sub_2317( 12, 0 );
            ...
            else if ((NOT g_U15654[11]) || (g_U15654[54]))
            {
            ...
            switch (l_U612)
            {
                ...
                l_U617 = 0;
                l_U618 = -1;
                if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "REPLY_HELP_B" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "REPLY_HELP_C" )))
                {
                    CLEAR_HELP();
                }
                if (sub_7447( ref l_U590 ))
                {
                    if (sub_6799() == 0)
                    {
                        if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "CANT_REPLY" )) || ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "REPLY_HELP_B" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "REPLY_HELP_C" ))))
                        {
                            CLEAR_HELP();
                        }
                        l_U586 = 0;
...
void sub_459()
{
    ...
    {
        iVar3 = sub_487( 13 );
        if ((g_U9932[g_U9999[I]._fU0]._fU0) AND (sub_532( 13, iVar3 )))
        {
    ...
    {
        iVar3 = sub_487( 11 );
        if ((g_U9932[g_U10090[I]._fU0]._fU0) AND (sub_532( 11, iVar3 )))
        {
    ...
    {
        iVar3 = sub_1013( I );
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_532( g_U10324[I]._fU12, iVar3 )))
        {
...
void sub_1550()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_1013( I )))
        {
            iVar4++;
        }
    }
...
int sub_2709()
{
    ...
    for ( I = 0; I < l_U552; I++ )
    {
        ...
        {
            WAIT( 0 );
            if ((NOT (I == 10)) AND (l_U552[iVar5]._fU0 == 10))
            {
                l_U552[iVar5]._fU0 = I;
                bVar3 = true;
            }
    ...
    for ( I = 0; I < l_U552; I++ )
    {
        ...
        {
            WAIT( 0 );
            if ((NOT (I == 10)) AND (l_U552[iVar5]._fU4 == 10))
            {
                l_U552[iVar5]._fU4 = I;
                bVar2 = true;
            }
    ...
    switch (sub_6622( ref l_U590, 0 ))
    {
        ...
        if (NOT l_U589)
        {
            if (sub_6799() == 3)
            {
                ...
                else if ((g_U9914._fU0) || (IS_AUTO_SAVE_IN_PROGRESS()))
                {
...
int sub_13295()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_8702( 1, g_U569[I] )) != 0))
        {
            sub_8953( I );
            return 1;
        }
