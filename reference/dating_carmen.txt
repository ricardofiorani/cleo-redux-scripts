        ...
        if (NOT g_U33838)
        {
            ...
            switch (l_U594)
            {
                ...
                else
                {
                    ...
                    sub_2749();
                    if ((IS_KEYBOARD_KEY_PRESSED( 11 )) || (l_U728 > (l_U811 + l_U818)))
                    {
                ...
                switch (sub_15721())
                {
                    ...
                    else if ((sub_15721() == 8) || (sub_15721() == 5))
                    {
                ...
                {
                    l_U834 = 500;
                    if ((NOT (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( sub_10760(), 57 ))) AND (sub_23116()))
                    {
...
int sub_7448(unknown uParam0)
{
    ...
    if (g_U33837)
    {
        if ((g_U15946[sub_5997( uParam0 )]._fU4) || (sub_7499( sub_5997( uParam0 ), 1 )))
        {
            switch (uParam0)
            {
                case 0:
...
int sub_10515(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_10760() ))) AND (IS_CHAR_IN_ANY_CAR( sub_10760() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_11092()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
int sub_21861()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_21899( 1, g_U569[I] )) != 0))
        {
            sub_22162( I );
            return 1;
        }
...
int sub_23233(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, int iParam5, unknown uParam6)
{
    ...
    if ((uParam4^) < 3)
    {
        ...
        PRINTNL();
        if (((uParam4^) > 0) AND (iVar10 < ((uParam1^) + (sub_1324( 20.00000000 )))))
        {
            iParam5 = 0;
        }
    }
...
int sub_25297(unknown uParam0, boolean bParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    ...
    if ((IS_PLAYER_PLAYING( sub_10681() )) AND (NOT (IS_CHAR_DEAD( sub_10760() ))))
    {
        if (GET_MISSION_FLAG())
        {
            if ((uParam2^) <= iVar13)
...
int sub_28037(int iParam0, unknown uParam1, unknown uParam2, boolean bParam3, unknown uParam4)
{
    ...
    if ((uParam1^) < 0)
    {
        if ((NOT sub_20552()) AND ((NOT ((GET_MISSION_FLAG()) || (g_U10978))) AND (NOT bParam3)))
        {
            GET_GAME_TIMER( uParam1 );
    ...
    {
        if ((sub_20552()) || (((GET_MISSION_FLAG()) || (g_U10978)) || (bParam3)))
        {
            (uParam1^) = -1;
            return 0;
        }
...
int sub_29787(unknown uParam0, int iParam1, unknown uParam2, int iParam3)
{
    if (iParam3 != 1)
    {
        ...
        {
            if (((sub_29827( iParam1 )) < 65476) || ((sub_29827( iParam1 )) > 90))
            {
    ...
    else
    {
        ...
        if ((iParam1->_fU4 >= 0) AND (iParam1->_fU0 >= 0))
        {
            if (((sub_30308( iParam1 )) < 65356) || ((sub_30308( iParam1 )) > 180))
            {
    ...
    if (NOT (sub_29787( iParam0, iParam5, (uParam1^), iParam7 )))
    {
        if (NOT ((GET_MISSION_FLAG()) || (g_U10978)))
        {
            if (IS_PLAYER_PLAYING( sub_10681() ))
            {
                ...
                {
                    if ((NOT (IS_WANTED_LEVEL_GREATER( sub_10681(), 0 ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_10760(), uParam2._fU0, uParam2._fU4, uParam2._fU8, 8.00000000, 8.00000000, 8.00000000, 0 )))
                    {
                        g_U33841 = 0;
                    }
                }
...
int sub_31800(unknown uParam0)
{
    ...
    if (sub_7499( sub_5997( uParam0 ), 1 ))
    {
        ...
        if ((g_U15946[sub_5997( uParam0 )]._fU8[1]._fU0[1]) || (g_U15946[sub_5997( uParam0 )]._fU8[1]._fU0[0]))
        {
        ...
        if (NOT (IS_CAR_DEAD( uVar21 )))
        {
            switch (l_U592)
            {
                ...
                else
                {
                    ...
                    if ((IS_PLAYER_PLAYING( sub_10681() )) AND (NOT (IS_CAR_DEAD( uVar21 ))))
                    {
...
int sub_34429(unknown uParam0, int iParam1)
{
    if ((uParam0^))
    {
        if ((iParam1 > 0) AND ((IS_SCREEN_FADED_IN()) AND (sub_34446())))
        {
            return 1;
        }
        else
...
int sub_44952(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    ...
    if (IS_PLAYER_PLAYING( sub_10681() ))
    {
        switch (l_U592)
        {
            ...
            if (NOT (IS_CHAR_DEAD( (uParam3^) )))
            {
                if (((sub_46224( sub_10760(), 17 )) AND (sub_46224( (uParam3^), 17 ))) || (NOT (IS_SPECIFIC_CAM_INTERPOLATING( l_U573[2] ))))
                {
                    INCREMENT_INT_STAT_NO_MESSAGE( 373, 1 );
                    l_U592 = 5;
                }
...
void sub_49490(int iParam0, int iParam1, unknown uParam2)
{
    if (iParam0 == 2)
    {
        if ((iParam1 == 26) || ((iParam1 == 27) || (NOT (sub_49512( iParam0, uParam2 )))))
        {
            sub_49589( iParam1 );
        }
    }
            ...
            switch ((uParam2^))
            {
                ...
                if (NOT IS_MESSAGE_BEING_DISPLAYED())
                {
                    ...
                    else
                    {
                        ...
                        if ((NOT (IS_CHAR_ON_ANY_BIKE( sub_10760() ))) AND (IS_CHAR_IN_ANY_CAR( sub_10760() )))
                        {
                        ...
                        WAIT( 0 );
                        if ((NOT (IS_CHAR_DEAD( (uParam0^) ))) AND (IS_PLAYER_PLAYING( sub_10681() )))
                        {
                            bVar59 = false;
                            if ((NOT (IS_CHAR_ON_ANY_BIKE( sub_10760() ))) AND (IS_CHAR_IN_ANY_CAR( sub_10760() )))
                            {
                ...
                else if (sub_76337( iParam1, uParam12, uParam2 ))
                {
                    if (sub_75988())
                    {
                        if (sub_59670( 25, ref l_U581, (uParam8^), iParam1, 83, 0 ))
                        {
                            ...
                            TASK_PERFORM_SEQUENCE( (uParam0^), uVar54 );
                            CLEAR_SEQUENCE_TASK( uVar54 );
                            if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TRY_LUCK" )) || (IS_THIS_HELP_MESSAGE_WITH_STRING_BEING_DISPLAYED( "GET_NUM", sub_18692( iParam1, 1 ) )))
                            {
                                CLEAR_HELP();
                            }
                ...
                break;
                case 5:
                if ((NOT (IS_CHAR_DEAD( (uParam0^) ))) AND (NOT (sub_81972( l_U581 ))))
                {
                    if ((uParam8^) <= 1)
                    {
                        if (NOT l_U572)
                        {
                            ...
                            else if ((IS_CHAR_PLAYING_ANIM( sub_10760(), "Cellphone", "cellphone_text" )) || (IS_CHAR_PLAYING_ANIM( sub_10760(), "amb@dating", "pass_text" )))
                            {
                ...
                if ((NOT ((LOCATE_CHAR_ON_FOOT_3D( (uParam0^), uParam9._fU0, uParam9._fU4, uParam9._fU8 + 1.00000000, vVar85.x, vVar85.y, vVar85.z, 0 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_10760(), uParam9._fU0, uParam9._fU4, uParam9._fU8 + 1.00000000, vVar85.x, vVar85.y, vVar85.z, 0 )))) AND (((IS_CHAR_ON_SCREEN( (uParam0^) )) || (IS_CHAR_ON_SCREEN( sub_10760() ))) AND (IS_SPECIFIC_CAM_INTERPOLATING( l_U573[6] ))))
                {
                ...
                break;
                case 8:
                if ((NOT ((IS_SCREEN_FADED_IN()) AND (sub_34446()))) AND ((NOT IS_SCRIPTED_CONVERSATION_ONGOING()) AND (IS_SPECIFIC_CAM_INTERPOLATING( l_U573[6] ))))
                {
...
int sub_88801(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15)
{
    ...
    switch ((uParam15^))
    {
        ...
        if ((NOT (((IS_KEYBOARD_KEY_PRESSED( 157 )) || (IS_KEYBOARD_KEY_PRESSED( 29 ))) AND (IS_KEYBOARD_KEY_PRESSED( 11 )))) AND (iVar81 <= ((uParam12^) + (sub_1324( 20.00000000 )))))
        {
            sub_2494( "  * WAIT_FOR_" );
        ...
        {
            if ((DOES_CHAR_EXIST( (uParam0^) )) || ((LOCATE_CHAR_ANY_MEANS_2D( sub_10760(), g_U33981[iParam1]._fU0, g_U33981[iParam1]._fU4, 50.00000000 * 1.50000000, 50.00000000 * 1.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_2D( sub_10760(), g_U10090[uParam13]._fU4._fU0, g_U10090[uParam13]._fU4._fU4, 50.00000000 * 1.50000000, 50.00000000 * 1.50000000, 0 ))))
            {
            ...
            else if (NOT IS_MESSAGE_BEING_DISPLAYED())
            {
                ...
                else
                {
                    ...
                    if (IS_PLAYER_PLAYING( sub_10681() ))
                    {
                        ...
                        {
                            WAIT( 1500 );
                            if ((IS_PLAYER_PLAYING( sub_10681() )) AND (NOT (IS_CHAR_INJURED( (uParam0^) ))))
                            {
