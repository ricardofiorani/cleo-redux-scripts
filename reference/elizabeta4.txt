...
void sub_1548()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_1586( 5, g_U569[I] )) == 1))
        {
...
void sub_6808()
{
    ...
    if (IS_CHAR_IN_ANY_POLICE_VEHICLE( sub_6536() ))
    {
        ...
        if ((NOT (IS_CHAR_IN_MODEL( sub_6536(), -488123221 ))) AND (NOT (IS_CHAR_IN_MODEL( sub_6536(), 837858166 ))))
        {
...
void sub_22923()
{
    ...
    while ((NOT (HAVE_ANIMS_LOADED( "MISSELIZABETA4" ))) || ((NOT (HAS_MODEL_LOADED( l_U504 ))) || ((NOT (HAS_MODEL_LOADED( l_U499 ))) || (NOT (HAS_MODEL_LOADED( iVar2 ))))))
    {
        WAIT( 0 );
    }
...
int sub_26135(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_6493() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_6493() )))
            {
                if (((g_U9202) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_6493() )))))
                {
                    if (NOT sub_26231())
                    {
        ...
        if (NOT l_U520)
        {
            ...
            if (fVar4 < 0.25000000)
            {
                if (TIMERB() > 1000)
                {
                    ...
                    while ((NOT sub_31503()) || (NOT sub_31318()))
                    {
                        WAIT( 0 );
                    }
                    l_U520 = 1;
...
int sub_32329()
{
    if (IS_VEH_DRIVEABLE( l_U486 ))
    {
        if ((CHECK_STUCK_TIMER( l_U486, 0, 5000 )) || ((CHECK_STUCK_TIMER( l_U486, 1, 40000 )) || ((CHECK_STUCK_TIMER( l_U486, 2, 30000 )) || (CHECK_STUCK_TIMER( l_U486, 3, 60000 )))))
        {
            return 1;
        }
        if (l_U521)
    ...
    if (l_U521)
    {
        if (IS_VEH_DRIVEABLE( l_U486 ))
        {
            ...
            if (GET_CLOSEST_CHAR( uVar2._fU0, uVar2._fU4, uVar2._fU8, 5.00000000, 1, 1, ref uVar6 ))
            {
                ...
                {
                    if ((IS_CHAR_MODEL( uVar6, -1518937979 )) || ((IS_CHAR_MODEL( uVar6, -183203150 )) || (IS_CHAR_MODEL( uVar6, -370395528 ))))
                    {
                        if (NOT (IS_WANTED_LEVEL_GREATER( sub_6493(), 1 )))
                        {
                            ALTER_WANTED_LEVEL_NO_DROP( sub_6493(), 2 );
...
void sub_33379()
{
    ...
    if (NOT g_U64686)
    {
        if (sub_33437())
        {
            if (NOT (IS_WANTED_LEVEL_GREATER( sub_6493(), 0 )))
            {
                if ((LOCATE_CHAR_IN_CAR_3D( sub_6536(), vVar5.x, vVar5.y, vVar5.z, 20.00000000, 20.00000000, 20.00000000, 0 )) || (LOCATE_CHAR_IN_CAR_3D( sub_6536(), vVar2.x, vVar2.y, vVar2.z, 20.00000000, 20.00000000, 20.00000000, 0 )))
                {
                    if (sub_33686( 3 ))
                    {
...
int sub_35097(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_6536() ))) AND (IS_CHAR_IN_ANY_CAR( sub_6536() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_35612()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
int sub_40120()
{
    if (IS_CHAR_DEAD( l_U498 ))
    {
        ...
        if ((HAS_CAR_RECORDING_BEEN_LOADED( 624 )) AND (HAS_MODEL_LOADED( l_U497 )))
        {
            if (NOT (IS_CAR_DEAD( l_U486 )))
            {
