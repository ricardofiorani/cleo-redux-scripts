void main()
{
    ...
    l_U133 = {1202.73300000, 1713.70200000, 15.66150000};
    l_U136 = {-1575.97400000, 19.67334000, 9.01099900};
    l_U139 = {-1555.46800000, 9.48290000, 9.01099900};
                ...
                if (NOT g_U9158)
                {
                    ...
                    if (NOT l_U178)
                    {
                        if (NOT l_U176)
                        {
                            ...
                            {
                                if ((IS_WANTED_LEVEL_GREATER( sub_1853(), 0 )) || ((IS_CHAR_ON_ANY_BIKE( sub_432() )) || (IS_CHAR_ARMED( sub_432(), 7 ))))
                                {
                    ...
                    {
                        if ((IS_CHAR_SHOOTING( sub_432() )) || (IS_PLAYER_TARGETTING_CHAR( sub_1853(), l_U123 )))
                        {
                            g_U9158 = 1;
                        }
                    }
...
int sub_4240()
{
    ...
    if (l_U145 > 0)
    {
        if (NOT (IS_CHAR_DEAD( sub_432() )))
        {
            ...
            if ((iVar2 == (GET_HASH_KEY( l_U169 ))) || ((iVar2 == (GET_HASH_KEY( l_U168 ))) || ((iVar2 == (GET_HASH_KEY( l_U167 ))) || (iVar2 == (GET_HASH_KEY( l_U166 ))))))
            {
                return 1;
            }
        }
...
int sub_4940()
{
    ...
    if (l_U145 > 0)
    {
        ...
        {
            GET_KEY_FOR_CHAR_IN_ROOM( sub_432(), ref iVar2 );
            if ((iVar2 == (GET_HASH_KEY( l_U169 ))) || (iVar2 == (GET_HASH_KEY( l_U166 ))))
            {
                return 1;
            }
        }
