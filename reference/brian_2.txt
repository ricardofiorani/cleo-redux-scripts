                ...
                while (true)
                {
                    ...
                    if (NOT l_U225)
                    {
                        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
                        {
                            ...
                            {
                                sub_2978();
                                if ((sub_3473( ref l_U272, 22.00000000 )) || (sub_3381( ref l_U272 )))
                                {
                                    sub_3650();
                                }
                                sub_4023( ref l_U277 );
                    ...
                    if (l_U225)
                    {
                        ...
                        if ((NOT l_U227) AND (IS_KEYBOARD_KEY_PRESSED( 31 )))
                        {
                            l_U227 = 1;
                            sub_30939();
                        }
                        if ((NOT l_U253) AND (IS_KEYBOARD_KEY_PRESSED( 45 )))
                        {
                        ...
                        if ((NOT l_U233) AND (IS_KEYBOARD_KEY_PRESSED( 30 )))
                        {
                            if (sub_3191( ref l_U277 ))
                            {
                        ...
                        if ((NOT l_U256) AND (IS_KEYBOARD_KEY_PRESSED( 32 )))
                        {
...
int sub_2978()
{
    if (l_U239)
    {
        if (IS_HINT_RUNNING())
        {
            if ((sub_3178()) || ((sub_3013( ref l_U272 )) > 18.00000000))
            {
                HINT_CAM( 0.00000000, 0.00000000, 0.50000000, l_U272, 0, 0, 0 );
                l_U239 = 0;
                return 1;
...
void sub_4129()
{
    switch (l_U196)
    {
        ...
        if (NOT l_U246)
        {
            if ((HAS_MODEL_LOADED( l_U491 )) AND (HAS_MODEL_LOADED( l_U486 )))
            {
...
void sub_9839()
{
    ...
    l_U577._fU144[0] = {6.40000000, 0.77999990, 160.05000000};
...
void sub_12078()
{
    ...
    if ((l_U514[0] == 1) AND (NOT (l_U499[0] == 1)))
    {
    ...
    switch (l_U199)
    {
        ...
        if (sub_15007( l_U272 ))
        {
            if (DOES_BLIP_EXIST( l_U278 ))
            {
                ...
                if ((NOT (IS_CHAR_INJURED( l_U273[1] ))) AND (NOT (IS_CHAR_INJURED( l_U273[0] ))))
                {
            ...
            if (NOT (IS_CHAR_INJURED( l_U272 )))
            {
                if (NOT (IS_CHAR_INJURED( l_U273[0] )))
                {
                    if (NOT (IS_CHAR_INJURED( l_U273[1] )))
                    {
                        ...
                        SET_CAM_POS( l_U479, 1115.45300000, -319.85270000, 18.03590000 );
                        SET_CAM_ROT( l_U479, 5.38981500, 0.00000000, 94.78581000 );
                        SET_CAM_FOV( l_U479, 31.50004000 );
                        ACTIVATE_SCRIPTED_CAMS( 1, 1 );
                        SET_CAM_ACTIVE( l_U479, 1 );
                        SET_CAM_PROPAGATE( l_U479, 1 );
...
void sub_12098()
{
    for ( l_U492 = 0; l_U492 <= (l_U503 - 1); l_U492++ )
    {
        if (DOES_CHAR_EXIST( l_U273[l_U492] ))
        {
            ...
            {
                if ((IS_CHAR_RESPONDING_TO_EVENT( l_U273[l_U492], 9 )) || (((HAS_CHAR_SPOTTED_CHAR( l_U273[l_U492], sub_2128() )) AND (IS_PLAYER_TARGETTING_CHAR( sub_1404(), l_U273[l_U492] ))) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U273[l_U492], sub_2128(), 0 ))))
                {
                    CLEAR_PRINTS();
                    sub_2223( 0 );
                    GET_GAME_TIMER( ref l_U577._fU220 );
...
int sub_15007(unknown uParam0)
{
    ...
    if (((sub_3013( ref uParam0 )) < (10.00000000 * 2.00000000)) AND (IS_PLAYER_PRESSING_HORN( sub_1404() )))
    {
        return 1;
    }
    return 0;
...
int sub_17190(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
    {
        if (IS_PED_IN_GROUP( (uParam0^) ))
        {
            ...
            if ((IS_CHAR_ON_FOOT( sub_2128() )) AND (IS_CHAR_ON_FOOT( (uParam0^) )))
            {
                return 1;
            }
            if (DOES_VEHICLE_EXIST( (uParam1^) ))
            {
                ...
                {
                    if ((IS_CHAR_SITTING_IN_CAR( sub_2128(), (uParam1^) )) AND (IS_CHAR_SITTING_IN_CAR( (uParam0^), (uParam1^) )))
                    {
                        return 1;
                    }
                }
...
void sub_27211()
{
    ...
    switch (l_U202)
    {
            ...
            if (NOT (IS_CHAR_INJURED( l_U272 )))
            {
                ...
                if (NOT (sub_18575( l_U540[5] )))
                {
                    ...
                    if (NOT (IS_CAR_DEAD( l_U277 )))
                    {
                        ...
                        if ((l_U474 < 90) || (l_U474 > 270))
                        {
                            l_U372 = {981.36630000, -467.42000000, 15.15200000};
                        }
                        else
                        {
                            l_U372 = {981.54170000, -495.73200000, 14.70740000};
                        }
                        CLEAR_SEQUENCE_TASK( l_U530 );
                        OPEN_SEQUENCE_TASK( ref l_U530 );
        ...
        {
            GET_SCRIPT_TASK_STATUS( l_U272, 29, ref l_U537 );
            if ((l_U537 == 7) || (NOT (IS_CHAR_ON_SCREEN( l_U272 ))))
            {
                l_U202 = 11;
            }
        }
