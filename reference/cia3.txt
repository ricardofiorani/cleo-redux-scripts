void main()
{
    ...
    while (true)
    {
        ...
        switch (l_U718)
        {
            ...
            else if ((NOT l_U560) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_2676(), -64.73371000, 54.27560000, 13.76190000, 70.00000000, 70.00000000, 70.00000000, 0 ))))
            {
                if (sub_7884() == 3)
                {
                    l_U560 = 1;
            ...
            case 2:
            sub_11927();
            SWITCH_ROADS_BACK_TO_ORIGINAL( 132.81170000, 285.77020000, 0.00000000, 211.33040000, 290.82670000, 25.00000000 );
            ...
            if (NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U506 )))
            {
                ...
                SET_CAR_COORDINATES( l_U506, -709.02690000, 357.86700000, 3.94586000 );
                WAIT( 0 );
                if (NOT (IS_CAR_DEAD( l_U506 )))
                {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND ((NOT bVar6) AND (sub_19469())))
                    {
                ...
                if (NOT l_U563)
                {
                    if ((l_U538 > 150000.00000000) || (LOCATE_CHAR_ANY_MEANS_3D( sub_2676(), -718.71000000, 345.71000000, 3.05000000, 350.00000000, 350.00000000, 450.00000000, 0 )))
                    {
                        sub_19873();
                    }
                }
                ...
                {
                    if ((l_U538 > 165000.00000000) || (LOCATE_CHAR_ANY_MEANS_3D( sub_2676(), -718.71000000, 345.71000000, 3.05000000, 250.00000000, 250.00000000, 350.00000000, 0 )))
                    {
                        sub_20021();
                    }
                }
            ...
            {
                sub_14879();
                if ((NOT l_U540) AND ((NOT (IS_CHAR_DEAD( l_U511 ))) AND (NOT (IS_CHAR_INJURED( l_U526 )))))
                {
                ...
                if ((NOT l_U539) AND ((l_U540) AND ((NOT (IS_CHAR_INJURED( l_U511 ))) AND (NOT (IS_CHAR_INJURED( l_U526 ))))))
                {
                    ...
                    if (l_U541 == 7)
                    {
                        ...
                        if (l_U541 == 7)
                        {
                            ...
                            if ((NOT (IS_CHAR_DEAD( l_U509 ))) AND (NOT (IS_CHAR_DEAD( l_U521[1] ))))
                            {
                                TASK_TURN_CHAR_TO_FACE_CHAR( l_U521[1], l_U509 );
                            }
                            if ((NOT (IS_CAR_DEAD( l_U506 ))) AND (NOT (IS_CHAR_DEAD( l_U521[1] ))))
                            {
            ...
            else
            {
                ...
                {
                    if ((NOT l_U594) AND (NOT (sub_29144( l_U542 ))))
                    {
                    ...
                    if (LOCATE_CHAR_IN_CAR_2D( sub_2676(), 2323.53900000, 72.98220000, 100.00000000, 100.00000000, 0 ))
                    {
                        ...
                        else if ((NOT bVar9) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
                        {
                            if (# -NULL-0xc238b5( 0 ))
                            {
...
void sub_1557()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_1595( 5, g_U569[I] )) == 1))
        {
...
void sub_2459()
{
    ...
    if ((NOT l_U558) AND (DOES_CHAR_EXIST( l_U509 )))
    {
        DELETE_CHAR( ref l_U509 );
    }
    if ((NOT l_U558) AND (DOES_CHAR_EXIST( l_U511 )))
    {
...
void sub_4455()
{
    ...
    while ((NOT (HAS_CAR_RECORDING_BEEN_LOADED( 249 ))) || ((NOT (HAVE_ANIMS_LOADED( "misscia3" ))) || ((NOT (HAS_MODEL_LOADED( -1341473171 ))) || ((NOT (HAS_MODEL_LOADED( l_U510 ))) || ((NOT (HAS_MODEL_LOADED( l_U508 ))) || (NOT (HAS_MODEL_LOADED( l_U505 ))))))))
    {
        WAIT( 0 );
    }
    ...
    else
    {
        ...
        SWITCH_ROADS_OFF( 132.81170000, 285.77020000, 0.00000000, 211.33040000, 290.82670000, 25.00000000 );
        ...
        l_U684[5] = {-710.94060000, 348.40300000, 3.05170000};
...
int sub_8047(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_2676() ))) AND (IS_CHAR_IN_ANY_CAR( sub_2676() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_8574()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_11927()
{
    ...
    while ((NOT bVar3) AND (NOT bVar2))
    {
        ...
        if ((IS_SCREEN_FADED_IN()) AND ((sub_12005()) AND (iVar11 >= 1000)))
        {
        ...
        else
        {
            switch (iVar4)
            {
                ...
                if (TIMERA() > 2000)
                {
                    SET_CAM_POS( uVar6[0], 213.06530000, 327.59470000, 29.61244000 );
                    SET_CAM_ROT( uVar6[0], 11.03047000, -0.00038200, -143.55100000 );
                    SET_CAM_FOV( uVar6[1], 47.00000000 );
                    SET_CAM_POS( uVar6[1], 209.22330000, 333.24240000, 31.89635000 );
...
void sub_14879()
{
    ...
    if (NOT l_U579)
    {
        if ((DOES_CHAR_EXIST( l_U521[3] )) AND (DOES_CHAR_EXIST( l_U521[2] )))
        {
            if ((NOT (IS_CHAR_INJURED( l_U521[3] ))) AND (NOT (IS_CHAR_INJURED( l_U521[2] ))))
            {
                if ((IS_EXPLOSION_IN_AREA( -1, l_U722[3]._fU0 - 8, l_U722[3]._fU4 - 8, l_U722[3]._fU8 - 8, l_U722[3]._fU0 + 8, l_U722[3]._fU4 + 8, l_U722[3]._fU8 + 8 )) || ((IS_EXPLOSION_IN_AREA( -1, l_U722[2]._fU0 - 8, l_U722[2]._fU4 - 8, l_U722[2]._fU8 - 8, l_U722[2]._fU0 + 8, l_U722[2]._fU4 + 8, l_U722[2]._fU8 + 8 )) || ((IS_SNIPER_BULLET_IN_AREA( l_U722[3]._fU0 - 8, l_U722[3]._fU4 - 8, l_U722[3]._fU8 - 8, l_U722[3]._fU0 + 8, l_U722[3]._fU4 + 8, l_U722[3]._fU8 + 8 )) || ((IS_SNIPER_BULLET_IN_AREA( l_U722[2]._fU0 - 8, l_U722[2]._fU4 - 8, l_U722[2]._fU8 - 8, l_U722[2]._fU0 + 8, l_U722[2]._fU4 + 8, l_U722[2]._fU8 + 8 )) || (((IS_CHAR_ON_FOOT( sub_2676() )) AND (IS_CHAR_IN_AREA_3D( sub_2676(), -626.60000000, 339.50000000, 3, -622.40000000, 347.70000000, 10, 0 ))) || ((IS_CHAR_IN_AREA_3D( sub_2676(), -625.30000000, 339, 3, 64843, 375.70000000, 10, 0 )) || ((IS_CHAR_RESPONDING_TO_EVENT( l_U521[3], 49 )) || ((IS_PED_RAGDOLL( l_U521[3] )) || ((IS_PED_RAGDOLL( l_U521[2] )) || ((IS_CHAR_RESPONDING_TO_EVENT( l_U521[3], 49 )) || ((IS_CHAR_RESPONDING_TO_EVENT( l_U521[2], 49 )) || (((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U521[3], sub_2676() )) AND (IS_PLAYER_TARGETTING_CHAR( sub_2633(), l_U521[3] ))) || (((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U521[2], sub_2676() )) AND (IS_PLAYER_TARGETTING_CHAR( sub_2633(), l_U521[2] ))) || ((IS_PED_RAGDOLL( l_U521[3] )) || ((IS_PED_RAGDOLL( l_U521[2] )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U521[3], sub_2676(), 0 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U521[2], sub_2676(), 0 ))))))))))))))))))
                {
                    sub_14459( 1 );
                }
                else if (l_U751)
                {
                    ...
                    else if ((sub_16078( l_U521[3], 29 )) || (sub_16078( l_U521[2], 29 )))
                    {
                        l_U751 = 0;
                        sub_14459( 1 );
                    };;;
...
void sub_18782(unknown uParam0)
{
    ...
    if ((iVar3 != 4) AND ((NOT sub_18950()) AND ((NOT (IS_CHAR_DEAD( (uParam0^) ))) AND ((IS_CHAR_IN_ANY_CAR( sub_2676() )) AND (IS_CONTROL_PRESSED( 0, 51 ))))))
    {
...
int sub_19469()
{
    ...
    if ((IS_CHAR_SITTING_IN_ANY_CAR( sub_2676() )) AND ((iVar2 != 5) AND (iVar2 != 4)))
    {
        return 1;
    }
    return 0;
...
void sub_19567()
{
    ...
    {
        GET_CAR_COORDINATES( l_U506, ref l_U532._fU0, ref l_U532._fU4, ref l_U532._fU8 );
        if ((NOT (IS_CAR_ON_SCREEN( l_U506 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_2676(), l_U532._fU0, l_U532._fU4, l_U532._fU8, 280.00000000, 280.00000000, 280.00000000, 0 ))))
        {
            CLEAR_SMALL_PRINTS();
            sub_3254( 0 );
        }
...
void sub_20021()
{
    if ((HAS_MODEL_LOADED( -625748998 )) AND ((HAS_MODEL_LOADED( 1976502708 )) AND (HAS_MODEL_LOADED( 1543404628 ))))
    {
...
void sub_23193()
{
    ...
    if ((NOT g_U64676) AND ((sub_7884() == 2) || (sub_7884() == 6)))
    {
        g_U64676 = 1;
        GET_GAME_TIMER( ref l_U740 );
    }
    if ((NOT g_U64677) AND (g_U64676))
    {
        sub_24838();
    }
    return;
...
void sub_24838()
{
    ...
    GET_GAME_TIMER( ref l_U548 );
    if ((l_U548 > (l_U740 + 4000)) AND (NOT g_U64677))
    {
        iVar2 = 0;
        if (l_U750)
        {
...
int sub_25450()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_1595( 1, g_U569[I] )) != 0))
        {
            sub_1881( I );
            return 1;
        }
...
void sub_26483(unknown uParam0, int iParam1)
{
    ...
    {
        if ((IS_VEH_DRIVEABLE( l_U506 )) AND (NOT (IS_CHAR_INJURED( uParam0 ))))
        {
            if (IS_PED_RAGDOLL( uParam0 ))
            {
                if ((CHECK_NM_FEEDBACK( uParam0, 162, 0 )) || (CHECK_NM_FEEDBACK( uParam0, 188, 0 )))
                {
                    if (NOT l_U580)
                    {
                        SETTIMERB( 0 );
                    ...
                    else if ((NOT l_U581[iParam1]) AND (TIMERB() > 2000))
                    {
                        SAY_AMBIENT_SPEECH( uParam0, "DODGE", 1, 1, 0 );
                        l_U581[iParam1] = 1;
                    }
                    GET_CHAR_HEIGHT_ABOVE_GROUND( sub_2676(), ref l_U538 );
                    if ((NOT l_U564) AND (l_U538 > 8.00000000))
                    {
                        l_U564 = 1;
                    }
                    if ((l_U613[iParam1] != 4) AND ((l_U538 < 6.00000000) AND (((iParam1 == 1) AND (TIMERB() > 6000)) || (((iParam1 == 0) AND (TIMERB() > 4000)) AND (l_U564)))))
                    {
                        GET_GAME_TIMER( ref l_U567 );
                        if (((l_U567 > (l_U566 + 800)) AND (l_U565 == 1)) || (l_U565 == 0))
                        {
                ...
                else if ((NOT l_U584[iParam1]) AND (l_U581[iParam1]))
                {
            ...
            switch (l_U613[iParam1])
            {
                ...
                break;
                case 1:
                if ((IS_CHAR_IN_CAR( sub_2676(), l_U506 )) AND (NOT (IS_CAR_IN_AREA_3D( l_U506, -724.00000000, 335.00000000, 0.00000000, -694.00000000, 378.00000000, 40.00000000, 0 ))))
                {
                    CLEAR_CHAR_TASKS( uParam0 );
                    SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( uParam0, 0 );
                    TASK_COMBAT( uParam0, sub_2676() );
                ...
                else
                {
                    ...
                    if ((l_U538 < 0.60000000) AND (l_U538 > -0.30000000))
                    {
...
{
    if ((g_U9241._fU148[uParam0] == 9) || (g_U9241._fU148[uParam0] == 7))
    {
        return 1;
    }
    return 0;
    ...
    while ((NOT bVar3) AND (NOT bVar2))
    {
        ...
        else
        {
            switch (iVar4)
            {
                ...
                while ((NOT (HAS_MODEL_LOADED( -685276541 ))) || ((NOT (HAS_CAR_RECORDING_BEEN_LOADED( 235 ))) || ((NOT (HAS_MODEL_LOADED( l_U505 ))) || (NOT (HAS_MODEL_LOADED( -999506922 ))))))
                {
                    WAIT( 0 );
                }
                CLEAR_AREA( 2333.77300000, 83.33680000, 4.80770000, 200.00000000, 1 );
                ...
                OPEN_SEQUENCE_TASK( ref l_U516 );
                TASK_PAUSE( 0, 700 );
                TASK_FOLLOW_NAV_MESH_TO_COORD( 0, 2325.00000000, 75.69999000, 5.00000000, 2, 20000, 0.10000000 );
                ...
                if (l_U541 == 7)
                {
                    ...
                    if ((NOT (IS_CAR_DEAD( l_U506 ))) AND (NOT (IS_CHAR_DEAD( l_U527[0] ))))
                    {
                ...
                if (NOT (sub_29144( l_U542 )))
                {
                    if ((NOT (IS_CAR_DEAD( l_U506 ))) AND ((NOT (IS_CHAR_DEAD( l_U527[1] ))) AND (NOT (IS_CHAR_DEAD( l_U527[0] )))))
                    {
                        ...
                        SET_CHAR_COORDINATES( l_U527[0], 2324.94300000, 74.69993000, 4.71870000 );
                ...
                if ((NOT (IS_CAR_DEAD( l_U506 ))) AND ((NOT (IS_CHAR_DEAD( l_U527[1] ))) AND (NOT (IS_CHAR_DEAD( l_U527[0] )))))
                {
                    if ((IS_CHAR_IN_CAR( l_U527[0], l_U506 )) AND (IS_CHAR_IN_CAR( l_U527[1], l_U506 )))
                    {
                        SET_CAM_POS( uVar6[1], 2335.80600000, 75.99666000, 5.45769100 );
...
void sub_46254()
{
    if (l_U718 == 3)
    {
        if (l_U562)
        {
            if ((NOT (IS_CHAR_DEAD( l_U526 ))) AND ((NOT (IS_CHAR_DEAD( l_U521[1] ))) AND (NOT (IS_CHAR_DEAD( l_U521[0] )))))
            {
                if (((NOT l_U552) AND (IS_EXPLOSION_IN_AREA( -1, 64811, 338, 0, 64826, 350, 10 ))) || ((IS_SNIPER_BULLET_IN_AREA( 64811, 338, 0, 64826, 350, 10 )) || ((IS_CHAR_RESPONDING_TO_EVENT( l_U521[0], 49 )) || (((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U521[1], sub_2676() )) AND (IS_PLAYER_TARGETTING_CHAR( sub_2633(), l_U521[1] ))) || (((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U521[0], sub_2676() )) AND (IS_PLAYER_TARGETTING_CHAR( sub_2633(), l_U521[0] ))) || (((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U526, sub_2676() )) AND (IS_PLAYER_TARGETTING_CHAR( sub_2633(), l_U526 ))) || ((IS_PED_RAGDOLL( l_U521[1] )) || ((IS_PED_RAGDOLL( l_U521[0] )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U521[1], sub_2676(), 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U521[0], sub_2676(), 0 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U526, sub_2676(), 0 ))))))))))))
                {
                    if (NOT l_U556)
                    {
                        sub_22736();
            ...
            if (NOT (IS_CAR_DEAD( l_U506 )))
            {
                if (((FIND_TIME_POSITION_IN_RECORDING( l_U506 )) > 175000.00000000) AND (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U506 )))
                {
                    if ((l_U552) || (IS_CHAR_IN_AREA_3D( sub_2676(), -725.50000000, 329.00000000, 1.00000000, -695.50000000, 385.00000000, 8.00000000, 0 )))
                    {
                        if (l_U552)
                        {
                            ;
    ...
    {
        if ((NOT (IS_CHAR_DEAD( l_U511 ))) AND ((NOT (IS_CHAR_DEAD( l_U509 ))) AND ((NOT (IS_CHAR_DEAD( l_U526 ))) AND ((NOT (IS_CHAR_DEAD( l_U521[1] ))) AND (NOT (IS_CHAR_DEAD( l_U521[0] )))))))
        {
            if (((NOT l_U552) AND (IS_EXPLOSION_IN_AREA( -1, -725.50000000, 329.00000000, 1.00000000, -695.50000000, 385.00000000, 8.00000000 ))) || ((IS_SNIPER_BULLET_IN_AREA( 64811, 338, 0, 64826, 350, 10 )) || (((l_U579) AND (IS_CHAR_IN_AREA_2D( sub_2676(), -719.90000000, 341.40000000, -692.00000000, 372.10000000, 0 ))) || ((IS_CHAR_IN_AREA_3D( sub_2676(), -725.50000000, 329.00000000, 1.00000000, -695.50000000, 385.00000000, 8.00000000, 0 )) || ((IS_CHAR_RESPONDING_TO_EVENT( l_U511, 49 )) || ((IS_CHAR_RESPONDING_TO_EVENT( l_U521[0], 49 )) || (((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U511, sub_2676() )) AND (IS_PLAYER_TARGETTING_CHAR( sub_2633(), l_U511 ))) || (((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U509, sub_2676() )) AND (IS_PLAYER_TARGETTING_CHAR( sub_2633(), l_U509 ))) || (((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U521[1], sub_2676() )) AND (IS_PLAYER_TARGETTING_CHAR( sub_2633(), l_U521[1] ))) || (((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U521[0], sub_2676() )) AND (IS_PLAYER_TARGETTING_CHAR( sub_2633(), l_U521[0] ))) || (((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U526, sub_2676() )) AND (IS_PLAYER_TARGETTING_CHAR( sub_2633(), l_U526 ))) || ((IS_PED_RAGDOLL( l_U521[1] )) || ((IS_PED_RAGDOLL( l_U521[0] )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U511, sub_2676(), 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U509, sub_2676(), 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U521[1], sub_2676(), 0 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U521[0], sub_2676(), 0 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U526, sub_2676(), 0 )))))))))))))))))))
            {
                if (NOT l_U556)
                {
                    sub_22736();
        ...
        {
            GET_CAR_COORDINATES( l_U506, ref l_U532._fU0, ref l_U532._fU4, ref l_U532._fU8 );
            if ((NOT l_U555) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_2676(), l_U532._fU0, l_U532._fU4, l_U532._fU8, 6.00000000, 6.00000000, 6.00000000, 0 )))
            {
                l_U555 = 1;
                if (NOT l_U552)
                {
        ...
        if ((NOT (IS_CAR_DEAD( l_U506 ))) AND ((NOT (IS_CHAR_DEAD( l_U511 ))) AND (NOT (IS_CHAR_DEAD( l_U509 )))))
        {
            if ((l_U539) AND ((NOT l_U554) AND (TIMERB() > 60000)))
            {
        ...
        if ((NOT (IS_CAR_DEAD( l_U506 ))) AND ((NOT (IS_CHAR_DEAD( l_U511 ))) AND (NOT (IS_CHAR_DEAD( l_U509 )))))
        {
            if ((l_U554) AND ((IS_CHAR_IN_CAR( l_U511, l_U506 )) AND (IS_CHAR_IN_CAR( l_U509, l_U506 ))))
            {
                sub_47003( 0 );
                sub_3254( 0 );
            }
...
{
    if ((NOT (IS_CAR_DEAD( l_U506 ))) AND (NOT (IS_CHAR_DEAD( l_U509 ))))
    {
