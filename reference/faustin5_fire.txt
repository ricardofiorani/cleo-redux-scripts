...
void sub_63()
{
    ...
    SWITCH_PED_ROADS_BACK_TO_ORIGINAL( 600.06290000, 1468.30200000, 9.94909900, 645.37510000, 1488.85700000, 14.73830000 );
...
void sub_351()
{
    ...
    SWITCH_PED_PATHS_OFF( 600.06290000, 1468.30200000, 9.94909900, 645.37510000, 1488.85700000, 14.73830000 );
...
int sub_1208()
{
    ...
    if ((HAS_MODEL_LOADED( l_U101 )) AND (HAS_MODEL_LOADED( l_U100 )))
    {
        return 1;
    }
    return 0;
