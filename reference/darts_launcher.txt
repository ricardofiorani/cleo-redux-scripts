void main()
{
    ...
    {
        WAIT( 0 );
        if ((NOT l_U26) AND (NOT (IS_CONTROL_PRESSED( 0, 23 ))))
        {
            l_U26 = 1;
        }
        if (NOT (l_U8 == 1))
        ...
        if (l_U8 == 0)
        {
            if (DOES_OBJECT_EXIST( l_U11 ))
            {
                ...
                if (IS_PLAYER_PLAYING( sub_460() ))
                {
                    if ((sub_3964()) AND ((NOT (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_460() ))) AND (IS_WANTED_LEVEL_GREATER( sub_460(), 0 ))))
                    {
                        l_U34 = 0;
                    }
                }
...
int sub_1143(unknown uParam0)
{
    ...
    {
        if ((IS_CHAR_MODEL( uParam0, sub_1170( 7 ) )) || ((IS_CHAR_MODEL( uParam0, sub_1170( 8 ) )) || ((IS_CHAR_MODEL( uParam0, sub_1170( 13 ) )) || ((IS_CHAR_MODEL( uParam0, sub_1170( 3 ) )) || (IS_CHAR_MODEL( uParam0, sub_1170( 0 ) ))))))
        {
            return 1;
        }
        if ((IS_CHAR_MODEL( uParam0, sub_1170( 30 ) )) || ((IS_CHAR_MODEL( uParam0, sub_1170( 29 ) )) || ((IS_CHAR_MODEL( uParam0, sub_1170( 28 ) )) || ((IS_CHAR_MODEL( uParam0, sub_1170( 10 ) )) || (IS_CHAR_MODEL( uParam0, sub_1170( 2 ) ))))))
        {
            return 1;
        }
    }
...
{
    GET_OFFSET_FROM_OBJECT_IN_WORLD_COORDS( l_U11, 0.00000000, -1.50000000, -1.72000000, ref l_U19._fU0, ref l_U19._fU4, ref l_U19._fU8 );
    if ((((l_U31 < 181) AND (l_U31 > 179)) AND (IS_CHAR_IN_AREA_3D( sub_2859(), l_U19._fU0 - 1, l_U19._fU4 + 4.00000000, l_U19._fU8 - 1, l_U19._fU0 + 1, l_U19._fU4 - 1.60000000, l_U19._fU8 + 1, 0 ))) || (((l_U31 < 1) || (l_U31 > 359)) AND (IS_CHAR_IN_AREA_3D( sub_2859(), l_U19._fU0 - 1, l_U19._fU4 - 4.00000000, l_U19._fU8 - 1, l_U19._fU0 + 1, l_U19._fU4 + 1.60000000, l_U19._fU8 + 1, 0 ))))
    {
        return 1;
    }
    return 0;
...
int sub_4114(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_460() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_460() )))
            {
                if (((g_U9202) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_460() )))))
                {
                    if (NOT sub_4210())
                    {
