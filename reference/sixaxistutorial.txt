...
void sub_319(boolean bParam0)
{
    ...
    # -NULL-0xc23897( 0 );
    if ((NOT (IS_CHAR_DEAD( sub_420() ))) AND (IS_PLAYER_PLAYING( sub_382() )))
    {
    ...
    {
        while ((NOT (IS_PLAYER_PLAYING( sub_382() ))) || (IS_CHAR_DEAD( sub_420() )))
        {
            WAIT( 0 );
        }
    }
...
void sub_8076()
{
    if (l_U3 != 0)
    {
        ...
        else if ((l_U60) AND (IS_PLAYER_PLAYING( sub_382() )))
        {
    ...
    switch (l_U3)
    {
        ...
        switch (l_U82)
        {
            ...
            if (LOCATE_CHAR_IN_CAR_3D( sub_420(), 2348.05000000, 827.81000000, 5.77000000, 10, 10, 10, 0 ))
            {
                ...
                SET_PLAYER_CONTROL( sub_382(), 0 );
                GET_CHAR_HEADING( sub_420(), ref l_U67 );
                if (NOT ((l_U67 < 270) AND (l_U67 > 180)))
                {
                    DO_SCREEN_FADE_OUT( 500 );
                    while (NOT IS_SCREEN_FADED_OUT())
                    {
...
void sub_12286()
{
    if (l_U4 != 0)
    {
        ...
        else if ((sub_12352( l_U21 )) || (sub_9198( l_U21, 1 )))
        {
            l_U123 = 4;
            sub_8117();
            return;
...
void sub_14861()
{
    ...
    switch (l_U5)
    {
        ...
        {
            if ((IS_CHAR_SITTING_IN_CAR( sub_420(), l_U22 )) AND (LOCATE_CHAR_IN_CAR_3D( sub_420(), 2248.60000000, 756.30000000, 5.10000000, 10, 10, 1, 1 )))
            {
                if (NOT l_U55)
                {
                    SETTIMERA( 0 );
        ...
        if (l_U0 != 6)
        {
            if ((NOT (DOES_BLIP_EXIST( l_U25 ))) || (l_U56))
            {
                DELETE_CHECKPOINT( l_U117 );
                REMOVE_BLIP( l_U25 );
...
void sub_17648()
{
    switch (l_U6)
    {
        ...
        break;
        case 1:
        if ((TIMERA() >= l_U78) AND (NOT l_U36))
        {
            PRINT_NOW( "ATUT_GODLEAVE", 7500, 1 );
            SETTIMERA( 0 );
            l_U36 = 1;
        }
        if ((l_U36) AND (TIMERA() >= 2000))
        {
            if (NOT (l_U77 == 1))
            {
