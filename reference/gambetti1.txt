...
void sub_2067()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_2105( 5, g_U569[I] )) == 1))
        {
...
void sub_6450()
{
    ...
    while ((NOT (HAS_MODEL_LOADED( l_U788 ))) || (NOT (HAS_MODEL_LOADED( l_U787 ))))
    {
        WAIT( 0 );
    }
    ...
    LOAD_ALL_OBJECTS_NOW();
    while ((NOT (HAS_MODEL_LOADED( l_U794 ))) || (NOT (HAS_MODEL_LOADED( l_U793 ))))
    {
        WAIT( 0 );
    }
    ...
    LOAD_ALL_OBJECTS_NOW();
    while ((NOT (HAVE_ANIMS_LOADED( "missheli_tour" ))) || (NOT (HAVE_ANIMS_LOADED( "missgambetti1" ))))
    {
        WAIT( 0 );
    }
...
void sub_7354()
{
    ...
    else if ((sub_10441()) AND (sub_9946()))
    {
        if (NOT l_U567)
        {
            if (NOT (IS_CHAR_INJURED( l_U594[0] )))
            {
                if ((sub_10920( 1, 1 )) AND (LOCATE_CHAR_ON_FOOT_CHAR_3D( sub_5685(), l_U594[0], 3.00000000, 3.00000000, 3.00000000, 0 )))
                {
...
int sub_9946()
{
    ...
    {
        if ((NOT (CHECK_STUCK_TIMER( l_U659, 1, 40000 ))) AND (NOT (CHECK_STUCK_TIMER( l_U659, 0, 5000 ))))
        {
            if (NOT (IS_CHAR_INJURED( l_U592 )))
            {
    ...
    {
        if ((NOT (CHECK_STUCK_TIMER( l_U660, 1, 40000 ))) AND (NOT (CHECK_STUCK_TIMER( l_U660, 0, 5000 ))))
        {
            if (NOT (IS_CHAR_INJURED( l_U593 )))
            {
    ...
    {
        if ((CHECK_STUCK_TIMER( l_U658, 1, 40000 )) || (CHECK_STUCK_TIMER( l_U658, 0, 5000 )))
        {
            return 0;
        }
...
void sub_12168()
{
    ...
    if ((l_U564 == 6) || ((l_U564 == 4) || ((l_U564 == 1) || (l_U564 == 5))))
    {
        CLEAR_HELP();
        l_U559 = 0;
    }
    ...
    switch (l_U559)
    {
        ...
        if (sub_10920( 1, 1 ))
        {
            ...
            if (sub_9946())
            {
                ...
                for ( l_U776 = 0; l_U776 < 4; l_U776++ )
                {
                    if ((l_U776 == 0) || (NOT (LOCATE_CHAR_ON_FOOT_3D( l_U594[l_U776], vVar14[l_U776]._fU0, vVar14[l_U776]._fU4, vVar14[l_U776]._fU8, 0.50000000, 0.50000000, 2.50000000, 0 ))))
                    {
            ...
            SET_CAM_ROT( l_U805, -5.73358100, 0.00000000, 150.19070000 );
    ...
    if ((sub_10441()) AND (sub_9946()))
    {
        if (NOT (IS_CHAR_INJURED( l_U591 )))
        {
            if (IS_CHAR_SITTING_IN_CAR( sub_5685(), l_U658 ))
            {
                ...
                if ((LOCATE_CHAR_ANY_MEANS_3D( l_U591, 21.94100000, -43.54180000, 14.81190000, 10.00000000, 10.00000000, 4.00000000, 0 )) AND ((LOCATE_CHAR_ANY_MEANS_3D( sub_5685(), 21.94100000, -43.54180000, 14.81190000, 10.00000000, 10.00000000, 4.00000000, 0 )) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_5685(), l_U591, 6.00000000, 6.00000000, 5.00000000, 0 ))))
                {
                    fVar2 = 0.00000000;
    ...
    if (sub_20944())
    {
        ...
        switch (l_U560)
        {
            ...
            if (IS_CHAR_SITTING_IN_CAR( sub_5685(), l_U658 ))
            {
                if (sub_22693())
                {
                    if (LOCATE_CHAR_ANY_MEANS_3D( sub_5685(), 78.94171000, -198.75480000, 14.78500000, 9.40000000, 21.90000000, 5.00000000, 0 ))
                    {
                        l_U568 = 1;
                        l_U572 = 0;
                        l_U559 = 0;
        ...
        else if (NOT l_U827)
        {
            ...
            else if ((NOT (LOCATE_CHAR_ANY_MEANS_CAR_3D( sub_5685(), l_U660, 250.00000000, 250.00000000, 30.00000000, 0 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_CAR_3D( sub_5685(), l_U659, 250.00000000, 250.00000000, 30.00000000, 0 ))))
            {
                if ((NOT (IS_CAR_ON_SCREEN( l_U660 ))) AND (NOT (IS_CAR_ON_SCREEN( l_U659 ))))
                {
                    l_U564 = 5;
                    sub_12168();
                }
        ...
        if (NOT l_U827)
        {
            if ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U660, sub_5685() )) || ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U659, sub_5685() )) || (HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U658, sub_5685() ))))
            {
                CLEAR_CAR_LAST_DAMAGE_ENTITY( l_U658 );
                CLEAR_CAR_LAST_DAMAGE_ENTITY( l_U659 );
                CLEAR_CAR_LAST_DAMAGE_ENTITY( l_U660 );
        ...
        {
            if ((NOT (HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U660, sub_5685() ))) AND ((NOT (HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U659, sub_5685() ))) AND (NOT (HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U658, sub_5685() )))))
            {
                GET_GAME_TIMER( ref l_U778 );
                if ((l_U778 - l_U783) >= 5000)
                {
...
int sub_20944()
{
    if (IS_VEH_DRIVEABLE( l_U659 ))
    {
        if ((NOT (CHECK_STUCK_TIMER( l_U659, 2, 30000 ))) AND ((NOT (CHECK_STUCK_TIMER( l_U659, 3, 60000 ))) AND ((NOT (CHECK_STUCK_TIMER( l_U659, 1, 40000 ))) AND (NOT (CHECK_STUCK_TIMER( l_U659, 0, 5000 ))))))
        {
            if (NOT (IS_CHAR_DEAD( l_U592 )))
            {
                if (NOT (IS_CHAR_IN_CAR( l_U592, l_U659 )))
...
void sub_21693(unknown uParam0)
{
    ...
    if ((iVar3 != 4) AND ((NOT sub_21861()) AND ((NOT (IS_CHAR_DEAD( (uParam0^) ))) AND ((IS_CHAR_IN_ANY_CAR( sub_5685() )) AND (IS_CONTROL_PRESSED( 0, 51 ))))))
    {
        ...
        if (sub_10920( 1, 1 ))
        {
            ...
            if (NOT (IS_CHAR_INJURED( sub_5685() )))
            {
                ...
                if (IS_VEH_DRIVEABLE( l_U658 ))
                {
                    ...
                    SET_CAR_COORDINATES( l_U658, 76.42121000, -196.21020000, 13.64410000 );
                    SET_CAR_ON_GROUND_PROPERLY( l_U658 );
                ...
                SET_CAM_ROT( l_U807, -8.00160300, -0.00000000, 144.57690000 );
            ...
            while ((NOT (HAS_MODEL_LOADED( l_U792 ))) || (NOT (HAS_MODEL_LOADED( l_U789 ))))
            {
                WAIT( 0 );
            }
            if (l_U826)
        ...
        for ( l_U776 = 0; l_U776 < l_U770; l_U776++ )
        {
            if (NOT (IS_CHAR_INJURED( l_U594[l_U776] )))
            {
                ...
                if (l_U776 < 3)
                {
                    if (l_U776 == 0)
                    {
                        l_U749 = {85.73359000, -192.33770000, 14.75560000};
                    }
                    else if (l_U776 == 1)
                    {
...
void sub_36078()
{
    ...
    vVar2[5] = {66.84291000, -226.43880000, 14.80740000};
    ...
    vVar44[5] = {71.85221000, -222.22010000, 14.81610000};
    l_U773 = 6;
    l_U607[0] = l_U606;
    ...
    for ( l_U776 = 0; l_U776 < l_U773; l_U776++ )
    {
        ...
        if (NOT (IS_CHAR_DEAD( l_U607[l_U776] )))
        {
            ...
            if ((l_U776 == 4) || ((l_U776 == 5) || ((l_U776 == 3) || (l_U776 == 1))))
            {
...
void sub_39796()
{
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_5685(), 57.39900000, -186.90600000, 20.17200000, 13.22500000, 11.72500000, 2.50000000, 0 )) || (CAM_IS_SPHERE_VISIBLE( uVar76, vVar2[0]._fU0, vVar2[0]._fU4, vVar2[0]._fU8, 2.00000000 )))
    {
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_5685(), 57.39900000, -186.90600000, 20.17200000, 13.22500000, 11.72500000, 2.50000000, 0 )) || (CAM_IS_SPHERE_VISIBLE( uVar76, vVar2[1]._fU0, vVar2[1]._fU4, vVar2[1]._fU8, 2.00000000 )))
    {
...
void sub_42805()
{
    ...
    array(ref fVar33, 10);
    array(ref vVar44, 10);
    vVar2[0] = {99.58989000, -213.12720000, 14.91980000};
    fVar33[0] = 83.14589000;
    ...
    if (NOT (IS_CHAR_INJURED( l_U591 )))
    {
        ...
        if (NOT l_U577)
        {
            if (NOT l_U578)
            {
                ...
                {
                    GET_GAME_TIMER( ref l_U778 );
                    if (((l_U778 - l_U780) >= 3000) || (NOT IS_MESSAGE_BEING_DISPLAYED()))
                    {
                        if (NOT (sub_12608( l_U813 )))
                        {
                            if (NOT l_U825)
...
void sub_47829()
{
    ...
    else if (NOT l_U571)
    {
        for ( l_U776 = 0; l_U776 < 4; l_U776++ )
        {
            if ((NOT (IS_CHAR_DEAD( l_U640[l_U776] ))) AND (IS_VEH_DRIVEABLE( l_U662[l_U776] )))
            {
                if (l_U579[l_U776])
                {
                        ...
                        if (NOT (LOCATE_CHAR_ON_FOOT_CAR_3D( sub_5685(), l_U662[l_U776], 10.00000000, 10.00000000, 5.00000000, 0 )))
                        {
                            ...
                            if (l_U578)
                            {
                                if (NOT (IS_CHAR_INJURED( l_U645[l_U776] )))
                                {
                                    ...
                                    {
                                        if ((NOT (l_U667 == nil)) AND (IS_VEH_DRIVEABLE( l_U667 )))
                                        {
                                ...
                                else if ((NOT (l_U667 == nil)) AND (IS_VEH_DRIVEABLE( l_U667 )))
                                {
                                    GET_SCRIPT_TASK_STATUS( l_U640[l_U776], 49, ref l_U803 );
                                    if (l_U803 == 7)
                                    {
...
void sub_54958()
{
    ...
    if ((IS_CHAR_ON_ANY_BIKE( sub_5685() )) || (IS_CHAR_IN_ANY_CAR( sub_5685() )))
    {
        SET_PLAYER_CONTROL( sub_6907(), 0 );
    ...
    switch (l_U559)
    {
        ...
        if (NOT (sub_12608( l_U813 )))
        {
            if (NOT (IS_CHAR_INJURED( l_U591 )))
            {
                ...
                GET_GAME_TIMER( ref l_U778 );
                l_U777 = l_U778 - l_U779;
                if ((NOT bVar3) || ((l_U777 > 15000) || (l_U803 == 7)))
                {
                    l_U559 = 13;
                }
            }
...
void sub_74002()
{
    switch (l_U559)
    {
        ...
        if (NOT IS_MESSAGE_BEING_DISPLAYED())
        {
            if ((IS_SCREEN_FADED_IN()) AND (sub_10920( 1, 1 )))
            {
                if ((IS_VEH_DRIVEABLE( l_U658 )) AND (NOT (IS_CHAR_INJURED( l_U591 ))))
                {
        ...
        if (IS_VEH_DRIVEABLE( l_U658 ))
        {
            if ((NOT (IS_CAR_ON_SCREEN( l_U658 ))) || (l_U777 > 6000))
            {
                sub_76194();
                l_U559 = 13;
            }
...
void sub_74360()
{
    ...
    if (IS_PLAYER_PLAYING( sub_6907() ))
    {
        ...
        if (IS_VEH_DRIVEABLE( l_U658 ))
        {
            if ((NOT (CHECK_STUCK_TIMER( l_U658, 1, 40000 ))) AND (NOT (CHECK_STUCK_TIMER( l_U658, 0, 5000 ))))
            {
