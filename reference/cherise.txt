...
void sub_2767()
{
    switch (l_U196)
    {
        ...
        while ((NOT (HAVE_ANIMS_LOADED( "misscherise" ))) || (NOT (HAS_MODEL_LOADED( l_U290 ))))
        {
            WAIT( 0 );
        }
        l_U196 = 1;
...
void sub_3320()
{
    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U217, sub_2417(), 0 )) || (IS_CHAR_INJURED( l_U217 )))
    {
        if (IS_HINT_RUNNING())
        {
            HINT_CAM( -1.00000000, -1.00000000, -1.00000000, l_U217, 0, 0, 0 );
    ...
    if ((IS_CHAR_ON_FOOT( sub_2417() )) AND (sub_3486() < 25))
    {
    ...
    {
        case 0:
        if ((IS_WANTED_LEVEL_GREATER( sub_1061(), 0 )) || ((IS_CHAR_ON_FIRE( l_U217 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U217, sub_2417(), 0 )) || (IS_CHAR_INJURED( l_U217 )))))
        {
        ...
        if ((IS_CHAR_ON_FOOT( sub_2417() )) AND (NOT (IS_CHAR_INJURED( l_U217 ))))
        {
            if (sub_3486() < 18)
            {
                if ((NOT l_U294) AND (NOT IS_HINT_RUNNING()))
                {
...
void sub_7866()
{
    ...
    if (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U217, sub_2417(), 0 ))
    {
        ...
        if ((NOT (IS_CHAR_DEAD( l_U217 ))) AND (l_U302 < 150))
        {
            if (NOT l_U316)
            {
            ...
            if (NOT (IS_GROUP_MEMBER( l_U217, sub_5364() )))
            {
                ...
                if (DOES_BLIP_EXIST( l_U221 ))
                {
                    if (sub_3486() < 12.00000000)
                    {
                        ...
                        l_U209 = 1;
                        if ((l_U302 > 150) AND (NOT (IS_CHAR_INJURED( l_U217 ))))
                        {
                            if ((NOT (IS_CHAR_IN_ANY_CAR( sub_2417() ))) AND (NOT (IS_CHAR_INJURED( sub_2417() ))))
                            {
                                if (NOT l_U307)
                                {
    ...
    switch (l_U200)
    {
        ...
        while ((NOT (HAS_MODEL_LOADED( -314369597 ))) || (NOT (HAS_MODEL_LOADED( -552829610 ))))
        {
            WAIT( 0 );
        }
        ...
        if ((NOT (IS_VEH_DRIVEABLE( l_U220 ))) AND (DOES_VEHICLE_EXIST( l_U220 )))
        {
        ...
        if (NOT (IS_WANTED_LEVEL_GREATER( sub_1061(), 0 )))
        {
            if (NOT (IS_CHAR_INJURED( l_U217 )))
            {
                ...
                {
                    if ((sub_4648( 1, 1 )) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_2417(), -324.78000000, 1607.89000000, 19.46000000 + 2.50000000, 2.50000000, 2.50000000, 2.50000000, 1 )))
                    {
                        SET_PLAYER_CONTROL( sub_1061(), 0 );
                        if (sub_3486() < 3.00000000)
                        {
                            ...
                            if (IS_CHAR_IN_ANY_CAR( sub_2417() ))
                            {
                                if ((IS_VEH_DRIVEABLE( l_U220 )) AND (NOT (IS_CAR_UPSIDEDOWN( l_U220 ))))
                                {
                    ...
                    else if ((IS_CHAR_IN_ANY_CAR( sub_2417() )) AND (sub_15781() < 12.50000000))
                    {
        ...
        else if ((NOT l_U308) AND ((sub_16456( l_U266 )) == 1))
        {
            if (NOT (IS_CHAR_INJURED( sub_2417() )))
            {
        ...
        if ((NOT sub_369()) AND ((sub_15781() < 4.50000000) AND ((sub_4648( 1, 1 )) AND (IS_CHAR_ON_FOOT( sub_2417() )))))
        {
        ...
        if (sub_15781() > 100)
        {
            if ((NOT (IS_CHAR_ON_SCREEN( l_U218 ))) AND (NOT (IS_CHAR_DEAD( l_U218 ))))
            {
        ...
        if (NOT (IS_CHAR_DEAD( l_U218 )))
        {
            ...
            {
                l_U306 = 0;
                if ((sub_15781() > 20.00000000) || (NOT (sub_9964( l_U284 ))))
                {
                    l_U200 = 12;
                }
            }
        ...
        {
            if ((NOT (IS_CHAR_INJURED( sub_2417() ))) AND (NOT (IS_CHAR_INJURED( l_U217 ))))
            {
                TASK_LOOK_AT_CHAR( l_U217, sub_2417(), -2, 0 );
            }
            PRINT( "CHRS_PMT5", 7500, 1 );
        ...
        if (sub_3486() < 3.50000000)
        {
            ...
            if ((IS_VEH_DRIVEABLE( l_U220 )) AND (DOES_VEHICLE_EXIST( l_U220 )))
            {
