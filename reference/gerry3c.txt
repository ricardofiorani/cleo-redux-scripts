void main()
{
    ...
    l_U526 = 0;
    l_U527 = 0;
    l_U538 = {-1000.69700000, 1223.56400000, 27.41770000};
    l_U572 = "GM3_BARR";
    l_U579 = "GM3_PHOT";
    l_U586 = "GM3_BOUT";
    l_U593 = "GM3_BPAS";
    ...
    while (true)
    {
        ...
        if (IS_PLAYER_PLAYING( sub_3524() ))
        {
            if (LOCATE_CHAR_ANY_MEANS_3D( sub_16732(), l_U494._fU0, l_U494._fU4, l_U494._fU8, 50.00000000, 50.00000000, 50.00000000, 0 ))
            {
                ...
                {
                    case 0:
                    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_16732(), l_U550._fU0, l_U550._fU4, l_U550._fU8, 10.00000000, 10.00000000, 5.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( sub_16732(), l_U544._fU0, l_U544._fU4, l_U544._fU8, 10.00000000, 10.00000000, 10.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_16732(), l_U547._fU0, l_U547._fU4, l_U547._fU8, 10.00000000, 10.00000000, 10.00000000, 0 ))))
                    {
                        if (l_U522 == 0)
                        {
                    ...
                    if (l_U522 == 0)
                    {
                        if ((HAVE_ANIMS_LOADED( "missgerry3c" )) AND ((HAS_MODEL_LOADED( l_U662 )) AND ((sub_20434( l_U660 )) AND (sub_20434( l_U661 )))))
                        {
                            g_U9151 = 0;
                            l_U491 = 2;
                        }
                    ...
                    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_16732(), l_U550._fU0, l_U550._fU4, l_U550._fU8, 1.50000000, 1.50000000, 1.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( sub_16732(), l_U547._fU0, l_U547._fU4, l_U547._fU8, 1.00000000, 1.00000000, 1.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_16732(), l_U544._fU0, l_U544._fU4, l_U544._fU8, 1.00000000, 1.00000000, 1.00000000, 0 ))))
                    {
...
void sub_1673()
{
    ...
    iVar2 = 0;
    if ((g_U22274[13]._fU20) AND (g_U22274[13]._fU16))
    {
        iVar2 = 1;
    }
    sub_1718();
...
void sub_12275()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_12313( 5, g_U569[I] )) == 1))
        {
...
void sub_17606()
{
    ...
    if (DOES_CHAR_EXIST( l_U667 ))
    {
        if ((IS_CHAR_INJURED( l_U667 )) || (IS_CHAR_DEAD( l_U667 )))
        {
            sub_14718( 0 );
            if (DOES_BLIP_EXIST( l_U676 ))
            {
        ...
        if (sub_20434( l_U661 ))
        {
            if (HAS_MODEL_LOADED( l_U663 ))
            {
                if (HAVE_ANIMS_LOADED( "missgerry3c" ))
                {
                    ...
                    if ((DOES_OBJECT_EXIST( l_U664 )) AND (NOT (IS_CHAR_INJURED( l_U667 ))))
                    {
...
int sub_28899()
{
    if ((sub_28947()) || ((IS_BUTTON_PRESSED( 0, 16 )) || ((IS_BUTTON_PRESSED( 0, 15 )) || ((IS_BUTTON_PRESSED( 0, 14 )) || (IS_BUTTON_PRESSED( 0, 17 ))))))
    {
...
{
    if ((iParam0 == g_U91._fU60) AND (g_U91._fU88))
    {
        return 1;
    }
    return 0;
