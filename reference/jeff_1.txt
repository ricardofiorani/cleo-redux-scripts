void main()
{
    ...
    if ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "jeff_1_mission" )) < 1)
    {
        if (sub_651( l_U401, l_U378 ))
        {
            ...
            {
                sub_1371( ref l_U415 );
                if ((l_U415._fU8._fU0 <= 14) || (l_U415._fU8._fU0 >= 9))
                {
                                ...
                                if (NOT l_U219)
                                {
                                    if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
                                    {
                                        ...
                                        if (NOT (IS_WANTED_LEVEL_GREATER( sub_1471(), 0 )))
                                        {
                                            sub_3055();
                                            sub_3280();
                                            if ((sub_3597( ref l_U265, 22.00000000 )) || (sub_3505( ref l_U265 )))
                                            {
                                                sub_3774();
                                            }
                                            sub_4352( ref l_U273 );
...
int sub_3280()
{
    if (l_U237)
    {
        if (IS_HINT_RUNNING())
        {
            if ((sub_3326()) || ((sub_3078( ref l_U265 )) > 18.00000000))
            {
