...
int sub_39405()
{
    ...
    fVar3 = 0.00000000;
    GET_CAR_SPEED( uVar2, ref fVar3 );
    if ((sub_39480( 1, 1 )) AND (fVar3 < 0.01000000))
    {
        if (NOT l_U113)
        {
...
int sub_39843()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    bVar3 = false;
    if ((IS_PLAYER_PRESSING_HORN( sub_3715() )) AND ((sub_39480( 1, 1 )) AND (IS_CHAR_IN_ANY_CAR( sub_1574() ))))
    {
        if (l_U113)
        {
            return 0;
...
void sub_51312()
{
    ...
    sub_51640( iVar3[30], -437.20600000, 463.31500000, 11.30600000, 273.22870000, -451.98690000, 469.22640000, 14.42270000, -12.98044000, 0.00000000, -130.48930000 );
                ...
                switch (l_U223)
                {
                    ...
                    if (sub_63047( uParam0 ))
                    {
                        ...
                        if (DOES_OBJECT_EXIST( l_U232 ))
                        {
                            if (HAVE_ANIMS_LOADED( l_U235 ))
                            {
                                if ((NOT (IS_SCRIPTED_SPEECH_PLAYING( uParam0 ))) AND ((NOT (IS_AMBIENT_SPEECH_PLAYING( uParam0 ))) AND ((NOT (sub_64750( uParam0 ))) AND ((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( uParam0 ))) AND ((NOT (IS_CHAR_GESTURING( uParam0 ))) AND ((NOT (IS_CHAR_PLAYING_ANIM( uParam0, l_U235, l_U236 ))) AND ((NOT (IS_CHAR_DUCKING( uParam0 ))) AND (NOT (IS_PED_RAGDOLL( uParam0 ))))))))))
                                {
                            ...
                            else if ((sub_65256( uParam0 )) || (sub_53194( uParam0 )))
                            {
        ...
        switch (l_U225)
        {
            ...
            if (DOES_VEHICLE_EXIST( l_U266 ))
            {
                if (NOT (IS_CAR_DEAD( l_U266 )))
                {
                    ...
                    if ((NOT (sub_53079( l_U227[3] ))) AND ((NOT (sub_53079( l_U227[2] ))) AND ((NOT (sub_53079( l_U227[1] ))) AND (NOT (sub_53079( l_U227[0] ))))))
                    {
                        l_U225 = 0;
                        l_U218 = 0.00000000;
                    }
            ...
            if (DOES_VEHICLE_EXIST( l_U266 ))
            {
                if (NOT (IS_CAR_DEAD( l_U266 )))
                {
                    if (l_U218 > 1000.00000000)
                    {
                        ...
                        else if ((NOT (sub_53079( l_U227[3] ))) AND ((NOT (sub_53079( l_U227[2] ))) AND ((NOT (sub_53079( l_U227[1] ))) AND (NOT (sub_53079( l_U227[0] ))))))
                        {
                            l_U225 = 1;
                        }
                    }
...
int sub_53562(unknown uParam0)
{
    if (DOES_VEHICLE_EXIST( uParam0 ))
    {
        if (NOT (IS_CAR_DEAD( uParam0 )))
        {
            ...
            {
                if ((NOT (sub_53617( uParam0, 3 ))) AND ((NOT (sub_53617( uParam0, 2 ))) AND ((NOT (sub_53617( uParam0, 1 ))) AND (NOT (sub_53617( uParam0, 0 ))))))
                {
                    return 1;
                }
            }
        ...
        for ( I = 0; I < 1; I++ )
        {
            if (l_U337 == -1)
            {
                if (sub_66573( I ))
                {
                    ...
                    if ((NOT (sub_38382( sub_1574() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1574(), l_U401[I]._fU4._fU0, l_U401[I]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar7 )))
                    {
...
int sub_72853(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, boolean bParam5, unknown uParam6)
{
    ...
    if (l_U325 == 12)
    {
        ...
        if ((TIMERA() > 7000) || (sub_83315( iParam1, l_U359 )))
        {
            l_U325++;
        }
    }
...
int sub_95345(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 5; Result++ )
    {
        ...
        if ((NOT (sub_95480( iVar4 ))) AND (sub_95417( Result )))
        {
            iVar5 = g_U10324[iVar4]._fU28 == g_U9937;
            fVar6 = l_U790[Result]._fU4._fU8;
            if ((NOT (sub_38382( sub_1574() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1574(), l_U790[Result]._fU4._fU0, l_U790[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )))
            {
...
int sub_95831(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_95890( Result ))
        {
            ...
            if ((NOT (sub_38382( sub_1574() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1574(), l_U417[Result]._fU4._fU0, l_U417[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )))
            {
                if (sub_95688( uParam0 ))
                {
                    return Result;
...
int sub_111389(unknown uParam0)
{
    ...
    if ((sub_111479( uParam0, "Bada_room1" )) || ((sub_111479( uParam0, "Bada_room2" )) || ((sub_111479( uParam0, "Bada-Private" )) || (sub_111479( uParam0, "Bada_room1" )))))
    {
        return 1;
    }
    if ((sub_111479( uParam0, "clammainroom" )) || ((sub_111479( uParam0, "clamfronrm" )) || ((sub_111479( uParam0, "clampalbkrm" )) || (sub_111479( uParam0, "clammainroom" )))))
    {
        return 1;
    }
    return 0;
...
void sub_112423(unknown uParam0)
{
    ...
    if (l_U344._fU12)
    {
        if (g_U22274[l_U158]._fU688._fU24 >= 0)
        {
            ...
            if (NOT l_U344._fU24)
            {
                if (((sub_96603( l_U147 )) > 5) || (sub_112479( ref l_U147 )))
                {
                    bVar5 = true;
                }
            }
...
void sub_113084()
{
    ...
    if ((NOT (sub_38382( sub_1574() ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_1574() )))
    {
        sub_3293( "MF10AUD" );
        sub_3412( 0, sub_1574(), "NIKO", 0 );
