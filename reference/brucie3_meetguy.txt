...
void sub_2268()
{
    if ((sub_2315( 20000 )) AND ((NOT g_U22274[0]._fU4) AND ((NOT g_U15654[11]) AND (sub_1923( l_U491 )))))
    {
        switch (l_U557)
        {
            case 0:
...
int sub_4140()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_3716( 1, g_U569[I] )) != 0))
        {
            sub_4204( I );
            return 1;
        }
...
void sub_7639(unknown uParam0, unknown uParam1, boolean bParam2, boolean bParam3, boolean bParam4, boolean bParam5, unknown uParam6, unknown uParam7)
{
    ...
    while (true)
    {
        ...
        if ((iVar14) AND (sub_8246( (uParam6^), (uParam7^) )))
        {
            return;
        }
...
void sub_10107()
{
    ...
    if (NOT g_U10978)
    {
        if (sub_1923( l_U503 ))
        {
            ...
            if ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "organiserHelp" )) == 0)
            {
                ...
                if (TIMERB() >= 8000)
                {
                    if ((NOT l_U484) AND ((NOT sub_10310()) AND ((NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_9751(), l_U515._fU0, l_U515._fU4, l_U515._fU8, 25.00000000, 25.00000000, 4.00000000, 0 ))) AND (NOT (sub_10450( sub_9751() ))))))
                    {
        ...
        {
            if ((sub_10450( sub_9751() )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_9751(), l_U515._fU0, l_U515._fU4, l_U515._fU8, 25.00000000, 25.00000000, 4.00000000, 0 )))
            {
                if ((sub_10908()) AND ((NOT g_U9893._fU12) AND (NOT sub_2403())))
                {
                    iVar2 = 0;
                    GET_GAME_TIMER( ref iVar2 );
                    g_U26757 = iVar2 + 5000;
    ...
    if ((sub_1923( l_U495 )) AND (g_U10978))
    {
        l_U555 = 0;
        l_U554 = 5;
        return;
...
void sub_12366()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_3716( 5, g_U569[I] )) == 1))
        {
            if ((sub_3716( 1, g_U569[I] )) != 0)
            {
                sub_4204( I );
