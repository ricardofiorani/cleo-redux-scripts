        ...
        if (NOT g_U33838)
        {
            ...
            switch (l_U594)
            {
                ...
                else
                {
                    ...
                    sub_2765();
                    if ((IS_KEYBOARD_KEY_PRESSED( 11 )) || (l_U717 > (l_U810 + l_U817)))
                    {
                ...
                switch (sub_15735())
                {
                    ...
                    else if ((sub_15735() == 8) || (sub_15735() == 5))
                    {
                ...
                else if (IS_PLAYER_PLAYING( sub_10695() ))
                {
                    ...
                    else
                    {
                        ...
                        else if ((g_U15946[sub_6013( 2 )]._fU4) || (sub_7513( sub_6013( 2 ), 1 )))
                        {
...
int sub_7462(unknown uParam0)
{
    ...
    if (g_U33837)
    {
        if ((g_U15946[sub_6013( uParam0 )]._fU4) || (sub_7513( sub_6013( uParam0 ), 1 )))
        {
            switch (uParam0)
            {
                case 0:
...
int sub_10529(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_10774() ))) AND (IS_CHAR_IN_ANY_CAR( sub_10774() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_11106()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
int sub_21875()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_21913( 1, g_U569[I] )) != 0))
        {
            sub_22176( I );
            return 1;
        }
...
int sub_25246(unknown uParam0, boolean bParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    ...
    if ((IS_PLAYER_PLAYING( sub_10695() )) AND (NOT (IS_CHAR_DEAD( sub_10774() ))))
    {
        if (GET_MISSION_FLAG())
        {
            if ((uParam2^) <= iVar13)
...
int sub_29475(unknown uParam0, int iParam1, unknown uParam2, int iParam3)
{
    if (iParam3 != 1)
    {
        ...
        {
            if (((sub_29515( iParam1 )) < 65476) || ((sub_29515( iParam1 )) > 90))
            {
    ...
    else
    {
        ...
        if ((iParam1->_fU4 >= 0) AND (iParam1->_fU0 >= 0))
        {
            if (((sub_29996( iParam1 )) < 65356) || ((sub_29996( iParam1 )) > 180))
            {
    ...
    if (NOT (sub_29475( iParam0, iParam5, (uParam1^), iParam7 )))
    {
        if (NOT ((GET_MISSION_FLAG()) || (g_U10978)))
        {
            if (IS_PLAYER_PLAYING( sub_10695() ))
            {
                ...
                {
                    if ((NOT (IS_WANTED_LEVEL_GREATER( sub_10695(), 0 ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_10774(), uParam2._fU0, uParam2._fU4, uParam2._fU8, 8.00000000, 8.00000000, 8.00000000, 0 )))
                    {
                        g_U33841 = 0;
                    }
                }
...
int sub_31488(unknown uParam0)
{
    ...
    if (sub_7513( sub_6013( uParam0 ), 1 ))
    {
        ...
        if ((g_U15946[sub_6013( uParam0 )]._fU8[1]._fU0[1]) || (g_U15946[sub_6013( uParam0 )]._fU8[1]._fU0[0]))
        {
        ...
        if (NOT (IS_CAR_DEAD( uVar21 )))
        {
            switch (l_U592)
            {
                ...
                else
                {
                    ...
                    if ((IS_PLAYER_PLAYING( sub_10695() )) AND (NOT (IS_CAR_DEAD( uVar21 ))))
                    {
...
int sub_34123(unknown uParam0, int iParam1)
{
    if ((uParam0^))
    {
        if ((iParam1 > 0) AND ((IS_SCREEN_FADED_IN()) AND (sub_34140())))
        {
            return 1;
        }
        else
...
int sub_44646(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    ...
    if (IS_PLAYER_PLAYING( sub_10695() ))
    {
        switch (l_U592)
        {
            ...
            if (NOT (IS_CHAR_DEAD( (uParam3^) )))
            {
                if (((sub_45918( sub_10774(), 17 )) AND (sub_45918( (uParam3^), 17 ))) || (NOT (IS_SPECIFIC_CAM_INTERPOLATING( l_U573[2] ))))
                {
                    INCREMENT_INT_STAT_NO_MESSAGE( 373, 1 );
                    l_U592 = 5;
                }
...
void sub_49207(int iParam0, int iParam1, unknown uParam2)
{
    if (iParam0 == 2)
    {
        if ((iParam1 == 26) || ((iParam1 == 27) || (NOT (sub_49229( iParam0, uParam2 )))))
        {
            sub_28405( iParam1 );
        }
    }
            ...
            switch ((uParam2^))
            {
                ...
                if (NOT IS_MESSAGE_BEING_DISPLAYED())
                {
                    ...
                    else
                    {
                        ...
                        if ((NOT (IS_CHAR_ON_ANY_BIKE( sub_10774() ))) AND (IS_CHAR_IN_ANY_CAR( sub_10774() )))
                        {
                        ...
                        WAIT( 0 );
                        if ((NOT (IS_CHAR_DEAD( (uParam0^) ))) AND (IS_PLAYER_PLAYING( sub_10695() )))
                        {
                            bVar59 = false;
                            if ((NOT (IS_CHAR_ON_ANY_BIKE( sub_10774() ))) AND (IS_CHAR_IN_ANY_CAR( sub_10774() )))
                            {
                ...
                else if (sub_75551( iParam1, uParam12, uParam2 ))
                {
                    if (sub_75202())
                    {
                        if (sub_58884( 25, ref l_U581, (uParam8^), iParam1, 83, 0 ))
                        {
                            ...
                            TASK_PERFORM_SEQUENCE( (uParam0^), uVar54 );
                            CLEAR_SEQUENCE_TASK( uVar54 );
                            if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TRY_LUCK" )) || (IS_THIS_HELP_MESSAGE_WITH_STRING_BEING_DISPLAYED( "GET_NUM", sub_18706( iParam1, 1 ) )))
                            {
                                CLEAR_HELP();
                            }
                ...
                break;
                case 5:
                if ((NOT (IS_CHAR_DEAD( (uParam0^) ))) AND (NOT (sub_81125( l_U581 ))))
                {
                    if ((uParam8^) <= 1)
                    {
                        if (NOT l_U572)
                        {
                            ...
                            else if ((IS_CHAR_PLAYING_ANIM( sub_10774(), "Cellphone", "cellphone_text" )) || (IS_CHAR_PLAYING_ANIM( sub_10774(), "amb@dating", "pass_text" )))
                            {
                ...
                if ((NOT ((LOCATE_CHAR_ON_FOOT_3D( (uParam0^), uParam9._fU0, uParam9._fU4, uParam9._fU8 + 1.00000000, vVar85.x, vVar85.y, vVar85.z, 0 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_10774(), uParam9._fU0, uParam9._fU4, uParam9._fU8 + 1.00000000, vVar85.x, vVar85.y, vVar85.z, 0 )))) AND (((IS_CHAR_ON_SCREEN( (uParam0^) )) || (IS_CHAR_ON_SCREEN( sub_10774() ))) AND (IS_SPECIFIC_CAM_INTERPOLATING( l_U573[6] ))))
                {
                ...
                break;
                case 8:
                if ((NOT ((IS_SCREEN_FADED_IN()) AND (sub_34140()))) AND ((NOT IS_SCRIPTED_CONVERSATION_ONGOING()) AND (IS_SPECIFIC_CAM_INTERPOLATING( l_U573[6] ))))
                {
...
int sub_88190(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15)
{
    ...
    switch ((uParam15^))
    {
        ...
        {
            if ((DOES_CHAR_EXIST( (uParam0^) )) || ((LOCATE_CHAR_ANY_MEANS_2D( sub_10774(), g_U33981[iParam1]._fU0, g_U33981[iParam1]._fU4, 50.00000000 * 1.50000000, 50.00000000 * 1.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_2D( sub_10774(), g_U10090[uParam13]._fU4._fU0, g_U10090[uParam13]._fU4._fU4, 50.00000000 * 1.50000000, 50.00000000 * 1.50000000, 0 ))))
            {
            ...
            else if (NOT IS_MESSAGE_BEING_DISPLAYED())
            {
                ...
                else
                {
                    ...
                    if (IS_PLAYER_PLAYING( sub_10695() ))
                    {
                        ...
                        {
                            WAIT( 1500 );
                            if ((IS_PLAYER_PLAYING( sub_10695() )) AND (NOT (IS_CHAR_INJURED( (uParam0^) ))))
                            {
...
int sub_99357(int iParam0, unknown uParam1, unknown uParam2, boolean bParam3, unknown uParam4)
{
    ...
    if ((uParam1^) < 0)
    {
        if ((NOT sub_20566()) AND ((NOT ((GET_MISSION_FLAG()) || (g_U10978))) AND (NOT bParam3)))
        {
            GET_GAME_TIMER( uParam1 );
    ...
    {
        if ((sub_20566()) || (((GET_MISSION_FLAG()) || (g_U10978)) || (bParam3)))
        {
            (uParam1^) = -1;
            return 0;
        }
