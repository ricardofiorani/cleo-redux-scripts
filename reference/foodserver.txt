...
int sub_1264()
{
    ...
    else
    {
        ...
        if ((HAVE_ANIMS_LOADED( "amb@FFOOD_SERVER" )) AND ((HAS_MODEL_LOADED( l_U115 )) AND (HAS_MODEL_LOADED( l_U114 ))))
        {
...
int sub_3197()
{
    ...
    if (IS_PLAYER_PLAYING( sub_3271() ))
    {
        ...
        {
            if ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_3271(), l_U113 )) || (sub_3332()))
            {
        ...
        if (NOT sub_3803())
        {
            ...
            if ((IS_ANY_CHAR_SHOOTING_IN_AREA( vVar2, vVar5, 0 )) || (IS_CHAR_SHOOTING( sub_2843() )))
            {
                sub_3444( l_U133, l_U132 );
                return 1;
            }
...
int sub_6221(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_3271() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_3271() )))
            {
                if (((g_U9202) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_3271() )))))
                {
                    if (NOT sub_6317())
                    {
    ...
    if ((NOT (IS_CHAR_INJURED( l_U113 ))) AND (NOT (IS_CHAR_INJURED( sub_2843() ))))
    {
        switch (l_U104)
        {
            ...
            else
            {
                ...
                {
                    if ((IS_PLAYER_CLIMBING( sub_3271() )) || (TIMERB() > 5000))
                    {
                        ;
                    }
                }
            ...
            if ((NOT (IS_CHAR_PLAYING_ANIM( sub_2843(), "amb@FFOOD_SERVER", "EAT_BURGER_PLYR" ))) || (fVar3 > 0.90000000))
            {
                if (DOES_OBJECT_EXIST( l_U116 ))
                {
                    if (IS_OBJECT_ATTACHED( l_U116 ))
