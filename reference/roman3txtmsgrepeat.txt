void main()
{
    ...
    while (true)
    {
        ...
        if (l_U11 < iVar3)
        {
            ...
            {
                if ((sub_1881( 0, 30000 )) AND ((NOT g_U9893._fU12) AND ((NOT g_U10978) AND (sub_1052( 25000 )))))
                {
                    if (l_U13)
                    {
                        sub_1958();
...
void sub_109()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_147( 5, g_U569[I] )) == 1))
        {
...
int sub_3007()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_147( 1, g_U569[I] )) != 0))
        {
            sub_433( I );
            return 1;
        }
