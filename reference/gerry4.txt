...
void sub_1707()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_1745( 5, g_U569[I] )) == 1))
        {
    ...
    if (IS_VEH_DRIVEABLE( l_U767 ))
    {
        switch (l_U486)
        {
            ...
            if (IS_VEH_DRIVEABLE( l_U767 ))
            {
                ...
                if ((l_U577[8]) AND ((l_U577[7] == 1) AND ((l_U577[6] == 1) AND ((l_U577[5] == 1) AND ((l_U577[4] == 1) AND ((l_U577[3] == 1) AND ((l_U577[1] == 1) AND (l_U577[0] == 1))))))))
                {
...
void sub_18253()
{
    ...
    if ((IS_VEH_DRIVEABLE( l_U768[5] )) AND (NOT (IS_CHAR_INJURED( l_U742[5] ))))
    {
...
void sub_19657()
{
    ...
    CREATE_CHAR_INSIDE_CAR( l_U768[1], l_U675, l_U672, ref l_U742[1] );
    CREATE_CHAR_AS_PASSENGER( l_U768[1], l_U675, l_U672, 0, ref l_U752[1] );
    if ((IS_VEH_DRIVEABLE( l_U768[1] )) AND (NOT (IS_CHAR_INJURED( l_U742[1] ))))
    {
...
void sub_20410()
{
    ...
    CLEAR_AREA_OF_CARS( -1034.31200000, 1165.56900000, 15.58880000, 7.00000000 );
    CREATE_CAR( l_U669, -1034.31200000, 1165.56900000, 15.58880000, ref l_U768[1], 1 );
    CREATE_CHAR_INSIDE_CAR( l_U768[1], l_U675, l_U672, ref l_U742[1] );
    CREATE_CHAR_AS_PASSENGER( l_U768[1], l_U675, l_U672, 0, ref l_U752[1] );
    if (IS_VEH_DRIVEABLE( l_U768[1] ))
    {
...
void sub_25332(unknown uParam0)
{
    ...
    {
        if ((IS_CHAR_INJURED( l_U742[uParam0] )) || (NOT (IS_VEH_DRIVEABLE( l_U768[uParam0] ))))
        {
            if (DOES_BLIP_EXIST( l_U790[uParam0] ))
            {
                CHANGE_BLIP_DISPLAY( l_U790[uParam0], 0 );
...
void sub_26223(unknown uParam0)
{
    ...
    if (NOT (IS_CAR_DEAD( l_U767 )))
    {
        if (NOT (IS_CAR_DEAD( l_U768[uParam0] )))
        {
            if (NOT (IS_CHAR_INJURED( l_U742[uParam0] )))
            {
                if ((NOT (sub_26314( uParam0 ))) AND (NOT (IS_CHAR_IN_CAR( sub_2924(), l_U767 ))))
                {
                    switch (l_U640[uParam0])
                    {
                        case 0:
                        GET_CAR_SPEED( l_U768[uParam0], ref fVar4 );
                        if ((fVar4 < 7) AND (LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U742[uParam0], l_U767, 15.00000000, 15.00000000, 15.00000000, 0 )))
                        {
                            l_U650[uParam0] = 0;
                            l_U640[uParam0]++;
                        }
                        ...
                        if (DOES_VEHICLE_EXIST( l_U767 ))
                        {
                            if (NOT (IS_CAR_DEAD( l_U767 )))
                            {
                                if (l_U484 != 3)
                                {
                                    if (sub_28755( l_U767 ))
                                    {
                                        if ((l_U484 == 3) || ((l_U484 == 2) || ((l_U484 == 5) || ((l_U484 == 1) || ((l_U484 == 4) || (l_U484 == 0))))))
                                        {
                                            l_U603 = 1;
                                        }
                                        else
                            ...
                            else if ((l_U484 == 3) || ((l_U484 == 2) || ((l_U484 == 5) || ((l_U484 == 1) || ((l_U484 == 4) || (l_U484 == 0))))))
                            {
                                l_U603 = (l_U484 == 2) || (1);
                            }
                            else
...
void sub_42445()
{
    ...
    else if (l_U602 == 1)
    {
        ...
        if ((l_U623 == 0) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_2924(), l_U513._fU0, l_U513._fU4, l_U513._fU8, 30.00000000, 30.00000000, 30.00000000, 0 )))
        {
            SET_PLAYER_CONTROL( sub_2668(), 0 );
            WAIT( 1500 );
            DO_SCREEN_FADE_OUT( 3000 );
...
void sub_43536(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    if (NOT (IS_CHAR_DEAD( uParam0 )))
    {
        if ((IS_CHAR_SITTING_IN_ANY_CAR( sub_2924() )) || (IS_CHAR_IN_ANY_CAR( uParam0 )))
        {
