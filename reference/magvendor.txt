...
void sub_2406(unknown uParam0)
{
    ...
    if ((HAS_MODEL_LOADED( l_U95 )) AND ((HAS_MODEL_LOADED( 957096072 )) AND (NOT (IS_OBJECT_ON_SCREEN( uParam0 )))))
    {
...
void sub_3118()
{
    switch (l_U12)
    {
        ...
        if (l_U98 == nil)
        {
            if ((HAS_MODEL_LOADED( l_U93 )) AND ((HAS_MODEL_LOADED( 583751396 )) AND (HAVE_ANIMS_LOADED( "amb@kiosk" ))))
            {
        ...
        if (l_U98 == nil)
        {
            if ((HAS_MODEL_LOADED( l_U92 )) AND (HAVE_ANIMS_LOADED( "amb@kiosk" )))
            {
                BEGIN_CHAR_SEARCH_CRITERIA();
                SEARCH_CRITERIA_REJECT_PEDS_WITH_FLAG_TRUE( 36 );
                SEARCH_CRITERIA_REJECT_PEDS_WITH_FLAG_TRUE( 44 );
...
int sub_6712(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_649() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_649() )))
            {
                if (((g_U9202) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_649() )))))
                {
                    if (NOT sub_5627())
                    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U98 )))
        {
            if (NOT (IS_CHAR_INJURED( l_U97 )))
            {
                switch (l_U13)
                {
                    ...
                    if ((l_U64[0] == 0) AND (l_U56 > 0.48300000))
                    {
                        if (DOES_OBJECT_EXIST( l_U104 ))
                        {
                    ...
                    if ((l_U64[1] == 0) AND (l_U56 > 0.64000000))
                    {
                        if (DOES_OBJECT_EXIST( l_U104 ))
                        {
                    ...
                    if ((l_U64[2] == 0) AND (l_U58 > 0.47100000))
                    {
                        if (DOES_OBJECT_EXIST( l_U105 ))
                        {
                    ...
                    if ((l_U64[3] == 0) AND (l_U58 > 0.61200000))
                    {
                    ...
                    if ((l_U64[4] == 0) AND (l_U58 > 0.72000000))
                    {
                        sub_3917( l_U105 );
                        l_U64[4] = 1;
                    }
...
int sub_13158()
{
    if ((sub_13206()) || ((IS_BUTTON_PRESSED( 0, 16 )) || ((IS_BUTTON_PRESSED( 0, 15 )) || ((IS_BUTTON_PRESSED( 0, 14 )) || (IS_BUTTON_PRESSED( 0, 17 ))))))
    {
        return 1;
    }
    return 0;
