void main()
{
    ...
    while (true)
    {
        ...
        if ((NOT (IS_CHAR_DEAD( sub_220() ))) AND (IS_PLAYER_PLAYING( sub_182() )))
        {
            switch (l_U481)
            {
                case 0:
...
int sub_567(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_220() ))) AND (IS_CHAR_IN_ANY_CAR( sub_220() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_1094()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_18855()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_18893( 5, g_U569[I] )) == 1))
        {
