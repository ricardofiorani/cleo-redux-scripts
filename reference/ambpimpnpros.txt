...
void sub_2046()
{
    ...
    if ((NOT (HAVE_ANIMS_LOADED( l_U147 ))) || (NOT (HAVE_ANIMS_LOADED( l_U144 ))))
    {
        REQUEST_ANIMS( l_U144 );
        REQUEST_ANIMS( l_U147 );
    }
...
void sub_3164()
{
    ...
    if (NOT (IS_CHAR_DEAD( l_U116 )))
    {
        if (NOT g_U8670)
        {
            if ((IS_SCORE_GREATER( sub_738(), ProtectedGet(l_U177[0]) - 1 )) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U116, sub_1076(), 10.00000000, 10.00000000, 10.00000000, 0 )))
            {
            ...
            if (NOT (l_U120 == nil))
            {
                if (IS_VEH_DRIVEABLE( l_U120 ))
                {
                    ...
                    if (fVar3 <= 2.00000000)
                    {
                        ...
                        {
                            if ((NOT (IS_WANTED_LEVEL_GREATER( sub_738(), 0 ))) AND (IS_SCORE_GREATER( sub_738(), ProtectedGet(l_U177[0]) - 1 )))
                            {
...
void sub_4709()
{
    ...
    switch (l_U103)
    {
        ...
        break;
        case 5:
        if ((NOT (IS_WANTED_LEVEL_GREATER( sub_738(), 0 ))) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U116, sub_1076(), 5.00000000, 5.00000000, 5.00000000, 0 )))
        {
            ...
            if (l_U142 == 1)
            {
                ...
                if (l_U143 > 0)
                {
                    if ((IS_CHAR_IN_ANY_CAR( l_U116 )) AND (IS_CHAR_IN_ANY_CAR( sub_1076() )))
                    {
                        if (l_U114)
                        {
                            if (IS_PLAYER_PLAYING( sub_738() ))
                        ...
                        if (IS_VEH_DRIVEABLE( l_U120 ))
                        {
                            if ((IS_CHAR_IN_CAR( sub_1076(), l_U120 )) AND (IS_CHAR_IN_CAR( l_U116, l_U120 )))
                            {
    ...
    if (l_U142 == 7)
    {
        if (IS_CHAR_IN_ANY_CAR( sub_1076() ))
        {
            ...
            if (IS_VEH_DRIVEABLE( l_U120 ))
            {
                ...
                {
                    GET_CAR_SPEED( l_U120, ref fVar2 );
                    if ((NOT (IS_WANTED_LEVEL_GREATER( sub_738(), 0 ))) AND (fVar2 <= 2.00000000))
                    {
                        GET_CAR_MODEL( l_U120, ref l_U122 );
                        GET_MODEL_DIMENSIONS( l_U122, ref vVar12, ref vVar9 );
                        vVar6 = {vVar9 - vVar12};
                    ...
                    else if ((IS_WANTED_LEVEL_GREATER( sub_738(), 0 )) || (NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U116, sub_1076(), 15.00000000, 15.00000000, 5.00000000, 0 ))))
                    {
                        CLEAR_CHAR_TASKS( l_U116 );
                        SET_PED_WITH_BRAIN_CAN_BE_CONVERTED_TO_DUMMY_PED( l_U116, 1 );
                        l_U103 = 11;
...
void sub_6955()
{
    ...
    if (IS_CHAR_IN_ANY_CAR( sub_1076() ))
    {
        ...
        if ((NOT (IS_WANTED_LEVEL_GREATER( sub_738(), 0 ))) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U116, sub_1076(), 15.00000000, 15.00000000, 5.00000000, 0 )))
        {
            if (sub_7065( 4, 0 ))
            {
                if (NOT l_U114)
...
int sub_7065(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_738() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            ...
            {
                if (((g_U9202) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_738() )))))
                {
                    if (NOT sub_7161())
                    {
...
void sub_9545()
{
    ...
    if (NOT l_U115)
    {
        if ((NOT (IS_AMBIENT_SPEECH_PLAYING( l_U116 ))) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( sub_1076() ))))
        {
    ...
    if ((NOT (IS_WANTED_LEVEL_GREATER( sub_738(), 0 ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_1076() )))
    {
        STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_1076(), ref l_U120 );
        if (IS_VEH_DRIVEABLE( l_U120 ))
        {
            ...
            {
                GET_CAR_SPEED( l_U120, ref fVar2 );
                if ((IS_PLAYER_CONTROL_ON( sub_738() )) AND (fVar2 <= 2.00000000))
                {
                    if (NOT l_U107)
                    {
                        if (sub_9930())
                    ...
                    else
                    {
                        ...
                        if (l_U133 >= iVar3)
                        {
                            if ((NOT sub_7161()) AND (NOT IS_HELP_MESSAGE_BEING_DISPLAYED()))
                            {
                                l_U175 = 0;
                                l_U176 = 1;
...
void sub_10880()
{
    ...
    if ((NOT (IS_WANTED_LEVEL_GREATER( sub_738(), 0 ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_1076() )))
    {
        ...
        if (IS_VEH_DRIVEABLE( l_U120 ))
        {
            ...
            {
                GET_CAR_SPEED( l_U120, ref fVar2 );
                if ((l_U175) || ((NOT sub_7161()) AND ((IS_PLAYER_CONTROL_ON( sub_738() )) AND (fVar2 <= 2.00000000))))
                {
                    if ((l_U175) || ((# -NULL-0xc27e8e()) || (IS_THIS_HELP_MESSAGE_WITH_NUMBER_BEING_DISPLAYED( ref l_U214, ProtectedGet(l_U177[l_U145]) ))))
                    {
                        if (NOT l_U175)
                        {
...
void sub_14163()
{
    ...
    if ((NOT (IS_WANTED_LEVEL_GREATER( sub_738(), 0 ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( l_U116 )))
    {
        STORE_CAR_CHAR_IS_IN_NO_SAVE( l_U116, ref l_U120 );
        if (IS_VEH_DRIVEABLE( l_U120 ))
        {
            GET_CAR_SPEED( l_U120, ref fVar9 );
            if ((IS_PLAYER_CONTROL_ON( sub_738() )) AND (fVar9 <= 2.00000000))
            {
                sub_11860();
                GET_GAME_TIMER( ref l_U132 );
                if (NOT l_U174)
                    ...
                    if (NOT (IS_COP_VEHICLE_IN_AREA_3D_NO_SAVE( uVar3._fU0, uVar3._fU4, uVar3._fU8, uVar6._fU0, uVar6._fU4, uVar6._fU8 )))
                    {
                        ...
                        if (NOT l_U174)
                        {
                            if (NOT (l_U145 == 3))
                            {
                                if (HAVE_ANIMS_LOADED( l_U147 ))
                                {
                                    if ((IS_CHAR_PLAYING_ANIM( sub_1076(), l_U147, l_U160[l_U145] )) AND (IS_CHAR_PLAYING_ANIM( l_U116, l_U147, l_U148[l_U145] )))
                                    {
                                        if ((HAS_CHAR_ANIM_FINISHED( sub_1076(), l_U147, l_U160[l_U145] )) AND (HAS_CHAR_ANIM_FINISHED( l_U116, l_U147, l_U148[l_U145] )))
                                        {
    ...
    switch (l_U103)
    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U117 )))
        {
            ...
            if (l_U142 == 7)
            {
                GET_GAME_TIMER( ref l_U132 );
                l_U133 = l_U132 - l_U130;
                if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U116, l_U117, 12.00000000, 12.00000000, 5.00000000, 0 ))) || (l_U133 >= 10000))
                {
                    sub_18186();
                }
            }
...
void sub_19596()
{
    ...
    if (NOT (IS_CHAR_INJURED( l_U117 )))
    {
        if (IS_VEH_DRIVEABLE( l_U119 ))
        {
            ...
            {
                GET_CAR_SPEED( l_U119, ref fVar2 );
                if ((fVar2 <= 1.00000000) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U117, l_U116, 15.00000000, 15.00000000, 5.00000000, 0 )))
                {
                    GET_GAME_TIMER( ref l_U132 );
                    l_U133 = l_U132 - l_U130;
                    if (l_U133 >= l_U135)
