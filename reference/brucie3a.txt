void main()
{
    ...
    while (true)
    {
        ...
        switch (l_U571)
        {
            ...
            if (NOT l_U576)
            {
                ...
                else
                {
                    switch (l_U572)
                    {
                        ...
                        {
                            if ((l_U573 >= l_U574) || (NOT sub_10003()))
                            {
                                l_U572 = 2;
                                l_U576 = 1;
                                break;
            ...
            if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND ((sub_9678( 0 )) AND ((l_U576) AND (NOT l_U578))))
            {
...
void sub_1395()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_1433( 5, g_U569[I] )) == 1))
        {
...
void sub_2430()
{
    ...
    {
        iVar3 = sub_2458( 13 );
        if ((g_U9932[g_U9999[I]._fU0]._fU0) AND (sub_2503( 13, iVar3 )))
        {
    ...
    {
        iVar3 = sub_2458( 11 );
        if ((g_U9932[g_U10090[I]._fU0]._fU0) AND (sub_2503( 11, iVar3 )))
        {
    ...
    {
        iVar3 = sub_2982( I );
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_2503( g_U10324[I]._fU12, iVar3 )))
        {
...
void sub_3519()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_2982( I )))
        {
            iVar4++;
        }
    }
...
int sub_5519()
{
    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3973(), -1581.15000000, 464.32500000, 26.30900000, 19.00000000, 19.00000000, 19.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( sub_3973(), -337.16420000, 1392.44200000, 12.91310000, 19.00000000, 19.00000000, 19.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3973(), 972.65480000, -170.45200000, 24.19370000, 19.00000000, 19.00000000, 19.00000000, 0 ))))
    {
        return 1;
        break;
    }
...
int sub_5839(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3973() ))) AND (IS_CHAR_IN_ANY_CAR( sub_3973() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_6366()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
