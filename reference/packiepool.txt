...
int sub_39304()
{
    ...
    fVar3 = 0.00000000;
    GET_CAR_SPEED( uVar2, ref fVar3 );
    if ((sub_39379( 1, 1 )) AND (fVar3 < 0.01000000))
    {
        if (NOT l_U113)
        {
...
int sub_39742()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    bVar3 = false;
    if ((IS_PLAYER_PRESSING_HORN( sub_3635() )) AND ((sub_39379( 1, 1 )) AND (IS_CHAR_IN_ANY_CAR( sub_1586() ))))
    {
        if (l_U113)
        {
            return 0;
...
void sub_51212()
{
    ...
    sub_51540( iVar3[30], -437.20600000, 463.31500000, 11.30600000, 273.22870000, -451.98690000, 469.22640000, 14.42270000, -12.98044000, 0.00000000, -130.48930000 );
        ...
        for ( I = 0; I < 1; I++ )
        {
            if (l_U337 == -1)
            {
                if (sub_53339( I ))
                {
                    ...
                    if ((NOT (sub_38281( sub_1586() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1586(), l_U401[I]._fU4._fU0, l_U401[I]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar7 )))
                    {
...
int sub_59606(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, boolean bParam5, unknown uParam6)
{
    ...
    if (l_U325 == 12)
    {
        ...
        if ((TIMERA() > 7000) || (sub_70068( iParam1, l_U359 )))
        {
            l_U325++;
        }
    }
...
int sub_82098(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 5; Result++ )
    {
        ...
        if ((NOT (sub_82233( iVar4 ))) AND (sub_82170( Result )))
        {
            iVar5 = g_U10324[iVar4]._fU28 == g_U9937;
            fVar6 = l_U790[Result]._fU4._fU8;
            if ((NOT (sub_38281( sub_1586() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1586(), l_U790[Result]._fU4._fU0, l_U790[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )))
            {
...
int sub_82584(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_82643( Result ))
        {
            ...
            if ((NOT (sub_38281( sub_1586() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1586(), l_U417[Result]._fU4._fU0, l_U417[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )))
            {
                if (sub_82441( uParam0 ))
                {
                    return Result;
...
int sub_98142(unknown uParam0)
{
    ...
    if ((sub_98232( uParam0, "Bada_room1" )) || ((sub_98232( uParam0, "Bada_room2" )) || ((sub_98232( uParam0, "Bada-Private" )) || (sub_98232( uParam0, "Bada_room1" )))))
    {
        return 1;
    }
    if ((sub_98232( uParam0, "clammainroom" )) || ((sub_98232( uParam0, "clamfronrm" )) || ((sub_98232( uParam0, "clampalbkrm" )) || (sub_98232( uParam0, "clammainroom" )))))
    {
        return 1;
    }
    return 0;
...
void sub_99176(unknown uParam0)
{
    ...
    if (l_U344._fU12)
    {
        if (g_U22274[l_U158]._fU688._fU24 >= 0)
        {
            ...
            if (NOT l_U344._fU24)
            {
                if (((sub_83356( l_U147 )) > 5) || (sub_99232( ref l_U147 )))
                {
                    bVar5 = true;
                }
            }
...
void sub_99837()
{
    ...
    if ((NOT (sub_38281( sub_1586() ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_1586() )))
    {
        sub_3203( "MF10AUD" );
        sub_3322( 0, sub_1586(), "NIKO", 0 );
