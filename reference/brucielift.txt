...
void sub_13508()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_13546( 5, g_U569[I] )) == 1))
        {
...
void sub_23026()
{
    ...
    if (IS_CHAR_IN_ANY_POLICE_VEHICLE( sub_2522() ))
    {
        ...
        if ((NOT (IS_CHAR_IN_MODEL( sub_2522(), -488123221 ))) AND (NOT (IS_CHAR_IN_MODEL( sub_2522(), 837858166 ))))
        {
...
int sub_25780()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_13546( 1, g_U569[I] )) != 0))
        {
            sub_13832( I );
            return 1;
        }
...
int sub_33319()
{
    ...
    fVar3 = 0.00000000;
    GET_CAR_SPEED( uVar2, ref fVar3 );
    if ((sub_33394( 1, 1 )) AND (fVar3 < 0.01000000))
    {
        if (NOT l_U113)
        {
...
int sub_33757()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    bVar3 = false;
    if ((IS_PLAYER_PRESSING_HORN( sub_2876() )) AND ((sub_33394( 1, 1 )) AND (IS_CHAR_IN_ANY_CAR( sub_2522() ))))
    {
        if (l_U113)
        {
            return 0;
...
int sub_34361(unknown uParam0, unknown uParam1)
{
    ...
    iVar11 = 0;
    if ((NOT l_U119) AND (IS_CHAR_IN_ANY_CAR( sub_2522() )))
    {
...
int sub_42719(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, boolean bParam5, unknown uParam6)
{
    ...
    if (bVar10)
    {
        ...
        {
            if ((NOT (IS_CHAR_DEAD( iParam1 ))) AND (NOT (IS_CHAR_DEAD( sub_2522() ))))
            {
    ...
    if (l_U325 == 7)
    {
        ...
        else if ((IS_CHAR_DEAD( iParam1 )) || (IS_CHAR_DEAD( sub_2522() )))
        {
            l_U325++;
        }
        else
    ...
    if (l_U325 == 12)
    {
        ...
        if ((TIMERA() > 7000) || (sub_54284( iParam1, l_U359 )))
        {
            l_U325++;
        }
    }
...
void sub_57187(unknown uParam0)
{
    ...
    if (l_U344._fU12)
    {
        if (g_U22274[l_U158]._fU688._fU24 >= 0)
        {
            ...
            if (NOT l_U344._fU24)
            {
                if (((sub_57973( l_U147 )) > 5) || (sub_57243( ref l_U147 )))
                {
                    bVar5 = true;
                }
            }
...
void sub_57848()
{
    ...
    if ((NOT (sub_32296( sub_2522() ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_2522() )))
    {
        sub_2416( "MF10AUD" );
        sub_2571( 0, sub_2522(), "NIKO", 0 );
...
int sub_59085(unknown uParam0)
{
    ...
    if ((l_U344._fU24) || (sub_59094()))
    {
        return 0;
    }
    if (NOT l_U344._fU8)
    {
        if ((NOT (IS_CHAR_DEAD( uParam0 ))) AND (NOT (IS_CHAR_DEAD( sub_2522() ))))
        {
            if (IS_CHAR_IN_ANY_CAR( sub_2522() ))
            {
                STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_2522(), ref uVar3 );
