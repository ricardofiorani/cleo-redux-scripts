...
void sub_14348()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_14386( 5, g_U569[I] )) == 1))
        {
...
void sub_22405()
{
    ...
    {
        iVar3 = sub_22433( 13 );
        if ((g_U9932[g_U9999[I]._fU0]._fU0) AND (sub_22478( 13, iVar3 )))
        {
    ...
    {
        iVar3 = sub_22433( 11 );
        if ((g_U9932[g_U10090[I]._fU0]._fU0) AND (sub_22478( 11, iVar3 )))
        {
    ...
    {
        iVar3 = sub_22911( I );
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_22478( g_U10324[I]._fU12, iVar3 )))
        {
...
void sub_23448()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_22911( I )))
        {
            iVar4++;
        }
    }
...
int sub_32006()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_14386( 1, g_U569[I] )) != 0))
        {
            sub_14672( I );
            return 1;
        }
...
int sub_39410()
{
    ...
    fVar3 = 0.00000000;
    GET_CAR_SPEED( uVar2, ref fVar3 );
    if ((sub_39485( 1, 1 )) AND (fVar3 < 0.01000000))
    {
        if (NOT l_U113)
        {
...
int sub_39848()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    bVar3 = false;
    if ((IS_PLAYER_PRESSING_HORN( sub_3716() )) AND ((sub_39485( 1, 1 )) AND (IS_CHAR_IN_ANY_CAR( sub_1574() ))))
    {
        if (l_U113)
        {
            return 0;
...
void sub_46464()
{
    ...
    sub_46788( iVar3[10], 1150.94800000, 735.32490000, 35.89890000, 109.25990000, 1163.71000000, 769.05490000, 44.09430000, -24.06020000, 0.00000000, 140.83640000 );
    for ( I = 0; I < l_U413; I++ )
    {
        if (NOT l_U414[I])
        {
...
void sub_51330()
{
    ...
    sub_51658( iVar3[30], -437.20600000, 463.31500000, 11.30600000, 273.22870000, -451.98690000, 469.22640000, 14.42270000, -12.98044000, 0.00000000, -130.48930000 );
                ...
                switch (l_U223)
                {
                    ...
                    if (sub_63062( uParam0 ))
                    {
                        ...
                        if (DOES_OBJECT_EXIST( l_U232 ))
                        {
                            if (HAVE_ANIMS_LOADED( l_U235 ))
                            {
                                if ((NOT (IS_SCRIPTED_SPEECH_PLAYING( uParam0 ))) AND ((NOT (IS_AMBIENT_SPEECH_PLAYING( uParam0 ))) AND ((NOT (sub_64765( uParam0 ))) AND ((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( uParam0 ))) AND ((NOT (IS_CHAR_GESTURING( uParam0 ))) AND ((NOT (IS_CHAR_PLAYING_ANIM( uParam0, l_U235, l_U236 ))) AND ((NOT (IS_CHAR_DUCKING( uParam0 ))) AND (NOT (IS_PED_RAGDOLL( uParam0 ))))))))))
                                {
                            ...
                            else if ((sub_65271( uParam0 )) || (sub_53209( uParam0 )))
                            {
...
void sub_52970(unknown uParam0)
{
    ...
    if ((IS_PLAYER_PLAYING( sub_3716() )) AND (NOT (IS_CHAR_INJURED( uParam0 ))))
    {
        switch (l_U225)
        {
            case 0:
            ...
            if (DOES_VEHICLE_EXIST( l_U266 ))
            {
                if (NOT (IS_CAR_DEAD( l_U266 )))
                {
                    ...
                    if ((NOT (sub_53094( l_U227[3] ))) AND ((NOT (sub_53094( l_U227[2] ))) AND ((NOT (sub_53094( l_U227[1] ))) AND (NOT (sub_53094( l_U227[0] ))))))
                    {
                        l_U225 = 0;
                        l_U218 = 0.00000000;
                    }
            ...
            if (DOES_VEHICLE_EXIST( l_U266 ))
            {
                if (NOT (IS_CAR_DEAD( l_U266 )))
                {
                    if (l_U218 > 1000.00000000)
                    {
                        ...
                        else if ((NOT (sub_53094( l_U227[3] ))) AND ((NOT (sub_53094( l_U227[2] ))) AND ((NOT (sub_53094( l_U227[1] ))) AND (NOT (sub_53094( l_U227[0] ))))))
                        {
                            l_U225 = 1;
                        }
                    }
...
int sub_53577(unknown uParam0)
{
    if (DOES_VEHICLE_EXIST( uParam0 ))
    {
        if (NOT (IS_CAR_DEAD( uParam0 )))
        {
            ...
            {
                if ((NOT (sub_53632( uParam0, 3 ))) AND ((NOT (sub_53632( uParam0, 2 ))) AND ((NOT (sub_53632( uParam0, 1 ))) AND (NOT (sub_53632( uParam0, 0 ))))))
                {
                    return 1;
                }
            }
        ...
        for ( I = 0; I < 1; I++ )
        {
            if (l_U337 == -1)
            {
                if (sub_66591( I ))
                {
                    ...
                    if ((NOT (sub_38387( sub_1574() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1574(), l_U401[I]._fU4._fU0, l_U401[I]._fU4._fU4, fVar6, 1.60000000, 1.60000000, 1.60000000, iVar7 )))
                    {
...
int sub_72888(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, boolean bParam5, unknown uParam6)
{
    ...
    if (l_U325 == 12)
    {
        ...
        if ((TIMERA() > 7000) || (sub_83350( iParam1, l_U359 )))
        {
            l_U325++;
        }
    }
...
void sub_84689(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    sub_87697( uParam2 );
    sub_87837();
    if ((l_U856._fU8) AND (NOT (IS_CHAR_DEAD( sub_1574() ))))
    {
    ...
    if ((l_U865._fU8) AND (NOT (IS_CHAR_DEAD( uParam1 ))))
    {
...
void sub_86390()
{
    ...
    if (bVar12)
    {
        fVar19 = -1.00000000;
        fVar20 = 2.00000000;
        if ((IS_CAR_MODEL( l_U877, 1208856469 )) || ((IS_CAR_MODEL( l_U877, 1884962369 )) || (IS_CAR_MODEL( l_U877, -956048545 ))))
        {
            fVar20 = 4.00000000;
            fVar19 = 0.00000000;
            bVar18 = true;
...
int sub_95380(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 5; Result++ )
    {
        ...
        if ((NOT (sub_95515( iVar4 ))) AND (sub_95452( Result )))
        {
            iVar5 = g_U10324[iVar4]._fU28 == g_U9937;
            fVar6 = l_U790[Result]._fU4._fU8;
            if ((NOT (sub_38387( sub_1574() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1574(), l_U790[Result]._fU4._fU0, l_U790[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )))
            {
...
int sub_95866(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_95925( Result ))
        {
            ...
            if ((NOT (sub_38387( sub_1574() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1574(), l_U417[Result]._fU4._fU0, l_U417[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )))
            {
                if (sub_95723( uParam0 ))
                {
                    return Result;
...
int sub_111423(unknown uParam0)
{
    ...
    if ((sub_111513( uParam0, "Bada_room1" )) || ((sub_111513( uParam0, "Bada_room2" )) || ((sub_111513( uParam0, "Bada-Private" )) || (sub_111513( uParam0, "Bada_room1" )))))
    {
        return 1;
    }
    if ((sub_111513( uParam0, "clammainroom" )) || ((sub_111513( uParam0, "clamfronrm" )) || ((sub_111513( uParam0, "clampalbkrm" )) || (sub_111513( uParam0, "clammainroom" )))))
    {
        return 1;
    }
    return 0;
...
void sub_112457(unknown uParam0)
{
    ...
    if (l_U344._fU12)
    {
        if (g_U22274[l_U158]._fU688._fU24 >= 0)
        {
            ...
            if (NOT l_U344._fU24)
            {
                if (((sub_96638( l_U147 )) > 5) || (sub_112513( ref l_U147 )))
                {
                    bVar5 = true;
                }
            }
...
void sub_113118()
{
    ...
    if ((NOT (sub_38387( sub_1574() ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_1574() )))
    {
        sub_3293( "MF10AUD" );
        sub_3412( 0, sub_1574(), "NIKO", 0 );
