void main()
{
    ...
    if (DOES_VEHICLE_EXIST( uVar53 ))
    {
        ...
        {
            if ((LOCATE_CAR_2D( uVar53, 1392.95500000, 623.19520000, 20.00000000, 20.00000000, 0 )) || (LOCATE_CAR_2D( uVar53, 1386.54300000, 616.77080000, 50.00000000, 20.00000000, 0 )))
            {
                if (IS_VEH_DRIVEABLE( uVar53 ))
                {
    ...
    CLEAR_AREA( 1386.54300000, 616.77080000, 34.81610000, 10.00000000, 1 );
    ...
    while ((NOT (HAS_MODEL_LOADED( 467469635 ))) || ((NOT (HAS_MODEL_LOADED( 1348744438 ))) || (NOT (HAS_MODEL_LOADED( 1708842493 )))))
    {
        WAIT( 0 );
    }
            ...
            switch (l_U586)
            {
                ...
                if ((NOT (IS_CHAR_INJURED( sub_3362() ))) AND (NOT (IS_CHAR_INJURED( l_U623 ))))
                {
                    ...
                    if (sub_12475( ref l_U765, ref l_U763, l_U623, l_U701, "GOAL1", "BUDDY1", "CONT_DEST" ))
                    {
                        ...
                        {
                            if ((sub_13174( 1, 1 )) AND ((LOCATE_CHAR_ANY_MEANS_3D( l_U623, l_U701._fU0, l_U701._fU4, l_U701._fU8, 4.00000000, 4.00000000, 2.00000000, 0 )) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_3362(), l_U701._fU0, l_U701._fU4, l_U701._fU8, 4.00000000, 4.00000000, 2.00000000, 0 ))))
                            {
                                if (sub_4020( l_U826 ))
                                {
                        ...
                        else if ((LOCATE_CHAR_ANY_MEANS_3D( l_U623, l_U701._fU0, l_U701._fU4, l_U701._fU8, 4.00000000, 4.00000000, 2.00000000, 0 )) AND (LOCATE_CHAR_ON_FOOT_3D( sub_3362(), l_U701._fU0, l_U701._fU4, l_U701._fU8, 4.00000000, 4.00000000, 2.00000000, 0 )))
                        {
                            if (sub_4020( l_U826 ))
                            {
                                sub_4202( ref l_U826, 0 );
                    ...
                    if (NOT (IS_CHAR_INJURED( sub_3362() )))
                    {
                        if (IS_CHAR_IN_ANY_CAR( sub_3362() ))
                        {
                            ...
                            else
                            {
                                ...
                                else if ((fVar62 >= 45) AND (fVar62 < 135))
                                {
                                ...
                                else if ((fVar62 >= 135) AND (fVar62 < 225))
                                {
                                    SET_CAM_POS( l_U719, 310.17790000, -326.91230000, 6.96342500 );
                                    SET_CAM_ROT( l_U719, -9.66423000, 0.00000000, -7.60470200 );
                ...
                break;
                case 5:
                if ((NOT l_U743) AND (NOT (sub_4020( l_U820 ))))
                {
                    BLOCK_CHAR_GESTURE_ANIMS( l_U623, 0 );
                    sub_10272( "PM1_FOLL", ref l_U820, 7, 1 );
                    l_U743 = 1;
                }
                if ((l_U743) AND ((NOT l_U908) AND (NOT (sub_4020( l_U820 )))))
                {
                    PRINT_NOW( "GOAL4", 7500, 3 );
                    l_U908 = 1;
                }
                if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND ((l_U908) AND (NOT l_U748)))
                {
                    l_U748 = 1;
                    sub_17407();
                }
                if ((NOT l_U740) AND (NOT (IS_CHAR_INJURED( l_U623 ))))
                {
                ...
                if ((NOT (IS_CHAR_INJURED( sub_3362() ))) AND (NOT (IS_CHAR_INJURED( l_U623 ))))
                {
                    if ((IS_CHAR_IN_AREA_3D( l_U623, 382.47910000, -281.37700000, 11.94022000, 369.75920000, -300.15240000, 3.12569000, 0 )) AND (IS_CHAR_IN_AREA_3D( sub_3362(), 372.04800000, -283.28350000, 3.45984500, 383.54310000, -294.87000000, 8.70751000, 0 )))
                    {
                ...
                if ((NOT (IS_CHAR_INJURED( sub_3362() ))) AND (NOT (IS_CHAR_INJURED( l_U623 ))))
                {
                    switch (l_U588)
                    {
                        ...
                        if ((iVar67 > l_U602) || (iVar6 == 7))
                        {
                            ...
                            if (NOT (IS_CHAR_INJURED( l_U623 )))
                            {
                                if (uVar16._fU8 > 6.50000000)
                                {
                                    if (NOT (IS_CHAR_IN_AREA_3D( sub_3362(), 372.55700000, -285.38360000, 9.52093000, 373.99040000, -283.51560000, 7.34028600, 0 )))
                                    {
                        ...
                        if ((l_U724 + 11000) < iVar68)
                        {
                            if (NOT l_U738)
                            {
                                ...
                                GET_CHAR_COORDINATES( l_U623, ref uVar16._fU0, ref uVar16._fU4, ref uVar16._fU8 );
                                if ((iVar4 != 2) AND ((iVar4 != 4) AND (uVar16._fU8 > 6.50000000)))
                                {
                                    OPEN_SEQUENCE_TASK( ref uVar9 );
                                    TASK_FLUSH_ROUTE();
                        ...
                        if (NOT l_U738)
                        {
                            if (LOCATE_CHAR_ANY_MEANS_3D( l_U623, 372.42200000, -281.46450000, 8.97280400, 2.00000000, 1.00000000, 2.00000000, 0 ))
                            {
                                l_U738 = 1;
                            }
                        }
                        if ((NOT (IS_CHAR_INJURED( sub_3362() ))) AND (NOT (IS_CHAR_INJURED( l_U623 ))))
                        {
                            ...
                            if (iVar4 == 2)
                            {
                                if (LOCATE_CHAR_ANY_MEANS_3D( l_U623, 372.42200000, -275.16460000, 8.97280400, 2.00000000, 1.00000000, 2.00000000, 0 ))
                                {
                        ...
                        if (NOT (IS_CHAR_INJURED( sub_3362() )))
                        {
                            ...
                            if ((IS_CHAR_IN_AREA_3D( sub_3362(), 371.79610000, -254.77460000, 12.02427000, 347.29000000, -302.05870000, 20.67250000, 0 )) || (IS_CHAR_IN_AREA_3D( sub_3362(), 371.86790000, -276.36520000, 6.99961800, 375.13320000, -267.48950000, 16.48098000, 0 )))
                            {
                                OPEN_SEQUENCE_TASK( ref uVar10 );
                                TASK_LOOK_AT_CHAR( 0, sub_3362(), 0, 0 );
                                TASK_FLUSH_ROUTE();
                            ...
                            if ((l_U756) AND (NOT l_U739))
                            {
                                GET_GAME_TIMER( ref J );
                                if ((NOT (sub_4020( l_U892 ))) AND (J > l_U725))
                                {
                                    CLEAR_PRINTS();
                    ...
                    if ((NOT l_U760) AND (NOT (sub_4020( l_U886 ))))
                    {
                        PRINT( "GOAL2", 7500, 3 );
                        l_U760 = 1;
                    }
                ...
                if ((NOT (IS_CHAR_INJURED( sub_3362() ))) AND (NOT (IS_CHAR_INJURED( l_U623 ))))
                {
                    if ((NOT l_U907) AND ((LOCATE_CHAR_ANY_MEANS_3D( l_U623, l_U704._fU0, l_U704._fU4, l_U704._fU8, 3.50000000, 3.50000000, 2.00000000, 0 )) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_3362(), l_U704._fU0, l_U704._fU4, l_U704._fU8, 3.50000000, 3.50000000, 2.00000000, 0 ))))
                    {
                        if ((NOT (sub_4020( l_U820 ))) AND (l_U739))
                        {
                ...
                sub_20607();
                if ((sub_13174( 1, 1 )) AND ((NOT (sub_4020( l_U850 ))) AND (l_U907)))
                {
                    if (NOT (IS_CHAR_INJURED( sub_3362() )))
                    {
                        if ((NOT (IS_CHAR_IN_ANY_HELI( sub_3362() ))) AND ((NOT (IS_CHAR_IN_ANY_BOAT( sub_3362() ))) AND (NOT (IS_CHAR_IN_ANY_CAR( sub_3362() )))))
                        {
                            l_U586 = 8;
                        }
                    }
                ...
                if ((NOT (IS_CHAR_INJURED( sub_3362() ))) AND (NOT (IS_CHAR_INJURED( l_U623 ))))
                {
                    if ((sub_13174( 1, 1 )) AND (IS_CHAR_IN_AREA_3D( sub_3362(), 347.37300000, -254.69400000, 11.84629000, 371.91880000, -260.05500000, 18.03516000, 0 )))
                    {
                        if (NOT (IS_CHAR_INJURED( sub_3362() )))
                        {
                            if ((NOT (IS_CHAR_IN_ANY_HELI( sub_3362() ))) AND ((NOT (IS_CHAR_IN_ANY_BOAT( sub_3362() ))) AND (NOT (IS_CHAR_IN_ANY_CAR( sub_3362() )))))
                ...
                switch (l_U587)
                {
                    ...
                    if ((NOT (IS_CHAR_INJURED( sub_3362() ))) AND (NOT (IS_CHAR_INJURED( l_U623 ))))
                    {
                        ...
                        SET_CAM_ROT( l_U719, 7.55403500, -0.00000000, -103.51210000 );
                    ...
                    if (l_U723 > l_U722)
                    {
                        if ((NOT (IS_CHAR_INJURED( l_U645 ))) AND (IS_VEH_DRIVEABLE( l_U651 )))
                        {
                    ...
                    if (l_U723 > l_U722)
                    {
                        ...
                        SET_CAM_ROT( l_U719, -21.00855000, -20.66644000, -78.99006000 );
                    ...
                    if (l_U723 > l_U722)
                    {
                        ...
                        sub_14947( ref l_U719, ref l_U720, ref l_U721 );
                        if ((NOT (IS_CAR_DEAD( l_U649 ))) AND ((NOT (IS_CHAR_INJURED( l_U645 ))) AND (NOT (IS_CAR_DEAD( l_U651 )))))
                        {
                        ...
                        SET_CAM_ACTIVE( l_U721, 1 );
                        SET_CAM_PROPAGATE( l_U721, 1 );
                        if ((NOT (IS_CHAR_INJURED( l_U624[9] ))) AND (NOT (IS_CHAR_INJURED( l_U624[10] ))))
                        {
                    ...
                    if ((NOT l_U733) AND (l_U723 > l_U600))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U624[9] )))
                        {
                    ...
                    if (NOT l_U747)
                    {
                        if ((NOT (IS_CHAR_INJURED( l_U624[10] ))) AND (HAVE_ANIMS_LOADED( "misspackie2" )))
                        {
                    ...
                    if (NOT (sub_4020( l_U820 )))
                    {
                        ...
                        SET_CAM_ROT( l_U719, -5.33983300, -5.59077400, 65.63990000 );
                        SET_CAM_FOV( l_U719, 74.40006000 );
                    ...
                    if ((NOT (IS_CHAR_INJURED( l_U624[0] ))) AND (NOT (IS_CHAR_INJURED( l_U624[8] ))))
                    {
                ...
                GET_GAME_TIMER( ref l_U723 );
                if ((l_U723 > l_U599) AND (sub_15618()))
                {
                    sub_4007( ref l_U820 );
                    if (NOT l_U755)
                    {
                        if ((NOT (IS_CHAR_INJURED( l_U624[14] ))) AND (NOT (IS_CHAR_INJURED( l_U624[13] ))))
                        {
                ...
                if ((NOT (IS_CHAR_INJURED( l_U623 ))) AND (NOT (IS_CHAR_INJURED( sub_3362() ))))
                {
                    ...
                    if ((NOT l_U753) AND ((IS_CHAR_IN_AREA_3D( sub_3362(), 393.10990000, -250.19800000, 5.66912300, 363.03760000, -237.07480000, 0.14922900, 0 )) || (IS_CHAR_IN_AREA_3D( sub_3362(), 376.86500000, -179.61050000, 24.02446000, 322.34820000, -250.00000000, -1.08112800, 0 ))))
                    {
                        if (sub_4020( l_U838 ))
                        {
                            sub_4202( ref l_U838, 0 );
                        }
                        if ((NOT (IS_CHAR_INJURED( sub_3362() ))) AND (NOT (IS_CHAR_INJURED( l_U624[5] ))))
                        {
                    ...
                    if ((NOT l_U753) AND (IS_CHAR_IN_AREA_3D( sub_3362(), 355.75250000, -254.91310000, 3.43044400, 350.81490000, -228.96140000, 8.64031300, 0 )))
                    {
                        if (sub_4020( l_U838 ))
                        {
                            sub_4202( ref l_U838, 0 );
                        }
                        if ((NOT (IS_CHAR_INJURED( sub_3362() ))) AND (NOT (IS_CHAR_INJURED( l_U624[8] ))))
                        {
                    ...
                    if ((NOT l_U753) AND (IS_CHAR_IN_AREA_3D( sub_3362(), 339.51880000, -252.15680000, 3.33742600, 320.46360000, -265.65160000, 6.42068200, 0 )))
                    {
                        if (sub_4020( l_U838 ))
                        {
                            sub_4202( ref l_U838, 0 );
                        }
                        if ((NOT (IS_CHAR_INJURED( sub_3362() ))) AND (NOT (IS_CHAR_INJURED( l_U624[12] ))))
                        {
                    ...
                    if ((IS_CHAR_SHOOTING_IN_AREA( l_U623, 315.16180000, -277.95220000, 396.43490000, -148.10370000, 0 )) || (IS_CHAR_SHOOTING_IN_AREA( sub_3362(), 315.16180000, -277.95220000, 396.43490000, -148.10370000, 0 )))
                    {
                        l_U753 = 1;
                        l_U909 = 1;
                    }
                }
                if (((l_U909) || (NOT (sub_4020( l_U856 )))) AND (l_U753))
                {
                    for ( J = 0; J <= 9; J++ )
                    {
                        iVar96 = nil;
                    ...
                    for ( J = 0; J <= 15; J++ )
                    {
                        if ((NOT (IS_CHAR_INJURED( l_U623 ))) AND ((NOT (IS_CHAR_INJURED( l_U624[J] ))) AND (NOT (IS_CHAR_INJURED( sub_3362() )))))
                        {
                ...
                if ((NOT sub_35902()) AND ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT l_U901)))
                {
                ...
                if ((NOT l_U742) AND (NOT (IS_CHAR_INJURED( sub_3362() ))))
                {
                    if (IS_CHAR_IN_AREA_3D( sub_3362(), 361.01860000, -228.12790000, 7.80395600, 348.44470000, -217.83810000, 3.55960700, 0 ))
                    {
                        if ((NOT (IS_CHAR_INJURED( sub_3362() ))) AND (NOT (IS_CHAR_INJURED( l_U624[2] ))))
                        {
                            TASK_COMBAT( l_U624[2], sub_3362() );
                        }
                        if ((NOT (IS_CHAR_INJURED( sub_3362() ))) AND (NOT (IS_CHAR_INJURED( l_U624[3] ))))
                        {
                            TASK_COMBAT( l_U624[3], sub_3362() );
                        }
                        if ((NOT (IS_CHAR_INJURED( sub_3362() ))) AND (NOT (IS_CHAR_INJURED( l_U624[4] ))))
                        {
                            SET_COMBAT_DECISION_MAKER( l_U624[4], l_U609 );
                            TASK_COMBAT( l_U624[4], sub_3362() );
                        }
                        if ((NOT (IS_CHAR_INJURED( sub_3362() ))) AND (NOT (IS_CHAR_INJURED( l_U624[15] ))))
                        {
                ...
                if (NOT (IS_CHAR_INJURED( sub_3362() )))
                {
                    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3362(), 346.00000000, -249.00000000, 4.49130000, 26.00000000, 5.00000000, 10.00000000, 0 )) AND (NOT l_U758))
                    {
                        for ( J = 0; J <= 2; J++ )
                        {
                ...
                if ((IS_VEH_DRIVEABLE( l_U646 )) AND (NOT (IS_CHAR_INJURED( sub_3362() ))))
                {
                    if (IS_CHAR_IN_CAR( sub_3362(), l_U646 ))
                    {
                        ...
                        if (NOT (IS_CHAR_INJURED( l_U623 )))
                        {
                            if (NOT (IS_CHAR_IN_AREA_3D( l_U623, 346.83200000, -217.73620000, 2.22601900, 376.48030000, -253.23570000, 8.93464200, 0 )))
                            {
                ...
                break;
                case 15:
                if ((IS_VEH_DRIVEABLE( l_U646 )) AND ((NOT (IS_CHAR_INJURED( l_U623 ))) AND (NOT (IS_CHAR_INJURED( sub_3362() )))))
                {
                ...
                if ((IS_VEH_DRIVEABLE( l_U646 )) AND (NOT (IS_CHAR_INJURED( sub_3362() ))))
                {
                    if ((IS_CHAR_IN_CAR( sub_3362(), l_U646 )) AND (NOT (IS_CHAR_IN_AREA_3D( sub_3362(), 321.50620000, -251.16970000, 1.71408700, 397.77310000, -178.26980000, 15.30561000, 0 ))))
                    {
                        l_U586 = 17;
                    }
                }
                ...
                if ((IS_VEH_DRIVEABLE( l_U646 )) AND ((NOT (IS_CHAR_INJURED( l_U623 ))) AND (NOT (IS_CHAR_INJURED( sub_3362() )))))
                {
                    ...
                    if ((NOT (IS_CHAR_IN_AREA_3D( sub_3362(), 319.69320000, -311.16420000, 3.19766600, 410.92780000, -176.08800000, 19.76229000, 0 ))) || (LOCATE_CHAR_IN_CAR_3D( sub_3362(), l_U710._fU0, l_U710._fU4, l_U710._fU8, 10.00000000, 10.00000000, 3.00000000, 0 )))
                    {
                        if (IS_CHAR_IN_CAR( sub_3362(), l_U646 ))
                        {
                ...
                if ((IS_VEH_DRIVEABLE( l_U646 )) AND ((NOT (IS_CHAR_INJURED( l_U623 ))) AND (NOT (IS_CHAR_INJURED( sub_3362() )))))
                {
                    ...
                    {
                        if ((IS_CHAR_SITTING_IN_CAR( sub_3362(), l_U646 )) AND (IS_CHAR_SITTING_IN_CAR( l_U623, l_U646 )))
                        {
...
void sub_1603()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_1641( 5, g_U569[I] )) == 1))
        {
...
void sub_10229()
{
    ...
    if ((NOT l_U904) AND (NOT l_U898))
    {
        sub_10272( "PM1_2GO", ref l_U874, 7, 1 );
        l_U898 = 1;
    }
    if ((NOT l_U904) AND ((NOT (sub_4020( l_U874 ))) AND ((NOT l_U899) AND (l_U898))))
    {
        sub_10272( "PM1_GETCAR", ref l_U880, 7, 1 );
        l_U899 = 1;
    }
    if ((NOT l_U900) AND ((NOT (sub_4020( l_U880 ))) AND ((NOT (sub_4020( l_U874 ))) AND (l_U898))))
    {
        PRINT( "GOAL1", 7500, 3 );
        l_U900 = 1;
    }
    if ((NOT (IS_CHAR_INJURED( l_U623 ))) AND (NOT (IS_CHAR_INJURED( sub_3362() ))))
    {
        if ((IS_CHAR_SITTING_IN_ANY_CAR( l_U623 )) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_3362() )))
        {
            ...
            if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND ((l_U898) AND (NOT l_U904)))
            {
                if (g_U64940)
                {
            ...
            if (IS_CHAR_SITTING_IN_ANY_CAR( l_U623 ))
            {
                ...
                if (IS_VEH_DRIVEABLE( iVar2 ))
                {
                    ...
                    {
                        if ((NOT l_U902) AND (sub_4020( l_U826 )))
                        {
            ...
            if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (l_U902))
            {
                if (iVar2 != nil)
                {
        ...
        else if ((NOT l_U902) AND (sub_4020( l_U826 )))
        {
            sub_11654( ref l_U826 );
            l_U902 = 1;
        }
...
void sub_22577()
{
    ...
    while ((NOT (HAS_MODEL_LOADED( 886934177 ))) || ((NOT (HAS_MODEL_LOADED( -1099960214 ))) || ((NOT (HAS_MODEL_LOADED( -459749237 ))) || ((NOT (HAS_MODEL_LOADED( 1759673526 ))) || ((NOT (HAS_MODEL_LOADED( l_U716[1] ))) || (NOT (HAS_MODEL_LOADED( l_U716[0] ))))))))
    {
        WAIT( 0 );
    }
    ...
    if ((NOT (IS_CHAR_INJURED( l_U624[2] ))) AND (NOT (IS_CHAR_INJURED( l_U624[1] ))))
    {
    ...
    if ((NOT (IS_CHAR_INJURED( l_U624[4] ))) AND (NOT (IS_CHAR_INJURED( l_U624[3] ))))
    {
        OPEN_SEQUENCE_TASK( ref uVar7 );
    ...
    if ((NOT (IS_CHAR_INJURED( l_U624[7] ))) AND (NOT (IS_CHAR_INJURED( l_U624[6] ))))
    {
        OPEN_SEQUENCE_TASK( ref uVar9 );
...
void sub_36125()
{
    ...
    if (IS_VEH_DRIVEABLE( l_U646 ))
    {
        if (IS_VEH_DRIVEABLE( l_U646 ))
        {
            if ((NOT l_U757) AND (sub_36320( l_U646 )))
            {
            ...
            if ((NOT l_U757) AND (sub_36492( l_U646 )))
            {
                GET_GAME_TIMER( ref l_U727 );
                l_U727 += 12000;
                SET_ENGINE_HEALTH( l_U646, -1 );
    ...
    else if ((NOT (IS_CAR_DEAD( l_U646 ))) AND (NOT l_U757))
    {
        SET_ENGINE_HEALTH( l_U646, -1 );
        GET_GAME_TIMER( ref l_U727 );
        l_U727 += 12000;
...
void sub_37946()
{
    ...
    if ((NOT l_U905) AND ((iVar3 > 4) AND (NOT (sub_4020( l_U844 )))))
    {
        sub_10272( "PM1_TRIADS", ref l_U844, 7, 1 );
        l_U905 = 1;
    }
    if ((NOT l_U906) AND ((iVar3 > 8) AND (NOT (sub_4020( l_U844 )))))
    {
        sub_10272( "PM1_TRIADS", ref l_U844, 7, 1 );
        l_U906 = 1;
    }
...
void sub_41429()
{
    ...
    for ( I = 0; I <= 1; I++ )
    {
        if (IS_VEH_DRIVEABLE( l_U805[I] ))
        {
            if (NOT (IS_CHAR_INJURED( l_U808[I] )))
            {
                if ((sub_41547( ref l_U805[I], 15.00000000, 10.00000000, uVar2 + 15, 1 )) || (sub_41547( ref l_U805[I], 15.00000000, 10.00000000, uVar2 + 15, 5 )))
                {
...
void sub_44010()
{
    if ((IS_VEH_DRIVEABLE( l_U646 )) AND ((NOT (IS_CHAR_INJURED( l_U623 ))) AND (NOT (IS_CHAR_INJURED( sub_3362() )))))
    {
        ...
        {
            case 0:
            if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND ((IS_CHAR_IN_CAR( l_U623, l_U646 )) AND ((IS_CHAR_IN_CAR( sub_3362(), l_U646 )) AND (NOT sub_35902()))))
            {
                if (g_U64940)
                {
            ...
            else if ((IS_CHAR_IN_CAR( l_U623, l_U646 )) AND ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (sub_44380( l_U868 ))))
            {
                if (g_U64940)
                {
...
void sub_45714()
{
    if ((NOT l_U732) AND ((NOT l_U731) AND (IS_CHAR_INJURED( l_U623 ))))
    {
        l_U589 = 0;
        l_U731 = 1;
    }
...
void sub_45784()
{
    ...
    switch (l_U590)
    {
        ...
        break;
        case 1:
        if ((sub_13174( 1, 1 )) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
        {
            sub_46109();
            l_U590 = 2;
        }
        ...
        switch (l_U591)
        {
            ...
            if ((NOT (IS_CHAR_INJURED( sub_3362() ))) AND (NOT (IS_CHAR_INJURED( l_U623 ))))
            {
                ...
                sub_14170( ref l_U598, 0 );
                CREATE_CAM( 14, ref l_U719 );
                SET_CAM_POS( l_U719, 1411.18800000, 610.02990000, 32.59519000 );
                SET_CAM_ROT( l_U719, -18.93186000, -2.60163600, -131.37570000 );
                ...
                if ((IS_VEH_DRIVEABLE( l_U648 )) AND (NOT (IS_CHAR_INJURED( sub_3362() ))))
                {
                    if (NOT (IS_CHAR_IN_ANY_CAR( sub_3362() )))
                    {
                ...
                if ((IS_VEH_DRIVEABLE( l_U648 )) AND (NOT (IS_CHAR_INJURED( l_U623 ))))
                {
                    if (NOT (IS_CHAR_IN_ANY_CAR( l_U623 )))
                    {
        ...
        if ((TIMERA() > 3000) AND ((NOT (l_U591 == 0)) AND (sub_15618())))
        {
            sub_4007( ref l_U820 );
            l_U591 = 3;
        }
