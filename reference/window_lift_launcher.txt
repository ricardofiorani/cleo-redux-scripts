...
int sub_4824(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_2357() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_2357() )))
            {
                if (((g_U9202) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_2357() )))))
                {
                    if (NOT sub_4920())
                    {
...
void sub_6312(unknown uParam0)
{
    ...
    if (l_U12)
    {
        if (l_U124)
        {
            if (NOT (IS_CHAR_DEAD( sub_2081() )))
            {
                if ((IS_CHAR_PLAYING_ANIM( sub_2081(), uParam0, "GET_IN_LIFT_TOP" )) || (IS_CHAR_PLAYING_ANIM( sub_2081(), uParam0, "GET_IN_LIFT_BOTTOM" )))
                {
                    l_U149 = 1;
                }
            }
