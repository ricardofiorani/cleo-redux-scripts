...
void sub_2337()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_2375( 5, g_U569[I] )) == 1))
        {
...
void sub_3251()
{
    ...
    SWITCH_ROADS_BACK_TO_ORIGINAL( 1680.96000000, 711.78990000, 25.74000000, 1892.89000000, 724.94000000, 23.40000000 );
    ...
    for ( I = 0; I < l_U2582; I++ )
    {
        if ((NOT (IS_CHAR_DEAD( sub_4063() ))) AND (NOT (IS_CHAR_INJURED( l_U2582[I] ))))
        {
    ...
    for ( I = 0; I < l_U2586; I++ )
    {
        if ((NOT (IS_CHAR_DEAD( sub_4063() ))) AND (NOT (IS_CHAR_INJURED( l_U2586[I] ))))
        {
...
void sub_5428()
{
    ...
    if ((l_U2598 != nil) AND ((NOT (IS_CAR_DEAD( l_U2598 ))) AND (DOES_VEHICLE_EXIST( l_U2598 ))))
    {
        ...
        if ((iVar2 == 1917016601) || ((iVar2 == 1938952078) || ((iVar2 == 1677715180) || ((iVar2 == -1099960214) || ((iVar2 == 2053223216) || ((iVar2 == 904750859) || ((iVar2 == 569305213) || ((iVar2 == -1961627517) || ((iVar2 == -2137348917) || ((iVar2 == 850991848) || ((iVar2 == 1353720154) || (iVar2 == -713569950))))))))))))
        {
            PRINTSTRING( "\n ---> PLAYER IN LARGE CAR <--- \n\n" );
            iVar4 = 1;
        }
        if (((iVar4 == 1) AND (LOCATE_CAR_3D( l_U2598, 1329.51400000, -846.77630000, 7.11670000, 15.00000000, 15.00000000, 15.00000000, 0 ))) || (LOCATE_CAR_3D( l_U2598, 1329.51400000, -846.77630000, 7.11670000, 3.00000000, 3.00000000, 3.00000000, 0 )))
        {
            PRINTSTRING( "\n ---> MOVE CAR <--- \n\n" );
            if ((iVar3 != nil) AND (iVar3 != l_U2598))
            {
...
void sub_6570()
{
    if (l_U2531 == 0)
    {
        ...
        {
            ADD_BLIP_FOR_COORD( 962.21400000, -604.44050000, 13.64740000, ref l_U2543 );
            SET_ROUTE( l_U2543, 1 );
        }
        l_U2531 = 1;
    }
    if (l_U2530 == 0)
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( l_U2611, 962.21400000, -604.44050000, 13.64740000, 150.00000000, 150.00000000, 100.00000000, 0 ))
        {
            sub_6737();
            sub_7018();
            sub_7103();
    ...
    if ((l_U2464 == 0) AND ((l_U2542 == 0) AND (NOT (IS_CHAR_INJURED( l_U2581 )))))
    {
        if ((NOT (IS_CHAR_ON_FIRE( l_U2581 ))) AND ((sub_8448( 1, 1 )) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U2611, 959.50000000, -604.44050000, 13.80000000 + (2.50000000 / 2), 2.50000000, 2.50000000, 2.50000000, 1 ))))
        {
            if (DOES_BLIP_EXIST( l_U2543 ))
            {
                REMOVE_BLIP( l_U2543 );
    ...
    if ((l_U2464 == 0) AND ((l_U2542 == 0) AND ((NOT (IS_CHAR_INJURED( l_U2581 ))) AND (NOT (IS_CAR_DEAD( l_U2593 ))))))
    {
        if ((NOT (IS_CHAR_ON_FIRE( l_U2581 ))) AND ((sub_8448( 1, 1 )) AND (LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U2611, l_U2593, 4.00000000, 4.00000000, 4.00000000, 0 ))))
        {
            if (DOES_BLIP_EXIST( l_U2543 ))
            {
                REMOVE_BLIP( l_U2543 );
    ...
    if ((l_U2464 == 0) AND ((l_U2542 == 0) AND (NOT (IS_CHAR_INJURED( l_U2581 )))))
    {
        if ((NOT (IS_CHAR_ON_FIRE( l_U2581 ))) AND ((sub_8448( 1, 1 )) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U2611, l_U2581, 8.00000000, 8.00000000, 4.00000000, 0 ))))
        {
            if (DOES_BLIP_EXIST( l_U2543 ))
            {
                REMOVE_BLIP( l_U2543 );
...
void sub_7103()
{
    CREATE_CHAR( 26, l_U2590, 975.33670000, -605.49360000, 13.22130000, ref l_U2581, 1 );
...
void sub_7515()
{
    if ((l_U2464 == 0) AND (DOES_CHAR_EXIST( l_U2581 )))
    {
        if ((IS_CHAR_INJURED( l_U2581 )) || (IS_CHAR_DEAD( l_U2581 )))
        {
...
void sub_9131()
{
    ...
    if (l_U2464 == 0)
    {
        ...
        CLEAR_AREA( 962.21400000, -604.44050000, 13.80000000, 5.00000000, 1 );
...
void sub_9912()
{
    if (l_U2532 == 0)
    {
        ...
        SETTIMERB( 0 );
        l_U2439 = 8000;
        if ((NOT (IS_CAR_DEAD( l_U2593 ))) AND (NOT (DOES_BLIP_EXIST( l_U2545 ))))
        {
        ...
        SWITCH_ROADS_OFF( 1680.96000000, 711.78990000, 25.74000000, 1892.89000000, 724.94000000, 23.40000000 );
        ADD_SCENARIO_BLOCKING_AREA( 680.96010000, 711.78990000, 25.74000000, 1892.89000000, 724.94000000, 23.40000000 );
        l_U2532 = 1;
        SETTIMERA( 0 );
    }
    if (NOT (IS_CAR_DEAD( l_U2593 )))
    ...
    if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U2611, 972.90440000, -604.80160000, 13.22360000, 10.00000000, 10.00000000, 10.00000000, 0 ))) AND (IS_CHAR_IN_ANY_CAR( l_U2611 )))
    {
        if (NOT (IS_CHAR_DEAD( l_U2580 )))
        {
...
void sub_10085()
{
    ...
    if ((NOT (IS_CHAR_DEAD( l_U2580 ))) AND (NOT (IS_CAR_DEAD( l_U2592 ))))
    {
...
void sub_10663()
{
    ...
    l_U1589[9] = -276900515;
    l_U1751[10] = {992.55260000, -565.75430000, 13.88960000};
    ...
    l_U1751[36] = {1437.05900000, 0.76169990, 24.65890000};
    ...
    l_U1977[8] = {1481.83000000, 278.08330000, 25.28250000};
    l_U990[8] = 0.00190000;
    ...
    l_U1751[61] = {1731.24100000, 533.09810000, 28.88190000};
    ...
    l_U1751[65] = {1731.46700000, 721.93800000, 25.34690000};
...
void sub_24399(unknown uParam0)
{
    ...
    if ((iVar3 != 4) AND ((NOT sub_24567()) AND ((NOT (IS_CHAR_DEAD( (uParam0^) ))) AND ((IS_CHAR_IN_ANY_CAR( sub_4063() )) AND (IS_CONTROL_PRESSED( 0, 51 ))))))
    {
...
void sub_28979(unknown uParam0, float fParam1)
{
    ...
    if (NOT l_U497)
    {
        ...
        if ((IS_SCREEN_FADED_OUT()) || (l_U1304 == 0))
        {
            iVar10 = 1;
        }
        if ((NOT l_U519) AND (iVar10))
        {
            if (NOT l_U485)
            {
...
void sub_31132(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 75; I++ )
        {
            ...
            if (l_U1400[I] == 0)
            {
                if ((NOT (l_U1589[I] == 0)) AND ((l_U1324[I] < 3000) AND (l_U1324[I] > 0)))
                {
                    if (NOT l_U485)
                    {
            ...
            if (l_U1400[I] == 2)
            {
                if (HAS_MODEL_LOADED( l_U1589[I] ))
                {
                    if (NOT (DOES_VEHICLE_EXIST( l_U2249[I] )))
                    {
                        ...
                        {
                            bVar17 = false;
                            if ((NOT (sub_32646( l_U1751[I] ))) AND (NOT (sub_30659( l_U1751[I], 5.00000000, 1120403456 ))))
                            {
                                bVar17 = true;
                            }
                            if (l_U511)
                        ...
                        if (8 > l_U1572)
                        {
                            ...
                            if (HAS_CAR_RECORDING_BEEN_LOADED( l_U1324[I] ))
                            {
                                if (fVar14 < (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U1324[I] )))
                                {
                                    ...
                                    if ((sub_30659( uVar11, 5.00000000, 1120403456 )) AND (NOT (sub_30659( uVar8, 5.00000000, 1120403456 ))))
                                    {
                                        sub_31532( I, 1090519040 );
                                    }
                    ...
                    if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U2249[I] ))
                    {
                        ...
                        if (DOES_CHAR_EXIST( uVar6 ))
                        {
                            if (NOT (IS_CHAR_INJURED( uVar6 )))
                            {
                                if (IS_PLAYER_PLAYING( sub_5010() ))
                                {
                                    if ((NOT l_U500) AND ((NOT l_U488) AND ((NOT l_U491) AND (IS_CHAR_TOUCHING_VEHICLE( sub_4063(), l_U2249[I] )))))
                                    {
                                        if (IS_CHAR_IN_ANY_CAR( sub_4063() ))
                                        {
                                            bVar16 = false;
                                    ...
                                    else if ((NOT l_U500) AND (sub_35503( uParam0, l_U2249[I] )))
                                    {
                                        sub_35376( l_U2249[I] );
                                        l_U1400[I]++;
                                    }
        ...
        if (IS_PLAYER_PLAYING( sub_5010() ))
        {
            ...
            for ( I = 0; I < 75; I++ )
            {
                ...
                if (DOES_VEHICLE_EXIST( l_U2249[I] ))
                {
                    if (IS_VEH_DRIVEABLE( l_U2249[I] ))
                    {
                        if ((sub_37221( l_U2249[I], uVar6 )) || (sub_37221( l_U2249[I], (uParam0^) )))
                        {
            ...
            if (l_U1496[I] == 1)
            {
                if (6 > l_U1575)
                {
                    if (HAS_MODEL_LOADED( l_U1665[I] ))
                    {
                        ...
                        {
                            if ((l_U511) || ((l_U485) || (NOT (sub_30659( l_U1977[I], 5.00000000, 1120403456 )))))
                            {
                                if (l_U504)
                                {
...
void sub_39281(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 9; I++ )
        {
            if ((NOT (l_U1741[I] == 0)) AND ((l_U1476[I] < 3000) AND (l_U1476[I] > 0)))
            {
                if (l_U1486[I] == 0)
                {
                    if (NOT l_U485)
                ...
                if (l_U1486[I] == 2)
                {
                    if (HAS_MODEL_LOADED( l_U1741[I] ))
                    {
                        if (NOT (DOES_VEHICLE_EXIST( l_U2410[I] )))
                        {
                            ...
                            if (bVar15)
                            {
                                if ((l_U511) || (NOT (sub_30659( l_U2203[I], 5.00000000, 1120403456 ))))
                                {
                            ...
                            if (4 > l_U1574)
                            {
                                ...
                                if (HAS_CAR_RECORDING_BEEN_LOADED( l_U1476[I] ))
                                {
                                    if (fVar13 < (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U1476[I] )))
                                    {
                                        ...
                                        if ((NOT l_U511) AND ((sub_30659( uVar10, 5.00000000, 1120403456 )) AND (NOT (sub_30659( uVar7, 5.00000000, 1120403456 )))))
                                        {
                                            l_U1574++;
                                            l_U1486[I]++;
                                        }
                        ...
                        if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U2410[I] ))
                        {
                            ...
                            if (DOES_CHAR_EXIST( uVar5 ))
                            {
                                if (NOT (IS_CHAR_INJURED( uVar5 )))
                                {
                                    if (IS_PLAYER_PLAYING( sub_5010() ))
                                    {
                                        if ((NOT l_U488) AND ((NOT l_U491) AND (IS_CHAR_TOUCHING_VEHICLE( sub_4063(), l_U2410[I] ))))
                                        {
                                            if (IS_CHAR_IN_ANY_CAR( sub_4063() ))
                                            {
                                                bVar15 = false;
...
int sub_43213(unknown uParam0, unknown uParam1)
{
    ...
    if ((l_U1588 == 0) AND ((l_U1587 == 0) AND (l_U1586 == 0)))
    {
        l_U488 = 0;
        l_U485 = 0;
        l_U514 = 0;
...
void sub_44229()
{
    if ((l_U2536 == 0) AND ((NOT (IS_CAR_DEAD( l_U2592 ))) AND (NOT (IS_CHAR_DEAD( l_U2580 )))))
    {
    ...
    else if ((l_U2536 == 0) AND (IS_CAR_DEAD( l_U2592 )))
    {
        l_U2535 = 1;
        SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U2580, 0 );
        SET_CHAR_RELATIONSHIP( l_U2580, 5, 0 );
...
void sub_44725()
{
    if ((l_U2536 == 0) AND (NOT (IS_CAR_DEAD( l_U2592 ))))
    {
        if ((NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U2592 ))) || ((LOCATE_CAR_3D( l_U2592, 1767.23200000, 828.23800000, 15.43190000, 1.00000000, 1.00000000, 1.00000000, 0 )) || ((IS_CAR_IN_WATER( l_U2592 )) || (NOT (IS_VEH_DRIVEABLE( l_U2592 ))))))
        {
            STOP_PLAYBACK_RECORDED_CAR( l_U2592 );
            l_U2535 = 1;
            TASK_EVERYONE_LEAVE_CAR( l_U2592 );
            WAIT( 1000 );
            if ((NOT (IS_CHAR_DEAD( l_U2611 ))) AND (NOT (IS_CHAR_INJURED( l_U2580 ))))
            {
                SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U2580, 0 );
...
void sub_45016()
{
    ...
    {
        if ((NOT (IS_PED_RAGDOLL( l_U2581 ))) AND ((NOT (sub_45103( l_U2613 ))) AND ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U2581, l_U2611, 0 )) || ((IS_PLAYER_TARGETTING_CHAR( l_U2612, l_U2581 )) || (IS_PLAYER_FREE_AIMING_AT_CHAR( l_U2612, l_U2581 ))))))
        {
            if (l_U2500 == 1)
            {
                SETTIMERB( 15000 );
...
void sub_46367()
{
    if (NOT (IS_CHAR_DEAD( l_U2581 )))
    {
        if ((NOT (IS_PED_RAGDOLL( l_U2581 ))) AND ((NOT (sub_45103( l_U2613 ))) AND ((TIMERB() > l_U2439) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U2611, l_U2581, 8.00000000, 8.00000000, 8.00000000, 0 )))))
        {
            TASK_TURN_CHAR_TO_FACE_CHAR( l_U2581, l_U2611 );
...
void sub_46575()
{
    if ((l_U2464 == 0) AND (NOT (IS_CHAR_DEAD( l_U2580 ))))
    {
        if (l_U2540 == 0)
        {
...
void sub_46965()
{
    if (NOT (IS_CHAR_DEAD( l_U2581 )))
    {
        if ((NOT (IS_CHAR_ON_SCREEN( l_U2581 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U2611, l_U2581, 50.00000000, 50.00000000, 50.00000000, 0 ))))
        {
            MARK_MODEL_AS_NO_LONGER_NEEDED( l_U2590 );
            DELETE_CHAR( ref l_U2581 );
        }
...
void sub_47089()
{
    if (l_U2533 == 0)
    {
        ...
        if ((NOT (IS_CHAR_DEAD( l_U2580 ))) AND (NOT (DOES_BLIP_EXIST( l_U2544 ))))
        {
    ...
    if (NOT (IS_CHAR_DEAD( l_U2580 )))
    {
        ...
        {
            if ((l_U2501[0] == 0) AND (LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U2580, l_U2410[0], 9.00000000, 9.00000000, 2.00000000, 0 )))
            {
        ...
        {
            if ((l_U2501[4] == 0) AND (LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U2580, l_U2410[4], 16.00000000, 16.00000000, 3.00000000, 0 )))
            {
        ...
        {
            if ((l_U2501[5] == 0) AND (LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U2580, l_U2410[5], 16.00000000, 16.00000000, 3.00000000, 0 )))
            {
        ...
        {
            if ((l_U2501[6] == 0) AND (LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U2580, l_U2410[6], 20.00000000, 20.00000000, 2.00000000, 0 )))
            {
        ...
        {
            if ((l_U2501[8] == 0) AND (LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U2580, l_U2410[8], 10.00000000, 10.00000000, 2.00000000, 0 )))
            {
    ...
    sub_44725();
    sub_50423();
    if ((NOT (IS_CAR_DEAD( l_U2592 ))) AND (l_U2540 == 0))
    {
...
void sub_47299()
{
    if ((NOT (IS_CAR_DEAD( l_U2593 ))) AND (NOT (IS_CHAR_DEAD( l_U2611 ))))
    {
        if (IS_CHAR_SITTING_IN_CAR( l_U2611, l_U2593 ))
        {
            if (TIMERA() < 5000)
            ...
            if ((TIMERA() < 10000) AND (TIMERA() > 5000))
            {
                PRINT_HELP_FOREVER( "FAU4_HELP2" );
            }
            if ((TIMERA() < 16000) AND (TIMERA() > 10000))
            {
                if (# -NULL-0xc238b5( 1 ))
                {
            ...
            if ((TIMERA() < 22000) AND (TIMERA() > 16000))
            {
                PRINT_HELP_FOREVER( "FAU4_HELP3" );
            }
            if ((TIMERA() < 28000) AND (TIMERA() > 22000))
            {
...
void sub_47935()
{
    ...
    if ((NOT (IS_CHAR_DEAD( l_U2582[0] ))) AND (NOT (IS_CAR_DEAD( l_U2594[0] ))))
    {
        WARP_CHAR_INTO_CAR( l_U2582[0], l_U2594[0] );
    }
    if ((NOT (IS_CHAR_DEAD( l_U2582[1] ))) AND (NOT (IS_CAR_DEAD( l_U2594[1] ))))
    {
        WARP_CHAR_INTO_CAR( l_U2582[1], l_U2594[1] );
    }
    if ((NOT (IS_CHAR_DEAD( l_U2582[2] ))) AND (NOT (IS_CAR_DEAD( l_U2594[2] ))))
    {
        WARP_CHAR_INTO_CAR( l_U2582[2], l_U2594[2] );
    }
    if ((NOT (IS_CHAR_DEAD( l_U2586[0] ))) AND (NOT (IS_CAR_DEAD( l_U2594[1] ))))
    {
        WARP_CHAR_INTO_CAR_AS_PASSENGER( l_U2586[0], l_U2594[1], 0 );
    }
    if ((NOT (IS_CHAR_DEAD( l_U2586[1] ))) AND (NOT (IS_CAR_DEAD( l_U2594[2] ))))
    {
...
void sub_50423()
{
    if ((l_U2540 == 0) AND ((NOT (IS_CHAR_INJURED( l_U2580 ))) AND (NOT (IS_CAR_DEAD( l_U2592 )))))
    {
        if ((IS_CHAR_SITTING_IN_CAR( l_U2580, l_U2592 )) AND (LOCATE_CAR_3D( l_U2592, 1728.46200000, 705.07890000, 24.84420000, 30.00000000, 30.00000000, 30.00000000, 1 )))
        {
...
void sub_50697()
{
    while (l_U2511 == 0)
    {
        ...
        if ((l_U2512[0] == 1) AND ((l_U2512[1] == 0) AND (TIMERA() > 0)))
        {
            SET_PLAYER_CONTROL( l_U2612, 0 );
        ...
        if ((l_U2512[1] == 1) AND ((l_U2512[2] == 0) AND (TIMERA() > 0)))
        {
            SETTIMERA( 1 );
            l_U2512[2] = 1;
        }
        if ((l_U2512[2] == 1) AND ((l_U2512[3] == 0) AND (TIMERA() > 0)))
        {
            DISPLAY_RADAR( 0 );
            DISPLAY_HUD( 0 );
            ...
            SET_CAM_ROT( l_U2557, 1.71487700, 0.00000000, 59.26214000 );
            SET_CAM_FOV( l_U2557, 15.00000000 );
            SET_CAM_POS( l_U2558, 1722.11500000, 708.41770000, 25.22554000 );
            SET_CAM_ROT( l_U2558, 1.71487700, 0.00000000, 59.26214000 );
            SET_CAM_FOV( l_U2558, 25.00000000 );
            SET_CAM_POS( l_U2557, 1692.66000000, 715.73360000, 25.19839000 );
            ...
            SET_CAM_ROT( l_U2559, 1.71487700, 0.00000000, 59.26214000 );
        ...
        if ((l_U2512[3] == 1) AND ((l_U2512[4] == 0) AND (TIMERA() > 0)))
        {
        ...
        if ((l_U2512[4] == 1) AND ((l_U2512[5] == 0) AND (TIMERA() > 0)))
        {
            SETTIMERA( 0 );
            l_U2512[5] = 1;
        }
        if ((l_U2512[4] == 1) AND ((l_U2498 == 0) AND ((sub_52145( l_U2582[0], 1692.66000000, 715.73360000, 25.19839000 )) < 1.50000000)))
        {
        ...
        if ((l_U2512[4] == 1) AND ((l_U2499 == 0) AND ((sub_52145( l_U2582[2], 1692.66000000, 715.73360000, 25.19839000 )) < 3.80000000)))
        {
        ...
        if ((l_U2512[5] == 1) AND ((l_U2512[6] == 0) AND (TIMERA() > 1750)))
        {
            sub_7584( ref l_U2613, 0 );
            sub_45379( "F4_ARRGS", ref l_U2613, 3, 1 );
            l_U2512[6] = 1;
        }
        if ((l_U2512[6] == 1) AND ((l_U2512[7] == 0) AND (TIMERA() > 3000)))
        {
        ...
        if ((l_U2512[7] == 1) AND ((l_U2512[8] == 0) AND (TIMERA() > 3000)))
        {
        ...
        if ((l_U2512[8] == 1) AND ((l_U2512[9] == 0) AND (TIMERA() > 100)))
        {
            SETTIMERA( 0 );
            l_U2512[9] = 1;
        }
        if ((NOT (sub_45103( l_U2613 ))) AND ((l_U2512[9] == 1) AND ((l_U2512[10] == 0) AND (TIMERA() > ((l_U2443[0] + l_U2443[1]) + l_U2443[2])))))
        {
        ...
        if ((l_U2511 == 0) AND ((IS_SCREEN_FADED_IN()) AND (sub_53767())))
        {
            ...
            if (NOT (IS_CAR_DEAD( l_U2598 )))
            {
                ...
                SET_CHAR_COORDINATES( l_U2611, 1745.09200000, 716.20790000, 24.87880000 );
...
void sub_55332()
{
    if (NOT (IS_CHAR_DEAD( l_U2580 )))
    {
        if ((NOT (IS_PED_RAGDOLL( l_U2580 ))) AND ((NOT (sub_45103( l_U2613 ))) AND ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U2611, l_U2580, 13.00000000, 13.00000000, 13.00000000, 0 )) AND (TIMERB() > l_U2439))))
        {
...
void sub_55516()
{
    if ((l_U2493 == 0) AND (NOT (IS_CAR_DEAD( l_U2592 ))))
    {
...
void sub_55896()
{
    ...
    for ( I = 0; I < l_U2582; I++ )
    {
        if ((l_U2494[I] == 0) AND (NOT (IS_CAR_DEAD( l_U2594[I] ))))
        {
            if (NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U2594[I] )))
            {
                STOP_PLAYBACK_RECORDED_CAR( l_U2594[I] );
                GET_CHAR_COORDINATES( l_U2611, ref l_U2448._fU0, ref l_U2448._fU4, ref l_U2448._fU8 );
                if ((NOT (IS_CHAR_DEAD( l_U2611 ))) AND (NOT (IS_CHAR_INJURED( l_U2582[I] ))))
                {
                ...
                if ((I == 1) || (I == 0))
                {
                    if ((NOT (IS_CHAR_DEAD( l_U2611 ))) AND (NOT (IS_CHAR_INJURED( l_U2586[I] ))))
                    {
...
void sub_56559()
{
    ...
    for ( I = 0; I < l_U2582; I++ )
    {
        if ((l_U2489[I] == 0) AND ((NOT (IS_CAR_DEAD( l_U2594[I] ))) AND (NOT (IS_CHAR_INJURED( l_U2582[I] )))))
        {
        ...
        else if ((l_U2489[I] == 0) AND ((NOT (IS_CAR_DEAD( l_U2594[I] ))) AND (IS_CHAR_INJURED( l_U2582[I] ))))
        {
            STOP_PLAYBACK_RECORDED_CAR( l_U2594[I] );
            if (NOT (IS_CHAR_DEAD( l_U2582[I] )))
            {
        ...
        else if ((l_U2489[I] == 0) AND (IS_CAR_DEAD( l_U2594[I] )))
        {
            if (NOT (IS_CHAR_DEAD( l_U2582[I] )))
            {
                SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U2582[I], 0 );
...
void sub_57013()
{
    ...
    {
        if ((NOT (sub_45103( l_U2613 ))) AND (TIMERB() > l_U2439))
        {
...
void sub_57240()
{
    if ((NOT (IS_CHAR_IN_ANY_CAR( l_U2611 ))) AND ((l_U2563 == 0) AND (l_U2493 == 1)))
    {
        l_U2563 = 1;
    }
    if ((l_U2564 == 0) AND (l_U2563 == 1))
    {
        if (l_U2565 == 0)
        {
            l_U2565 = 1;
...
void sub_57486()
{
    if ((IS_CHAR_INJURED( l_U2586[1] )) AND ((IS_CHAR_INJURED( l_U2586[0] )) AND ((IS_CHAR_INJURED( l_U2582[2] )) AND ((IS_CHAR_INJURED( l_U2582[1] )) AND ((IS_CHAR_INJURED( l_U2582[0] )) AND (IS_CHAR_DEAD( l_U2580 )))))))
    {
        sub_44347( 0 );
        sub_3353();
        while (TIMERA() < 3000)
