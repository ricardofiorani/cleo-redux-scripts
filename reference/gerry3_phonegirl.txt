...
void sub_12030()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_12068( 5, g_U569[I] )) == 1))
        {
...
int sub_15623()
{
    ...
    if ((g_U9371) || ((sub_15891()) || ((g_U33837) || ((sub_15686()) || ((IS_WANTED_LEVEL_GREATER( sub_3279(), 0 )) || ((IS_THREAD_ACTIVE( g_U812 )) || (g_U10978)))))))
    {
        return 0;
    }
    if (sub_15946( l_U484 ))
...
int sub_16155(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_16374() ))) AND (IS_CHAR_IN_ANY_CAR( sub_16374() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_16706()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
int sub_23434()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_12068( 1, g_U569[I] )) != 0))
        {
            sub_12354( I );
            return 1;
        }
