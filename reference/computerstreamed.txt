void main()
{
    ...
    while (true)
    {
        ...
        if (IS_PLAYER_PLAYING( sub_372() ))
        {
            ...
            {
                case 0:
                if ((HAS_OBJECT_BEEN_DAMAGED( l_U5 )) || (HAS_OBJECT_BEEN_UPROOTED( l_U5 )))
                {
                    sub_487( "Computer has been uprooted, or damaged" );
                    sub_504();
                }
                if (((NOT l_U4) AND (g_U945)) || (g_U944))
                {
                    break;
                }
                ...
                else if ((NOT IS_REPLAY_SAVING()) AND (sub_1629( 2, "USE_COMPUTER", 0 )))
                {
...
int sub_1253(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_372() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_372() )))
            {
                if (((g_U9202) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_372() )))))
                {
                    if (NOT sub_1349())
                    {
