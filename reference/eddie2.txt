...
void sub_2216()
{
    ...
    {
        case 0:
        l_U208 = {-1638.94600000, 697.53240000, 27.31000000};
        l_U220 = -1600585231;
...
void sub_2779()
{
    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U204, sub_1956(), 0 )) || (IS_CHAR_INJURED( l_U204 )))
    {
        if (IS_HINT_RUNNING())
        {
            HINT_CAM( -1.00000000, -1.00000000, -1.00000000, l_U204, 0, 0, 0 );
    ...
    if ((IS_CHAR_ON_FOOT( sub_1956() )) AND (sub_2945() < 25))
    {
    ...
    {
        case 0:
        if ((IS_WANTED_LEVEL_GREATER( sub_957(), 0 )) || ((IS_CHAR_ON_FIRE( l_U204 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U204, sub_1956(), 0 )) || (IS_CHAR_INJURED( l_U204 )))))
        {
        ...
        if (NOT (IS_CHAR_INJURED( l_U204 )))
        {
            if ((IS_CHAR_ON_FOOT( sub_1956() )) AND (sub_2945() < 18))
            {
                if ((NOT l_U226) AND (NOT IS_HINT_RUNNING()))
                {
    ...
    switch (l_U200)
    {
        ...
        if (DOES_VEHICLE_EXIST( l_U206 ))
        {
            if (IS_VEH_DRIVEABLE( l_U206 ))
            {
                ...
                SET_CAR_COORDINATES( l_U206, -1629.21700000, 686.06740000, 26.67540000 );
        ...
        SET_CHAR_COORDINATES( sub_1956(), -1631.97000000, 692.61760000, 27.04020000 );
        ...
        else if ((NOT (IS_CHAR_ON_SCREEN( l_U204 ))) AND ((NOT (IS_CHAR_INJURED( l_U204 ))) AND (sub_2945() > 100)))
        {
            if (NOT IS_MESSAGE_BEING_DISPLAYED())
            {
                CLEAR_PRINTS();
