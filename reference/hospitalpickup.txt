...
void sub_4476(unknown uParam0)
{
    ...
    iVar7 = 0;
    if ((NOT l_U546._fU88) AND ((NOT (COMPARE_STRING( ref l_U546._fU48, l_U545 ))) AND ((l_U481 == 2) AND (l_U546._fU80 == 1))))
    {
        iVar7 = 1;
    }
    bVar8 = false;
    if (l_U546._fU100)
    {
        ...
        if ((NOT l_U546._fU92) AND ((NOT (COMPARE_STRING( ref l_U546._fU64, l_U545 ))) AND ((bVar9) AND ((l_U481 == 2) AND (l_U546._fU80 == 1)))))
        {
            iVar7 = 1;
            bVar8 = true;
        }
...
int sub_12402()
{
    ...
    fVar3 = 0.00000000;
    GET_CAR_SPEED( uVar2, ref fVar3 );
    if ((sub_12477( 1, 1 )) AND (fVar3 < 0.01000000))
    {
        if (NOT l_U492)
        {
...
int sub_12840()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    bVar3 = false;
    if ((IS_PLAYER_PRESSING_HORN( sub_4140() )) AND ((sub_12477( 1, 1 )) AND (IS_CHAR_IN_ANY_CAR( sub_2893() ))))
    {
        if (l_U492)
        {
            return 0;
...
int sub_13438(unknown uParam0, unknown uParam1)
{
    ...
    iVar11 = 0;
    if ((NOT l_U498) AND (IS_CHAR_IN_ANY_CAR( sub_2893() )))
    {
        ...
        if (NOT (IS_CHAR_IN_CAR( (uParam0^), uVar7 )))
        {
            if (NOT (l_U544 == 0))
            {
                ...
                if ((NOT (IS_VEH_DRIVEABLE( uVar7 ))) || (l_U544 < iVar12))
                {
                    SET_PLAYER_CONTROL( sub_4140(), 1 );
                    HINT_CAM( -1.00000000, -1.00000000, -1.00000000, 0, 0, 0, 0 );
    ...
    if ((NOT l_U498) AND (IS_HINT_RUNNING()))
    {
        HINT_CAM( -1.00000000, -1.00000000, -1.00000000, 0, 0, 0, 0 );
    }
    return 0;
...
int sub_16852(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, boolean bParam5, unknown uParam6)
{
    ...
    if (bVar10)
    {
        ...
        {
            if ((NOT (IS_CHAR_DEAD( iParam1 ))) AND (NOT (IS_CHAR_DEAD( sub_2893() ))))
            {
    ...
    if (l_U704 == 7)
    {
        ...
        else if ((IS_CHAR_DEAD( iParam1 )) || (IS_CHAR_DEAD( sub_2893() )))
        {
            l_U704++;
        }
        else
    ...
    if (l_U704 == 12)
    {
        ...
        if ((TIMERA() > 7000) || (sub_27816( iParam1, l_U738 )))
        {
            l_U704++;
        }
    }
...
int sub_25187()
{
    ...
    if (l_U572 == 1)
    {
        ...
        if ((l_U499 < iVar2) || (fVar4 < 0.04000000))
        {
            SET_PLAYER_CONTROL( sub_4140(), 1 );
            l_U572 = 0;
            return 1;
...
int sub_30582()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_14208( 1, g_U569[I] )) != 0))
        {
            sub_14459( I );
            return 1;
        }
...
void sub_34149()
{
    ...
    l_U487 = 0;
    if ((NOT (IS_CHAR_DEAD( l_U781 ))) AND (NOT (l_U781 == nil)))
    {
...
void sub_34769(unknown uParam0)
{
    ...
    if (l_U723._fU12)
    {
        if (g_U22274[l_U537]._fU688._fU24 >= 0)
        {
            ...
            if (NOT l_U723._fU24)
            {
                if (((sub_35555( l_U526 )) > 5) || (sub_34825( ref l_U526 )))
                {
                    bVar5 = true;
                }
            }
...
void sub_35430()
{
    ...
    if ((NOT (sub_8180( sub_2893() ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_2893() )))
    {
        sub_2779( "MF10AUD" );
        sub_2942( 0, sub_2893(), "NIKO", 0 );
...
int sub_36667(unknown uParam0)
{
    ...
    if ((l_U723._fU24) || (sub_36676()))
    {
        return 0;
    }
    if (NOT l_U723._fU8)
    {
        if ((NOT (IS_CHAR_DEAD( uParam0 ))) AND (NOT (IS_CHAR_DEAD( sub_2893() ))))
        {
            if (IS_CHAR_IN_ANY_CAR( sub_2893() ))
            {
                STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_2893(), ref uVar3 );
...
int sub_36676()
{
    if ((l_U723._fU48) || ((l_U723._fU44) || ((l_U723._fU40) || ((l_U723._fU36) || (l_U723._fU32)))))
    {
        return 1;
    }
    return 0;
...
int sub_46034(unknown uParam0)
{
    ...
    if (l_U723._fU24)
    {
        if (NOT sub_36676())
        {
            ...
            if ((iVar3 > l_U723._fU28) AND (NOT (l_U723._fU28 == 0)))
            {
                l_U723._fU28 = 0;
                if (l_U723._fU8)
                {
