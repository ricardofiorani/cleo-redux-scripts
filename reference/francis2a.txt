...
void sub_1562()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_1600( 5, g_U569[I] )) == 1))
        {
...
void sub_2562()
{
    ...
    {
        iVar3 = sub_2590( 13 );
        if ((g_U9932[g_U9999[I]._fU0]._fU0) AND (sub_2635( 13, iVar3 )))
        {
    ...
    {
        iVar3 = sub_2590( 11 );
        if ((g_U9932[g_U10090[I]._fU0]._fU0) AND (sub_2635( 11, iVar3 )))
        {
    ...
    {
        iVar3 = sub_3114( I );
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_2635( g_U10324[I]._fU12, iVar3 )))
        {
...
void sub_3651()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_3114( I )))
        {
            iVar4++;
        }
    }
...
void sub_7834()
{
    ...
    if ((iVar3 != nil) AND ((NOT (IS_CAR_DEAD( iVar3 ))) AND (DOES_VEHICLE_EXIST( iVar3 ))))
    {
        ...
        if (((iVar5 == 1) AND (LOCATE_CAR_3D( iVar3, -406.63070000, 279.57920000, 12.10630000, 15.00000000, 15.00000000, 15.00000000, 0 ))) || (LOCATE_CAR_3D( iVar3, -406.63070000, 279.57920000, 12.10630000, 3.00000000, 3.00000000, 3.00000000, 0 )))
        {
            PRINTSTRING( "\n ---> MOVE CAR <--- \n\n" );
            if ((iVar4 != nil) AND (iVar4 != iVar3))
            {
...
void sub_8753()
{
    ...
    if ((NOT (IS_CHAR_DEAD( l_U662 ))) AND (l_U644 == 0))
    {
        iVar2 = 5;
    ...
    {
        l_U565 = sub_8939();
        if ((l_U561 != 1) AND (sub_8985( "www.eyefind.info" )))
        {
            l_U561 = 1;
            PRINT_HELP_FOREVER( "FM_NETCAFE_03" );
            l_U645 = 0;
        }
        if ((l_U561 != 2) AND (sub_8985( "www.goldberglignerandshyster.com" )))
        {
            l_U561 = 2;
        ...
        if (l_U645 == 0)
        {
            if ((l_U561 != 3) AND (sub_8985( "www.goldberglignerandshyster.com/careers.html" )))
            {
                l_U561 = 3;
        ...
        if ((l_U561 != 4) AND (sub_8985( "www.goldberglignerandshyster.com/resume.html" )))
        {
            l_U561 = 4;
            PRINT_HELP_FOREVER( "FM_NETCAFE_07" );
        }
        if ((l_U561 != 5) AND (sub_9364() == 1))
        {
            l_U561 = 5;
            CLEAR_HELP();
            ALLOW_THIS_SCRIPT_TO_BE_PAUSED( 0 );
        }
        if ((l_U561 != 7) AND (sub_9364() == 0))
        {
            l_U561 = 7;
            CLEAR_HELP();
            l_U644 = 0;
        }
        if ((l_U561 != 6) AND (l_U565 > 0))
        {
            l_U561 = 6;
            l_U582 = 1;
            CLEAR_HELP();
