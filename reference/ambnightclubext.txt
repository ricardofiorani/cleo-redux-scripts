    ...
    while (true)
    {
        ...
        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
        {
            switch (l_U437)
            {
                ...
                while ((NOT (HAS_MODEL_LOADED( -1850743775 ))) || (NOT (HAS_MODEL_LOADED( l_U430 ))))
                {
                    WAIT( 0 );
                }
                    ...
                    if ((CAN_CREATE_RANDOM_CHAR( 0, 1 )) || (CAN_CREATE_RANDOM_CHAR( 1, 0 )))
                    {
                        ...
                        if (DOES_CHAR_EXIST( l_U113[l_U239] ))
                        {
                            if (NOT (IS_CHAR_DEAD( l_U113[l_U239] )))
                            {
                                ...
                                if ((l_U431 == -142386662) || ((l_U431 == -1827421800) || (l_U431 == -1080673049)))
                                {
                                    if (NOT (IS_CHAR_DEAD( l_U113[l_U239] )))
                                    {
...
void sub_162()
{
    ...
    {
        if ((NOT (IS_CHAR_INJURED( l_U154 ))) AND (NOT (IS_CHAR_DEAD( l_U154 ))))
        {
    ...
    {
        WAIT( 0 );
        if ((DOES_CHAR_EXIST( l_U113[l_U239] )) AND ((NOT (IS_CHAR_INJURED( l_U113[l_U239] ))) AND (NOT (IS_CHAR_DEAD( l_U113[l_U239] )))))
        {
            CLEAR_CHAR_TASKS_IMMEDIATELY( l_U113[l_U239] );
            MARK_CHAR_AS_NO_LONGER_NEEDED( ref l_U113[l_U239] );
        }
            ...
            if (l_U395 == 0)
            {
                ...
                if (l_U436 == 7)
                {
                    ...
                    while (l_U239 < l_U243)
                    {
                        ...
                        if (l_U397 == 0)
                        {
                            if ((DOES_CHAR_EXIST( l_U155 )) AND ((NOT (IS_CHAR_INJURED( l_U155 ))) AND (NOT (IS_CHAR_DEAD( l_U155 )))))
                            {
                                if (l_U396 == 1)
                                {
...
void sub_7259(unknown uParam0)
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_737() ))) AND (NOT (IS_CHAR_INJURED( (uParam0^) ))))
    {
...
int sub_7807(unknown uParam0)
{
    ...
    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
    {
        if (GET_CHAR_READY_TO_BE_STUNNED( (uParam0^) ))
        {
            if (HAVE_ANIMS_LOADED( "melee_unarmed_base" ))
            {
                if ((NOT (IS_CHAR_PLAYING_ANIM( sub_737(), "melee_unarmed_base", "stun_punch" ))) AND (IS_PED_IN_COMBAT( (uParam0^) )))
                {
                    bVar3 = true;
                }
                if ((NOT (IS_CHAR_PLAYING_ANIM( sub_737(), "melee_unarmed_base", "stun_punch" ))) AND (IS_CHAR_IN_MELEE_COMBAT( (uParam0^) )))
                {
                    bVar3 = true;
                }
            }
            if ((IS_CHAR_ARMED( (uParam0^), 4 )) AND (IS_PLAYER_TARGETTING_CHAR( sub_911(), (uParam0^) )))
            {
                bVar3 = true;
            }
            if ((IS_CHAR_ARMED( (uParam0^), 4 )) AND (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_911(), (uParam0^) )))
            {
                bVar3 = true;
            }
        ...
        if ((g_U9209 == 1) AND (l_U399 == 0))
        {
            if (IS_PLAYER_PLAYING( sub_911() ))
            {
                ...
                if (l_U397 == 0)
                {
                    if ((NOT (IS_CHAR_INJURED( l_U154 ))) AND (NOT (IS_CHAR_DEAD( l_U154 ))))
                    {
                        if ((NOT (IS_CHAR_INJURED( l_U155 ))) AND (NOT (IS_CHAR_DEAD( l_U155 ))))
                        {
                            if (LOCATE_CHAR_ANY_MEANS_3D( sub_737(), 957.90000000, -288.65000000, 19.88000000, 3.50000000, 3.50000000, 3.50000000, 0 ))
                            {
                                ...
                                l_U397 = 1;
                                if ((DOES_CHAR_EXIST( l_U155 )) AND (NOT (IS_CHAR_DEAD( l_U155 ))))
                                {
                                    CLEAR_CHAR_TASKS_IMMEDIATELY( l_U155 );
                                    SET_CHAR_RELATIONSHIP( l_U155, 5, 0 );
                                    SET_CHAR_READY_TO_BE_STUNNED( l_U155, 0 );
            ...
            if (l_U397 == 1)
            {
                if (IS_PLAYER_PLAYING( sub_911() ))
                {
                    if ((DOES_CHAR_EXIST( l_U154 )) AND ((NOT (IS_CHAR_INJURED( l_U154 ))) AND (NOT (IS_CHAR_DEAD( l_U154 )))))
                    {
                        if ((DOES_CHAR_EXIST( l_U155 )) AND ((NOT (IS_CHAR_INJURED( l_U155 ))) AND (NOT (IS_CHAR_DEAD( l_U155 )))))
                        {
