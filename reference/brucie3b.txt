void main()
{
    ...
    l_U497 = {882.77920000, -486.58250000, 16.03978000};
    ...
    while (true)
    {
        ...
        if ((NOT l_U518) AND ((NOT (IS_WANTED_LEVEL_GREATER( sub_2681(), 0 ))) AND ((NOT l_U530) AND ((NOT (sub_4167( sub_2571() ))) AND ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT l_U522))))))
        {
            if (NOT l_U520)
            {
        ...
        switch (l_U481)
        {
            ...
            if (NOT l_U530)
            {
                if ((NOT (IS_CHAR_INJURED( l_U485 ))) AND ((NOT l_U529) AND (IS_WANTED_LEVEL_GREATER( sub_2681(), 0 ))))
                {
            ...
            if (NOT (IS_CHAR_INJURED( l_U485 )))
            {
                if ((l_U522) AND ((sub_6578( 1, 1 )) AND (sub_6420( sub_2571(), l_U485 ))))
                {
                    sub_6876( 2 );
                }
            }
            if ((NOT (IS_CHAR_DEAD( l_U485 ))) AND (sub_4167( sub_2571() )))
            {
                if (sub_4167( l_U485 ))
                {
                    GET_CHAR_COORDINATES( l_U485, ref l_U540, ref l_U541, ref l_U542 );
                    if ((sub_6578( 1, 1 )) AND ((NOT l_U530) AND ((NOT l_U529) AND (LOCATE_CHAR_ON_FOOT_3D( sub_2571(), l_U540, l_U541, l_U542, 1.60000000, 1.60000000, 2.00000000, 0 )))))
                    {
                        l_U481 = 2;
                    }
                }
            ...
            if ((NOT l_U530) AND (sub_4167( sub_2571() )))
            {
                l_U481 = 2;
            ...
            switch (l_U482)
            {
                ...
                case 1:
                sub_9149();
                if ((NOT (IS_CHAR_INJURED( l_U485 ))) AND (NOT l_U516))
                {
                    if ((IS_CHAR_SITTING_IDLE( l_U485 )) AND (IS_CHAR_SITTING_IDLE( sub_2571() )))
                    {
                        l_U516 = 1;
                ...
                if ((l_U532 == 0) AND ((sub_9359( l_U546 )) == 0))
                {
                    BEGIN_CAM_COMMANDS( ref l_U533 );
                ...
                if ((l_U532 == 1) AND (NOT (sub_9164( l_U546 ))))
                {
                    SETTIMERB( 0 );
                    l_U532 = 2;
                }
                if ((TIMERB() >= 400) AND (l_U532 == 2))
                {
                    l_U482 = 2;
                }
                break;
            ...
            if (NOT (IS_CHAR_INJURED( l_U485 )))
            {
                ...
                if (NOT l_U529)
                {
                    if ((l_U526) AND ((IS_CONTROL_JUST_PRESSED( 2, 23 )) AND (NOT l_U521)))
                    {
                    ...
                    if ((l_U527) AND ((TIMERB() >= 2000) AND (NOT l_U526)))
                    {
                        PRINT_HELP( "DAN4_GETUP" );
                        l_U526 = 1;
                    }
                    if ((TIMERB() >= 400) AND ((NOT l_U528) AND ((NOT (sub_9164( l_U546 ))) AND (NOT l_U527))))
                    {
                        sub_10182( "BR3_ARR", ref l_U546, 7, 1 );
                        l_U527 = 1;
                    }
                    if ((NOT l_U517) AND (NOT l_U528))
                    {
                        if (l_U521)
                        {
                            if (IS_CHAR_ARMED( sub_2571(), 7 ))
                            {
                                if ((NOT (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U485, sub_2571(), 0 ))) AND (HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U485, sub_2571() )))
                                {
                                    GET_CURRENT_CHAR_WEAPON( sub_2571(), ref l_U487 );
                                    if ((l_U487 == 17) || ((l_U487 == 16) || ((l_U487 == 15) || ((l_U487 == 14) || ((l_U487 == 13) || ((l_U487 == 12) || ((l_U487 == 11) || ((l_U487 == 10) || ((l_U487 == 9) || (l_U487 == 7))))))))))
                                    {
                                    ...
                                    else if ((l_U487 == 6) || ((l_U487 == 18) || (l_U487 == 4)))
                                    {
                                        sub_2808( ref l_U552, 0 );
                            ...
                            else if ((NOT (IS_CHAR_SITTING_IDLE( l_U485 ))) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U485, sub_2571(), 0 )) AND (l_U487 == 0)))
                            {
                                sub_2808( ref l_U552, 0 );
                        ...
                        else if ((TIMERB() >= 3000) AND (NOT (sub_9164( l_U546 ))))
                        {
                            l_U528 = 1;
                        }
                    }
                    if ((NOT l_U517) AND (l_U528))
                    {
                        sub_5853();
                    }
                }
                if ((l_U517) AND ((l_U528) AND ((l_U516) AND ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND ((NOT (sub_9164( l_U552 ))) AND ((NOT (sub_9164( l_U546 ))) AND (NOT l_U515)))))))
                {
                    PRINT_NOW( "DAN4_04", 7500, 1 );
                    l_U515 = 1;
                }
                GET_CHAR_COORDINATES( l_U485, ref l_U540, ref l_U541, ref l_U542 );
                if ((l_U515) AND ((TIMERA() >= 4000) AND ((l_U517) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_2571(), l_U540, l_U541, l_U542, 10.00000000, 10.00000000, 10.00000000, 0 )))))
                {
                    sub_16160();
                }
                if (l_U517)
                ...
                if ((sub_6578( 1, 1 )) AND (sub_6420( sub_2571(), l_U485 )))
                {
                    sub_6876( 2 );
                }
...
void sub_1660()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_1698( 5, g_U569[I] )) == 1))
        {
...
void sub_5221()
{
    if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_2571(), l_U488._fU0, l_U488._fU4, l_U488._fU8, 30.00000000, 30.00000000, 4.00000000, 0 ))))
    {
...
void sub_5680()
{
    if (NOT (IS_CHAR_INJURED( l_U485 )))
    {
        if (((NOT (IS_CHAR_SITTING_IDLE( l_U485 ))) AND (l_U525)) || (((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U485, sub_2571() )) AND ((IS_CHAR_ARMED( sub_2571(), 7 )) AND ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_2681(), l_U485 )) || (IS_PLAYER_TARGETTING_CHAR( sub_2681(), l_U485 ))))) || ((IS_ANY_CHAR_SHOOTING_IN_AREA( 877.27000000, -488.17000000, -10, 891.79000000, -481.69000000, 19, 0 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U485, sub_2571(), 0 )))))
        {
            sub_5853();
            if (l_U481 == 0)
            {
...
void sub_16160()
{
    if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND ((NOT (sub_9164( l_U552 ))) AND (NOT (sub_9164( l_U546 )))))
    {
        if (l_U538 >= l_U539)
        {
...
void sub_16850(boolean bParam0)
{
    ...
    if (bParam0)
    {
        ...
        {
            sub_9359( l_U546 );
            if ((iVar3 == 5) || ((iVar3 == 3) || ((iVar3 == 2) || (iVar3 == 0))))
            {
                sub_2808( ref l_U546, 0 );
            }
            else
