...
void sub_2009()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_2047( 5, g_U569[I] )) == 1))
        {
...
void sub_4389()
{
    ...
    if ((l_U760 != nil) AND ((NOT (IS_CAR_DEAD( l_U760 ))) AND (DOES_VEHICLE_EXIST( l_U760 ))))
    {
        ...
        {
            if ((l_U613 != nil) AND (l_U613 != l_U760))
            {
...
void sub_4816()
{
    ...
    CREATE_PICKUP_ROTATE( 1069950328, 22, 200, -98.83999000, 854.75000000, 26.10000000, 0, 0, 0, ref l_U509 );
...
void sub_6040()
{
    ...
    if ((l_U566 == 1) AND (IS_WANTED_LEVEL_GREATER( l_U825, 0 )))
    {
    ...
    if ((l_U566 == 0) AND (NOT (IS_WANTED_LEVEL_GREATER( l_U825, 0 ))))
    {
    ...
    if ((l_U566 == 1) AND (NOT (IS_CHAR_DEAD( l_U658 ))))
    {
        if (NOT (IS_CHAR_IN_ANY_CAR( l_U824 )))
        {
            if ((sub_9455( 1, 1 )) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U824, l_U658, 7.00000000, 4.20000000, 2.00000000, 0 )))
            {
                if (DOES_BLIP_EXIST( l_U602 ))
                {
                    REMOVE_BLIP( l_U602 );
        ...
        else if ((sub_9455( 1, 1 )) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U824, l_U658, 10.00000000, 5.00000000, 10.00000000, 0 )))
        {
            if (DOES_BLIP_EXIST( l_U602 ))
            {
                REMOVE_BLIP( l_U602 );
...
void sub_6430()
{
    ...
    SET_CAR_ON_GROUND_PROPERLY( l_U744[2] );
    CREATE_CAR( l_U808, -94.48410000, 894.15270000, 14.27020000, ref l_U744[3], 1 );
...
void sub_7145()
{
    ...
    CREATE_CAR( l_U805, -61.28390000, 803.44570000, 13.52400000, ref l_U749[3], 1 );
...
void sub_9949()
{
    ...
    if (l_U567[0] == 0)
    {
        if (NOT (IS_CAR_DEAD( l_U749[0] )))
        {
            ...
            if ((NOT (LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U824, l_U749[0], 7.50000000, 7.50000000, 7.50000000, 0 ))) AND ((NOT (IS_CHAR_TOUCHING_VEHICLE( l_U824, l_U749[0] ))) AND ((NOT (IS_CHAR_IN_CAR( l_U824, l_U749[0] ))) AND (l_U494 < 750))))
            {
    ...
    for ( I = 1; I <= 4; I++ )
    {
        if (l_U567[0] == 0)
        {
            if (NOT (IS_CAR_DEAD( l_U749[I] )))
            {
                ...
                if ((NOT (LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U824, l_U749[I], 8.00000000, 8.00000000, 8.00000000, 0 ))) AND ((NOT (IS_CHAR_TOUCHING_VEHICLE( l_U824, l_U749[I] ))) AND ((NOT (IS_CHAR_IN_CAR( l_U824, l_U749[I] ))) AND (l_U494 < (300 - ((4) XOR (I)))))))
                {
...
void sub_10458()
{
    ...
    else if ((IS_CHAR_INJURED( l_U658 )) AND (DOES_CHAR_EXIST( l_U658 )))
    {
        if (NOT (IS_CHAR_INJURED( l_U658 )))
        {
            SET_CHAR_RELATIONSHIP( l_U658, 5, 0 );
...
void sub_12244()
{
    ...
    if (l_U561 == 0)
    {
        if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U824, -123.63790000, -256.57810000, 11.68540000, 4.00000000, 4.00000000, 4.00000000, 0 ))) || (TIMERA() > 4000))
        {
    ...
    if ((l_U521[0] == 0) AND (NOT (IS_CHAR_INJURED( l_U679[4] ))))
    {
    ...
    if ((l_U521[1] == 0) AND (NOT (IS_CHAR_INJURED( l_U679[2] ))))
    {
    ...
    if ((l_U521[2] == 0) AND (NOT (IS_CHAR_INJURED( l_U686[1] ))))
    {
    ...
    if ((l_U505._fU8 < 23.00000000) || (LOCATE_CHAR_ANY_MEANS_3D( l_U824, -100.87830000, 873.18660000, 25.93190000, 3.00000000, 3.00000000, 3.00000000, 0 )))
    {
        l_U489++;
    }
    return;
...
void sub_13393()
{
    ...
    CREATE_PICKUP_ROTATE( 993473937, 22, 5, -98.72000000, 870.23000000, 24.95500000, 94.62001000, 40.28000000, 0, ref l_U517 );
...
void sub_14866()
{
    CREATE_CHAR( 7, l_U741, -107.50590000, 794.66170000, 25.93190000 - 1.00000000, ref l_U661[2], 1 );
    SET_CHAR_HEADING( l_U661[2], 0.60399990 );
    sub_14964( l_U661[2], 2, 1, 1, "Museum2_Hall" );
    sub_8480( l_U661[2], 0 );
    SET_CHAR_SPHERE_DEFENSIVE_AREA( l_U661[2], -107.50590000, 794.66170000, 25.93190000 - 1.00000000, 1.00000000 );
...
void sub_15357()
{
    ...
    CREATE_CHAR( 8, l_U739, -92.37910000, 817.59130000, 25.93200000 - 1.00000000, ref l_U670[5], 1 );
    SET_CHAR_HEADING( l_U670[5], 177.31980000 );
    sub_14964( l_U670[5], 2, 1, 1, "Museum2_Hall" );
    sub_8480( l_U670[5], 0 );
    SET_CHAR_SPHERE_DEFENSIVE_AREA( l_U670[5], -92.37910000, 817.59130000, 25.93200000 - 1.00000000, 10.00000000 );
...
void sub_16496()
{
    ...
    CREATE_CHAR( 8, l_U742, -122.47550000, 809.90380000, 24.93230000, ref l_U679[5], 1 );
...
void sub_17533()
{
    CREATE_CHAR( 8, l_U742, -91.88681000, 871.38590000, 24.93230000, ref l_U686[0], 1 );
    SET_CHAR_HEADING( l_U686[0], 186.02380000 );
    sub_14964( l_U686[0], 2, 1, 1, "Museum2_jugs" );
    sub_8480( l_U686[0], 0 );
    SET_CHAR_SPHERE_DEFENSIVE_AREA( l_U686[0], -91.88681000, 871.38590000, 24.93230000, 3.00000000 );
...
void sub_20082()
{
    if ((l_U591 == 0) AND (NOT (IS_CHAR_INJURED( l_U661[2] ))))
    {
    ...
    if ((l_U594 == 0) AND (NOT (IS_CHAR_INJURED( l_U686[2] ))))
    {
...
void sub_20323()
{
    if (NOT (IS_CHAR_INJURED( l_U660 )))
    {
        if ((NOT (sub_20403( l_U826 ))) AND ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U824, l_U660, 8.00000000, 8.00000000, 2.00000000, 0 )) AND (TIMERB() > l_U492)))
        {
...
void sub_21590()
{
    if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U824, 65429, 821, 20, 25.00000000, 75.00000000, 35.00000000, 0 ))) AND (l_U577 == 1))
    {
        STOP_SOUND( l_U495 );
        RELEASE_SOUND_ID( l_U495 );
        l_U577 = 0;
    }
    else if ((LOCATE_CHAR_ANY_MEANS_3D( l_U824, 65429, 821, 20, 25.00000000, 75.00000000, 35.00000000, 0 )) AND (l_U577 == 0))
    {
        l_U495 = GET_SOUND_ID();
        PLAY_SOUND_FROM_POSITION( l_U495, "RB4_MUSEUM_PIECE_ALARM", 65429, 821, 20 );
        l_U577 = 1;
    ...
    if (l_U577 == 1)
    {
        if (NOT (HAS_SOUND_FINISHED( l_U495 )))
        {
            ...
            if ((l_U576 == 0) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U824, -101.34560000, 857.80050000, 16.31420000, 1.50000000, 1.50000000, 2.00000000, 0 )))
            {
                SET_VARIABLE_ON_SOUND( l_U495, "Control", 0.30000000 );
                l_U576 = 1;
            }
            else if ((l_U576 == 1) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U824, -101.51580000, 854.89260000, 17.62630000, 1.50000000, 1.50000000, 2.00000000, 0 )))
            {
                SET_VARIABLE_ON_SOUND( l_U495, "Control", 1.00000000 );
                l_U576 = 1;
            }
            else if ((l_U576 == 0) AND (l_U493 == 2004012895))
            {
                SET_VARIABLE_ON_SOUND( l_U495, "Control", 1.00000000 );
            }
...
void sub_22285()
{
    if ((l_U559 == 0) AND ((IS_CHAR_FATALLY_INJURED( l_U658 )) || (IS_CHAR_DEAD( l_U658 ))))
    {
    ...
    if ((l_U559 == 0) AND (NOT (IS_CHAR_DEAD( l_U658 ))))
    {
...
void sub_22596()
{
    if ((IS_CHAR_FATALLY_INJURED( l_U660 )) || (IS_CHAR_DEAD( l_U660 )))
    {
...
void sub_23441()
{
    ...
    if (l_U562 == 0)
    {
        ...
        if ((l_U563 == 0) AND ((l_U496._fU8 < 20.00000000) AND (l_U496._fU4 < 832.00000000)))
        {
            if (NOT (IS_CHAR_INJURED( l_U694[7] )))
            {
                ...
                FIRE_SINGLE_BULLET( -116.90000000, 803.80000000, 27.00000000, -109.69000000, 816.22990000, 22.91000000, 50 );
                ...
                FIRE_SINGLE_BULLET( -112.90000000, 805.80000000, 25.00000000, -109.69000000, 816.22990000, 22.91000000, 50 );
                ...
                FIRE_SINGLE_BULLET( -119.90000000, 807.80000000, 29.00000000, -109.69000000, 816.22990000, 22.91000000, 50 );
        ...
        if ((l_U564 == 0) AND ((l_U496._fU8 < 20.00000000) AND (l_U496._fU4 < 820.00000000)))
        {
...
void sub_23462()
{
    ...
    CREATE_CHAR( 8, l_U739, -96.97180000, 805.74470000, 18.62470000 - 1.00000000, ref l_U694[5], 1 );
    ...
    CREATE_CHAR( 8, l_U740, -97.20150000, 806.26640000, 17.62490000, ref l_U694[12], 1 );
...
void sub_27885()
{
    if ((l_U595 == 0) AND (NOT (IS_CHAR_INJURED( l_U686[3] ))))
    {
    ...
    if ((l_U596 == 0) AND (NOT (IS_CHAR_INJURED( l_U694[7] ))))
    {
...
void sub_28716()
{
    ...
    sub_22285();
    sub_22596();
    if ((l_U548 == 0) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U824, -111.89320000, 767.98640000, 15.99850000, 2.00000000, 2.00000000, 2.00000000, 0 )))
    {
        sub_29642();
        l_U548 = 1;
    }
    GET_KEY_FOR_CHAR_IN_ROOM( l_U824, ref l_U493 );
    if ((l_U493 == 0) || (LOCATE_CHAR_ANY_MEANS_3D( l_U824, -106.36830000 - 0.20000000, 762.87490000, 14.50000000, 1.60000000 + 1.00000000, 1.60000000, 1.60000000, 0 )))
    {
        if (DOES_BLIP_EXIST( l_U603 ))
        {
            REMOVE_BLIP( l_U603 );
...
void sub_29642()
{
    ...
    CREATE_CHAR( 8, l_U741, -81.43039000, 784.32690000 + 1.00000000, 14.21130000 - 1.00000000, ref l_U717[4], 1 );
...
void sub_30613()
{
    ...
    if (l_U555 == 0)
    {
        ...
        if ((NOT (IS_CAR_DEAD( l_U760 ))) AND (l_U598 == 1))
        {
            MARK_CAR_AS_NO_LONGER_NEEDED( ref l_U760 );
            l_U598 = 0;
        }
    ...
    if (TIMERB() > 120000)
    {
        if ((NOT (IS_WANTED_LEVEL_GREATER( l_U825, 2 ))) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U824, -106.76030000, 762.18690000, 14.29030000, 75, 75, 100, 0 )))
        {
            ALTER_WANTED_LEVEL( l_U825, 3 );
            APPLY_WANTED_LEVEL_CHANGE_NOW( l_U825 );
        }
        else if ((NOT (IS_WANTED_LEVEL_GREATER( l_U825, 1 ))) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U824, -106.76030000, 762.18690000, 14.29030000, 150, 150, 100, 0 )))
        {
    ...
    {
        if ((NOT (IS_WANTED_LEVEL_GREATER( l_U825, 1 ))) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U824, -106.76030000, 762.18690000, 14.29030000, 75, 75, 100, 0 )))
        {
            ALTER_WANTED_LEVEL( l_U825, 2 );
            APPLY_WANTED_LEVEL_CHANGE_NOW( l_U825 );
        }
        else if ((NOT (IS_WANTED_LEVEL_GREATER( l_U825, 0 ))) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U824, -106.76030000, 762.18690000, 14.29030000, 150, 150, 100, 0 )))
        {
            ALTER_WANTED_LEVEL( l_U825, 1 );
            APPLY_WANTED_LEVEL_CHANGE_NOW( l_U825 );
        }
    }
    if ((l_U785 == 1) AND ((l_U566 == 1) AND (IS_WANTED_LEVEL_GREATER( l_U825, 0 ))))
    {
        if (DOES_BLIP_EXIST( l_U604 ))
        {
            REMOVE_BLIP( l_U604 );
    ...
    if ((l_U785 == 1) AND ((l_U566 == 0) AND (NOT (IS_WANTED_LEVEL_GREATER( l_U825, 0 )))))
    {
        l_U566 = 1;
    }
    if (l_U549 == 0)
    {
        if ((IS_CHAR_IN_ANY_CAR( l_U824 )) || (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U824, -106.36860000, 763.03520000, 15.29020000, 22.00000000, 22.00000000, 22.00000000, 0 ))))
        {
            sub_31659();
    ...
    if (l_U557 == 0)
    {
        ...
        if (l_U493 == 0)
        {
            if ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U749[4], l_U824 )) || ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U749[3], l_U824 )) || (((NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U824, -106.36860000, 763.03520000, 15.29020000, 40.00000000, 40.00000000, 40.00000000, 0 ))) AND (IS_CHAR_IN_ANY_CAR( l_U824 ))) || (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U824, -106.36860000, 763.03520000, 15.29020000, 50.00000000, 50.00000000, 50.00000000, 0 ))))))
            {
                sub_34483();
                sub_35002();
                l_U557 = 1;
    ...
    {
        if ((l_U578[l_U786] == 0) AND (IS_CHAR_INJURED( l_U723[l_U786] )))
        {
            if ((NOT (IS_CAR_DEAD( l_U749[l_U786] ))) AND (NOT (IS_CHAR_INJURED( l_U717[l_U786] ))))
            {
        ...
        if ((l_U584[l_U786] == 0) AND (IS_CHAR_INJURED( l_U717[l_U786] )))
        {
            if ((NOT (IS_CAR_DEAD( l_U749[l_U786] ))) AND (NOT (IS_CHAR_INJURED( l_U723[l_U786] ))))
            {
    ...
    if (l_U785 == 0)
    {
        ...
        if ((l_U784 == 1) AND ((l_U783 == 1) AND (l_U782 == 1)))
        {
            l_U785 = 1;
        }
        else
        ...
        if ((IS_WANTED_LEVEL_GREATER( l_U825, 0 )) AND (l_U785 == 1))
        {
            PRINT_NOW( "RB4_COMMAND_07", 7500, 1 );
            l_U566 = 0;
        }
    }
    if ((l_U566 == 1) AND ((l_U785 == 1) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U824, -106.76030000, 762.18690000, 14.29030000, 150, 150, 100, 0 ))))
    {
        if (l_U575 == 0)
        {
    ...
    if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U824, -106.76030000, 762.18690000, 14.29030000, 150, 150, 100, 0 ))) AND ((l_U566 == 1) AND (l_U785 == 1)))
    {
        l_U489++;
    }
    return;
...
void sub_31659()
{
    ...
    if ((l_U556 == 0) AND (NOT (IS_CAR_DEAD( l_U749[0] ))))
    {
        if ((LOCATE_CAR_3D( l_U749[0], -106.36860000, 763.03520000, 15.29020000, 20.00000000, 20.00000000, 20.00000000, 0 )) AND (NOT (IS_CHAR_IN_CAR( l_U824, l_U749[0] ))))
        {
    ...
    if ((l_U556 == 0) AND (NOT (IS_CAR_DEAD( l_U749[1] ))))
    {
        if ((LOCATE_CAR_3D( l_U749[1], -106.36860000, 763.03520000, 15.29020000, 20.00000000, 20.00000000, 20.00000000, 0 )) AND (NOT (IS_CHAR_IN_CAR( l_U824, l_U749[1] ))))
        {
    ...
    if ((l_U556 == 0) AND (NOT (IS_CAR_DEAD( l_U749[2] ))))
    {
        if ((LOCATE_CAR_3D( l_U749[2], -106.36860000, 763.03520000, 15.29020000, 20.00000000, 20.00000000, 20.00000000, 0 )) AND (NOT (IS_CHAR_IN_CAR( l_U824, l_U749[2] ))))
        {
...
void sub_35002()
{
    ...
    if ((NOT (IS_CHAR_INJURED( l_U730[0] ))) AND (NOT (IS_CAR_DEAD( l_U755[0] ))))
    {
...
void sub_35421()
{
    GET_CURRENT_POLICE_CAR_MODEL( ref l_U810 );
    GET_CURRENT_COP_MODEL( ref l_U743 );
    if ((HAS_MODEL_LOADED( l_U743 )) AND (HAS_MODEL_LOADED( l_U810 )))
    {
        ...
        if ((NOT (IS_CHAR_INJURED( l_U730[1] ))) AND (NOT (IS_CAR_DEAD( l_U755[1] ))))
        {
    ...
    if ((HAS_MODEL_LOADED( l_U743 )) AND (HAS_MODEL_LOADED( l_U810 )))
    {
        ...
        if ((NOT (IS_CHAR_INJURED( l_U730[2] ))) AND (NOT (IS_CAR_DEAD( l_U755[2] ))))
        {
