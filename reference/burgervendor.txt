...
void sub_2664(unknown uParam0)
{
    ...
    {
        if ((sub_4405( l_U19 )) || ((IS_PLAYER_TARGETTING_CHAR( sub_509(), l_U68 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U68, sub_637(), 0 ))))
        {
            if (NOT (IS_CHAR_INJURED( l_U67 )))
            {
                CLEAR_CHAR_TASKS( l_U67 );
            ...
            if (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_509() ))
            {
                ...
                if (l_U71 == nil)
                {
                    if (HAVE_ANIMS_LOADED( "amb@burgercart" ))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U67 )))
                        {
                            if ((NOT (IS_CHAR_IN_ANY_CAR( sub_637() ))) AND (l_U11 != 1))
                            {
...
int sub_5917(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_509() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_509() )))
            {
                if (((g_U9202) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_509() )))))
                {
                    if (NOT sub_3456())
                    {
...
void sub_8740()
{
    ...
    if (NOT (IS_CHAR_INJURED( l_U67 )))
    {
        switch (l_U12)
        {
            ...
            if ((l_U55 == 0) AND (l_U38 > 0.02410000))
            {
                if (DOES_OBJECT_EXIST( l_U69 ))
                {
            ...
            if ((l_U53 == 0) AND (l_U38 > 0.64400000))
            {
                if (DOES_OBJECT_EXIST( l_U69 ))
                {
                    if (IS_OBJECT_ATTACHED( l_U69 ))
            ...
            if ((l_U54 == 0) AND (l_U50 > 0.93500000))
            {
                if (NOT (IS_CHAR_INJURED( l_U68 )))
                {
...
void sub_11017()
{
    if (NOT (IS_CHAR_INJURED( l_U67 )))
    {
        switch (l_U12)
        {
            ...
            if ((l_U55 == 0) AND (l_U38 > 0.28400000))
            {
            ...
            BLOCK_CHAR_GESTURE_ANIMS( sub_637(), 1 );
            if ((NOT (IS_CHAR_PLAYING_ANIM( sub_637(), "amb@burgercart", "EAT_BURGER_PLYR" ))) || (l_U38 > 0.80000000))
            {
                if (DOES_OBJECT_EXIST( l_U70 ))
                {
                    if (IS_OBJECT_ATTACHED( l_U70 ))
...
int sub_11142()
{
    if ((sub_11190()) || ((IS_BUTTON_PRESSED( 0, 16 )) || ((IS_BUTTON_PRESSED( 0, 15 )) || ((IS_BUTTON_PRESSED( 0, 14 )) || (IS_BUTTON_PRESSED( 0, 17 ))))))
    {
        CLEAR_CHAR_TASKS_IMMEDIATELY( sub_637() );
        SET_PLAYER_CONTROL( sub_509(), 1 );
        return 1;
