...
void sub_1295()
{
    ...
    if ((NOT (HAS_MODEL_LOADED( l_U115 ))) || (NOT (HAVE_ANIMS_LOADED( l_U139 ))))
    {
        ;
    }
    else
...
void sub_1415()
{
    ...
    {
        case 0:
        if ((NOT (IS_WANTED_LEVEL_GREATER( sub_594(), 0 ))) AND (IS_SCORE_GREATER( sub_594(), 9 )))
        {
            l_U103 = 1;
        }
        else
        ...
        if (NOT g_U8670)
        {
            if ((NOT (IS_WANTED_LEVEL_GREATER( sub_594(), 0 ))) AND (LOCATE_CHAR_ON_FOOT_CHAR_3D( l_U111, sub_1120(), 10.00000000, 10.00000000, 2.00000000, 0 )))
            {
                sub_1719();
            }
        }
...
void sub_1437()
{
    if ((IS_PED_IN_COMBAT( sub_1120() )) || (IS_PED_IN_COMBAT( l_U111 )))
    {
        sub_324( 2, ref l_U140 );
        l_U103 = 9;
    }
...
int sub_2485(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_594() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_594() )))
            {
                if (((g_U9202) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_594() )))))
                {
                    if (NOT sub_2581())
                    {
