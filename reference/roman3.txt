...
void sub_1553()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_1591( 5, g_U569[I] )) == 1))
        {
...
void sub_2696()
{
    ...
    {
        iVar3 = sub_2724( 13 );
        if ((g_U9932[g_U9999[I]._fU0]._fU0) AND (sub_2769( 13, iVar3 )))
        {
    ...
    {
        iVar3 = sub_2724( 11 );
        if ((g_U9932[g_U10090[I]._fU0]._fU0) AND (sub_2769( 11, iVar3 )))
        {
    ...
    {
        iVar3 = sub_3248( I );
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_2769( g_U10324[I]._fU12, iVar3 )))
        {
...
void sub_3785()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_3248( I )))
        {
            iVar4++;
        }
    }
...
void sub_6536()
{
    ...
    while ((NOT (HAS_MODEL_LOADED( l_U557 ))) || ((NOT (HAS_MODEL_LOADED( l_U555 ))) || (NOT (HAS_MODEL_LOADED( l_U554 )))))
    {
        WAIT( 0 );
    }
    ...
    LOAD_ALL_OBJECTS_NOW();
    while ((NOT (HAVE_ANIMS_LOADED( "MISSPASS" ))) || (NOT (HAVE_ANIMS_LOADED( "missroman3" ))))
    {
        WAIT( 0 );
    }
...
void sub_7278()
{
            ...
            if (NOT (CHECK_STUCK_TIMER( l_U524, 1, 40000 )))
            {
                if (NOT (CHECK_STUCK_TIMER( l_U524, 0, 5000 )))
                {
                    if (IS_CHAR_SITTING_IN_CAR( sub_4239(), l_U524 ))
                    {
                        ...
                        {
                            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_4239(), l_U535._fU0, l_U535._fU4, 15.63200000, 4.00000000, 4.00000000, 2.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_4239(), l_U535._fU0, l_U535._fU4, 15.63200000, 2.50000000, 2.50000000, 2.00000000, 1 )))
                            {
                                if (NOT l_U521)
                                {
                                ...
                                else
                                {
                                    ...
                                    if ((NOT (IS_PLAYER_PRESSING_HORN( sub_7098() ))) || (l_U558 >= 3000))
                                    {
                                        CLEAR_HELP();
    ...
    else if (IS_PLAYER_PLAYING( sub_7098() ))
    {
        ...
        else if ((NOT (IS_CHAR_INJURED( l_U523 ))) AND (NOT (IS_CHAR_DEAD( l_U523 ))))
        {
            CLEAR_PRINTS();
            l_U499 = 3;
            sub_9209();
...
void sub_7699()
{
    ...
    if ((IS_CHAR_ON_ANY_BIKE( sub_4239() )) || (IS_CHAR_IN_ANY_CAR( sub_4239() )))
    {
        SET_PLAYER_CONTROL( sub_7098(), 0 );
...
void sub_9209()
{
    ...
    TASK_CLEAR_LOOK_AT( sub_4239() );
    l_U497 = 7;
    if ((l_U499 == 7) || ((l_U499 == 6) || ((l_U499 == 4) || (l_U499 == 3))))
    {
        l_U498 = 0;
        l_U506 = 1;
    }
    else if ((l_U499 == 1) || (l_U499 == 0))
    {
        if ((l_U499 == 1) || ((DOES_CHAR_EXIST( l_U522 )) || (DOES_CHAR_EXIST( l_U523 ))))
        {
            if (l_U507)
            {
                l_U498 = 0;
...
void sub_15157()
{
    ...
    switch (l_U498)
    {
        ...
        if (sub_15417( 1, 1 ))
        {
            ...
            if (NOT (IS_CAR_DEAD( l_U524 )))
            {
                SET_CAR_COORDINATES( l_U524, 994.37450000, l_U535._fU4, l_U535._fU8 );
                GET_CAR_HEADING( l_U524, ref fVar11 );
                if ((fVar11 > 270.00000000) || (fVar11 < 90.00000000))
                {
                ...
                else
                {
                    ...
                    SET_CAM_POS( l_U571, 992.37780000, -545.87640000, 14.81762000 );
        ...
        if (sub_17216())
        {
            ...
            if (NOT (IS_CAR_DEAD( l_U524 )))
            {
                if ((LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U523, l_U524, 2.00000000, 2.00000000, 2.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U522, l_U524, 2.00000000, 2.00000000, 2.00000000, 0 )))
                {
                    GET_CAR_HEADING( l_U524, ref fVar11 );
                    if ((fVar11 > 270.00000000) || (fVar11 < 90.00000000))
                    {
                    ...
                    {
                        SET_CAM_POS( l_U571, 996.21620000, -547.08670000, 14.70370000 );
...
int sub_17216()
{
    ...
    if ((NOT (IS_CHAR_INJURED( l_U522 ))) AND (NOT (IS_CHAR_DEAD( l_U522 ))))
    {
        if ((NOT (IS_CHAR_INJURED( l_U523 ))) AND (NOT (IS_CHAR_DEAD( l_U523 ))))
        {
            if (IS_VEH_DRIVEABLE( l_U524 ))
            {
                if (sub_10296( l_U524 ))
...
void sub_21067()
{
    ...
    if (sub_17216())
    {
        if (IS_CHAR_SITTING_IN_CAR( sub_4239(), l_U524 ))
        {
            ...
            if ((NOT l_U504) AND (NOT l_U503))
            {
                if (NOT l_U505)
                {
                    if ((IS_CHAR_IN_CAR( l_U522, l_U524 )) AND (IS_CHAR_IN_CAR( l_U523, l_U524 )))
                    {
                        ADD_BLIP_FOR_COORD( l_U532._fU0, l_U532._fU4, l_U532._fU8, ref l_U529 );
                        SET_ROUTE( l_U529, 1 );
                        l_U505 = 1;
...
void sub_23665()
{
    ...
    switch (l_U498)
    {
        ...
        if (NOT (IS_CAR_DEAD( l_U524 )))
        {
            ...
            if ((fVar5 > 247.00000000) || (fVar5 < 67.00000000))
            {
        ...
        else if ((fVar5 > 247.00000000) || (fVar5 < 67.00000000))
        {
        ...
        if ((NOT (IS_CHAR_INJURED( l_U523 ))) AND (NOT (IS_CHAR_INJURED( l_U522 ))))
        {
            ...
            {
                GET_SCRIPT_TASK_STATUS( l_U523, 29, ref l_U564 );
                if ((NOT (sub_9627( l_U565 ))) AND (l_U564 == 7))
                {
                    CLEAR_CHAR_TASKS( l_U522 );
                    OPEN_SEQUENCE_TASK( ref l_U563 );
                ...
                else if (NOT (IS_CHAR_IN_ANY_CAR( l_U523 )))
                {
                    ...
                    if ((fVar5 > 247.00000000) || (fVar5 < 67.00000000))
                    {
                        ...
                        SET_CAM_FOV( l_U571, 23.40006000 );
                    }
                }
            }
            else if (NOT (IS_CHAR_IN_ANY_CAR( l_U523 )))
...
int sub_27617(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_4239() ))) AND (IS_CHAR_IN_ANY_CAR( sub_4239() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_28132()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_44750()
{
    ...
    switch (l_U498)
    {
        ...
        if (NOT IS_MESSAGE_BEING_DISPLAYED())
        {
            if ((IS_SCREEN_FADED_IN()) AND (sub_15417( 1, 1 )))
            {
                if (l_U499 == 3)
                {
                    if (NOT (IS_CHAR_INJURED( l_U523 )))
                ...
                else if ((l_U499 == 1) || ((NOT (IS_CHAR_INJURED( l_U523 ))) || (NOT (IS_CHAR_INJURED( l_U522 )))))
                {
                    if (NOT (l_U499 == 1))
                    {
        ...
        if (NOT IS_SCREEN_FADING())
        {
            ...
            SET_CAM_PROPAGATE( l_U571, 1 );
            ACTIVATE_SCRIPTED_CAMS( 1, 1 );
            if ((IS_CHAR_DEAD( l_U523 )) || (IS_CHAR_INJURED( l_U523 )))
            {
                DELETE_CHAR( ref l_U523 );
            }
            if ((IS_CHAR_DEAD( l_U522 )) || (IS_CHAR_INJURED( l_U522 )))
            {
                DELETE_CHAR( ref l_U522 );
            }
            if (l_U499 == 3)
            ...
            else if ((NOT (l_U499 == 1)) AND (NOT (l_U499 == 0)))
            {
            ...
            SET_CAM_ROT( l_U571, -1.09301600, 0.00000000, 43.38658000 );
        ...
        if (l_U499 == 3)
        {
            if (NOT (IS_CHAR_INJURED( l_U523 )))
            {
                if ((NOT (IS_CHAR_ON_SCREEN( l_U523 ))) || (l_U558 > 6000))
                {
                    sub_45002();
                    l_U498 = 9;
                }
        ...
        else if (l_U499 == 4)
        {
            if (NOT (IS_CHAR_INJURED( l_U522 )))
            {
                if ((NOT (IS_CHAR_ON_SCREEN( l_U522 ))) || (l_U558 > 6000))
                {
                    sub_45002();
                    l_U498 = 9;
                }
...
void sub_45929(unknown uParam0, unknown uParam1, int iParam2)
{
    ...
    bVar5 = false;
    if ((NOT (IS_VEH_DRIVEABLE( l_U524 ))) || (l_U499 == 0))
    {
        MARK_CAR_AS_NO_LONGER_NEEDED( ref l_U524 );
        if (IS_CHAR_IN_ANY_CAR( sub_4239() ))
        {
    ...
    if (bVar5)
    {
        ...
        CREATE_CAR( l_U556, 829.04100000, -304.01900000, 14.82140000, ref l_U524, 1 );
        ADD_CAR_TO_MISSION_DELETION_LIST( l_U524 );
        SET_CAR_HEADING( l_U524, 180.00000000 );
    ...
    {
        CLEAR_AREA_OF_CARS( 829.04100000, -304.01900000, 15.56650000, 20.00000000 );
        SET_CAR_COORDINATES( l_U524, 829.04100000, -304.01900000, 14.82140000 );
        SET_CAR_HEADING( l_U524, 180.00000000 );
        SET_CAR_ON_GROUND_PROPERLY( l_U524 );
        CLOSE_ALL_CAR_DOORS( l_U524 );
    }
    LOAD_SCENE( 829.04100000, -304.01900000, 15.56650000 );
    return;
}
