...
{
    if ((HAS_MODEL_LOADED( l_U73 )) AND (HAS_MODEL_LOADED( l_U74 )))
    {
        if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_659(), l_U13._fU0, l_U13._fU4, l_U13._fU8, 50.00000000, 50.00000000, 50.00000000, 0 ))) || (NOT (IS_OBJECT_ON_SCREEN( uParam0 ))))
        {
...
void sub_3083(unknown uParam0)
{
    ...
    {
        if ((sub_4469( l_U19 )) || ((IS_PLAYER_TARGETTING_CHAR( sub_531(), l_U77 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U77, sub_659(), 0 ))))
        {
            if (NOT (IS_CHAR_INJURED( l_U76 )))
            {
                CLEAR_CHAR_TASKS( l_U76 );
    ...
    if (l_U11 == 6)
    {
        if ((l_U12 == 23) || ((l_U12 == 22) || ((l_U12 == 21) || (l_U12 == 19))))
        {
            if (sub_4862())
            {
                if (DOES_OBJECT_EXIST( l_U79 ))
                ...
                if (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_531() ))
                {
                    ...
                    if (l_U80 == nil)
                    {
                        if (DOES_OBJECT_EXIST( uParam0 ))
                        {
                            ...
                            {
                                if ((NOT (IS_CHAR_IN_ANY_CAR( sub_659() ))) AND (l_U11 != 1))
                                {
...
int sub_6887(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_531() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_531() )))
            {
                if (((g_U9202) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_531() )))))
                {
                    if (NOT sub_3783())
                    {
...
void sub_9869()
{
    ...
    if (NOT (IS_CHAR_INJURED( l_U76 )))
    {
        switch (l_U12)
        {
            ...
            if ((l_U61 == 0) AND (l_U38 > 0.15800000))
            {
                if (DOES_OBJECT_EXIST( l_U78 ))
                {
            ...
            if ((l_U62 == 0) AND (l_U38 > 0.72000000))
            {
                if (DOES_OBJECT_EXIST( l_U78 ))
                {
                    if (IS_OBJECT_ATTACHED( l_U78 ))
...
void sub_12222()
{
    if (NOT (IS_CHAR_INJURED( l_U76 )))
    {
        ...
        switch (l_U12)
        {
            ...
            if ((l_U61 == 0) AND (l_U38 > 0.19400000))
            {
                if (DOES_OBJECT_EXIST( l_U78 ))
                {
                    if (NOT (IS_OBJECT_ATTACHED( l_U78 )))
            ...
            if ((l_U62 == 0) AND (l_U38 > 0.64500000))
            {
                if (DOES_OBJECT_EXIST( l_U78 ))
                {
                    if (IS_OBJECT_ATTACHED( l_U78 ))
            ...
            if ((NOT (IS_CHAR_PLAYING_ANIM( sub_659(), "amb@hotdogcart", "EAT_HOTDOG_PLYR" ))) || (l_U38 > 0.99000000))
            {
                if (DOES_OBJECT_EXIST( l_U79 ))
                {
                    if (IS_OBJECT_ATTACHED( l_U79 ))
...
int sub_12433()
{
    if ((sub_12481()) || ((IS_BUTTON_PRESSED( 0, 16 )) || ((IS_BUTTON_PRESSED( 0, 15 )) || ((IS_BUTTON_PRESSED( 0, 14 )) || (IS_BUTTON_PRESSED( 0, 17 ))))))
    {
        CLEAR_CHAR_TASKS_IMMEDIATELY( sub_659() );
        SET_PLAYER_CONTROL( sub_531(), 1 );
        return 1;
