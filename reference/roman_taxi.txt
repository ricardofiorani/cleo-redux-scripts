void main()
{
    ...
    while (true)
    {
        ...
        switch (l_U1)
        {
            ...
            while ((NOT (HAS_MODEL_LOADED( 1552970117 ))) || (NOT (HAS_MODEL_LOADED( l_U13 ))))
            {
                WAIT( 0 );
            }
            l_U2 = 25;
            ...
            if (sub_78())
            {
                if ((NOT ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "taxi" )) == 0)) || (TIMERA() > 30000))
                {
                    sub_29();
                }
            }
            ...
            if (IS_VEH_DRIVEABLE( g_U2239 ))
            {
                if (IS_PLAYER_PLAYING( sub_383() ))
                {
                    if ((NOT (sub_5009( g_U2239 ))) AND ((NOT (sub_4806( g_U2239 ))) AND ((NOT (sub_4561( sub_426() ))) AND (NOT (IS_CHAR_IN_CAR( sub_426(), g_U2239 ))))))
                    {
...
void sub_29()
{
    ...
    if ((DOES_VEHICLE_EXIST( g_U2239 )) AND (DOES_CHAR_EXIST( l_U3 )))
    {
        if (NOT (IS_CHAR_DEAD( l_U3 )))
        {
            if (IS_VEH_DRIVEABLE( g_U2239 ))
...
int sub_78()
{
    if ((l_U3 == g_U2234) AND (g_U2239 == g_U2238))
    {
        return 1;
        break;
    }
...
void sub_717()
{
    ...
    if (IS_PLAYER_PLAYING( sub_383() ))
    {
        if ((ARE_WIDESCREEN_BORDERS_ACTIVE()) AND (NOT (IS_PLAYER_CONTROL_ON( sub_383() ))))
        {
            if (NOT l_U14)
            {
                if (IS_VEH_DRIVEABLE( g_U2239 ))
            ...
            if (IS_PLAYER_PLAYING( sub_383() ))
            {
                if (NOT l_U15)
                {
                    ...
                    else
                    {
                        ...
                        else if ((LOCATE_CAR_2D( g_U2239, uVar2._fU0, uVar2._fU4, 15.00000000, 15.00000000, 0 )) || (LOCATE_CAR_2D( g_U2239, l_U7._fU0, l_U7._fU4, 20.00000000, 20.00000000, 0 )))
                        {
                            CLEAR_CHAR_TASKS( l_U3 );
                            return 1;
                        }
                ...
                else
                {
                    ...
                    {
                        GET_CHAR_COORDINATES( sub_426(), ref uVar2._fU0, ref uVar2._fU4, ref uVar2._fU8 );
                        if ((LOCATE_CAR_2D( g_U2239, uVar2._fU0, uVar2._fU4, 20.00000000, 20.00000000, 0 )) || (LOCATE_CAR_2D( g_U2239, l_U4._fU0, l_U4._fU4, 20.00000000, 20.00000000, 0 )))
                        {
                            CLEAR_CHAR_TASKS( l_U3 );
                            return 1;
                        }
