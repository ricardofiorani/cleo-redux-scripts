...
void sub_4822()
{
    ...
    while ((NOT (HAS_MODEL_LOADED( 1159759556 ))) || ((NOT (HAS_MODEL_LOADED( 800869680 ))) || (NOT (HAVE_ANIMS_LOADED( "MISSVLAD3" )))))
    {
        WAIT( 0 );
    }
...
void sub_5495()
{
    ...
    switch (l_U561)
    {
        ...
        if (l_U582)
        {
            if (NOT (IS_CAR_DEAD( l_U641 )))
            {
                if (NOT l_U583)
                {
                    ...
                    if ((l_U564 == 0) AND (IS_CAR_STOPPED( l_U641 )))
                    {
        ...
        switch (l_U565)
        {
            ...
            {
                if ((IS_CHAR_ON_FOOT( sub_4041() )) AND (IS_CHAR_IN_AREA_3D( sub_4041(), 1076.41400000, -567.56020000, 22.00000000, 1037.90000000, -560.86000000, 26.68000000, 0 )))
                {
                    if (NOT l_U584)
                    {
...
void sub_5555()
{
    ...
    if ((IS_SCREEN_FADED_OUT()) AND (sub_5704( sub_4041() )))
    {
        LOAD_ALL_OBJECTS_NOW();
    }
    while ((NOT (HAVE_ANIMS_LOADED( "melee_unarmed_base" ))) || ((NOT (HAVE_ANIMS_LOADED( "melee_player_unarmed" ))) || ((NOT (HAS_MODEL_LOADED( 1223224881 ))) || ((NOT (HAS_MODEL_LOADED( -1552214124 ))) || (NOT (HAS_MODEL_LOADED( -344943009 )))))))
    {
        WAIT( 0 );
    }
    ...
    CREATE_CHAR( 26, 1223224881, 1197.39100000, 820.21620000, 35.12050000, ref l_U643[1], 1 );
    ...
    if (l_U588)
    {
        ...
        if (NOT (IS_CAR_DEAD( l_U641 )))
        {
            SET_MISSION_TRAIN_COORDINATES( l_U641, 1259.88300000, 757.39320000, 48.69820000 );
            SET_TRAIN_IS_STOPPED_AT_STATION( l_U641 );
            SET_TRAIN_SPEED( l_U641, 0.00000000 );
            SET_TRAIN_CRUISE_SPEED( l_U641, 0.00000000 );
        }
    ...
    if (IS_PLAYER_PLAYING( sub_4719() ))
    {
        if (NOT (IS_CAR_DEAD( l_U640 )))
        {
            ...
            if (NOT l_U576)
            {
                ...
                {
                    if ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U640, sub_4041() )) || (NOT (LOCATE_CAR_3D( l_U640, l_U597._fU0, l_U597._fU4, l_U597._fU8, 0.50000000, 0.50000000, 2.00000000, 0 ))))
                    {
                        sub_25027();
                    }
                }
                if (NOT (IS_CHAR_INJURED( l_U643[0] )))
                {
                    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U643[0], sub_4041(), 0 )) || (sub_10026( ref l_U643[0] )))
                    {
                        sub_25027();
                    }
                    if (l_U559 > 2)
                ...
                if (NOT (IS_CHAR_INJURED( l_U643[1] )))
                {
                    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U643[1], sub_4041(), 0 )) || (sub_10026( ref l_U643[1] )))
                    {
                        sub_25027();
                    }
                }
...
void sub_9478(unknown uParam0)
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_4041() ))) AND (NOT (IS_CHAR_INJURED( (uParam0^) ))))
    {
...
int sub_10026(unknown uParam0)
{
    ...
    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
    {
        if (GET_CHAR_READY_TO_BE_STUNNED( (uParam0^) ))
        {
            ...
            {
                if ((NOT (IS_CHAR_PLAYING_ANIM( sub_4041(), "melee_unarmed_base", "stun_punch" ))) AND (IS_PED_IN_COMBAT( (uParam0^) )))
                {
                    bVar3 = true;
                }
                if ((NOT (IS_CHAR_PLAYING_ANIM( sub_4041(), "melee_unarmed_base", "stun_punch" ))) AND (IS_CHAR_IN_MELEE_COMBAT( (uParam0^) )))
                {
                    bVar3 = true;
                }
            }
            if ((IS_CHAR_ARMED( (uParam0^), 4 )) AND (IS_PLAYER_TARGETTING_CHAR( sub_4719(), (uParam0^) )))
            {
                bVar3 = true;
            }
            if ((IS_CHAR_ARMED( (uParam0^), 4 )) AND (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_4719(), (uParam0^) )))
            {
                bVar3 = true;
            }
...
void sub_10436(unknown uParam0)
{
        ...
        if (NOT (IS_CHAR_INJURED( uParam0 )))
        {
            if ((g_U9180) || (NOT IS_MINIGAME_IN_PROGRESS()))
            {
                ...
                if (l_U499)
                {
                    ...
                    {
                        if ((NOT (IS_CHAR_PLAYING_ANIM( uParam0, l_U524, l_U527 ))) AND ((NOT (IS_CHAR_PLAYING_ANIM( uParam0, l_U524, l_U526 ))) AND (NOT (IS_CHAR_PLAYING_ANIM( uParam0, l_U524, l_U525 )))))
                        {
                            sub_20532( uParam0, 0 );
                            l_U499 = 0;
                        }
                ...
                switch (l_U512)
                {
                    ...
                    if (sub_20652( uParam0 ))
                    {
                        ...
                        if (DOES_OBJECT_EXIST( l_U521 ))
                        {
                            if (HAVE_ANIMS_LOADED( l_U524 ))
                            {
                                if ((NOT (IS_SCRIPTED_SPEECH_PLAYING( uParam0 ))) AND ((NOT (IS_AMBIENT_SPEECH_PLAYING( uParam0 ))) AND ((NOT (sub_22355( uParam0 ))) AND ((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( uParam0 ))) AND ((NOT (IS_CHAR_GESTURING( uParam0 ))) AND ((NOT (IS_CHAR_PLAYING_ANIM( uParam0, l_U524, l_U525 ))) AND ((NOT (IS_CHAR_DUCKING( uParam0 ))) AND (NOT (IS_PED_RAGDOLL( uParam0 ))))))))))
                                {
                            ...
                            else if ((sub_22861( uParam0 )) || (sub_10799( uParam0 )))
                            {
    ...
    if (NOT (IS_CHAR_INJURED( uParam0 )))
    {
        if (DOES_OBJECT_EXIST( l_U521 ))
        {
            if (HAVE_ANIMS_LOADED( l_U524 ))
            {
                if ((IS_CHAR_PLAYING_ANIM( uParam0, l_U524, l_U527 )) || ((IS_CHAR_PLAYING_ANIM( uParam0, l_U524, l_U526 )) || (IS_CHAR_PLAYING_ANIM( uParam0, l_U524, l_U525 ))))
                {
...
void sub_10560(unknown uParam0)
{
    ...
    if ((IS_PLAYER_PLAYING( sub_4719() )) AND (NOT (IS_CHAR_INJURED( uParam0 ))))
    {
        switch (l_U514)
        {
            case 0:
            ...
            if (DOES_OBJECT_EXIST( l_U521 ))
            {
                if (DOES_VEHICLE_EXIST( l_U555 ))
                {
                    if (NOT (IS_CAR_DEAD( l_U555 )))
                    {
                        ...
                        if ((l_U502) AND (NOT (DOES_OBJECT_EXIST( l_U522 ))))
                        {
            ...
            if (DOES_VEHICLE_EXIST( l_U555 ))
            {
                if (NOT (IS_CAR_DEAD( l_U555 )))
                {
                    ...
                    if ((NOT (sub_10684( l_U516[3] ))) AND ((NOT (sub_10684( l_U516[2] ))) AND ((NOT (sub_10684( l_U516[1] ))) AND (NOT (sub_10684( l_U516[0] ))))))
                    {
                        l_U514 = 0;
                        l_U507 = 0.00000000;
                    }
            ...
            if (DOES_VEHICLE_EXIST( l_U555 ))
            {
                if (NOT (IS_CAR_DEAD( l_U555 )))
                {
                    if (l_U507 > 1000.00000000)
                    {
                        ...
                        else if ((NOT (sub_10684( l_U516[3] ))) AND ((NOT (sub_10684( l_U516[2] ))) AND ((NOT (sub_10684( l_U516[1] ))) AND (NOT (sub_10684( l_U516[0] ))))))
                        {
                            l_U514 = 1;
                        }
                    }
...
int sub_11167(unknown uParam0)
{
    if (DOES_VEHICLE_EXIST( uParam0 ))
    {
        if (NOT (IS_CAR_DEAD( uParam0 )))
        {
            ...
            {
                if ((NOT (sub_11222( uParam0, 3 ))) AND ((NOT (sub_11222( uParam0, 2 ))) AND ((NOT (sub_11222( uParam0, 1 ))) AND (NOT (sub_11222( uParam0, 0 ))))))
                {
                    return 1;
                }
            }
...
void sub_25027()
{
    if (NOT l_U576)
    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U643[0] )))
        {
            ...
            if (IS_VEH_DRIVEABLE( l_U640 ))
            {
                if ((IS_CHAR_GETTING_IN_TO_A_CAR( sub_4041() )) || (IS_CHAR_IN_CAR( sub_4041(), l_U640 )))
                {
...
int sub_26627(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_4041() ))) AND (IS_CHAR_IN_ANY_CAR( sub_4041() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_27142()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
        ...
        if (NOT (IS_CAR_DEAD( l_U640 )))
        {
            switch (l_U568)
            {
                ...
                if (TIMERA() > 2000)
                {
                    ...
                    SET_CAM_POS( l_U650, 969.10010000, -324.00380000, 19.39528000 );
                ...
                break;
                case 4:
                if ((TIMERA() > 10000) || (LOCATE_CHAR_ANY_MEANS_3D( sub_4041(), 965.26400000, -327.79000000, 18.23530000, 4.00000000, 1.00000000, 2.00000000, 0 )))
                {
                    SET_PLAYER_CONTROL( sub_4719(), 1 );
                    REMOVE_BLIP( l_U648 );
                    REMOVE_BLIP( l_U649 );
...
void sub_48522()
{
    if ((NOT l_U573) AND (NOT (IS_CAR_DEAD( l_U640 ))))
    {
        if (NOT l_U569)
        {
            if (NOT (IS_CHAR_INJURED( l_U643[0] )))
