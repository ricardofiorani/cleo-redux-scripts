...
void sub_2579()
{
    switch (l_U106)
    {
        ...
        while ((NOT (HAVE_ANIMS_LOADED( "misssara2" ))) || (NOT (HAS_MODEL_LOADED( l_U184 ))))
        {
            WAIT( 0 );
        }
        l_U106 = 1;
...
void sub_3112()
{
    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U124, sub_2319(), 0 )) || (IS_CHAR_INJURED( l_U124 )))
    {
        if (IS_HINT_RUNNING())
        {
            HINT_CAM( -1.00000000, -1.00000000, -1.00000000, l_U124, 0, 0, 0 );
    ...
    if ((IS_CHAR_ON_FOOT( sub_2319() )) AND (sub_3290() < 25))
    {
    ...
    {
        case 0:
        if ((IS_WANTED_LEVEL_GREATER( sub_1083(), 0 )) || ((IS_CHAR_ON_FIRE( l_U124 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U124, sub_2319(), 0 )) || (IS_CHAR_INJURED( l_U124 )))))
        {
        ...
        if (NOT (IS_CHAR_INJURED( l_U124 )))
        {
            if ((IS_CHAR_ON_FOOT( sub_2319() )) AND (sub_3290() < 18))
            {
                if ((NOT l_U210) AND (NOT IS_HINT_RUNNING()))
                {
...
void sub_7588()
{
    ...
    switch (l_U110)
    {
        ...
        if (DOES_CHAR_EXIST( l_U124 ))
        {
            if (NOT (IS_CHAR_INJURED( l_U124 )))
            {
                if ((NOT (IS_CHAR_ON_SCREEN( l_U124 ))) AND (sub_3290() > 50))
                {
                    DELETE_CHAR( ref l_U124 );
                    l_U110 = 3;
                }
        ...
        {
            if ((IS_CHAR_INJURED( l_U125 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U125, sub_2319(), 0 )))
            {
                if (DOES_BLIP_EXIST( l_U133 ))
                {
                    REMOVE_BLIP( l_U133 );
        ...
        l_U111 = 0;
        if (((sub_10974( ref l_U125 )) < 6.00000000) || ((sub_10821( ref l_U125 )) < 1.50000000))
        {
            if (sub_4410( 1, 1 ))
            {
        ...
        if (NOT l_U114)
        {
            ...
            SET_CAM_ROT( l_U173, -6.98999900, -0.00000000, -36.36000000 );
        ...
        if (NOT (IS_WANTED_LEVEL_GREATER( sub_1083(), 0 )))
        {
            if ((sub_4410( 1, 1 )) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_2319(), 342.05460000, -487.55040000, 3.53970000 + 2.50000000, 2.50000000, 2.50000000, 2.50000000, 1 )))
            {
                ...
                if (IS_CHAR_IN_ANY_CAR( sub_2319() ))
                {
                    if ((NOT (IS_CAR_UPSIDEDOWN( l_U127 ))) AND (IS_VEH_DRIVEABLE( l_U127 )))
                    {
        ...
        if (IS_SCREEN_FADED_OUT())
        {
            ...
            while ((NOT (sub_20776( l_U124 ))) AND (NOT (IS_CHAR_INJURED( l_U124 ))))
            {
                WAIT( 0 );
            }
            if (NOT (IS_CHAR_INJURED( l_U124 )))
        ...
        {
            if ((TIMERB() > 5000) || ((NOT (IS_CHAR_ON_SCREEN( l_U124 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U124, 374.20000000, -489.69000000, 5.51000000, 1.50000000, 1.50000000, 1.50000000, 0 ))))
            {
                l_U110 = 19;
            }
        }
...
{
    if ((IS_CHAR_IN_ANY_CAR( sub_2319() )) AND ((NOT (IS_CHAR_INJURED( sub_2319() ))) AND (NOT (IS_CHAR_INJURED( (uParam0^) )))))
    {
        GET_CHAR_COORDINATES( sub_2319(), ref l_U137._fU0, ref l_U137._fU4, ref l_U137._fU8 );
        GET_CHAR_COORDINATES( (uParam0^), ref l_U143._fU0, ref l_U143._fU4, ref l_U143._fU8 );
        GET_DISTANCE_BETWEEN_COORDS_2D( l_U137._fU0, l_U137._fU4, l_U143._fU0, l_U143._fU4, ref l_U169 );
...
int sub_15073(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_1083() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_1083() )))
            {
                if (((g_U9202) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_1083() )))))
                {
                    if (NOT sub_391())
                    {
