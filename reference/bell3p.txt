    ...
    while (true)
    {
        ...
        switch (iVar31)
        {
            ...
            if (NOT (IS_CHAR_DEAD( sub_1856() )))
            {
                ...
                if ((g_U9893._fU12 == 0) AND ((l_U496 == 0) AND ((NOT g_U10978) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1856(), l_U485._fU0, l_U485._fU4, l_U485._fU8, 15.00000000, 15.00000000, 15.00000000, 0 )))))
                {
                    if (l_U530 == 0)
                    {
                        l_U531 = GET_SOUND_ID();
                ...
                if (g_U9893._fU12 == 0)
                {
                    if ((NOT sub_2757()) AND ((sub_2698() == 1) AND ((g_U813 == 0) AND ((sub_2378( 1, 1 )) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1856(), l_U485._fU0, l_U485._fU4, l_U485._fU8 + 2.50000000, 2.50000000, 2.50000000, 2.50000000, 1 ))))))
                    {
                        sub_2968();
...
void sub_590(unknown uParam0, unknown uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
    ...
    if (g_U15946[uParam0]._fU168._fU76[uParam1]._fU0[0] == -1)
    {
        ...
        if (iParam5 != -1)
        {
            ...
            {
                if ((g_U15946[uParam0]._fU168._fU76[uParam1]._fU0[I] == iParam4) || (g_U15946[uParam0]._fU168._fU76[uParam1]._fU0[I] == iParam3))
                {
                    for ( J = I + 1; J <= (I + iParam5); J++ )
                    {
                        if (J < iParam2)
                        {
                            if ((g_U15946[uParam0]._fU168._fU76[uParam1]._fU0[J] == iParam4) || (g_U15946[uParam0]._fU168._fU76[uParam1]._fU0[J] == iParam3))
                            {
...
void sub_4166()
{
    ...
    if (NOT (IS_CAR_DEAD( l_U482 )))
    {
        if (LOCATE_CAR_3D( l_U482, l_U485._fU0, l_U485._fU4, l_U485._fU8, 10.00000000, 10.00000000, 10.00000000, 0 ))
        {
            ...
            if ((IS_THIS_MODEL_A_CAR( l_U483 )) || (IS_THIS_MODEL_A_BIKE( l_U483 )))
            {
    ...
    if ((NOT (IS_CAR_DEAD( l_U482 ))) AND (l_U497 == 1))
    {
    ...
    WAIT( 2000 );
    if ((l_U496 == 1) AND (NOT (IS_CHAR_DEAD( sub_1856() ))))
    {
        l_U532 = GET_SOUND_ID();
    ...
    SETTIMERB( 0 );
    SETTIMERA( 0 );
    while ((NOT sub_8947()) AND (NOT bVar8))
    {
        WAIT( 0 );
        if ((l_U496 == 1) AND (iVar4 == -1))
        {
        ...
        if ((NOT (sub_9126( l_U524 ))) AND ((l_U496 == 0) AND (iVar4 == 0)))
        {
            iVar4 = 2;
            sub_9326( "B3_CFIX", ref l_U524, 8, 0 );
            l_U496 = 1;
        }
        if ((NOT (sub_9126( l_U524 ))) AND (iVar4 == 0))
        {
            iVar4 = 1;
            sub_9326( "B3_CWORK", ref l_U524, 8, 0 );
        }
        if ((NOT (sub_9126( l_U524 ))) AND (iVar4 == 1))
        {
            iVar4 = 2;
            if (g_U64980 == 1)
            {
        ...
        if ((NOT (sub_9126( l_U524 ))) AND (iVar4 == 2))
        {
            iVar4 = 3;
            SETTIMERA( 0 );
        }
        if ((NOT (sub_9126( l_U524 ))) AND ((TIMERA() > 0) AND (iVar4 == 3)))
        {
            iVar4 = 4;
            sub_10735();
            SETTIMERA( 0 );
        }
        if ((NOT (sub_9126( l_U524 ))) AND (iVar4 == 4))
        {
            iVar4 = 5;
            SETTIMERA( 0 );
        }
        if ((TIMERB() > 0) AND ((iVar4 > -1) AND (I == 0)))
        {
            I = 1;
        }
        if ((NOT (sub_9126( l_U524 ))) AND ((iVar4 == 5) AND ((TIMERB() > 10000) AND (I == 1))))
        {
            WAIT( 500 );
            if (NOT (IS_CHAR_DEAD( sub_1856() )))
            {
        ...
        if ((iVar4 > -1) AND ((iVar5 == 0) AND (TIMERB() > 12000)))
        {
            iVar5 = 1;
            sub_6452();
...
void sub_6452()
{
    ...
    {
        l_U499[0] = {-1368.08800000, 357.55560000, 15.28576000};
        l_U506[0] = {-3.09794100, -0.00000000, -123.11280000};
        l_U513[0] = 30;
    ...
    else if (l_U498 == 4)
    {
        ...
        l_U506[0] = {-5.51524000, -0.00000000, 81.61535000};
        l_U513[0] = 45;
    ...
    else if (l_U498 == 5)
    {
        ...
        l_U513[0] = 51;
        l_U499[1] = {-1361.70500000, 356.96210000, 14.62345000};
    ...
    else
    {
        ...
        l_U506[0] = {-8.87914700, 0.00000000, 89.10028000};
        l_U513[0] = 51;
        l_U499[1] = {-1360.28600000, 355.95560000, 15.37419000};
        l_U506[1] = {-8.87914700, 0.00000000, 89.10028000};
        l_U513[1] = 30;
        PRINTSTRING( "\n ----> CAMERA 7 <---- \n\n" );
    };;;;;;;
    for ( I = 0; I < l_U499; I++ )
...
int sub_18393()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_3167( 1, g_U569[I] )) != 0))
        {
            sub_3418( I );
            return 1;
        }
