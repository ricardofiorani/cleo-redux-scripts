...
int sub_1377()
{
    ...
    if ((NOT (iVar2 == 12)) AND ((NOT (iVar2 == 11)) AND (NOT (iVar2 == 5))))
    {
        return 0;
    }
    iVar3 = GET_CHAR_DRAWABLE_VARIATION( sub_455(), 2 );
    if ((NOT (iVar3 == 4)) AND (NOT (iVar3 == 2)))
    {
        return 0;
    }
    return 1;
...
void sub_12703()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_12741( 5, g_U569[I] )) == 1))
        {
...
void sub_15104()
{
    ...
    if ((sub_928()) || ((sub_15443( 15000 )) || ((sub_15243()) || ((sub_878()) || ((IS_WANTED_LEVEL_GREATER( sub_512(), 0 )) || (IS_THREAD_ACTIVE( g_U812 )))))))
    {
        l_U484 = 0;
        return;
    }
    if ((sub_15874( 19 )) || (NOT (sub_15809( 19, 30000 ))))
    {
        return;
    }
    iVar3 = 19;
...
int sub_16432()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_12741( 1, g_U569[I] )) != 0))
        {
            sub_13027( I );
            return 1;
        }
