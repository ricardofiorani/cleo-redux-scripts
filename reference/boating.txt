        ...
        if (IS_PLAYER_PLAYING( sub_897() ))
        {
            ...
            switch (l_U484)
            {
                ...
                if (IS_VEH_DRIVEABLE( l_U766 ))
                {
                    ...
                    if ((sub_11075( l_U801, l_U766 )) AND ((sub_11075( l_U800, l_U766 )) AND ((sub_11075( l_U802, l_U766 )) AND (IS_CHAR_IN_CAR( sub_990(), l_U766 )))))
                    {
                        sub_11180();
                        iVar2 = sub_8110( ref l_U765 );
                        RESET_STUCK_TIMER( l_U766, 3 );
    ...
    switch (l_U563)
    {
        ...
        if (l_U766 != nil)
        {
            if (NOT (IS_CAR_DEAD( l_U766 )))
            {
                ...
                {
                    if ((CHECK_STUCK_TIMER( l_U766, 1, 40000 )) || ((CHECK_STUCK_TIMER( l_U766, 2, 30000 )) || (CHECK_STUCK_TIMER( l_U766, 3, 10000 ))))
                    {
                        sub_2356();
    ...
    if (NOT (IS_CHAR_INJURED( l_U802 )))
    {
        if (NOT (IS_CHAR_INJURED( l_U800 )))
        {
            if (NOT (IS_CHAR_INJURED( l_U801 )))
            {
                ...
                {
                    case 0:
                    if ((sub_8796()) || (NOT (sub_3769( l_U748 ))))
                    {
                        if ((sub_8796()) || (NOT (sub_3769( l_U755 ))))
                        {
                            DO_SCREEN_FADE_OUT( 3000 );
...
void sub_9173(unknown uParam0, unknown uParam1, int iParam2)
{
    if (NOT (IS_CHAR_DEAD( uParam0 )))
    {
        ...
        {
            if ((IS_CHAR_SITTING_IN_ANY_CAR( sub_990() )) || (IS_CHAR_IN_ANY_CAR( uParam0 )))
            {
...
void sub_13008()
{
    ...
    switch (l_U485)
    {
        ...
        if ((iVar2 >= 3) AND (l_U517[l_U545] == 3))
        {
            if (g_U64581[l_U545] == 0)
            {
                l_U485 = 2;
...
void sub_15734(int iParam0)
{
    ...
    else if (iParam0 == 1)
    {
        ...
        ADD_CAM_SPLINE_NODE( l_U767, l_U768[0] );
        CREATE_CAM( 14, ref l_U768[1] );
        SET_CAM_POS( l_U768[1], -91.03800000, -1046.48000000, 24.54558000 );
    ...
    else if (iParam0 == 2)
    {
        ...
        ADD_CAM_SPLINE_NODE( l_U767, l_U768[0] );
        CREATE_CAM( 14, ref l_U768[1] );
        SET_CAM_POS( l_U768[1], 405.34890000, -585.03820000, 3.44765800 );
    ...
    else if (iParam0 == 4)
    {
        ...
        SET_CAM_POS( l_U768[3], -1084.33000000, -279.59640000, 41.53774000 );
    ...
    else if (iParam0 == 5)
    {
        ...
        ADD_CAM_SPLINE_NODE( l_U767, l_U768[1] );
        CREATE_CAM( 14, ref l_U768[2] );
        SET_CAM_POS( l_U768[2], -836.06140000, -13.10017000, 66.79539000 );
    ...
    else if (iParam0 == 7)
    {
        ...
        ADD_CAM_SPLINE_NODE( l_U767, l_U768[1] );
        CREATE_CAM( 14, ref l_U768[2] );
        SET_CAM_POS( l_U768[2], -641.25610000, 1475.39300000, 24.79806000 );
