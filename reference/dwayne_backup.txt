void main()
{
    ...
    while (true)
    {
        if ((NOT g_U64921) AND (IS_PLAYER_PLAYING( sub_174() )))
        {
            if (g_U9189)
            {
            ...
            if ((NOT (l_U124 == 5)) AND (NOT (l_U124 == 0)))
            {
                if (TIMERA() > 300000)
                {
                    PRINT( "PAK_02", 7500, 1 );
            ...
            switch (l_U124)
            {
                ...
                while ((NOT (HAS_MODEL_LOADED( l_U141[1] ))) || ((NOT (HAS_MODEL_LOADED( l_U141[0] ))) || ((NOT (HAS_MODEL_LOADED( -301223260 ))) || (NOT (HAS_MODEL_LOADED( l_U144 ))))))
                {
                    REQUEST_MODEL( l_U144 );
                    REQUEST_MODEL( -301223260 );
                    REQUEST_MODEL( l_U141[0] );
                ...
                {
                    if ((CHECK_STUCK_TIMER( l_U166, 0, 5000 )) || ((CHECK_STUCK_TIMER( l_U166, 1, 5000 )) || ((CHECK_STUCK_TIMER( l_U166, 2, 5000 )) || (CHECK_STUCK_TIMER( l_U166, 3, 5000 )))))
                    {
                        l_U124 = 3;
                    }
                    else if (sub_10081())
                ...
                for ( I = 0; I < 2; I++ )
                {
                    if (NOT (IS_CHAR_INJURED( l_U145[I] )))
                    {
                        if (NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U145[I], sub_218(), 20.00000000, 20.00000000, 3.00000000, 0 )))
                        {
                            ...
                            if (((VMAG( uVar5 )) > 5.00000000) || (l_U150 == 7))
                            {
                                OPEN_SEQUENCE_TASK( ref l_U149 );
                ...
                if (bVar10)
                {
                    if ((IS_PLAYER_CONTROL_ON( sub_174() )) AND (IS_SCREEN_FADED_IN()))
                    {
                        SETTIMERA( 0 );
                ...
                if (NOT l_U114)
                {
                    if (IS_PLAYER_PLAYING( sub_174() ))
                    {
                        if ((NOT (IS_CHAR_INJURED( l_U145[1] ))) AND (NOT (IS_CHAR_INJURED( l_U145[0] ))))
                        {
                        ...
                        else if ((IS_CHAR_INJURED( l_U145[1] )) AND (NOT (IS_CHAR_INJURED( l_U145[0] ))))
                        {
                            if (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_218(), l_U145[0], 10.00000000, 10.00000000, 2.00000000, 0 ))
                            {
                                l_U148 = l_U145[0];
                        ...
                        else if ((NOT (IS_CHAR_INJURED( l_U145[1] ))) AND (IS_CHAR_INJURED( l_U145[0] )))
                        {
                            if (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_218(), l_U145[1], 10.00000000, 10.00000000, 2.00000000, 0 ))
                            {
                                l_U148 = l_U145[1];
                ...
                {
                    bVar10 = true;
                    if ((IS_SCREEN_FADED_OUT()) || (sub_12819( l_U151 )))
                    {
                        bVar10 = false;
                    }
                    for ( I = 0; I < 2; I++ )
                ...
                {
                    bVar10 = true;
                    if ((IS_SCREEN_FADED_OUT()) || ((sub_12819( l_U151 )) || (IS_MESSAGE_BEING_DISPLAYED())))
                    {
                        bVar10 = false;
                    }
                    if (IS_PLAYER_PLAYING( sub_174() ))
                    ...
                    if (bVar10)
                    {
                        ...
                        else if ((NOT (IS_CHAR_INJURED( l_U145[1] ))) || (NOT (IS_CHAR_INJURED( l_U145[0] ))))
                        {
                ...
                if (TIMERA() > 720000)
                {
                    if ((NOT (IS_CHAR_INJURED( l_U145[1] ))) AND (NOT (IS_CHAR_INJURED( l_U145[0] ))))
                    {
                        if ((NOT (IS_PED_IN_COMBAT( l_U145[1] ))) AND (NOT (IS_PED_IN_COMBAT( l_U145[0] ))))
                        {
                            if (l_U113)
                            {
                ...
                if ((l_U114) AND ((NOT l_U105) AND (IS_PLAYER_PLAYING( sub_174() ))))
                {
                    GET_CHAR_COORDINATES( sub_218(), ref vVar2.x, ref vVar2.y, ref vVar2.z );
                    for ( I = 0; I < 2; I++ )
                    {
                ...
                if ((IS_CHAR_INJURED( l_U145[1] )) AND (IS_CHAR_INJURED( l_U145[0] )))
                {
                    if (l_U113)
                    {
...
void sub_572()
{
    ...
    l_U140 = 0;
    if ((NOT l_U105) AND (IS_PLAYER_PLAYING( sub_174() )))
    {
            ...
            if (DOES_GROUP_EXIST( sub_640() ))
            {
                ...
                if (iVar3 > iVar4)
                {
                    ...
                    for ( I = 0; I < 7; I++ )
                    {
                        ...
                        {
                            if ((iVar10 == l_U145[1]) || (iVar10 == l_U145[0]))
                            {
...
int sub_1308()
{
    ...
    {
        if ((sub_1342()) AND (ARE_WIDESCREEN_BORDERS_ACTIVE()))
        {
            return 1;
        }
        else if (l_U113)
...
void sub_3545()
{
    ...
    if (IS_PLAYER_PLAYING( sub_174() ))
    {
        if (DOES_GROUP_EXIST( sub_640() ))
        {
            ...
            {
                GET_GROUP_MEMBER( sub_640(), I, ref iVar8 );
                if ((NOT (iVar8 == l_U145[1])) AND (NOT (iVar8 == l_U145[0])))
                {
                    if (NOT (IS_CHAR_INJURED( iVar8 )))
                    {
                        if (l_U126[I] == -1)
            ...
            {
                GET_GROUP_MEMBER( sub_640(), I, ref iVar8 );
                if ((iVar8 == l_U145[1]) || (iVar8 == l_U145[0]))
                {
                    if (NOT (IS_CHAR_INJURED( iVar8 )))
                    {
                        if (l_U126[I] == -1)
            ...
            if (IS_PLAYER_PLAYING( sub_174() ))
            {
                ...
                if (IS_CHAR_IN_ANY_CAR( sub_218() ))
                {
                    ...
                    if (IS_VEH_DRIVEABLE( uVar8 ))
                    {
                        ...
                        if ((NOT (IS_THIS_MODEL_A_HELI( uVar10 ))) AND ((NOT (IS_THIS_MODEL_A_PLANE( uVar10 ))) AND (NOT (IS_THIS_MODEL_A_BOAT( uVar10 )))))
                        {
                ...
                if (bVar9)
                {
                    ...
                    else
                    {
                        ...
                        {
                            GET_CHAR_COORDINATES( sub_218(), ref uVar2._fU0, ref uVar2._fU4, ref uVar2._fU8 );
                            if ((LOCATE_CAR_3D( l_U166, uVar2._fU0, uVar2._fU4, uVar2._fU8, 15.00000000, 15.00000000, 2.00000000, 0 )) || (LOCATE_CAR_3D( l_U166, l_U160._fU0, l_U160._fU4, l_U160._fU8, 15.00000000, 15.00000000, 4.00000000, 0 )))
                            {
                                CLEAR_CHAR_TASKS( l_U145[0] );
                                return 1;
                            }
