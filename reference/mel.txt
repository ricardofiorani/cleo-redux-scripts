void main()
{
    ...
    l_U235 = {1165.51700000, -99.25850000, 34.92160000};
...
void sub_1153()
{
    if ((NOT l_U113) AND ((l_U112) AND (l_U111)))
    {
        if (sub_1185())
        {
            sub_1232( 0 );
...
void sub_2715()
{
    ...
    {
        case 0:
        l_U139 = {900.80690000, -383.82390000, 15.85480000};
        l_U153 = -807339118;
        REQUEST_MODEL( l_U153 );
        REQUEST_ANIMS( "missmel" );
        while ((NOT (HAVE_ANIMS_LOADED( "missmel" ))) || (NOT (HAS_MODEL_LOADED( l_U153 ))))
        {
            WAIT( 0 );
        }
        l_U103 = 1;
...
void sub_3241()
{
    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U127, sub_2049(), 0 )) || (IS_CHAR_INJURED( l_U127 )))
    {
        if (IS_HINT_RUNNING())
        {
            HINT_CAM( -1.00000000, -1.00000000, -1.00000000, l_U127, 0, 0, 0 );
    ...
    if ((IS_CHAR_ON_FOOT( sub_2049() )) AND (sub_3420() < 25))
    {
    ...
    {
        case 0:
        if ((IS_WANTED_LEVEL_GREATER( sub_1079(), 0 )) || ((IS_CHAR_ON_FIRE( l_U127 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U127, sub_2049(), 0 )) || (IS_CHAR_INJURED( l_U127 )))))
        {
        ...
        if (NOT (IS_CHAR_INJURED( l_U127 )))
        {
            if ((IS_CHAR_ON_FOOT( sub_2049() )) AND (sub_3420() < 18))
            {
                if ((NOT l_U216) AND (NOT IS_HINT_RUNNING()))
                {
...
void sub_7740()
{
    if ((NOT (l_U107 == 21)) AND (IS_CHAR_DEAD( l_U127 )))
    {
    ...
    switch (l_U107)
    {
        ...
        while ((NOT (HAS_MODEL_LOADED( -196312163 ))) || (NOT (HAS_MODEL_LOADED( 807236245 ))))
        {
            WAIT( 0 );
        }
        ...
        if ((NOT (IS_VEH_DRIVEABLE( l_U131 ))) AND (DOES_VEHICLE_EXIST( l_U131 )))
        {
        ...
        if (NOT (IS_WANTED_LEVEL_GREATER( sub_1079(), 0 )))
        {
            if (NOT (IS_CHAR_INJURED( l_U127 )))
            {
                ...
                {
                    if ((sub_4539( 1, 1 )) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_2049(), l_U229._fU0, l_U229._fU4, l_U229._fU8 + 2.50000000, 2.50000000, 2.50000000, 2.50000000, 1 )))
                    {
        ...
        else if ((sub_15514( l_U184 )) == 1)
        {
            ...
            {
                if ((NOT (IS_CHAR_IN_ANY_CAR( sub_2049() ))) AND (NOT (IS_CHAR_INJURED( sub_2049() ))))
                {
                    REMOVE_PED_HELMET( sub_2049(), 0 );
        ...
        switch (l_U102)
        {
            ...
            break;
            case 1:
            if ((NOT (IS_CHAR_ON_SCREEN( sub_2049() ))) || ((LOCATE_CHAR_ANY_MEANS_3D( sub_2049(), 1152.74100000, -107.69870000, 34.92160000, 1.00000000, 1.00000000, 1.00000000, 0 )) AND (NOT (IS_CHAR_INJURED( sub_2049() )))))
            {
            ...
            break;
            case 2:
            if ((IS_CHAR_ON_SCREEN( sub_2049() )) AND ((NOT (IS_CHAR_INJURED( sub_2049() ))) AND ((LOCATE_CHAR_ANY_MEANS_3D( l_U128, 1157.27800000, -103.87090000, 35.92160000, 2.00000000, 2.00000000, 21.00000000, 0 )) AND (NOT (IS_CHAR_INJURED( l_U128 ))))))
            {
                if (NOT (IS_CHAR_INJURED( sub_2049() )))
                {
                    if (NOT (IS_CHAR_INJURED( l_U128 )))
        ...
        if (sub_3420() < 20)
        {
            if (NOT (IS_CHAR_INJURED( l_U127 )))
            {
                ...
                else if ((NOT (sub_10462( l_U178 ))) AND (TIMERA() > 4500))
                {
        ...
        if ((NOT (IS_CHAR_ON_SCREEN( l_U127 ))) AND (sub_3420() > 100))
        {
            if (NOT (IS_CHAR_DEAD( l_U127 )))
            {
        ...
        if ((IS_CHAR_INJURED( l_U130 )) AND ((IS_CHAR_INJURED( l_U129 )) AND (IS_CHAR_INJURED( l_U128 ))))
        {
        ...
        break;
        case 16:
        if ((NOT (sub_10462( l_U190 ))) || (sub_15406( ref l_U190 )))
        {
            l_U107 = 17;
        }
        break;
        ...
        if (NOT (IS_CHAR_INJURED( l_U127 )))
        {
            if (IS_GROUP_MEMBER( l_U127, sub_5238() ))
            {
                if ((sub_4539( 1, 1 )) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_2049(), 903.12110000, -388.51770000, 15.86610000 + 2.50000000, 2.50000000, 2.50000000, 2.50000000, 1 )))
                {
                    SET_PLAYER_CONTROL( sub_1079(), 0 );
                    sub_7803( ref l_U166, 0 );
                    l_U123 = 0;
                    ...
                    if (IS_CHAR_IN_ANY_CAR( sub_2049() ))
                    {
                        if (NOT (IS_CAR_UPSIDEDOWN( l_U131 )))
                        {
                            ...
                            if ((l_U248 < 90) || (l_U248 > 270))
                            {
                                l_U247 = 1;
                            }
                            if ((NOT (IS_CHAR_INJURED( l_U127 ))) AND (IS_VEH_DRIVEABLE( l_U131 )))
                            {
        ...
        if (NOT l_U111)
        {
            ...
            if (l_U247)
            {
                SET_CAM_POS( l_U221, 911.78010000, -380.51000000, 18.35000000 );
        ...
        if (NOT (IS_CHAR_INJURED( l_U127 )))
        {
            ...
            else if ((TIMERB() > 6000) || (NOT (IS_CHAR_ON_SCREEN( l_U127 ))))
            {
                DELETE_CHAR( ref l_U127 );
                l_U107 = 21;
            }
