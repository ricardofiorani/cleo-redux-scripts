...
void sub_1895()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_1933( 5, g_U569[I] )) == 1))
        {
...
void sub_26257()
{
    ...
    if ((NOT l_U679) AND (IS_KEYBOARD_KEY_PRESSED( 36 )))
    {
...
void sub_26470(unknown uParam0)
{
    ...
    if ((IS_PROJECTILE_IN_AREA( -260.00000000, 1425.08000000, 30.00000000, -199.07000000, 1488.03000000, -30.00000000 )) || (IS_EXPLOSION_IN_AREA( -1, -260.00000000, 1425.08000000, 30.00000000, -199.07000000, 1488.03000000, -30.00000000 )))
    {
        sub_3400( uParam0 );
        return;
    }
...
int sub_26479()
{
    if (DOES_CHAR_EXIST( l_U649._fU0 ))
    {
        if (NOT (IS_CHAR_INJURED( l_U649._fU0 )))
        {
            ...
            if ((IS_CHAR_RESPONDING_TO_EVENT( l_U649._fU0, 9 )) || ((l_U851[4] < l_U857[4]) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U649._fU0, sub_3247(), 0 ))))
            {
    ...
    for ( l_U820 = 0; l_U820 <= 3; l_U820++ )
    {
        if (DOES_CHAR_EXIST( l_U600[l_U820]._fU0 ))
        {
            if (NOT (IS_CHAR_INJURED( l_U600[l_U820]._fU0 )))
            {
                ...
                if ((IS_CHAR_RESPONDING_TO_EVENT( l_U600[l_U820]._fU0, 9 )) || ((l_U851[l_U820] < l_U857[l_U820]) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U600[l_U820]._fU0, sub_3247(), 0 ))))
                {
                    if (IS_CHAR_SHOOTING( sub_3247() ))
                    {
                        l_U715 = 1;
...
void sub_28306()
{
    ...
    SET_CAM_POS( l_U815, -244.79000000, 1437.02400000, 20.73602000 );
    SET_CAM_ROT( l_U815, 4.46508400, 0.00000000, -39.78627000 );
    SET_CAM_FOV( l_U815, 40.20001000 );
    SET_CAM_POS( l_U816, -244.79000000, 1437.02400000, 20.73602000 );
    ...
    if (GET_IS_HIDEF())
    {
        ...
        SET_CAM_FOV( l_U817, 31.50004000 );
...
void sub_31319()
{
    if (NOT l_U720)
    {
        ...
        else if ((sub_31372()) || (((sub_3415( ref l_U649._fU0 )) < 25.00000000) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3247(), l_U786._fU0, l_U786._fU4, l_U786._fU8, 2.50000000, 2.50000000, 2.50000000, 1 ))))
        {
            REMOVE_BLIP( l_U737 );
            CLEAR_HELP();
            l_U721 = 0;
        ...
        if (NOT l_U721)
        {
            ...
            switch (l_U666)
            {
                ...
                if (NOT (IS_CHAR_INJURED( l_U649._fU0 )))
                {
                    ...
                    else if ((sub_32425( l_U600[1]._fU0 )) || (sub_32425( l_U600[0]._fU0 )))
                    {
                        l_U707 = 1;
                    }
                    else if ((sub_32425( l_U600[3]._fU0 )) || (sub_32425( l_U600[2]._fU0 )))
                    {
                        l_U708 = 1;
                    }
                    else if (sub_32596())
...
int sub_33730()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_1933( 1, g_U569[I] )) != 0))
        {
            sub_2219( I );
            return 1;
        }
...
int sub_34834(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3247() ))) AND (IS_CHAR_IN_ANY_CAR( sub_3247() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_35349()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
    ...
    if (NOT (IS_CHAR_INJURED( l_U649._fU0 )))
    {
        switch (l_U671)
        {
            ...
            if (l_U878[0] == 1)
            {
                ...
                if (l_U867 == 0)
                {
                    if ((sub_41347( ref l_U649._fU0, ref l_U575[l_U865]._fU0, 1, 10.00000000 )) || ((IS_CHAR_IN_CAR( sub_3247(), l_U575[l_U865]._fU0 )) || (NOT (IS_VEH_DRIVEABLE( l_U575[l_U865]._fU0 )))))
                    {
                        TASK_SMART_FLEE_CHAR( l_U649._fU0, sub_3247(), 100.00000000, -2 );
                        l_U671 = 3;
                    }
                ...
                {
                    if ((NOT (IS_CHAR_IN_CAR( sub_3247(), l_U575[l_U865]._fU0 ))) AND (IS_VEH_DRIVEABLE( l_U575[l_U865]._fU0 )))
                    {
                        l_U671 = 2;
                    }
                    else
            ...
            break;
            case 3:
            if ((sub_41940( ref l_U649._fU0, ref l_U857[4] )) || ((sub_3415( ref l_U649._fU0 )) < 5.00000000))
            {
                GIVE_WEAPON_TO_CHAR( l_U649._fU0, 13, 30000, 1 );
                sub_5133( ref l_U649._fU0, ref l_U872 );
                l_U671 = 4;
...
int sub_41940(unknown uParam0, unknown uParam1)
{
    ...
    if (DOES_CHAR_EXIST( (uParam0^) ))
    {
        if (NOT (IS_CHAR_INJURED( (uParam0^) )))
        {
            ...
            if ((IS_CHAR_RESPONDING_TO_EVENT( (uParam0^), 9 )) || ((iVar4 < (uParam1^)) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( (uParam0^), sub_3247(), 0 ))))
            {
                return 1;
            }
        }
...
int sub_42161(unknown uParam0, unknown uParam1, unknown uParam2, boolean bParam3)
{
    ...
    if (bParam3)
    {
        for ( I = 0; I <= ((uParam0^) - 1); I++ )
        {
            if (DOES_CHAR_EXIST( (uParam0^)[I]._fU0 ))
            {
                ...
                {
                    if ((NOT (IS_CHAR_ON_SCREEN( (uParam0^)[I]._fU0 ))) AND ((sub_3415( ref (uParam0^)[I]._fU0 )) > (uParam2^)))
                    {
                        return 1;
                    }
                }
    ...
    else if (DOES_CHAR_EXIST( (uParam1^) ))
    {
        if (NOT (IS_CHAR_INJURED( (uParam1^) )))
        {
            if ((NOT (IS_CHAR_ON_SCREEN( (uParam1^) ))) AND ((sub_3415( uParam1 )) > (uParam2^)))
            {
                return 1;
            }
        }
...
void sub_42409(unknown uParam0)
{
    ...
    if ((iVar3 != 4) AND ((NOT sub_31825()) AND ((NOT (IS_CHAR_DEAD( (uParam0^) ))) AND ((IS_CHAR_IN_ANY_CAR( sub_3247() )) AND (IS_CONTROL_PRESSED( 0, 51 ))))))
    {
...
void sub_43063()
{
    ...
    if ((sub_43552( ref l_U649 )) AND (sub_43398( ref l_U600 )))
    {
        sub_5650();
    }
    if ((sub_42142( ref l_U649._fU0, ref l_U790 )) || (sub_43693( ref l_U600, ref l_U789 )))
    {
        l_U847[2] = 1;
        sub_40152();
    }
