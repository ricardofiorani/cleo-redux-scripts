...
void sub_14354()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_14392( 5, g_U569[I] )) == 1))
        {
...
void sub_22424()
{
    ...
    {
        iVar3 = sub_22452( 13 );
        if ((g_U9932[g_U9999[I]._fU0]._fU0) AND (sub_22497( 13, iVar3 )))
        {
    ...
    {
        iVar3 = sub_22452( 11 );
        if ((g_U9932[g_U10090[I]._fU0]._fU0) AND (sub_22497( 11, iVar3 )))
        {
    ...
    {
        iVar3 = sub_22930( I );
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_22497( g_U10324[I]._fU12, iVar3 )))
        {
...
void sub_23467()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((g_U9932[g_U10324[I]._fU28]._fU0) AND (sub_22930( I )))
        {
            iVar4++;
        }
    }
...
void sub_29089()
{
    ...
    {
        STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_1580(), ref uVar2 );
        if ((NOT (IS_CHAR_IN_MODEL( sub_1580(), -488123221 ))) AND (NOT (IS_CHAR_IN_MODEL( sub_1580(), 837858166 ))))
        {
...
int sub_31843()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if ((g_U569[I]._fU20) AND ((sub_14392( 1, g_U569[I] )) != 0))
        {
            sub_14678( I );
            return 1;
        }
...
int sub_39248()
{
    ...
    fVar3 = 0.00000000;
    GET_CAR_SPEED( uVar2, ref fVar3 );
    if ((sub_39323( 1, 1 )) AND (fVar3 < 0.01000000))
    {
        if (NOT l_U113)
        {
...
int sub_39686()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    bVar3 = false;
    if ((IS_PLAYER_PRESSING_HORN( sub_3722() )) AND ((sub_39323( 1, 1 )) AND (IS_CHAR_IN_ANY_CAR( sub_1580() ))))
    {
        if (l_U113)
        {
            return 0;
...
int sub_40290(unknown uParam0, unknown uParam1)
{
    ...
    iVar11 = 0;
    if ((NOT l_U119) AND (IS_CHAR_IN_ANY_CAR( sub_1580() )))
    {
...
void sub_46302()
{
    ...
    sub_46630( iVar3[30], -437.20600000, 463.31500000, 11.30600000, 273.22870000, -451.98690000, 469.22640000, 14.42270000, -12.98044000, 0.00000000, -130.48930000 );
                ...
                switch (l_U223)
                {
                    ...
                    if (sub_61981( uParam0 ))
                    {
                        ...
                        if (DOES_OBJECT_EXIST( l_U232 ))
                        {
                            if (HAVE_ANIMS_LOADED( l_U235 ))
                            {
                                if ((NOT (IS_SCRIPTED_SPEECH_PLAYING( uParam0 ))) AND ((NOT (IS_AMBIENT_SPEECH_PLAYING( uParam0 ))) AND ((NOT (sub_63684( uParam0 ))) AND ((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( uParam0 ))) AND ((NOT (IS_CHAR_GESTURING( uParam0 ))) AND ((NOT (IS_CHAR_PLAYING_ANIM( uParam0, l_U235, l_U236 ))) AND ((NOT (IS_CHAR_DUCKING( uParam0 ))) AND (NOT (IS_PED_RAGDOLL( uParam0 ))))))))))
                                {
                            ...
                            else if ((sub_64190( uParam0 )) || (sub_52128( uParam0 )))
                            {
...
void sub_51889(unknown uParam0)
{
    ...
    if ((IS_PLAYER_PLAYING( sub_3722() )) AND (NOT (IS_CHAR_INJURED( uParam0 ))))
    {
        switch (l_U225)
        {
            case 0:
            ...
            if (DOES_VEHICLE_EXIST( l_U266 ))
            {
                if (NOT (IS_CAR_DEAD( l_U266 )))
                {
                    ...
                    if ((NOT (sub_52013( l_U227[3] ))) AND ((NOT (sub_52013( l_U227[2] ))) AND ((NOT (sub_52013( l_U227[1] ))) AND (NOT (sub_52013( l_U227[0] ))))))
                    {
                        l_U225 = 0;
                        l_U218 = 0.00000000;
                    }
            ...
            if (DOES_VEHICLE_EXIST( l_U266 ))
            {
                if (NOT (IS_CAR_DEAD( l_U266 )))
                {
                    if (l_U218 > 1000.00000000)
                    {
                        ...
                        else if ((NOT (sub_52013( l_U227[3] ))) AND ((NOT (sub_52013( l_U227[2] ))) AND ((NOT (sub_52013( l_U227[1] ))) AND (NOT (sub_52013( l_U227[0] ))))))
                        {
                            l_U225 = 1;
                        }
                    }
...
int sub_52496(unknown uParam0)
{
    if (DOES_VEHICLE_EXIST( uParam0 ))
    {
        if (NOT (IS_CAR_DEAD( uParam0 )))
        {
            ...
            {
                if ((NOT (sub_52551( uParam0, 3 ))) AND ((NOT (sub_52551( uParam0, 2 ))) AND ((NOT (sub_52551( uParam0, 1 ))) AND (NOT (sub_52551( uParam0, 0 ))))))
                {
                    return 1;
                }
            }
        ...
        for ( I = 0; I < 5; I++ )
        {
            if (l_U337 == -1)
            {
                if (sub_65507( I ))
                {
                    ...
                    if ((NOT (sub_38225( sub_1580() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1580(), l_U401[I]._fU4._fU0, l_U401[I]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar7 )))
                    {
...
void sub_78978(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    sub_81986( uParam2 );
    sub_82126();
    if ((l_U466._fU8) AND (NOT (IS_CHAR_DEAD( sub_1580() ))))
    {
        SET_CURRENT_CHAR_WEAPON( sub_1580(), 0, 0 );
    }
...
int sub_83408(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, boolean bParam5, unknown uParam6)
{
    ...
    if (bVar10)
    {
        ...
        {
            if ((NOT (IS_CHAR_DEAD( iParam1 ))) AND (NOT (IS_CHAR_DEAD( sub_1580() ))))
            {
    ...
    if (l_U325 == 7)
    {
        ...
        else if ((IS_CHAR_DEAD( iParam1 )) || (IS_CHAR_DEAD( sub_1580() )))
        {
            l_U325++;
        }
        else
    ...
    if (l_U325 == 12)
    {
        ...
        if ((TIMERA() > 7000) || (sub_93388( iParam1, l_U359 )))
        {
            l_U325++;
        }
    }
...
int sub_99283(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 5; Result++ )
    {
        ...
        if ((NOT (sub_99418( iVar4 ))) AND (sub_99355( Result )))
        {
            iVar5 = g_U10324[iVar4]._fU28 == g_U9937;
            fVar6 = l_U401[Result]._fU4._fU8;
            if ((NOT (sub_38225( sub_1580() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1580(), l_U401[Result]._fU4._fU0, l_U401[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )))
            {
...
int sub_99769(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_99828( Result ))
        {
            ...
            if ((NOT (sub_38225( sub_1580() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1580(), l_U489[Result]._fU4._fU0, l_U489[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )))
            {
                if (sub_99626( uParam0 ))
                {
                    return Result;
...
int sub_111812(unknown uParam0)
{
    ...
    if ((sub_111902( uParam0, "Bada_room1" )) || ((sub_111902( uParam0, "Bada_room2" )) || ((sub_111902( uParam0, "Bada-Private" )) || (sub_111902( uParam0, "Bada_room1" )))))
    {
        return 1;
    }
    if ((sub_111902( uParam0, "clammainroom" )) || ((sub_111902( uParam0, "clamfronrm" )) || ((sub_111902( uParam0, "clampalbkrm" )) || (sub_111902( uParam0, "clammainroom" )))))
    {
        return 1;
    }
    return 0;
...
void sub_112846(unknown uParam0)
{
    ...
    if (l_U344._fU12)
    {
        if (g_U22274[l_U158]._fU688._fU24 >= 0)
        {
            ...
            if (NOT l_U344._fU24)
            {
                if (((sub_100541( l_U147 )) > 5) || (sub_112902( ref l_U147 )))
                {
                    bVar5 = true;
                }
            }
...
void sub_113507()
{
    ...
    if ((NOT (sub_38225( sub_1580() ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_1580() )))
    {
        sub_3299( "MF10AUD" );
        sub_3418( 0, sub_1580(), "NIKO", 0 );
...
int sub_114619(unknown uParam0)
{
    ...
    if ((l_U344._fU24) || (sub_114628()))
    {
        return 0;
    }
    if (NOT l_U344._fU8)
    {
        if ((NOT (IS_CHAR_DEAD( uParam0 ))) AND (NOT (IS_CHAR_DEAD( sub_1580() ))))
        {
            if (IS_CHAR_IN_ANY_CAR( sub_1580() ))
            {
                STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_1580(), ref uVar3 );
