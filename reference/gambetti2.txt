...
void sub_1518()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_1556( 5, g_U569[I] )) == 1))
        {
...
void sub_3928()
{
    switch (l_U1717)
    {
        ...
        while ((NOT (HAS_MODEL_LOADED( l_U1002 ))) || ((NOT (HAS_MODEL_LOADED( l_U1000 ))) || ((NOT (HAS_MODEL_LOADED( l_U999 ))) || ((NOT (HAS_MODEL_LOADED( 1203311498 ))) || ((NOT (HAS_MODEL_LOADED( 1376298265 ))) || ((NOT (HAVE_ANIMS_LOADED( "gestures@niko" ))) || (NOT (HAVE_ANIMS_LOADED( "missgambetti2" )))))))))
        {
            l_U1512 = 1;
...
void sub_4964()
{
    ...
    if ((sub_5017()) || (LOCATE_CHAR_ANY_MEANS_3D( sub_2446(), -1244.99200000, 1071.71500000, 19.77960000, 12.00000000, 10.00000000, 1.00000000, 0 )))
    {
        REMOVE_BLIP( l_U1435 );
        ADD_COVER_POINT( -1234.01100000, 1088.31200000, 23.78020000, 3, 243.80440000, 3, 0, ref l_U984[0] );
        ADD_COVER_POINT( -1230.26200000, 1091.68900000, 23.78020000, 3, 238.22140000, 3, 0, ref l_U984[1] );
...
int sub_5017()
{
    if (NOT l_U1636)
    {
        if ((LOCATE_CHAR_ON_FOOT_3D( sub_2446(), -1241.49300000, 1073.10200000, 24.18570000, 2.00000000, 17.00000000, 2.00000000, 0 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_2446(), -1241.49300000, 1073.10200000, 24.18570000, 15.00000000, 2.00000000, 2.00000000, 0 )))
        {
            l_U1636 = 1;
        }
    }
...
void sub_5805(unknown uParam0)
{
    switch (uParam0)
    {
        ...
        l_U493[16]._fU40 = 0;
        l_U493[16]._fU28 = {-1234.20400000, 1083.03900000, 24.78020000};
        l_U493[16]._fU60 = l_U1012;
        break;
        case 2:
        if (NOT (DOES_CHAR_EXIST( l_U1251[12] )))
        {
            l_U1251[12] = sub_6477( l_U999, 23, -1220.38200000, 1091.91200000, 23.78010000, 120.06140000, 13, "Room_Rest", 1, 1, 1 );
        ...
        if ((IS_CHAR_FATALLY_INJURED( l_U1251[22] )) || (IS_CHAR_DEAD( l_U1251[22] )))
        {
            ;
        }
        break;
...
int sub_11556(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_2446() ))) AND (IS_CHAR_IN_ANY_CAR( sub_2446() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_12083()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_15729()
{
    ...
    if (l_U982 > 0)
    {
        ...
        else if ((NOT l_U1704) AND ((l_U982 < 7) AND (l_U982 > 0)))
        {
            if (sub_15765())
            {
    ...
    switch (l_U982)
    {
        ...
        if ((NOT (sub_16282( l_U1093, sub_2446() ))) AND (NOT (IS_CHAR_INJURED( l_U1093 ))))
        {
            if (LOCATE_CHAR_ON_FOOT_3D( sub_2446(), -1238.50600000, 1075.38800000, 20.34500000, 1.60000000, 1.60000000, 1.60000000, 1 ))
            {
                if (sub_16409( 1, 1 ))
                {
                    ...
                    CLEAR_AREA_OF_COPS( -1238.50600000, 1075.38800000, 20.34500000, 500.00000000 );
                    if (sub_3973())
                    {
                        SET_PLAYER_CONTROL( sub_2681(), 0 );
            ...
            else if ((LOCATE_CHAR_IN_CAR_3D( sub_2446(), -1242.54700000, 1072.07800000, 19.75170000, 2.00000000, 2.00000000, 2.00000000, 0 )) || ((LOCATE_CHAR_IN_CAR_3D( sub_2446(), -1241.11000000, 1076.74300000, 19.78020000, 2.00000000, 2.00000000, 1.00000000, 0 )) || ((LOCATE_CHAR_IN_CAR_3D( sub_2446(), -1237.57300000, 1074.02900000, 19.78020000, 2.00000000, 2.00000000, 1.00000000, 0 )) || (LOCATE_CHAR_IN_CAR_3D( sub_2446(), -1238.94200000, 1075.28400000, 19.78020000, 2.00000000, 2.00000000, 1.00000000, 0 )))))
            {
                if (sub_3973())
                {
                    l_U1705 = 1;
                    ...
                    CLEAR_AREA( -1237.57300000, 1074.02900000, 19.78020000, 20.00000000, 1 );
                    SET_CHAR_COORDINATES( sub_2446(), -1238.50600000, 1075.38800000, 18.78020000 );
        ...
        break;
        case 7:
        if ((sub_5017()) || ((sub_20887()) || ((sub_20684( l_U1093, 0 )) || (sub_16282( l_U1093, sub_2446() )))))
        {
            SET_WANTED_MULTIPLIER( 0.00000000 );
            if (NOT l_U493[24]._fU4)
            {
                if ((NOT sub_20887()) AND (NOT sub_5017()))
                {
                    sub_5805( 4 );
                    l_U493[24]._fU4 = 1;
                }
        ...
        case 8:
        uVar4[0] = {l_U493[24]};
        if ((sub_22507( ref uVar4, 1, 1, 1 )) || ((sub_5017()) || (LOCATE_CHAR_ANY_MEANS_3D( sub_2446(), -1233.10200000, 1077.64600000, 19.78020000, 2.00000000, 1.00000000, 1.00000000, 0 ))))
        {
            if (NOT sub_5017())
            {
                sub_5805( 3 );
...
int sub_20684(unknown uParam0, boolean bParam1)
{
    if (NOT (IS_CHAR_DEAD( uParam0 )))
    {
        ...
        else if ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_2681(), uParam0 )) || (IS_PLAYER_TARGETTING_CHAR( sub_2681(), uParam0 )))
        {
            if (IS_CHAR_ARMED( sub_2446(), 7 ))
            {
                return 1;
    ...
    for ( I = 0; I <= 29; I++ )
    {
        ...
        if (l_U493[I]._fU4)
        {
            ...
            if (NOT (IS_CHAR_DEAD( l_U493[I]._fU0 )))
            {
                ...
                if ((l_U493[I]._fU12) || (NOT l_U493[I]._fU16))
                {
                    if (I == l_U1688)
                    {
                        ;
...
void sub_25181()
{
    ...
    switch (l_U975)
    {
        ...
        if (NOT l_U493[21]._fU4)
        {
            ...
            {
                if ((IS_CHAR_INJURED( l_U1251[12] )) || (IS_CHAR_FATALLY_INJURED( l_U1251[12] )))
                {
                    l_U493[21]._fU28 = {-1225.16200000, 1090.98400000, 23.78020000};
                    l_U493[21]._fU40 = 2;
                    l_U493[21]._fU4 = 1;
                }
                else if ((IS_CHAR_INJURED( l_U1251[13] )) || (IS_CHAR_FATALLY_INJURED( l_U1251[13] )))
                {
        ...
        if ((uVar2._fU8 > 21.00000000) || (LOCATE_CHAR_ANY_MEANS_3D( sub_2446(), -1229.21000000, 1084.22400000, 20.35620000, 1.00000000, 1.00000000, 1.00000000, 0 )))
        {
            l_U1047 = 1;
        }
        GET_CHAR_COORDINATES( sub_2446(), ref uVar2._fU0, ref uVar2._fU4, ref uVar2._fU8 );
        if ((uVar2._fU8 > 21.00000000) || (LOCATE_CHAR_ANY_MEANS_3D( sub_2446(), -1224.37300000, 1083.71200000, 22.65380000, 1.00000000, 1.00000000, 1.00000000, 0 )))
        {
            l_U1045 = 1;
        ...
        if (l_U1045)
        {
            if (NOT (IS_CHAR_INJURED( l_U1251[15] )))
            {
                ...
                {
                    if ((IS_CHAR_ON_SCREEN( l_U1251[16] )) || (IS_CHAR_ON_SCREEN( l_U1251[15] )))
                    {
                        l_U1041 = 1;
                        l_U493[15]._fU4 = 1;
                        l_U493[16]._fU4 = 1;
        ...
        GET_CHAR_COORDINATES( sub_2446(), ref uVar2._fU0, ref uVar2._fU4, ref uVar2._fU8 );
        if ((uVar2._fU8 > 23.00000000) || (sub_26102() == 1))
        {
            l_U975 = 2;
            l_U1041 = 1;
        }
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_2446(), -1221.76500000, 1080.34600000, 24.75010000, 4.00000000, 5.00000000, 1.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( sub_2446(), -1226.65500000, 1077.03500000, 24.78020000, 1.00000000, 4.00000000, 1.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_2446(), -1220.44000000, 1087.22400000, 24.78020000, 2.00000000, 1.00000000, 1.00000000, 0 ))))
    {
        l_U1638 = 1;
    }
    sub_23249();
...
int sub_28223()
{
    if ((l_U1637) || ((LOCATE_CHAR_ANY_MEANS_3D( sub_2446(), -1221.76500000, 1080.34600000, 24.75010000, 4.00000000, 5.00000000, 1.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( sub_2446(), -1226.65500000, 1077.03500000, 24.78020000, 1.00000000, 4.00000000, 1.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_2446(), -1220.44000000, 1087.22400000, 24.78020000, 2.00000000, 1.00000000, 1.00000000, 0 )))))
    {
        return 1;
    }
    return 0;
...
void sub_29024(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        if (DOES_CHAR_EXIST( l_U1096[0] ))
        {
            ...
            {
                GET_GAME_TIMER( ref iVar4 );
                if ((sub_18885( l_U1096[0], 1, 0 )) || ((iVar4 - l_U1220[0]) > 30000))
                {
        ...
        if (DOES_CHAR_EXIST( l_U1096[9] ))
        {
            ...
            {
                GET_GAME_TIMER( ref iVar4 );
                if ((sub_18885( l_U1096[9], 1, 0 )) || ((iVar4 - l_U1220[9]) > 30000))
                {
        ...
        if (DOES_CHAR_EXIST( l_U1096[12] ))
        {
            ...
            {
                GET_GAME_TIMER( ref iVar4 );
                if ((sub_18885( l_U1096[12], 1, 0 )) || ((iVar4 - l_U1220[12]) > 30000))
                {
        ...
        if (DOES_CHAR_EXIST( l_U1096[13] ))
        {
            ...
            {
                GET_GAME_TIMER( ref iVar4 );
                if ((sub_18885( l_U1096[13], 1, 0 )) || ((iVar4 - l_U1220[13]) > 30000))
                {
        ...
        if (DOES_CHAR_EXIST( l_U1096[16] ))
        {
            ...
            {
                GET_GAME_TIMER( ref iVar4 );
                if ((sub_18885( l_U1096[16], 1, 0 )) || ((iVar4 - l_U1220[16]) > 30000))
                {
        ...
        if (DOES_CHAR_EXIST( l_U1096[17] ))
        {
            ...
            {
                GET_GAME_TIMER( ref iVar4 );
                if ((sub_18885( l_U1096[17], 1, 0 )) || ((iVar4 - l_U1220[17]) > 30000))
                {
        ...
        if (DOES_CHAR_EXIST( l_U1096[23] ))
        {
            ...
            {
                GET_GAME_TIMER( ref iVar4 );
                if ((sub_18885( l_U1096[23], 1, 0 )) || ((iVar4 - l_U1220[23]) > 30000))
                {
        ...
        if (DOES_CHAR_EXIST( l_U1096[22] ))
        {
            ...
            {
                GET_GAME_TIMER( ref iVar4 );
                if ((sub_18885( l_U1096[22], 1, 0 )) || ((iVar4 - l_U1220[22]) > 30000))
                {
...
void sub_31867()
{
    ...
    switch (l_U976)
    {
        ...
        {
            GET_CHAR_COORDINATES( sub_2446(), ref uVar2._fU0, ref uVar2._fU4, ref uVar2._fU8 );
            if ((sub_5017()) || ((uVar2._fU8 > 23.00000000) || ((LOCATE_CHAR_ANY_MEANS_3D( sub_2446(), -1413.01400000 + l_U1508._fU0, 1086.70100000 + l_U1508._fU4, 23.78140000 + l_U1508._fU8, 2.00000000, 2.00000000, 2.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_2446(), -1407.17100000 + l_U1508._fU0, 1081.27700000 + l_U1508._fU4, 23.87270000 + l_U1508._fU8, 2.00000000, 2.00000000, 2.00000000, 0 )))))
            {
                REQUEST_MODEL( l_U1000 );
                l_U1669 = 1;
            }
        ...
        if (NOT l_U1513)
        {
            if (NOT (IS_CHAR_INJURED( l_U1412 )))
            {
                if (NOT l_U1476[5])
                {
                    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_2446(), -1236.89100000, 1095.73500000, 24.78530000, 1.00000000, 2.00000000, 4.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_2446(), -1236.79700000, 1093.44600000, 24.79840000, 1.00000000, 1.00000000, 1.00000000, 0 )))
                    {
                        STOP_PED_SPEAKING( sub_2446(), 1 );
        ...
        break;
        case 3:
        if ((IS_CHAR_INJURED( l_U1412 )) || (NOT (sub_20149( l_U1021 ))))
        {
...
void sub_34695()
{
    ...
    switch (l_U978)
    {
        ...
        if (l_U976 == 3)
        {
            ...
            else if ((HAS_CAR_RECORDING_BEEN_LOADED( 455 )) AND (HAS_MODEL_LOADED( l_U1002 )))
            {
                sub_5805( 20 );
                FORCE_WEATHER( 1 );
                l_U978 = 1;
        ...
        if (NOT (IS_CHAR_DEAD( l_U1406 )))
        {
            if ((sub_20684( l_U1406, 0 )) || ((sub_16282( l_U1406, sub_2446() )) || (((IS_CHAR_ON_SCREEN( l_U1406 )) AND (sub_35246())) || (sub_34899()))))
            {
        ...
        if (NOT (IS_CHAR_DEAD( l_U1406 )))
        {
            ...
            if ((LOCATE_CHAR_ANY_MEANS_3D( l_U1406, -1206.90500000, 1094.75300000, 17.78010000, 3.00000000, 3.00000000, 1.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_2446(), -1212.16000000, 1095.42700000, 24.68900000, 1.50000000, 1.00000000, 1.00000000, 0 )))
            {
                ...
                if (NOT l_U1666)
                {
                    if ((sub_36406( l_U1437 )) AND (NOT (IS_CAR_DEAD( l_U1437 ))))
                    {
                        TASK_ENTER_CAR_AS_DRIVER( 0, l_U1437, -2 );
                    }
                    else if ((sub_36406( l_U1086 )) AND (NOT (IS_CAR_DEAD( l_U1086 ))))
                    {
...
int sub_34899()
{
    if ((l_U1044) AND ((LOCATE_CHAR_ANY_MEANS_3D( sub_2446(), -1218.63500000, 1076.64200000, 24.78530000, 2.00000000, 4.00000000, 2.00000000, 0 )) AND (IS_BULLET_IN_AREA( -1213.74600000, 1094.93600000, 23.78050000, 3.00000000, 1 ))))
    {
...
void sub_49678()
{
    ...
    switch (l_U979)
    {
        ...
        if (l_U976 == 3)
        {
            ...
            else if ((HAS_MODEL_LOADED( l_U1004 )) AND ((HAS_MODEL_LOADED( l_U1003 )) AND (HAS_MODEL_LOADED( -622222821 ))))
            {
                sub_5805( 21 );
                l_U979 = 1;
            }
...
void sub_51078()
{
    ...
    switch (l_U977)
    {
        ...
        if (NOT (IS_CHAR_DEAD( l_U1406 )))
        {
            if ((NOT l_U1647) AND (IS_CHAR_IN_ANY_CAR( l_U1406 )))
            {
                sub_21685( "In car!" );
                if (NOT (IS_CAR_DEAD( l_U1437 )))
                {
        ...
        if (NOT l_U1647)
        {
            if (NOT (IS_CAR_DEAD( l_U1437 )))
            {
                if (NOT (IS_CHAR_INJURED( l_U1406 )))
                {
                    if ((NOT (IS_VEH_DRIVEABLE( l_U1437 ))) || (NOT (IS_CHAR_IN_CAR( l_U1406, l_U1437 ))))
                    {
                        if (NOT l_U1409)
                        {
...
void sub_54420(unknown uParam0)
{
    ...
    if ((iVar3 != 4) AND ((NOT sub_54588()) AND ((NOT (IS_CHAR_DEAD( (uParam0^) ))) AND ((IS_CHAR_IN_ANY_CAR( sub_2446() )) AND (IS_CONTROL_PRESSED( 0, 51 ))))))
    {
