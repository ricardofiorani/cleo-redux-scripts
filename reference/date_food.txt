void main()
{
    ...
    while (l_U205)
    {
        ...
        if ((NOT (IS_CHAR_DEAD( sub_141() ))) AND (NOT (IS_CHAR_DEAD( l_U211 ))))
        {
            switch (l_U204)
            {
                case 0:
                ...
                else
                {
                    ...
                    vVar5 = {1149.82800000, 737.20470000, 34.39920000};
                    fVar8 = 84.96000000;
                    fVar9 = 83.16000000;
                    if (l_U226 == 17)
                    {
                    ...
                    if ((l_U226 != 17) AND (NOT (IS_CAR_DEAD( l_U210 ))))
                    {
                    ...
                    else if (l_U226 != 17)
                    {
                        ...
                        l_U238 = {l_U235 + (vector( 0.50000000, 0.50000000, 1.00000000))};
                        GET_GROUND_Z_FOR_3D_COORD( l_U238._fU0, l_U238._fU4, l_U238._fU8, ref l_U238._fU8 );
                        SET_CHAR_COORDINATES( l_U211, l_U238._fU0, l_U238._fU4, l_U238._fU8 );
                    }
                    else
...
void sub_132(unknown uParam0)
{
    ...
    {
        if ((l_U207) AND (NOT (IS_GROUP_MEMBER( (uParam0^), sub_419() ))))
        {
...
int sub_759(unknown uParam0, int iParam1)
{
    if ((uParam0^))
    {
        if ((iParam1 > 0) AND ((IS_SCREEN_FADED_IN()) AND (sub_776())))
        {
            return 1;
        }
        else
...
void sub_4028(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        break;
        case 15:
        vVar3 = {32.20470000, 995.59880000, 13.70000000};
        fVar9 = 167.04000000;
        ...
        break;
        case 17:
        vVar3 = {1134.57600000, 753.51720000, 34.24350000};
        fVar9 = 276.48000000;
        vVar6 = {1149.67600000, 749.81730000, 34.94350000};
        break;
        case 18:
        vVar3 = {-427.43140000, 460.41540000, 9.64299900};
        fVar9 = 81.00000000;
        vVar6 = {-442.63140000, 454.11540000, 9.84300100};
        break;
        case 19:
