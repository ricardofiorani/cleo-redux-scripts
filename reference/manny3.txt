void main()
{
    ...
    l_U757 = 0;
    l_U758 = 0;
    l_U786 = {1068.31400000, -568.25000000, 30.44080000};
    ...
    while (l_U756)
    {
        ...
        switch (l_U597)
        {
            ...
            break;
            case 4:
            if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "MANNY3_LB2" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "MANNY3_LB1" )))
            {
                CLEAR_HELP();
            }
...
void sub_1746()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_1784( 5, g_U569[I] )) == 1))
        {
...
void sub_6088()
{
    while ((NOT sub_6282()) || (NOT sub_6097()))
    {
        WAIT( 0 );
    }
...
void sub_8416()
{
    ...
    switch (l_U600)
    {
        ...
        if (NOT (DOES_VEHICLE_EXIST( l_U704._fU0 )))
        {
            ...
            {
                SET_CAM_POS( l_U864[0], 895.51220000, 353.24850000, 39.90803000 );
            ...
            SET_CAM_POS( l_U868[0], 883.41240000, 265.12570000, 36.37964000 );
...
int sub_8434(unknown uParam0, int iParam1)
{
    if ((uParam0^))
    {
        if ((iParam1 > 0) AND ((IS_SCREEN_FADED_IN()) AND (sub_8451())))
        {
            return 1;
        }
        else
...
void sub_12247(unknown uParam0)
{
    ...
    if ((iVar3 != 4) AND ((NOT sub_12415()) AND ((NOT (IS_CHAR_DEAD( (uParam0^) ))) AND ((IS_CHAR_IN_ANY_CAR( sub_3660() )) AND (IS_CONTROL_PRESSED( 0, 51 ))))))
    {
...
void sub_12925()
{
    ...
    if ((IS_VEH_DRIVEABLE( l_U704._fU0 )) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_3660() )))
    {
        if (sub_12966())
        {
            GET_GAME_TIMER( ref iVar2 );
        ...
        else
        {
            ...
            {
                GET_FOLLOW_VEHICLE_CAM_SUBMODE( ref uVar3 );
                if ((iVar2 > (l_U811 + 12000)) || (NOT sub_13174()))
                {
                    if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "MANNY3_LB2" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "MANNY3_LB1" )))
                    {
                        CLEAR_HELP();
...
int sub_13174()
{
    ...
    if ((IS_CHAR_SITTING_IN_ANY_CAR( sub_3660() )) AND ((iVar2 != 5) AND (iVar2 != 4)))
    {
        return 1;
    }
    return 0;
...
void sub_14366(unknown uParam0)
{
    ...
    fVar5 = fVar3 * l_U595;
    Result = fVar4 + fVar5;
    if ((l_U813 < 20.00000000) || (sub_15935()))
    {
        if (NOT l_U757)
        {
            l_U757 = 1;
...
int sub_16677(unknown uParam0, boolean bParam1)
{
    ...
    else if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (l_U813 < (l_U815 * 0.85000000)))
    {
        l_U881 = 0;
    };;;
    return 0;
...
void sub_17337()
{
    if ((NOT (IS_CHAR_INJURED( l_U627[1]._fU0 ))) AND ((NOT (IS_CHAR_INJURED( l_U627[0]._fU0 ))) AND (NOT (IS_CHAR_INJURED( l_U602._fU0 )))))
    {
        if ((IS_VEH_DRIVEABLE( l_U678._fU0 )) AND ((IS_VEH_DRIVEABLE( l_U840[1] )) AND (IS_VEH_DRIVEABLE( l_U704._fU0 ))))
        {
            if ((NOT (IS_CHAR_IN_CAR( l_U627[1]._fU0, l_U678._fU0 ))) || ((NOT (IS_CHAR_IN_CAR( l_U627[0]._fU0, l_U678._fU0 ))) || (NOT (IS_CHAR_IN_CAR( l_U602._fU0, l_U678._fU0 )))))
            {
            ...
            if ((sub_20307( l_U627[1]._fU0 )) || ((sub_20307( l_U627[0]._fU0 )) || (sub_20307( l_U602._fU0 ))))
            {
    ...
    else
    {
        ...
        if ((NOT (IS_CAR_DEAD( l_U840[1] ))) AND (NOT (IS_CHAR_INJURED( l_U602._fU0 ))))
        {
            if (IS_CHAR_IN_CAR( l_U602._fU0, l_U840[1] ))
            {
                WARP_CHAR_FROM_CAR_TO_COORD( l_U602._fU0, l_U602._fU44[0]._fU0, l_U602._fU44[0]._fU4, l_U602._fU44[0]._fU8 );
        ...
        if ((NOT (IS_CAR_DEAD( l_U840[1] ))) AND (NOT (IS_CHAR_INJURED( l_U627[0]._fU0 ))))
        {
            if (IS_CHAR_IN_CAR( l_U627[0]._fU0, l_U840[1] ))
            {
                WARP_CHAR_FROM_CAR_TO_COORD( l_U627[0]._fU0, l_U627[0]._fU44[0]._fU0, l_U627[0]._fU44[0]._fU4, l_U627[0]._fU44[0]._fU8 );
        ...
        if ((NOT (IS_CAR_DEAD( l_U840[1] ))) AND (NOT (IS_CHAR_INJURED( l_U627[1]._fU0 ))))
        {
            if (IS_CHAR_IN_CAR( l_U627[1]._fU0, l_U840[1] ))
            {
                WARP_CHAR_FROM_CAR_TO_COORD( l_U627[1]._fU0, l_U627[1]._fU44[0]._fU0, l_U627[1]._fU44[0]._fU4, l_U627[1]._fU44[0]._fU8 );
    ...
    switch ((uParam1^))
    {
        ...
        if (NOT (IS_CAR_DEAD( l_U678._fU0 )))
        {
            if (NOT (IS_CHAR_IN_CAR( uParam0, l_U678._fU0 )))
            {
                ...
                else if ((NOT l_U850) AND (sub_19059( uParam0, uParam4, 20000 )))
                {
                    if (iParam3 < 0)
                    {
...
int sub_19059(unknown uParam0, unknown uParam1, int iParam2)
{
    ...
    else
    {
        ...
        if ((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( uParam0 ))) AND ((NOT (IS_CHAR_IN_ANY_CAR( uParam0 ))) AND (l_U862 >= ((uParam1^) + iParam2))))
        {
            if ((sub_17600( uParam0, 11 )) AND (sub_17600( uParam0, 12 )))
            {
                l_U850 = 1;
                return 0;
            }
...
int sub_20307(unknown uParam0)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3660() )) AND (IS_CHAR_IN_ANY_CAR( uParam0 )))
    {
    ...
    if ((l_U839) || ((sub_16718( sub_3660(), uParam0 )) < l_U882))
    {
        if ((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( uParam0, sub_3660() )) AND (IS_CHAR_ARMED( sub_3660(), 3 )))
        {
        ...
        if (IS_VEH_DRIVEABLE( l_U678._fU0 ))
        {
            if (NOT (IS_CHAR_DEAD( l_U627[1]._fU0 )))
            {
                if (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U602._fU0, l_U801._fU0, l_U801._fU4, l_U801._fU8, 4.00000000, 4.00000000, 4.00000000, 0 )))
                {
                    ...
                    if (NOT l_U884)
                    {
                        if ((sub_19282( l_U678._fU0 )) || (HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U678._fU0, sub_3660() )))
                        {
                            if (sub_22776())
                            {
            ...
            STOP_PED_SPEAKING( sub_3660(), 1 );
            l_U597 = 7;;
            if ((IS_CHAR_INJURED( l_U627[1]._fU0 )) || ((IS_CHAR_INJURED( l_U627[0]._fU0 )) || (sub_25198( l_U602._fU0 ))))
            {
            ...
            else if (((LOCATE_CHAR_ON_FOOT_CAR_2D( sub_3660(), l_U678._fU0, 2.00000000, 2.00000000, 0 )) AND (IS_CHAR_GETTING_IN_TO_A_CAR( sub_3660() ))) || (IS_CHAR_IN_CAR( sub_3660(), l_U678._fU0 )))
            {
                if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U678._fU0 ))
                {
                    STOP_PLAYBACK_RECORDED_CAR( l_U678._fU0 );
...
int sub_22776()
{
    if (IS_VEH_DRIVEABLE( l_U678._fU0 ))
    {
        if ((NOT (IS_CHAR_INJURED( l_U627[1]._fU0 ))) AND ((NOT (IS_CHAR_INJURED( l_U627[0]._fU0 ))) AND (NOT (IS_CHAR_INJURED( l_U602._fU0 )))))
        {
            if ((NOT (IS_CHAR_SITTING_IN_CAR( l_U627[1]._fU0, l_U678._fU0 ))) || ((NOT (IS_CHAR_SITTING_IN_CAR( l_U627[0]._fU0, l_U678._fU0 ))) || (NOT (IS_CHAR_SITTING_IN_CAR( l_U602._fU0, l_U678._fU0 )))))
            {
...
void sub_26278()
{
    if ((NOT (IS_CAR_DEAD( l_U678._fU0 ))) AND ((NOT (IS_CHAR_DEAD( l_U627[1]._fU0 ))) AND ((NOT (IS_CHAR_DEAD( l_U627[0]._fU0 ))) AND (NOT (IS_CHAR_DEAD( l_U602._fU0 ))))))
    {
        switch (l_U601)
        {
            case 0:
            ...
            break;
            case 4:
            if ((NOT (IS_CHAR_IN_CAR( l_U627[1]._fU0, l_U678._fU0 ))) AND ((NOT (IS_CHAR_IN_CAR( l_U627[0]._fU0, l_U678._fU0 ))) AND (NOT (IS_CHAR_IN_CAR( l_U602._fU0, l_U678._fU0 )))))
            {
...
void sub_27295()
{
    ...
    if (NOT (sub_16677( 0.65000000, 0 )))
    {
        ...
        for ( I = 0; I < l_U627; I++ )
        {
            ...
            else if ((sub_17600( l_U627[I]._fU0, 29 )) AND (sub_17600( l_U627[I]._fU0, 91 )))
            {
