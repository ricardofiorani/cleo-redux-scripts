    ...
    while (true)
    {
        ...
        if (IS_PLAYER_PLAYING( sub_112() ))
        {
            ...
            for ( I = 0; I <= 1; I++ )
            {
                ...
                {
                    case 1:
                    if ((g_U9241._fU124[I] == 1) || ((g_U9241._fU112[I] == g_U9241._fU136[I]) AND (g_U9241._fU124[I] == 2)))
                    {
                        sub_314( I );
                        g_U9241._fU148[I] = 7;
                        break;
                    ...
                    if (I == 0)
                    {
                        if ((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref g_U9241._fU64[1] ))) AND (g_U9241._fU0 >= g_U9241._fU4[0]))
                        {
                            g_U9241._fU100[0]++;
                            g_U9241._fU112[0]++;
                            g_U9241._fU148[0] = 3;
