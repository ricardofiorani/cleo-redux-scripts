...
void sub_274()
{
    ...
    l_U486 = 1;
    if ((sub_644()) || ((sub_593()) || ((IS_WANTED_LEVEL_GREATER( sub_302(), 0 )) || ((IS_THREAD_ACTIVE( g_U812 )) || (g_U10978)))))
    {
        sub_346();
        return;
    }
    if (l_U483)
    {
        if ((sub_1310( 0 )) || ((NOT (sub_1244( 0, 30000 ))) || (sub_865( 0 ))))
        {
            sub_346();
            return;
        }
...
int sub_1654(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_2181()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_21982()
{
    ...
    {
        if ((g_U569[I]._fU20) AND ((sub_22020( 5, g_U569[I] )) == 1))
        {
