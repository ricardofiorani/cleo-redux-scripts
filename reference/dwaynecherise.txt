...
void sub_380()
{
    ...
    if ((sub_1048()) || ((sub_672( 20000 )) || ((sub_472()) || ((sub_421()) || ((IS_WANTED_LEVEL_GREATER( sub_264(), 0 )) || ((IS_THREAD_ACTIVE( g_U812 )) || (g_U10978)))))))
    {
        return 0;
    }
    if ((sub_1161( 7 )) || (NOT (sub_1096( 7, 30000 ))))
    {
        return 0;
    }
...
int sub_1323(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_1554() ))) AND (IS_CHAR_IN_ANY_CAR( sub_1554() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_1886()))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
